...
class MutableLiveBlogPosting {
  ...
  var coverageStartTime: java.util.Date by map
  var coverageEndTime: java.util.Date by map
  var liveBlogUpdate: BlogPosting by map
  fun liveBlogUpdate(builder: MutableBlogPosting.() -> Unit) { liveBlogUpdate = MutableBlogPosting().apply(builder).build() }
  var sharedContent: CreativeWork by map
  fun sharedContent(builder: MutableCreativeWork.() -> Unit) { sharedContent = MutableCreativeWork().apply(builder).build() }
