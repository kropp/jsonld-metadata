...
class MutableQuestion {
  ...
  var upvoteCount: Int by map
  var downvoteCount: Int by map
  var answerCount: Int by map
  var acceptedAnswer: Answer by map
  fun acceptedAnswer(builder: MutableAnswer.() -> Unit) { acceptedAnswer = MutableAnswer().apply(builder).build() }
  var suggestedAnswer: SuggestedAnswer by map
