...
class MutableSoftwareSourceCode {
  ...
  var codeRepository: String by map
  var programmingLanguage: Any by map
  fun programmingLanguageComputerLanguage(builder: MutableComputerLanguage.() -> Unit) { programmingLanguage = MutableComputerLanguage().apply(builder).build() }
  var runtimePlatform: String by map
  var codeSampleType: String by map
  var targetProduct: SoftwareApplication by map
  fun targetProduct(builder: MutableSoftwareApplication.() -> Unit) { targetProduct = MutableSoftwareApplication().apply(builder).build() }
