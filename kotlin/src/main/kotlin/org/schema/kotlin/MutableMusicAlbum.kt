...
class MutableMusicAlbum {
  ...
  var byArtist: MusicGroup by map
  fun byArtist(builder: MutableMusicGroup.() -> Unit) { byArtist = MutableMusicGroup().apply(builder).build() }
  var albumProductionType: MusicAlbumProductionType by map
  var albumReleaseType: MusicAlbumReleaseType by map
  var albumRelease: MusicRelease by map
  fun albumRelease(builder: MutableMusicRelease.() -> Unit) { albumRelease = MutableMusicRelease().apply(builder).build() }
