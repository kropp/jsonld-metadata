...
class MutableCar {
  ...
  var numberOfDoors: Any by map
  fun numberOfDoorsQuantitativeValue(builder: MutableQuantitativeValue.() -> Unit) { numberOfDoors = MutableQuantitativeValue().apply(builder).build() }
  var numberOfAirbags: Any by map
  var numberOfAxles: Any by map
  fun numberOfAxlesQuantitativeValue(builder: MutableQuantitativeValue.() -> Unit) { numberOfAxles = MutableQuantitativeValue().apply(builder).build() }
  var vehicleEngine: EngineSpecification by map
  fun vehicleEngine(builder: MutableEngineSpecification.() -> Unit) { vehicleEngine = MutableEngineSpecification().apply(builder).build() }
  var fuelConsumption: QuantitativeValue by map
  fun fuelConsumption(builder: MutableQuantitativeValue.() -> Unit) { fuelConsumption = MutableQuantitativeValue().apply(builder).build() }
  var fuelEfficiency: QuantitativeValue by map
  fun fuelEfficiency(builder: MutableQuantitativeValue.() -> Unit) { fuelEfficiency = MutableQuantitativeValue().apply(builder).build() }
  var numberOfForwardGears: Any by map
  fun numberOfForwardGearsQuantitativeValue(builder: MutableQuantitativeValue.() -> Unit) { numberOfForwardGears = MutableQuantitativeValue().apply(builder).build() }
  var vehicleIdentificationNumber: String by map
  var cargoVolume: QuantitativeValue by map
  fun cargoVolume(builder: MutableQuantitativeValue.() -> Unit) { cargoVolume = MutableQuantitativeValue().apply(builder).build() }
  var vehicleConfiguration: String by map
  var knownVehicleDamages: String by map
  var dateVehicleFirstRegistered: java.util.Date by map
  var driveWheelConfiguration: Any by map
  fun driveWheelConfigurationDriveWheelConfigurationValue(builder: MutableDriveWheelConfigurationValue.() -> Unit) { driveWheelConfiguration = MutableDriveWheelConfigurationValue().apply(builder).build() }
  ...
  var vehicleInteriorColor: String by map
  var vehicleInteriorType: String by map
  var mileageFromOdometer: QuantitativeValue by map
  fun mileageFromOdometer(builder: MutableQuantitativeValue.() -> Unit) { mileageFromOdometer = MutableQuantitativeValue().apply(builder).build() }
  var vehicleModelDate: java.util.Date by map
  var numberOfPreviousOwners: Any by map
  fun numberOfPreviousOwnersQuantitativeValue(builder: MutableQuantitativeValue.() -> Unit) { numberOfPreviousOwners = MutableQuantitativeValue().apply(builder).build() }
  var productionDate: java.util.Date by map
  var purchaseDate: java.util.Date by map
  var vehicleSeatingCapacity: Any by map
  fun vehicleSeatingCapacityQuantitativeValue(builder: MutableQuantitativeValue.() -> Unit) { vehicleSeatingCapacity = MutableQuantitativeValue().apply(builder).build() }
  var vehicleTransmission: Any by map
  fun vehicleTransmissionQualitativeValue(builder: MutableQualitativeValue.() -> Unit) { vehicleTransmission = MutableQualitativeValue().apply(builder).build() }
  var steeringPosition: SteeringPositionValue by map
  fun steeringPosition(builder: MutableSteeringPositionValue.() -> Unit) { steeringPosition = MutableSteeringPositionValue().apply(builder).build() }
  var vehicleSpecialUsage: String by map
