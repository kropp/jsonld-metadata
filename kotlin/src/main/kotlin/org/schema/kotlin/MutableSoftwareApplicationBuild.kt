...
class MutableSoftwareApplicationBuild {
  ...
  var softwareApplication: SoftwareApplication by map
  fun softwareApplication(builder: MutableSoftwareApplication.() -> Unit) { softwareApplication = MutableSoftwareApplication().apply(builder).build() }
  var project: Project by map
  fun project(builder: MutableProject.() -> Unit) { project = MutableProject().apply(builder).build() }
  var status: Status by map
  var state: BuildState by map
  var message: String by map
  var totalTestsCount: Int by map
  var successTestsCount: Int by map
  var failedTestsCount: Int by map
  var newlyFailedTestsCount: Int by map
  var ignoredTestsCount: Int by map
  var fixedTestsCount: Int by map
  var sourceCodeRevision: SourceCodeRevision by map
  fun sourceCodeRevision(builder: MutableSourceCodeRevision.() -> Unit) { sourceCodeRevision = MutableSourceCodeRevision().apply(builder).build() }
  var applicationCategory: String by map
  var applicationSubCategory: String by map
  var applicationSuite: String by map
  var countriesNotSupported: String by map
  var countriesSupported: String by map
  var availableOnDevice: String by map
  var downloadUrl: String by map
  var featureList: String by map
  var fileSize: String by map
  var installUrl: String by map
  var memoryRequirements: String by map
  var operatingSystem: String by map
  var permissions: String by map
  var processorRequirements: String by map
  var releaseNotes: String by map
  var softwareRequirements: String by map
  var screenshot: Any by map
  fun screenshotImageObject(builder: MutableImageObject.() -> Unit) { screenshot = MutableImageObject().apply(builder).build() }
  var softwareVersion: String by map
  var storageRequirements: String by map
  var supportingData: DataFeed by map
  fun supportingData(builder: MutableDataFeed.() -> Unit) { supportingData = MutableDataFeed().apply(builder).build() }
  var softwareAddOn: SoftwareApplication by map
  fun softwareAddOn(builder: MutableSoftwareApplication.() -> Unit) { softwareAddOn = MutableSoftwareApplication().apply(builder).build() }
  var softwareHelp: CreativeWork by map
  fun softwareHelp(builder: MutableCreativeWork.() -> Unit) { softwareHelp = MutableCreativeWork().apply(builder).build() }
