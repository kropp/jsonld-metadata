...
class MutableDataFeed {
  ...
  var dataFeedElement: Any by map
  fun dataFeedElementDataFeedItem(builder: MutableDataFeedItem.() -> Unit) { dataFeedElement = MutableDataFeedItem().apply(builder).build() }
  fun dataFeedElementThing(builder: MutableThing.() -> Unit) { dataFeedElement = MutableThing().apply(builder).build() }
  var includedInDataCatalog: DataCatalog by map
  fun includedInDataCatalog(builder: MutableDataCatalog.() -> Unit) { includedInDataCatalog = MutableDataCatalog().apply(builder).build() }
  var distribution: DataDownload by map
  fun distribution(builder: MutableDataDownload.() -> Unit) { distribution = MutableDataDownload().apply(builder).build() }
