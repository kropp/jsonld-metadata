...
class MutableProductModel {
  ...
  var isVariantOf: ProductModel by map
  fun isVariantOf(builder: MutableProductModel.() -> Unit) { isVariantOf = MutableProductModel().apply(builder).build() }
  var predecessorOf: ProductModel by map
  fun predecessorOf(builder: MutableProductModel.() -> Unit) { predecessorOf = MutableProductModel().apply(builder).build() }
  var successorOf: ProductModel by map
  fun successorOf(builder: MutableProductModel.() -> Unit) { successorOf = MutableProductModel().apply(builder).build() }
