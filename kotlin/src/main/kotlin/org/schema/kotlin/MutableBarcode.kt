...
class MutableBarcode {
  ...
  var exifData: Any by map
  fun exifDataPropertyValue(builder: MutablePropertyValue.() -> Unit) { exifData = MutablePropertyValue().apply(builder).build() }
  var representativeOfPage: Boolean by map
