...
class MutableEndorseAction {
  ...
  var endorsee: Any by map
  fun endorseeOrganization(builder: MutableOrganization.() -> Unit) { endorsee = MutableOrganization().apply(builder).build() }
  fun endorseePerson(builder: MutablePerson.() -> Unit) { endorsee = MutablePerson().apply(builder).build() }
