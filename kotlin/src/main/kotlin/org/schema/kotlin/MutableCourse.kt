...
class MutableCourse {
  ...
  var courseCode: String by map
  var coursePrerequisites: Any by map
  fun coursePrerequisitesAlignmentObject(builder: MutableAlignmentObject.() -> Unit) { coursePrerequisites = MutableAlignmentObject().apply(builder).build() }
  fun coursePrerequisitesCourse(builder: MutableCourse.() -> Unit) { coursePrerequisites = MutableCourse().apply(builder).build() }
  var hasCourseInstance: CourseInstance by map
  fun hasCourseInstance(builder: MutableCourseInstance.() -> Unit) { hasCourseInstance = MutableCourseInstance().apply(builder).build() }
