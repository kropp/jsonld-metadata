...
class MutableRentalCarReservation {
  ...
  var pickupLocation: Place by map
  fun pickupLocation(builder: MutablePlace.() -> Unit) { pickupLocation = MutablePlace().apply(builder).build() }
  var dropoffLocation: Place by map
  fun dropoffLocation(builder: MutablePlace.() -> Unit) { dropoffLocation = MutablePlace().apply(builder).build() }
  var pickupTime: java.util.Date by map
  var dropoffTime: java.util.Date by map
