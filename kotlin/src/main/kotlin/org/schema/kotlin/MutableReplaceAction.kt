...
class MutableReplaceAction {
  ...
  var replacee: Thing by map
  fun replacee(builder: MutableThing.() -> Unit) { replacee = MutableThing().apply(builder).build() }
  var replacer: Thing by map
  fun replacer(builder: MutableThing.() -> Unit) { replacer = MutableThing().apply(builder).build() }
  var targetCollection: Thing by map
  fun targetCollection(builder: MutableThing.() -> Unit) { targetCollection = MutableThing().apply(builder).build() }
