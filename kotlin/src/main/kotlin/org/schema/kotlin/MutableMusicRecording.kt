...
class MutableMusicRecording {
  ...
  var inAlbum: MusicAlbum by map
  fun inAlbum(builder: MutableMusicAlbum.() -> Unit) { inAlbum = MutableMusicAlbum().apply(builder).build() }
  var inPlaylist: MusicPlaylist by map
  fun inPlaylist(builder: MutableMusicPlaylist.() -> Unit) { inPlaylist = MutableMusicPlaylist().apply(builder).build() }
  var isrcCode: String by map
  var recordingOf: MusicComposition by map
  fun recordingOf(builder: MutableMusicComposition.() -> Unit) { recordingOf = MutableMusicComposition().apply(builder).build() }
