...
class MutableFlightReservation {
  ...
  var boardingGroup: String by map
  var passengerSequenceNumber: String by map
  var securityScreening: String by map
  var passengerPriorityStatus: Any by map
  fun passengerPriorityStatusQualitativeValue(builder: MutableQualitativeValue.() -> Unit) { passengerPriorityStatus = MutableQualitativeValue().apply(builder).build() }
