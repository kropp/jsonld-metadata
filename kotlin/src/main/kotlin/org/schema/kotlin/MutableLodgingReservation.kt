...
class MutableLodgingReservation {
  ...
  var checkinTime: java.util.Date by map
  var checkoutTime: java.util.Date by map
  var lodgingUnitType: Any by map
  fun lodgingUnitTypeQualitativeValue(builder: MutableQualitativeValue.() -> Unit) { lodgingUnitType = MutableQualitativeValue().apply(builder).build() }
  var lodgingUnitDescription: String by map
  var numAdults: Any by map
  fun numAdultsQuantitativeValue(builder: MutableQuantitativeValue.() -> Unit) { numAdults = MutableQuantitativeValue().apply(builder).build() }
  var numChildren: Any by map
  fun numChildrenQuantitativeValue(builder: MutableQuantitativeValue.() -> Unit) { numChildren = MutableQuantitativeValue().apply(builder).build() }
