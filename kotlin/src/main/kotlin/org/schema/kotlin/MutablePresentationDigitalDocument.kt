...
class MutablePresentationDigitalDocument {
  ...
  var hasDigitalDocumentPermission: DigitalDocumentPermission by map
  fun hasDigitalDocumentPermission(builder: MutableDigitalDocumentPermission.() -> Unit) { hasDigitalDocumentPermission = MutableDigitalDocumentPermission().apply(builder).build() }
