...
class MutableVideoGame {
  ...
  var musicBy: Any by map
  fun musicByMusicGroup(builder: MutableMusicGroup.() -> Unit) { musicBy = MutableMusicGroup().apply(builder).build() }
  fun musicByPerson(builder: MutablePerson.() -> Unit) { musicBy = MutablePerson().apply(builder).build() }
  var trailer: VideoObject by map
  fun trailer(builder: MutableVideoObject.() -> Unit) { trailer = MutableVideoObject().apply(builder).build() }
  var playMode: GamePlayMode by map
  var cheatCode: CreativeWork by map
  fun cheatCode(builder: MutableCreativeWork.() -> Unit) { cheatCode = MutableCreativeWork().apply(builder).build() }
  var gameTip: CreativeWork by map
  fun gameTip(builder: MutableCreativeWork.() -> Unit) { gameTip = MutableCreativeWork().apply(builder).build() }
  var gamePlatform: Any by map
  fun gamePlatformThing(builder: MutableThing.() -> Unit) { gamePlatform = MutableThing().apply(builder).build() }
  var gameServer: GameServer by map
  fun gameServer(builder: MutableGameServer.() -> Unit) { gameServer = MutableGameServer().apply(builder).build() }
  var numberOfPlayers: QuantitativeValue by map
  fun numberOfPlayers(builder: MutableQuantitativeValue.() -> Unit) { numberOfPlayers = MutableQuantitativeValue().apply(builder).build() }
  var quest: Thing by map
  fun quest(builder: MutableThing.() -> Unit) { quest = MutableThing().apply(builder).build() }
  var gameItem: Thing by map
  fun gameItem(builder: MutableThing.() -> Unit) { gameItem = MutableThing().apply(builder).build() }
  var characterAttribute: Thing by map
  fun characterAttribute(builder: MutableThing.() -> Unit) { characterAttribute = MutableThing().apply(builder).build() }
  var gameLocation: Any by map
  fun gameLocationPlace(builder: MutablePlace.() -> Unit) { gameLocation = MutablePlace().apply(builder).build() }
  fun gameLocationPostalAddress(builder: MutablePostalAddress.() -> Unit) { gameLocation = MutablePostalAddress().apply(builder).build() }
