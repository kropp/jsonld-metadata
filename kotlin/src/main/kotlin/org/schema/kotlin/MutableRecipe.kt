...
class MutableRecipe {
  ...
  var totalTime: Duration by map
  var cookTime: Duration by map
  var cookingMethod: String by map
  ...
  var prepTime: Duration by map
  var recipeCategory: String by map
  var recipeCuisine: String by map
  var recipeIngredient: String by map
  var recipeInstructions: Any by map
  fun recipeInstructionsItemList(builder: MutableItemList.() -> Unit) { recipeInstructions = MutableItemList().apply(builder).build() }
  var recipeYield: String by map
