...
class MutableMusicComposition {
  ...
  var musicArrangement: MusicComposition by map
  fun musicArrangement(builder: MutableMusicComposition.() -> Unit) { musicArrangement = MutableMusicComposition().apply(builder).build() }
  ...
  var firstPerformance: Event by map
  fun firstPerformance(builder: MutableEvent.() -> Unit) { firstPerformance = MutableEvent().apply(builder).build() }
  var includedComposition: MusicComposition by map
  fun includedComposition(builder: MutableMusicComposition.() -> Unit) { includedComposition = MutableMusicComposition().apply(builder).build() }
  var iswcCode: String by map
  var lyricist: Person by map
  fun lyricist(builder: MutablePerson.() -> Unit) { lyricist = MutablePerson().apply(builder).build() }
  var musicCompositionForm: String by map
  var musicalKey: String by map
  var recordedAs: MusicRecording by map
  fun recordedAs(builder: MutableMusicRecording.() -> Unit) { recordedAs = MutableMusicRecording().apply(builder).build() }
  var lyrics: CreativeWork by map
  fun lyrics(builder: MutableCreativeWork.() -> Unit) { lyrics = MutableCreativeWork().apply(builder).build() }
