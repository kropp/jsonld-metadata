...
class MutableUserComments {
  ...
  var commentText: String by map
  var commentTime: java.util.Date by map
  ...
  var discusses: CreativeWork by map
  fun discusses(builder: MutableCreativeWork.() -> Unit) { discusses = MutableCreativeWork().apply(builder).build() }
  var replyToUrl: String by map
