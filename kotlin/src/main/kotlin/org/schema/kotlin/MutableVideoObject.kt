...
class MutableVideoObject {
  ...
  var thumbnail: ImageObject by map
  fun thumbnail(builder: MutableImageObject.() -> Unit) { thumbnail = MutableImageObject().apply(builder).build() }
  var transcript: String by map
  var videoFrameSize: String by map
  var videoQuality: String by map
