...
class MutableBook {
  ...
  var bookEdition: String by map
  var bookFormat: BookFormatType by map
  var illustrator: Person by map
  fun illustrator(builder: MutablePerson.() -> Unit) { illustrator = MutablePerson().apply(builder).build() }
  var isbn: Identifier by map
  var numberOfPages: Int by map
