...
class MutableMenu {
  ...
  var hasMenuItem: MenuItem by map
  fun hasMenuItem(builder: MutableMenuItem.() -> Unit) { hasMenuItem = MutableMenuItem().apply(builder).build() }
  var hasMenuSection: MenuSection by map
  fun hasMenuSection(builder: MutableMenuSection.() -> Unit) { hasMenuSection = MutableMenuSection().apply(builder).build() }
