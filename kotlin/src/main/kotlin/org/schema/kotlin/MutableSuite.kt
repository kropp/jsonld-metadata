...
class MutableSuite {
  ...
  var bed: Any by map
  fun bedBedDetails(builder: MutableBedDetails.() -> Unit) { bed = MutableBedDetails().apply(builder).build() }
  var numberOfRooms: Any by map
  var occupancy: QuantitativeValue by map
  fun occupancy(builder: MutableQuantitativeValue.() -> Unit) { occupancy = MutableQuantitativeValue().apply(builder).build() }
  ...
  var floorSize: QuantitativeValue by map
  fun floorSize(builder: MutableQuantitativeValue.() -> Unit) { floorSize = MutableQuantitativeValue().apply(builder).build() }
  var permittedUsage: String by map
  var petsAllowed: Any by map
