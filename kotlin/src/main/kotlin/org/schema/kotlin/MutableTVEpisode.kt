...
class MutableTVEpisode {
  ...
  var countryOfOrigin: Country by map
  fun countryOfOrigin(builder: MutableCountry.() -> Unit) { countryOfOrigin = MutableCountry().apply(builder).build() }
  var subtitleLanguage: Any by map
  fun subtitleLanguageLanguage(builder: MutableLanguage.() -> Unit) { subtitleLanguage = MutableLanguage().apply(builder).build() }
  ...
  var partOfSeason: IsPartOf by map
  var partOfSeries: IsPartOf by map
