...
class MutablePerformAction {
  ...
  var entertainmentBusiness: EntertainmentBusiness by map
  fun entertainmentBusiness(builder: MutableEntertainmentBusiness.() -> Unit) { entertainmentBusiness = MutableEntertainmentBusiness().apply(builder).build() }
