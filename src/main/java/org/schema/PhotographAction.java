...
public class PhotographAction extends CreateAction {
  /**
   * Builder for {@see PhotographAction}
   */
  public static final class Builder {
    public PhotographAction build() {
      return new PhotographAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
