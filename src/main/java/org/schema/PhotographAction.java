...
public class PhotographAction extends CreateAction {
  ...
  public static final class Builder {
    ...
    public PhotographAction build() {
      return new PhotographAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
