...
public class FDAcategoryA {
  ...
  @Override public boolean equals(Object o) {
    ...
    FDAcategoryA fDAcategoryA = (FDAcategoryA) o;
   ...
   */
  public static class Builder implements ThingBuilder<FDAcategoryA> {
    public FDAcategoryA build() {
      return new FDAcategoryA();
    }
