...
public class MediaObject extends CreativeWork {
  ...
  protected MediaObject(Person editor, Person producer, Review review, Duration timeRequired, Organization creator, Offer offers, String educationalUse, String alternativeHeadline, Duration duration, Thing mentions, String additionalType, String contentUrl, Position position, MediaObject associatedMedia, NewsArticle associatedArticle, Boolean isFamilyFriendly, String playerType, Image image, String accessibilityControl, String keywords, String embedUrl, String discussionUrl, String encodingFormat, CreativeWork exampleOfWork, String isBasedOnUrl, Comment comment, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, String bitrate, Place regionsAllowed, Person character, String schemaVersion, String accessibilityAPI, String contentSize, MediaObject encoding, String headline, String publishingPrinciples, Number version, Thing mainEntity, Integer commentCount, Distance width, String genre, Boolean requiresSubscription, Action potentialAction, Audience audience, String contentRating, String inLanguage, Place contentLocation, String learningResourceType, Person accountablePerson, AudioObject audio, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, String accessibilityFeature, String accessibilityHazard, Organization productionCompany, CreativeWork license, String description, PublicationEvent publication, Person provider, java.util.Date uploadDate, AlignmentObject educationalAlignment, Event recordedAt, CreativeWork mainEntityOfPage, Organization contributor, IsPartOf isPartOf, CreativeWork workExample, java.util.Date dateCreated, Organization copyrightHolder, AggregateRating aggregateRating, String sameAs, java.util.Date expires, Distance height, String name, CreativeWork encodesCreativeWork, String typicalAgeRange, CreativeWork citation, Number copyrightYear, Person translator, Organization sourceOrganization, String text, String award) {
