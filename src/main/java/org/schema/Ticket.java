...
public class Ticket extends Intangible {
   ...
   */
  public static final class TicketThingBuilder implements Builder {
    /**
     ...
     * The seat associated with the ticket.
     */
    public Builder ticketedSeat(Seat.Builder seat) {
  ...
  Builder dateIssued(java.util.Date date);
  Builder ticketedSeat(Seat seat);
  Builder ticketedSeat(Seat.Builder seat);
  Builder ticketNumber(String ticketNumber);
  Builder ticketToken(String ticketToken);
