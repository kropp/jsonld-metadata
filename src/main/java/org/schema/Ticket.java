...
public class Ticket extends Intangible {
  ...
  public static final class Builder {
     ...
     */
    public Ticket build() {
      return new Ticket(totalPrice, priceCurrency, ticketedSeat, name, underName, dateIssued, ticketToken, mainEntityOfPage, additionalType, url, sameAs, alternateName, potentialAction, description, ticketNumber, issuedBy);
    }
    /**
     * The total price for the reservation or ticket, including applicable taxes, shipping, etc.
     */
  ...
  protected Ticket(PriceSpecificationOrStringOrNumber totalPrice, String priceCurrency, Seat ticketedSeat, String name, OrganizationOrPerson underName, java.util.Date dateIssued, String ticketToken, StringOrCreativeWork mainEntityOfPage, String additionalType, String url, String sameAs, String alternateName, Action potentialAction, String description, String ticketNumber, Organization issuedBy) {
