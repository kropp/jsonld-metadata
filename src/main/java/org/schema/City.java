...
public class City extends AdministrativeArea {
  ...
  public static final class Builder {
    /**
     * Creates new {@link City} instance.
     */
    public City build() {
      return new City(aggregateRating, review, logo, isicV4, globalLocationNumber, name, mainEntityOfPage, hasMap, event, containedIn, additionalType, sameAs, url, alternateName, openingHoursSpecification, faxNumber, telephone, geo, description, potentialAction, additionalProperty, photo, address);
    }
    /**
