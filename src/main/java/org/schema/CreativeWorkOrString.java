...
public class CreativeWorkOrString {
  ...
  @Override public int hashCode() {
    int result = 0;
    result = 31 * result + (myCreativeWork != null ? myCreativeWork.hashCode() : 0);
  ...
  @Override public boolean equals(Object o) {
    ...
    CreativeWorkOrString creativeWorkOrString = (CreativeWorkOrString) o;
    if (myCreativeWork != null ? !myCreativeWork.equals(creativeWorkOrString.myCreativeWork) : creativeWorkOrString.myCreativeWork != null) return false;
    if (myString != null ? !myString.equals(creativeWorkOrString.myString) : creativeWorkOrString.myString != null) return false;
    return true;
  }
