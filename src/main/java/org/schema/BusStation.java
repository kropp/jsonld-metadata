...
public class BusStation extends CivicStructure {
  /**
   * Builder for {@see BusStation}
   */
  public static final class Builder {
    public BusStation build() {
      return new BusStation(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
