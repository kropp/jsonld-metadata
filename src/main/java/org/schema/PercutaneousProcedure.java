...
public class PercutaneousProcedure {
  ...
  @Override public boolean equals(Object o) {
    ...
    PercutaneousProcedure percutaneousProcedure = (PercutaneousProcedure) o;
   ...
   */
  public static class Builder implements ThingBuilder<PercutaneousProcedure> {
    public PercutaneousProcedure build() {
      return new PercutaneousProcedure();
    }
