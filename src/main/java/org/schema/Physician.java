...
public class Physician extends MedicalOrganization {
   ...
   */
  public MedicalTherapyOrMedicalTestOrMedicalProcedure getAvailableService() {
  ...
  public static final class Builder {
    ...
    public Physician build() {
      return new Physician(aggregateRating, review, logo, parentOrganization, sameAs, additionalType, event, containedIn, priceRange, openingHoursSpecification, currenciesAccepted, availableService, potentialAction, address, additionalProperty, openingHours, globalLocationNumber, isicV4, name, paymentAccepted, mainEntityOfPage, hasMap, hospitalAffiliation, url, faxNumber, alternateName, telephone, geo, medicalSpecialty, description, photo);
    }
    /**
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
    ...
    private MedicalTherapyOrMedicalTestOrMedicalProcedure availableService;
  ...
  protected Physician(AggregateRating aggregateRating, Review review, ImageObjectOrString logo, Organization parentOrganization, String sameAs, String additionalType, Event event, Place containedIn, String priceRange, OpeningHoursSpecification openingHoursSpecification, String currenciesAccepted, MedicalTherapyOrMedicalTestOrMedicalProcedure availableService, Action potentialAction, PostalAddress address, PropertyValue additionalProperty, String openingHours, String globalLocationNumber, String isicV4, String name, String paymentAccepted, StringOrCreativeWork mainEntityOfPage, MapOrString hasMap, Hospital hospitalAffiliation, String url, String faxNumber, String alternateName, String telephone, GeoCoordinatesOrGeoShape geo, MedicalSpecialty medicalSpecialty, String description, ImageObjectOrPhotograph photo) {
  ...
  private MedicalTherapyOrMedicalTestOrMedicalProcedure myAvailableService;
