...
public class Physician extends MedicalOrganization {
  ...
  static final class PhysicianThingBuilder implements Builder {
     ...
     * A medical service available from this provider.
     */
    @NotNull public Builder availableService(MedicalProcedure medicalProcedure) {
     ...
     * A medical service available from this provider.
     */
    @NotNull public Builder availableService(MedicalProcedure.Builder medicalProcedure) {
      return this.availableService(medicalProcedure.build());
    }
    /**
     * A medical service available from this provider.
     */
    @NotNull public Builder availableService(MedicalTest medicalTest) {
      if (this.availableService == null) this.availableService = new MedicalProcedureOrMedicalTestOrMedicalTherapy();
     ...
     * A medical service available from this provider.
     */
    @NotNull public Builder availableService(MedicalTest.Builder medicalTest) {
      return this.availableService(medicalTest.build());
    }
    /**
     * A medical service available from this provider.
     */
    @NotNull public Builder availableService(MedicalTherapy medicalTherapy) {
      if (this.availableService == null) this.availableService = new MedicalProcedureOrMedicalTestOrMedicalTherapy();
     ...
     * A medical service available from this provider.
     */
    @NotNull public Builder availableService(MedicalTherapy.Builder medicalTherapy) {
      return this.availableService(medicalTherapy.build());
    }
    /**
     * A hospital with which the physician or office is affiliated.
     */
    @NotNull public Builder hospitalAffiliation(Hospital hospital) {
     ...
     * A hospital with which the physician or office is affiliated.
     */
    @NotNull public Builder hospitalAffiliation(Hospital.Builder hospital) {
      return this.hospitalAffiliation(hospital.build());
    }
    /**
     * A medical specialty of the provider.
     */
    @NotNull public Builder medicalSpecialty(MedicalSpecialty medicalSpecialty) {
     ...
     * A medical specialty of the provider.
     */
    @NotNull public Builder medicalSpecialty(MedicalSpecialty.Builder medicalSpecialty) {
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  public interface Builder extends ThingBuilder<Physician> {
    @NotNull Builder availableService(MedicalProcedure medicalProcedure);
    @NotNull Builder availableService(MedicalProcedure.Builder medicalProcedure);
    @NotNull Builder availableService(MedicalTest medicalTest);
    @NotNull Builder availableService(MedicalTest.Builder medicalTest);
    @NotNull Builder availableService(MedicalTherapy medicalTherapy);
    @NotNull Builder availableService(MedicalTherapy.Builder medicalTherapy);
    @NotNull Builder hospitalAffiliation(Hospital hospital);
    @NotNull Builder hospitalAffiliation(Hospital.Builder hospital);
    @NotNull Builder medicalSpecialty(MedicalSpecialty medicalSpecialty);
    @NotNull Builder medicalSpecialty(MedicalSpecialty.Builder medicalSpecialty);
