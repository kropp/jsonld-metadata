...
public class Physician extends MedicalOrganization {
   ...
   */
  public MedicalProcedureOrMedicalTestOrMedicalTherapy getAvailableService() { return myAvailableService; }
  /**
   * A hospital with which the physician or office is affiliated.
   */
  public Hospital getHospitalAffiliation() { return myHospitalAffiliation; }
  /**
   * A medical specialty of the provider.
   */
  public MedicalSpecialty getMedicalSpecialty() { return myMedicalSpecialty; }
   ...
   */
  public static class Builder implements ThingBuilder<Physician> {
