...
public class Physician extends MedicalOrganization {
   ...
   */
  public static final class PhysicianThingBuilder implements Builder {
    /**
     ...
     * A medical service available from this provider.
     */
    public Builder availableService(MedicalProcedure medicalProcedure) {
     ...
     * A medical service available from this provider.
     */
    public Builder availableService(MedicalProcedure.Builder medicalProcedure) {
      return this.availableService(medicalProcedure.build());
    }
    /**
     * A medical service available from this provider.
     */
    public Builder availableService(MedicalTest medicalTest) {
      if (this.availableService == null) this.availableService = new MedicalProcedureOrMedicalTestOrMedicalTherapy();
     ...
     * A medical service available from this provider.
     */
    public Builder availableService(MedicalTest.Builder medicalTest) {
      return this.availableService(medicalTest.build());
    }
    /**
     * A medical service available from this provider.
     */
    public Builder availableService(MedicalTherapy medicalTherapy) {
      if (this.availableService == null) this.availableService = new MedicalProcedureOrMedicalTestOrMedicalTherapy();
     ...
     * A medical service available from this provider.
     */
    public Builder availableService(MedicalTherapy.Builder medicalTherapy) {
      return this.availableService(medicalTherapy.build());
    }
    /**
     * A hospital with which the physician or office is affiliated.
     */
    public Builder hospitalAffiliation(Hospital hospital) {
     ...
     * A hospital with which the physician or office is affiliated.
     */
    public Builder hospitalAffiliation(Hospital.Builder hospital) {
      return this.hospitalAffiliation(hospital.build());
    }
    /**
     * A medical specialty of the provider.
     */
    public Builder medicalSpecialty(MedicalSpecialty medicalSpecialty) {
     ...
     * A medical specialty of the provider.
     */
    public Builder medicalSpecialty(MedicalSpecialty.Builder medicalSpecialty) {
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  Builder availableService(MedicalProcedure medicalProcedure);
  Builder availableService(MedicalProcedure.Builder medicalProcedure);
  Builder availableService(MedicalTest medicalTest);
  Builder availableService(MedicalTest.Builder medicalTest);
  Builder availableService(MedicalTherapy medicalTherapy);
  Builder availableService(MedicalTherapy.Builder medicalTherapy);
  Builder hospitalAffiliation(Hospital hospital);
  Builder hospitalAffiliation(Hospital.Builder hospital);
  Builder medicalSpecialty(MedicalSpecialty medicalSpecialty);
  Builder medicalSpecialty(MedicalSpecialty.Builder medicalSpecialty);
