...
public class Physician extends MedicalOrganization {
   ...
   */
  public MedicalProcedureOrMedicalTestOrMedicalTherapy getAvailableService() {
  ...
  static final class PhysicianThingBuilder implements Builder {
    ...
    @NotNull public Builder availableService(@NotNull MedicalProcedure.Builder medicalProcedure) {
      return this.availableService(medicalProcedure.build());
    }
    /**
     * A medical service available from this provider.
     */
    @NotNull public Builder availableService(@NotNull MedicalTest medicalTest) {
      if (this.availableService == null) this.availableService = new MedicalProcedureOrMedicalTestOrMedicalTherapy();
      this.availableService.setMedicalTest(medicalTest);
      return this;
    }
    /**
     * A medical service available from this provider.
    ...
    @NotNull public Builder availableService(@NotNull MedicalTest.Builder medicalTest) {
      return this.availableService(medicalTest.build());
    }
    /**
     * A medical service available from this provider.
     */
    @NotNull public Builder availableService(@NotNull MedicalTherapy medicalTherapy) {
      if (this.availableService == null) this.availableService = new MedicalProcedureOrMedicalTestOrMedicalTherapy();
      this.availableService.setMedicalTherapy(medicalTherapy);
      return this;
    }
    /**
     * A medical service available from this provider.
    ...
    @NotNull public Builder availableService(@NotNull MedicalTherapy.Builder medicalTherapy) {
      return this.availableService(medicalTherapy.build());
    }
    /**
     * A hospital with which the physician or office is affiliated.
     */
    @NotNull public Builder hospitalAffiliation(@NotNull Hospital hospital) {
      this.hospitalAffiliation = hospital;
      return this;
    }
    /**
     * A hospital with which the physician or office is affiliated.
    ...
    @NotNull public Builder hospitalAffiliation(@NotNull Hospital.Builder hospital) {
      return this.hospitalAffiliation(hospital.build());
    }
    /**
     * A medical specialty of the provider.
     */
    ...
    @NotNull public Builder medicalSpecialty(@NotNull MedicalSpecialty.Builder medicalSpecialty) {
      return this.medicalSpecialty(medicalSpecialty.build());
    }
    /**
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("availableService".equals(key) && value instanceof MedicalProcedure) { availableService((MedicalProcedure)value); continue; }
        if ("availableService".equals(key) && value instanceof MedicalTest) { availableService((MedicalTest)value); continue; }
        if ("availableService".equals(key) && value instanceof MedicalTherapy) { availableService((MedicalTherapy)value); continue; }
        if ("hospitalAffiliation".equals(key) && value instanceof Hospital) { hospitalAffiliation((Hospital)value); continue; }
        if ("medicalSpecialty".equals(key) && value instanceof MedicalSpecialty) { medicalSpecialty((MedicalSpecialty)value); continue; }
  ...
  public interface Builder extends ThingBuilder<Physician> {
    @NotNull Builder availableService(@NotNull MedicalProcedure medicalProcedure);
    @NotNull Builder availableService(@NotNull MedicalProcedure.Builder medicalProcedure);
    @NotNull Builder availableService(@NotNull MedicalTest medicalTest);
    @NotNull Builder availableService(@NotNull MedicalTest.Builder medicalTest);
    @NotNull Builder availableService(@NotNull MedicalTherapy medicalTherapy);
    @NotNull Builder availableService(@NotNull MedicalTherapy.Builder medicalTherapy);
    @NotNull Builder hospitalAffiliation(@NotNull Hospital hospital);
    @NotNull Builder hospitalAffiliation(@NotNull Hospital.Builder hospital);
    @NotNull Builder medicalSpecialty(@NotNull MedicalSpecialty medicalSpecialty);
    @NotNull Builder medicalSpecialty(@NotNull MedicalSpecialty.Builder medicalSpecialty);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myHospitalAffiliation != null ? myHospitalAffiliation.hashCode() : 0);
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myAvailableService != null ? !myAvailableService.equals(physician.myAvailableService) : physician.myAvailableService != null) return false;
    if (myHospitalAffiliation != null ? !myHospitalAffiliation.equals(physician.myHospitalAffiliation) : physician.myHospitalAffiliation != null) return false;
    if (myMedicalSpecialty != null ? !myMedicalSpecialty.equals(physician.myMedicalSpecialty) : physician.myMedicalSpecialty != null) return false;
    return true;
  }

  private MedicalProcedureOrMedicalTestOrMedicalTherapy myAvailableService;
  private Hospital myHospitalAffiliation;
