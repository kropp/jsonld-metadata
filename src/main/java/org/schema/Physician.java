...
public class Physician extends MedicalOrganization {
  ...
  public static class Builder extends MedicalOrganization.Builder {
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("availableService".equals(key) && value instanceof MedicalProcedure) { availableService((MedicalProcedure)value); return; }
      if ("availableService".equals(key) && value instanceof MedicalTest) { availableService((MedicalTest)value); return; }
      if ("availableService".equals(key) && value instanceof MedicalTherapy) { availableService((MedicalTherapy)value); return; }
      if ("hospitalAffiliation".equals(key) && value instanceof Hospital) { hospitalAffiliation((Hospital)value); return; }
      if ("medicalSpecialty".equals(key) && value instanceof MedicalSpecialty) { medicalSpecialty((MedicalSpecialty)value); return; }
