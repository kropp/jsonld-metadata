...
public class ControlAction extends Action {
  ...
  public static final class Builder {
    ...
    public ControlAction build() {
      return new ControlAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
