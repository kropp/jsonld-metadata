...
public class ControlAction extends Action {
  /**
   * Builder for {@see ControlAction}
   */
  public static final class Builder {
    public ControlAction build() {
      return new ControlAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, object, location, description);
    }
