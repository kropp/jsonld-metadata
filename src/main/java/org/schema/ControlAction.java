...
public class ControlAction extends Action {
  ...
  public static final class Builder {
    ...
    public ControlAction build() {
      return new ControlAction(additionalType, url, sameAs, agent, startTime, alternateName, potentialAction, target, description, name, endTime, mainEntityOfPage, error, actionStatus);
    }
    /**
