...
public class GovernmentBuilding extends CivicStructure {
  ...
  public static final class Builder {
    ...
    public GovernmentBuilding build() {
      return new GovernmentBuilding(aggregateRating, review, openingHours, logo, isicV4, globalLocationNumber, name, mainEntityOfPage, hasMap, url, sameAs, containedIn, event, additionalType, alternateName, openingHoursSpecification, faxNumber, telephone, geo, description, potentialAction, additionalProperty, photo, address);
    }
    /**
