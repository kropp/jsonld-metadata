...
public class Language extends Intangible {
   ...
   */
  public static final class LanguageThingBuilder implements Builder {
    /**
     * Creates new {@link Language} instance.
     */
    public Language build() {
      return new Language(additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<Language> {
