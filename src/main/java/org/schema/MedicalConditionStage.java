...
public class MedicalConditionStage extends MedicalIntangible {
   ...
   */
  public static final class MedicalConditionStageThingBuilder implements Builder {
    /**
     ...
     * The stage represented as a number, e.g. 3.
     */
    public Builder stageAsNumber(String stageAsNumber) {
      if (this.stageAsNumber == null) this.stageAsNumber = new Number();
  ...
  Builder stageAsNumber(Integer integer);
  Builder stageAsNumber(Long stageAsNumber);
  Builder stageAsNumber(Float stageAsNumber);
  Builder stageAsNumber(Double stageAsNumber);
  Builder stageAsNumber(String stageAsNumber);
  Builder subStageSuffix(String subStageSuffix);
