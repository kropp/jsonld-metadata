...
public class MedicalConditionStage extends MedicalIntangible {
  ...
  /**
   * Builder for {@see MedicalConditionStage}
   */
  public static final class Builder {
    public MedicalConditionStage build() {
      return new MedicalConditionStage(subStageSuffix, mainEntityOfPage, alternateName, potentialAction, stageAsNumber, url, additionalType, medicineSystem, sameAs, recognizingAuthority, study, code, image, name, relevantSpecialty, guideline, description);
    }
    /**
     * The substage, e.g. 'a' for Stage IIIa.
     */
    public Builder subStageSuffix(String value) {
      subStageSuffix = value;
      return this;
    }
    /**
     ...
     * The stage represented as a number, e.g. 3.
     */
    public Builder stageAsNumber(Number value) {
      stageAsNumber = value;
      return this;
    }
    /**
  ...
  protected MedicalConditionStage(String subStageSuffix, CreativeWork mainEntityOfPage, String alternateName, Action potentialAction, Number stageAsNumber, String url, String additionalType, MedicineSystem medicineSystem, String sameAs, Organization recognizingAuthority, MedicalStudy study, MedicalCode code, Image image, String name, MedicalSpecialty relevantSpecialty, MedicalGuideline guideline, String description) {
