...
public class MedicalConditionStage extends MedicalIntangible {
  ...
  public static final class Builder {
    ...
    public MedicalConditionStage build() {
      return new MedicalConditionStage(recognizingAuthority, code, name, mainEntityOfPage, guideline, url, sameAs, additionalType, stageAsNumber, subStageSuffix, alternateName, study, potentialAction, description, relevantSpecialty, medicineSystem);
    }
    /**
     ...
     * The substage, e.g. 'a' for Stage IIIa.
     */
    public Builder subStageSuffix(String subStageSuffix) {
  ...
  protected MedicalConditionStage(Organization recognizingAuthority, MedicalCode code, String name, StringOrCreativeWork mainEntityOfPage, MedicalGuideline guideline, String url, String sameAs, String additionalType, Number stageAsNumber, String subStageSuffix, String alternateName, MedicalStudy study, Action potentialAction, String description, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem) {
