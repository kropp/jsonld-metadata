...
<a href='unitCode'>unitCode</a>.
  ...
  public static final class Builder {
    ...
    public UnitPriceSpecification build() {
      return new UnitPriceSpecification(eligibleQuantity, unitText, maxPrice, valueAddedTaxIncluded, unitCode, billingIncrement, priceCurrency, name, eligibleTransactionVolume, mainEntityOfPage, price, minPrice, url, additionalType, sameAs, validFrom, priceType, validThrough, alternateName, description, potentialAction);
    }
    /**
...
<li>
  ...
  protected UnitPriceSpecification(QuantitativeValue eligibleQuantity, String unitText, Number maxPrice, Boolean valueAddedTaxIncluded, String unitCode, Number billingIncrement, String priceCurrency, String name, PriceSpecification eligibleTransactionVolume, StringOrCreativeWork mainEntityOfPage, StringOrNumber price, Number minPrice, String url, String additionalType, String sameAs, java.util.Date validFrom, String priceType, java.util.Date validThrough, String alternateName, String description, Action potentialAction) {
