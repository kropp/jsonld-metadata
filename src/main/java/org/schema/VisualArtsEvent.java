...
public class VisualArtsEvent extends Event {
   ...
   */
  static final class VisualArtsEventThingBuilder implements Builder {
    /**
     * Creates new {@link VisualArtsEvent} instance.
     */
    public VisualArtsEvent build() {
      return new VisualArtsEvent(aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<VisualArtsEvent> {
  ...
  @Override public boolean equals(Object o) {
    ...
    VisualArtsEvent visualArtsEvent = (VisualArtsEvent) o;
