...
public class Playground extends CivicStructure {
  /**
   * Builder for {@see Playground}
   */
  public static final class Builder {
    public Playground build() {
      return new Playground(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
