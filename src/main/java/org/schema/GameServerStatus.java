...
public class GameServerStatus extends Enumeration {
  /**
   * Builder for {@link GameServerStatus}
   */
  public static final class Builder {
    ...
    public GameServerStatus build() {
      return new GameServerStatus(sameAs, url, additionalType, alternateName, supersededBy, description, potentialAction, name, mainEntityOfPage);
    }
    /**
  ...
  protected GameServerStatus(String sameAs, String url, String additionalType, String alternateName, EnumerationOrProperty supersededBy, String description, Action potentialAction, String name, StringOrCreativeWork mainEntityOfPage) {
