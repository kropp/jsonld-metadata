...
public class FastFoodRestaurant extends FoodEstablishment {
  ...
  public static final class Builder {
    /**
     * Creates new {@link FastFoodRestaurant} instance.
     */
    public FastFoodRestaurant build() {
      return new FastFoodRestaurant(servesCuisine, aggregateRating, review, logo, parentOrganization, menu, additionalType, sameAs, event, containedIn, priceRange, openingHoursSpecification, currenciesAccepted, potentialAction, address, additionalProperty, acceptsReservations, openingHours, globalLocationNumber, isicV4, name, paymentAccepted, mainEntityOfPage, hasMap, url, alternateName, faxNumber, telephone, geo, description, photo);
    }
    /**
     * The cuisine of the restaurant.
     */
    public Builder servesCuisine(String servesCuisine) {
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
     ...
     */
    public Builder acceptsReservations(Boolean acceptsReservations) {
      this.acceptsReservations.setBoolean(acceptsReservations);
      return this;
    }
    /**
     * Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings <code>Yes</code> or <code>No</code>.
     */
    public Builder acceptsReservations(String acceptsReservations) {
      this.acceptsReservations.setString(acceptsReservations);
      return this;
    }
    /**
  ...
  protected FastFoodRestaurant(String servesCuisine, AggregateRating aggregateRating, Review review, ImageObjectOrString logo, Organization parentOrganization, String menu, String additionalType, String sameAs, Event event, Place containedIn, String priceRange, OpeningHoursSpecification openingHoursSpecification, String currenciesAccepted, Action potentialAction, PostalAddress address, PropertyValue additionalProperty, BooleanOrString acceptsReservations, String openingHours, String globalLocationNumber, String isicV4, String name, String paymentAccepted, StringOrCreativeWork mainEntityOfPage, MapOrString hasMap, String url, String alternateName, String faxNumber, String telephone, GeoCoordinatesOrGeoShape geo, String description, ImageObjectOrPhotograph photo) {
    super(servesCuisine, aggregateRating, review, logo, parentOrganization, containedIn, event, sameAs, additionalType, menu, priceRange, openingHoursSpecification, currenciesAccepted, potentialAction, address, additionalProperty, acceptsReservations, openingHours, globalLocationNumber, isicV4, name, paymentAccepted, mainEntityOfPage, hasMap, url, faxNumber, alternateName, geo, telephone, description, photo);
  }
}
