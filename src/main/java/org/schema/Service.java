...
public class Service extends Intangible {
   ...
   */
  public ServiceChannel getAvailableChannel() { return myAvailableChannel; }
  /**
   * The tangible thing generated by the service, e.g. a passport, permit, etc.
   */
  public Thing getServiceOutput() { return myServiceOutput; }
  /**
   ...
   */
  public AdministrativeArea getServiceArea() { return myServiceArea; }
  /**
   * The type of service being offered, e.g. veterans' benefits, emergency relief, etc.
   */
  public String getServiceType() { return myServiceType; }
  /**
   ...
   */
  public static class Builder implements ThingBuilder<Service> {
