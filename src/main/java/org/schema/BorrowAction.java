...
public class BorrowAction extends TransferAction {
   ...
   */
  static final class BorrowActionThingBuilder implements Builder {
    /**
    ...
    @NotNull public Builder lender(@NotNull Person.Builder person) {
      return this.lender(person.build());
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("lender".equals(key) && value instanceof Person) { lender((Person)value); continue; }
  ...
  public interface Builder extends ThingBuilder<BorrowAction> {
    @NotNull Builder lender(@NotNull Person person);
    @NotNull Builder lender(@NotNull Person.Builder person);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myLender != null ? myLender.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    BorrowAction borrowAction = (BorrowAction) o;
    if (!super.equals(o)) return false;
    if (myLender != null ? !myLender.equals(borrowAction.myLender) : borrowAction.myLender != null) return false;
    return true;
  }
