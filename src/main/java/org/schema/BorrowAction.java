...
public class BorrowAction extends TransferAction {
  ...
  static final class BorrowActionThingBuilder implements Builder {
     ...
     * A sub property of participant. The person that lends the object being borrowed.
     */
    @NotNull public Builder lender(Person person) {
      this.lender = person;
      return this;
    }
    /**
     * A sub property of participant. The person that lends the object being borrowed.
     */
    @NotNull public Builder lender(Person.Builder person) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<BorrowAction> {
    @NotNull Builder lender(Person person);
    @NotNull Builder lender(Person.Builder person);
