...
public class BorrowAction extends TransferAction {
  ...
  public static final class Builder {
    ...
    public BorrowAction build() {
      return new BorrowAction(startTime, toLocation, lender, name, mainEntityOfPage, error, fromLocation, url, sameAs, additionalType, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
     ...
     * A sub property of participant. The person that lends the object being borrowed.
     */
    public Builder lender(Person person) {
      this.lender = person;
      return this;
    }
    /**
