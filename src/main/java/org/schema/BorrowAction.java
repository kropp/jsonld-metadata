...
public class BorrowAction extends TransferAction {
  ...
  /**
   * Builder for {@see BorrowAction}
   */
  public static final class Builder {
    public BorrowAction build() {
      return new BorrowAction(instrument, toLocation, mainEntityOfPage, agent, endTime, alternateName, potentialAction, fromLocation, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, lender, object, description, location);
    }
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
     ...
     * A sub property of participant. The person that lends the object being borrowed.
     */
    public Builder lender(Person value) {
      lender = value;
      return this;
    }
  ...
  protected BorrowAction(Instrument instrument, Place toLocation, CreativeWork mainEntityOfPage, Organization agent, java.util.Date endTime, String alternateName, Action potentialAction, Place fromLocation, Participant participant, String additionalType, String url, String sameAs, java.util.Date startTime, ActionStatusType actionStatus, Result result, Image image, String name, Thing error, EntryPoint target, Person lender, Object object, String description, Location location) {
