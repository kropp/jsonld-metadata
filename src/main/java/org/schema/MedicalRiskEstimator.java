...
public class MedicalRiskEstimator extends MedicalEntity {
  ...
  /**
   * Builder for {@see MedicalRiskEstimator}
   */
  public static final class Builder {
    public MedicalRiskEstimator build() {
      return new MedicalRiskEstimator(mainEntityOfPage, alternateName, potentialAction, additionalType, includedRiskFactor, url, medicineSystem, sameAs, recognizingAuthority, study, code, estimatesRiskOf, image, name, relevantSpecialty, guideline, description);
    }
    /**
  ...
  protected MedicalRiskEstimator(CreativeWork mainEntityOfPage, String alternateName, Action potentialAction, String additionalType, MedicalRiskFactor includedRiskFactor, String url, MedicineSystem medicineSystem, String sameAs, Organization recognizingAuthority, MedicalStudy study, MedicalCode code, MedicalEntity estimatesRiskOf, Image image, String name, MedicalSpecialty relevantSpecialty, MedicalGuideline guideline, String description) {
