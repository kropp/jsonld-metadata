...
public class MedicalRiskEstimator extends MedicalEntity {
   ...
   */
  public static final class MedicalRiskEstimatorThingBuilder implements Builder {
    /**
     ...
     * The condition, complication, or symptom whose risk is being estimated.
     */
    public Builder estimatesRiskOf(MedicalEntity medicalEntity) {
     ...
     * The condition, complication, or symptom whose risk is being estimated.
     */
    public Builder estimatesRiskOf(MedicalEntity.Builder medicalEntity) {
      return this.estimatesRiskOf(medicalEntity.build());
    }
    /**
     * A modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting condition.
     */
    public Builder includedRiskFactor(MedicalRiskFactor medicalRiskFactor) {
     ...
     * A modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting condition.
     */
    public Builder includedRiskFactor(MedicalRiskFactor.Builder medicalRiskFactor) {
  ...
  Builder estimatesRiskOf(MedicalEntity medicalEntity);
  Builder estimatesRiskOf(MedicalEntity.Builder medicalEntity);
  Builder includedRiskFactor(MedicalRiskFactor medicalRiskFactor);
  Builder includedRiskFactor(MedicalRiskFactor.Builder medicalRiskFactor);
