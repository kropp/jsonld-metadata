...
public class MedicalRiskEstimator extends MedicalEntity {
  ...
  static final class MedicalRiskEstimatorThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("estimatesRiskOf".equals(key) && value instanceof MedicalEntity) { estimatesRiskOf((MedicalEntity)value); continue; }
        if ("includedRiskFactor".equals(key) && value instanceof MedicalRiskFactor) { includedRiskFactor((MedicalRiskFactor)value); continue; }
  ...
  public interface Builder extends ThingBuilder<MedicalRiskEstimator> {
    @NotNull Builder estimatesRiskOf(@NotNull MedicalEntity medicalEntity);
    @NotNull Builder estimatesRiskOf(@NotNull MedicalEntity.Builder medicalEntity);
    @NotNull Builder includedRiskFactor(@NotNull MedicalRiskFactor medicalRiskFactor);
    @NotNull Builder includedRiskFactor(@NotNull MedicalRiskFactor.Builder medicalRiskFactor);
