...
/**
 * Any rule set or interactive tool for estimating the risk of developing a complication or condition.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class MedicalRiskEstimator extends MedicalEntity {
  /**
   * The condition, complication, or symptom whose risk is being estimated.
   */
  public MedicalEntity getEstimatesRiskOf() { return myEstimatesRiskOf; }
  /**
   * A modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting condition.
   */
  public MedicalRiskFactor getIncludedRiskFactor() { return myIncludedRiskFactor; }
   ...
   */
  public static class Builder implements ThingBuilder<MedicalRiskEstimator> {
