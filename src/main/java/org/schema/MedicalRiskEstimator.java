...
public class MedicalRiskEstimator extends MedicalEntity {
  ...
  public MedicalEntity getEstimatesRiskOf() {
    return myEstimatesRiskOf;
  }
  /**
   * A modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting condition.
   */
  public MedicalRiskFactor getIncludedRiskFactor() {
    return myIncludedRiskFactor;
  }
  /**
   * Builder for {@link MedicalRiskEstimator}
   */
  static final class MedicalRiskEstimatorThingBuilder implements Builder {
    /**
     * Creates new {@link MedicalRiskEstimator} instance.
     */
    public MedicalRiskEstimator build() {
      return new MedicalRiskEstimator(estimatesRiskOf, includedRiskFactor, code, guideline, medicineSystem, recognizingAuthority, relevantSpecialty, study, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * The condition, complication, or symptom whose risk is being estimated.
     */
    @NotNull public Builder estimatesRiskOf(MedicalEntity medicalEntity) {
      this.estimatesRiskOf = medicalEntity;
      return this;
    }
    /**
     * The condition, complication, or symptom whose risk is being estimated.
     */
    @NotNull public Builder estimatesRiskOf(MedicalEntity.Builder medicalEntity) {
      return this.estimatesRiskOf(medicalEntity.build());
    }
    /**
     * A modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting condition.
     */
    @NotNull public Builder includedRiskFactor(MedicalRiskFactor medicalRiskFactor) {
      this.includedRiskFactor = medicalRiskFactor;
      return this;
    }
    /**
     * A modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting condition.
     */
    @NotNull public Builder includedRiskFactor(MedicalRiskFactor.Builder medicalRiskFactor) {
      return this.includedRiskFactor(medicalRiskFactor.build());
    }
    /**
  ...
  public interface Builder extends ThingBuilder<MedicalRiskEstimator> {
    @NotNull Builder estimatesRiskOf(MedicalEntity medicalEntity);
    @NotNull Builder estimatesRiskOf(MedicalEntity.Builder medicalEntity);
    @NotNull Builder includedRiskFactor(MedicalRiskFactor medicalRiskFactor);
    @NotNull Builder includedRiskFactor(MedicalRiskFactor.Builder medicalRiskFactor);
  ...
  protected MedicalRiskEstimator(MedicalEntity estimatesRiskOf, MedicalRiskFactor includedRiskFactor, MedicalCode code, MedicalGuideline guideline, MedicineSystem medicineSystem, Organization recognizingAuthority, MedicalSpecialty relevantSpecialty, MedicalStudy study, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
