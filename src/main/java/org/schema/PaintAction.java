...
public class PaintAction extends CreateAction {
  /**
   * Builder for {@see PaintAction}
   */
  public static final class Builder {
    public PaintAction build() {
      return new PaintAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
