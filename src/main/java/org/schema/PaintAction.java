...
public class PaintAction extends CreateAction {
  ...
  public static final class Builder {
    ...
    public PaintAction build() {
      return new PaintAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
