...
public class DeliveryEvent extends Event {
  ...
  static final class DeliveryEventThingBuilder implements Builder {
     ...
     * When the item is available for pickup from the store, locker, etc.
     */
    @NotNull public Builder availableFrom(java.util.Date date) {
     ...
     * After this date, the item will no longer be available for pickup.
     */
    @NotNull public Builder availableThrough(java.util.Date date) {
  ...
  public interface Builder extends ThingBuilder<DeliveryEvent> {
    @NotNull Builder accessCode(String accessCode);
    @NotNull Builder availableFrom(java.util.Date date);
    @NotNull Builder availableThrough(java.util.Date date);
