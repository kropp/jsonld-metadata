...
public class DeliveryEvent extends Event {
  ...
  public static final class Builder {
    ...
    public DeliveryEvent build() {
      return new DeliveryEvent(aggregateRating, review, endDate, attendee, hasDeliveryMethod, availableThrough, additionalType, sameAs, subEvent, workPerformed, potentialAction, eventStatus, duration, startDate, typicalAgeRange, availableFrom, organizer, doorTime, inLanguage, superEvent, name, mainEntityOfPage, recordedIn, previousStartDate, accessCode, url, performer, alternateName, description, offers);
    }
    /**
     ...
     * After this date, the item will no longer be available for pickup.
     */
    public Builder availableThrough(java.util.Date date) {
     ...
     * When the item is available for pickup from the store, locker, etc.
     */
    public Builder availableFrom(java.util.Date date) {
  ...
  protected DeliveryEvent(AggregateRating aggregateRating, Review review, java.util.Date endDate, OrganizationOrPerson attendee, DeliveryMethod hasDeliveryMethod, java.util.Date availableThrough, String additionalType, String sameAs, Event subEvent, CreativeWork workPerformed, Action potentialAction, EventStatusType eventStatus, Duration duration, java.util.Date startDate, String typicalAgeRange, java.util.Date availableFrom, OrganizationOrPerson organizer, java.util.Date doorTime, LanguageOrString inLanguage, Event superEvent, String name, StringOrCreativeWork mainEntityOfPage, CreativeWork recordedIn, java.util.Date previousStartDate, String accessCode, String url, OrganizationOrPerson performer, String alternateName, String description, Offer offers) {
