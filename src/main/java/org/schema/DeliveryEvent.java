...
public class DeliveryEvent extends Event {
  ...
  /**
   * Builder for {@see DeliveryEvent}
   */
  public static final class Builder {
    public DeliveryEvent build() {
      return new DeliveryEvent(performer, review, offers, endDate, potentialAction, duration, availableFrom, availableThrough, additionalType, inLanguage, hasDeliveryMethod, image, workPerformed, attendee, previousStartDate, description, mainEntityOfPage, organizer, doorTime, alternateName, eventStatus, url, superEvent, aggregateRating, sameAs, startDate, name, subEvent, recordedIn, typicalAgeRange, location, accessCode);
    }
    /**
     ...
     * When the item is available for pickup from the store, locker, etc.
     */
    public Builder availableFrom(java.util.Date value) {
      availableFrom = value;
      return this;
    }
    /**
     * After this date, the item will no longer be available for pickup.
     */
    public Builder availableThrough(java.util.Date value) {
     ...
     * Password, PIN, or access code needed for delivery (e.g. from a locker).
     */
    public Builder accessCode(String value) {
      accessCode = value;
      return this;
    }
  ...
  protected DeliveryEvent(Organization performer, Review review, Offer offers, java.util.Date endDate, Action potentialAction, Duration duration, java.util.Date availableFrom, java.util.Date availableThrough, String additionalType, String inLanguage, DeliveryMethod hasDeliveryMethod, Image image, CreativeWork workPerformed, Organization attendee, java.util.Date previousStartDate, String description, CreativeWork mainEntityOfPage, Person organizer, java.util.Date doorTime, String alternateName, EventStatusType eventStatus, String url, Event superEvent, AggregateRating aggregateRating, String sameAs, java.util.Date startDate, String name, Event subEvent, CreativeWork recordedIn, String typicalAgeRange, Location location, String accessCode) {
