...
public class DeliveryEvent extends Event {
   ...
   */
  public static final class DeliveryEventThingBuilder implements Builder {
    /**
  ...
  Builder accessCode(String accessCode);
  Builder availableFrom(java.util.Date date);
  Builder availableThrough(java.util.Date date);
