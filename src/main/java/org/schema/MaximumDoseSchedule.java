...
public class MaximumDoseSchedule extends DoseSchedule {
   ...
   */
  public static final class MaximumDoseScheduleThingBuilder implements Builder {
    /**
     * Creates new {@link MaximumDoseSchedule} instance.
     */
    public MaximumDoseSchedule build() {
      return new MaximumDoseSchedule(doseUnit, doseValue, frequency, targetPopulation, code, guideline, medicineSystem, recognizingAuthority, relevantSpecialty, study, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     ...
     * The value of the dose, e.g. 500.
     */
    public Builder doseValue(String doseValue) {
      if (this.doseValue == null) this.doseValue = new Number();
  ...
  public interface Builder extends ThingBuilder<MaximumDoseSchedule> {
  Builder doseUnit(String doseUnit);
  Builder doseValue(Integer integer);
  Builder doseValue(Long doseValue);
  Builder doseValue(Float doseValue);
  Builder doseValue(Double doseValue);
  Builder doseValue(String doseValue);
  Builder frequency(String frequency);
  Builder targetPopulation(String targetPopulation);
