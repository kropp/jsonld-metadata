...
public class SuperficialAnatomy extends MedicalEntity {
   ...
   */
  public AnatomicalSystemOrAnatomicalStructure getRelatedAnatomy() {
  ...
  public static final class Builder {
    /**
     * Creates new {@link SuperficialAnatomy} instance.
     */
    public SuperficialAnatomy build() {
      return new SuperficialAnatomy(recognizingAuthority, code, relatedTherapy, name, mainEntityOfPage, guideline, additionalType, url, sameAs, relatedCondition, relatedAnatomy, alternateName, associatedPathophysiology, study, potentialAction, description, relevantSpecialty, medicineSystem, significance);
    }
    /**
     ...
     * Anatomical systems or structures that relate to the superficial anatomy.
     */
    public Builder relatedAnatomy(AnatomicalSystem anatomicalSystem) {
     ...
     * Anatomical systems or structures that relate to the superficial anatomy.
     */
    public Builder relatedAnatomy(AnatomicalStructure anatomicalStructure) {
     ...
     * The significance associated with the superficial anatomy; as an example, how characteristics of the superficial anatomy can suggest underlying medical conditions or courses of treatment.
     */
    public Builder significance(String significance) {
    ...
    private AnatomicalSystemOrAnatomicalStructure relatedAnatomy;
  ...
  protected SuperficialAnatomy(Organization recognizingAuthority, MedicalCode code, MedicalTherapy relatedTherapy, String name, StringOrCreativeWork mainEntityOfPage, MedicalGuideline guideline, String additionalType, String url, String sameAs, MedicalCondition relatedCondition, AnatomicalSystemOrAnatomicalStructure relatedAnatomy, String alternateName, String associatedPathophysiology, MedicalStudy study, Action potentialAction, String description, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem, String significance) {
  ...
  private AnatomicalSystemOrAnatomicalStructure myRelatedAnatomy;
