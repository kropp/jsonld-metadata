...
public class SuperficialAnatomy extends MedicalEntity {
  ...
  public interface Builder extends ThingBuilder<SuperficialAnatomy> {
    ...
    @NotNull Builder relatedAnatomy(@NotNull AnatomicalStructure anatomicalStructure);
    @NotNull Builder relatedAnatomy(@NotNull AnatomicalStructure.Builder anatomicalStructure);
    @NotNull Builder relatedAnatomy(@NotNull AnatomicalSystem anatomicalSystem);
    @NotNull Builder relatedAnatomy(@NotNull AnatomicalSystem.Builder anatomicalSystem);
    ...
    @NotNull Builder significance(@NotNull String significance);
