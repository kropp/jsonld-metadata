...
public class AuthorizeAction extends AllocateAction {
  ...
  public static final class Builder {
    ...
    public AuthorizeAction build() {
      return new AuthorizeAction(purpose, startTime, name, mainEntityOfPage, error, sameAs, additionalType, url, recipient, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
