...
public class AuthorizeAction extends AllocateAction {
  ...
  /**
   * Builder for {@see AuthorizeAction}
   */
  public static final class Builder {
    public AuthorizeAction build() {
      return new AuthorizeAction(instrument, recipient, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, purpose, object, location, description);
    }
