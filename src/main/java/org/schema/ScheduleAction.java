...
public class ScheduleAction extends PlanAction {
  ...
  public static final class Builder {
    ...
    public ScheduleAction build() {
      return new ScheduleAction(startTime, name, mainEntityOfPage, error, scheduledTime, sameAs, additionalType, url, agent, alternateName, description, potentialAction, target, endTime, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected ScheduleAction(java.util.Date startTime, String name, StringOrCreativeWork mainEntityOfPage, Thing error, java.util.Date scheduledTime, String sameAs, String additionalType, String url, OrganizationOrPerson agent, String alternateName, String description, Action potentialAction, EntryPoint target, java.util.Date endTime, ActionStatusType actionStatus) {
    super(startTime, name, error, mainEntityOfPage, scheduledTime, sameAs, additionalType, url, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
  }
}
