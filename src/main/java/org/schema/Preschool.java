...
public class Preschool extends EducationalOrganization {
  ...
  public static final class Builder {
    /**
     * Creates new {@link Preschool} instance.
     */
    public Preschool build() {
      return new Preschool(aggregateRating, review, logo, duns, department, subOrganization, additionalType, sameAs, event, award, foundingDate, numberOfEmployees, seeks, brand, naics, potentialAction, dissolutionDate, foundingLocation, address, founder, owns, email, makesOffer, member, employee, isicV4, globalLocationNumber, taxID, name, vatID, mainEntityOfPage, legalName, memberOf, url, contactPoint, hasPOS, alumni, alternateName, faxNumber, telephone, description);
    }
    /**
