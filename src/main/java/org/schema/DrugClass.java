...
public class DrugClass extends MedicalTherapy {
   ...
   */
  public static final class DrugClassThingBuilder implements Builder {
    /**
     ...
     * A drug in this drug class.
     */
    public Builder drug(Drug.Builder drug) {
  ...
  Builder drug(Drug drug);
  Builder drug(Drug.Builder drug);
