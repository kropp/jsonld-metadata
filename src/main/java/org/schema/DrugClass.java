...
public class DrugClass extends MedicalTherapy {
  ...
  public static final class Builder {
    /**
     * Creates new {@link DrugClass} instance.
     */
    public DrugClass build() {
      return new DrugClass(recognizingAuthority, code, indication, name, adverseOutcome, mainEntityOfPage, seriousAdverseOutcome, guideline, additionalType, url, sameAs, duplicateTherapy, contraindication, alternateName, drug, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
  ...
  protected DrugClass(Organization recognizingAuthority, MedicalCode code, MedicalIndication indication, String name, MedicalEntity adverseOutcome, StringOrCreativeWork mainEntityOfPage, MedicalEntity seriousAdverseOutcome, MedicalGuideline guideline, String additionalType, String url, String sameAs, MedicalTherapy duplicateTherapy, MedicalContraindication contraindication, String alternateName, Drug drug, MedicalStudy study, String description, Action potentialAction, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem) {
