...
public class DrugClass extends MedicalTherapy {
  ...
  /**
   * Builder for {@see DrugClass}
   */
  public static final class Builder {
    public DrugClass build() {
      return new DrugClass(indication, adverseOutcome, mainEntityOfPage, contraindication, potentialAction, alternateName, additionalType, url, medicineSystem, recognizingAuthority, sameAs, study, code, name, image, duplicateTherapy, relevantSpecialty, drug, seriousAdverseOutcome, guideline, description);
    }
    /**
     ...
     * A drug in this drug class.
     */
    public Builder drug(Drug value) {
      drug = value;
      return this;
    }
    /**
