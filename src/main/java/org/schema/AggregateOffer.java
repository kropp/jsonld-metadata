...
public class AggregateOffer extends Offer {
   ...
   */
  public static final class AggregateOfferThingBuilder implements Builder {
    /**
...
<li>
  ...
  Builder highPrice(Number number);
  Builder highPrice(String highPrice);
  Builder lowPrice(Number number);
  Builder lowPrice(String lowPrice);
  Builder offerCount(Integer integer);
