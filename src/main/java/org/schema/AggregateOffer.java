...
public class AggregateOffer extends Offer {
   ...
   */
  public StringOrNumber getHighPrice() {
    return myHighPrice;
  }
  /**
   * The lowest price of all offers available.
   */
  public StringOrNumber getLowPrice() {
    return myLowPrice;
  }
  /**
  ...
  public static final class Builder {
    ...
    public AggregateOffer build() {
      return new AggregateOffer(highPrice, availabilityEnds, addOn, aggregateRating, availableDeliveryMethod, acceptedPaymentMethod, review, businessFunction, gtin14, seller, priceValidUntil, deliveryLeadTime, sameAs, additionalType, gtin12, validThrough, eligibleDuration, availabilityStarts, sku, potentialAction, eligibleQuantity, availableAtOrFrom, category, offerCount, priceCurrency, advanceBookingRequirement, mpn, name, eligibleTransactionVolume, includesObject, availability, ineligibleRegion, itemOffered, mainEntityOfPage, eligibleRegion, gtin8, price, validFrom, url, itemCondition, lowPrice, eligibleCustomerType, alternateName, inventoryLevel, gtin13, priceSpecification, description, offers, warranty);
    }
    /**
     * The highest price of all offers available.
     */
...
<li>
    ...
    private StringOrNumber highPrice;
    ...
    private StringOrNumber lowPrice;
  ...
  protected AggregateOffer(StringOrNumber highPrice, java.util.Date availabilityEnds, Offer addOn, AggregateRating aggregateRating, DeliveryMethod availableDeliveryMethod, PaymentMethod acceptedPaymentMethod, Review review, BusinessFunction businessFunction, String gtin14, Participant seller, java.util.Date priceValidUntil, QuantitativeValue deliveryLeadTime, String sameAs, String additionalType, String gtin12, java.util.Date validThrough, QuantitativeValue eligibleDuration, java.util.Date availabilityStarts, String sku, Action potentialAction, QuantitativeValue eligibleQuantity, Place availableAtOrFrom, ThingOrStringOrPhysicalActivityCategory category, Integer offerCount, String priceCurrency, QuantitativeValue advanceBookingRequirement, String mpn, String name, PriceSpecification eligibleTransactionVolume, TypeAndQuantityNode includesObject, ItemAvailability availability, PlaceOrGeoShapeOrString ineligibleRegion, Product itemOffered, StringOrCreativeWork mainEntityOfPage, PlaceOrGeoShapeOrString eligibleRegion, String gtin8, StringOrNumber price, java.util.Date validFrom, String url, OfferItemCondition itemCondition, StringOrNumber lowPrice, BusinessEntityType eligibleCustomerType, String alternateName, QuantitativeValue inventoryLevel, String gtin13, PriceSpecification priceSpecification, String description, Offer offers, WarrantyPromise warranty) {
    super(availabilityEnds, availableDeliveryMethod, aggregateRating, addOn, acceptedPaymentMethod, review, businessFunction, gtin14, seller, priceValidUntil, deliveryLeadTime, sameAs, additionalType, gtin12, validThrough, eligibleDuration, availabilityStarts, sku, potentialAction, eligibleQuantity, category, availableAtOrFrom, priceCurrency, advanceBookingRequirement, name, mpn, includesObject, eligibleTransactionVolume, mainEntityOfPage, itemOffered, ineligibleRegion, availability, price, gtin8, eligibleRegion, url, validFrom, itemCondition, alternateName, eligibleCustomerType, inventoryLevel, gtin13, description, priceSpecification, warranty);
    myHighPrice = highPrice;
    myLowPrice = lowPrice;
    myOfferCount = offerCount;
    myOffers = offers;
  }
  private StringOrNumber myHighPrice;
  private StringOrNumber myLowPrice;
