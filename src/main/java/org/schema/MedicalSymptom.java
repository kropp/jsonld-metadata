...
public class MedicalSymptom extends MedicalSignOrSymptom {
  ...
  public static final class Builder {
    ...
    public MedicalSymptom build() {
      return new MedicalSymptom(recognizingAuthority, code, name, mainEntityOfPage, guideline, possibleTreatment, cause, url, sameAs, additionalType, alternateName, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
