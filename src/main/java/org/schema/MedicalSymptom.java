...
public class MedicalSymptom extends MedicalSignOrSymptom {
   ...
   */
  static final class MedicalSymptomThingBuilder implements Builder {
    /**
     * Creates new {@link MedicalSymptom} instance.
     */
  ...
  public interface Builder extends ThingBuilder<MedicalSymptom> {
