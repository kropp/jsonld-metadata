...
public class MedicalSymptom extends MedicalSignOrSymptom {
  /**
   * Builder for {@see MedicalSymptom}
   */
  public static final class Builder {
    public MedicalSymptom build() {
      return new MedicalSymptom(mainEntityOfPage, possibleTreatment, alternateName, potentialAction, url, additionalType, medicineSystem, sameAs, recognizingAuthority, study, code, cause, name, image, relevantSpecialty, guideline, description);
    }
    /**
  ...
  protected MedicalSymptom(CreativeWork mainEntityOfPage, MedicalTherapy possibleTreatment, String alternateName, Action potentialAction, String url, String additionalType, MedicineSystem medicineSystem, String sameAs, Organization recognizingAuthority, MedicalStudy study, MedicalCode code, MedicalCause cause, String name, Image image, MedicalSpecialty relevantSpecialty, MedicalGuideline guideline, String description) {
