...
public class TipAction extends TradeAction {
  ...
  public static final class Builder {
    ...
    public TipAction build() {
      return new TipAction(recipient, price, priceSpecification, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
     * A sub property of participant. The participant who is at the receiving end of the action.
     */
