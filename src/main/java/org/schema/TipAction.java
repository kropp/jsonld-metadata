...
public class TipAction extends TradeAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link TipAction} instance.
     */
    public TipAction build() {
      return new TipAction(startTime, name, mainEntityOfPage, error, price, url, sameAs, additionalType, recipient, agent, alternateName, description, priceSpecification, target, potentialAction, endTime, actionStatus);
    }
    /**
