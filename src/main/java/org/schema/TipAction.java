...
public class TipAction extends TradeAction {
   ...
   */
  static final class TipActionThingBuilder implements Builder {
    /**
     * Creates new {@link TipAction} instance.
     */
    public TipAction build() {
      return new TipAction(recipient, price, priceSpecification, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of participant. The participant who is at the receiving end of the action.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<TipAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    TipAction tipAction = (TipAction) o;
    if (!super.equals(o)) return false;
    if (myRecipient != null ? !myRecipient.equals(tipAction.myRecipient) : tipAction.myRecipient != null) return false;
    return true;
  }
