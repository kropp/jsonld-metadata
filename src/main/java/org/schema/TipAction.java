...
public class TipAction extends TradeAction {
  ...
  /**
   * Builder for {@see TipAction}
   */
  public static final class Builder {
    public TipAction build() {
      return new TipAction(priceSpecification, instrument, recipient, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location, price);
    }
    /**
