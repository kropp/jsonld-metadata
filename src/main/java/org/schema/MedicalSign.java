...
public class MedicalSign extends MedicalSignOrSymptom {
  ...
  public static class Builder extends MedicalSignOrSymptom.Builder {
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("identifyingExam".equals(key) && value instanceof PhysicalExam) { identifyingExam((PhysicalExam)value); return; }
      if ("identifyingTest".equals(key) && value instanceof MedicalTest) { identifyingTest((MedicalTest)value); return; }
