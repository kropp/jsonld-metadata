...
/**
 * Any physical manifestation of a person's medical condition discoverable by objective diagnostic tests or physical examination.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class MedicalSign extends MedicalSignOrSymptom {
  /**
   * A physical examination that can identify this sign.
   */
  public PhysicalExam getIdentifyingExam() { return myIdentifyingExam; }
  /**
   * A diagnostic test that can identify this sign.
   */
  public MedicalTest getIdentifyingTest() { return myIdentifyingTest; }
   ...
   */
  public static class Builder implements ThingBuilder<MedicalSign> {
