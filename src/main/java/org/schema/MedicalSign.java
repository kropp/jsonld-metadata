...
public class MedicalSign extends MedicalSignOrSymptom {
  ...
  static final class MedicalSignThingBuilder implements Builder {
     ...
     * A physical examination that can identify this sign.
     */
    @NotNull public Builder identifyingExam(PhysicalExam physicalExam) {
     ...
     * A physical examination that can identify this sign.
     */
    @NotNull public Builder identifyingExam(PhysicalExam.Builder physicalExam) {
      return this.identifyingExam(physicalExam.build());
    }
    /**
     * A diagnostic test that can identify this sign.
     */
    @NotNull public Builder identifyingTest(MedicalTest medicalTest) {
  ...
  public interface Builder extends ThingBuilder<MedicalSign> {
    @NotNull Builder identifyingExam(PhysicalExam physicalExam);
    @NotNull Builder identifyingExam(PhysicalExam.Builder physicalExam);
    @NotNull Builder identifyingTest(MedicalTest medicalTest);
    @NotNull Builder identifyingTest(MedicalTest.Builder medicalTest);
