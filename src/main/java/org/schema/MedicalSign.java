...
public class MedicalSign extends MedicalSignOrSymptom {
   ...
   */
  static final class MedicalSignThingBuilder implements Builder {
    /**
    ...
    @NotNull public Builder identifyingExam(@NotNull PhysicalExam.Builder physicalExam) {
      return this.identifyingExam(physicalExam.build());
    }
    /**
     * A diagnostic test that can identify this sign.
     */
    ...
    @NotNull public Builder identifyingTest(@NotNull MedicalTest.Builder medicalTest) {
      return this.identifyingTest(medicalTest.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("identifyingExam".equals(key) && value instanceof PhysicalExam) { identifyingExam((PhysicalExam)value); continue; }
        if ("identifyingTest".equals(key) && value instanceof MedicalTest) { identifyingTest((MedicalTest)value); continue; }
  ...
  public interface Builder extends ThingBuilder<MedicalSign> {
    @NotNull Builder identifyingExam(@NotNull PhysicalExam physicalExam);
    @NotNull Builder identifyingExam(@NotNull PhysicalExam.Builder physicalExam);
    @NotNull Builder identifyingTest(@NotNull MedicalTest medicalTest);
    @NotNull Builder identifyingTest(@NotNull MedicalTest.Builder medicalTest);
