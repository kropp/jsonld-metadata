...
public class MedicalSign extends MedicalSignOrSymptom {
  ...
  public static final class Builder {
    ...
    public MedicalSign build() {
      return new MedicalSign(recognizingAuthority, code, name, mainEntityOfPage, identifyingTest, guideline, possibleTreatment, cause, url, sameAs, additionalType, alternateName, identifyingExam, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
     ...
     * A diagnostic test that can identify this sign.
     */
    public Builder identifyingTest(MedicalTest medicalTest) {
      this.identifyingTest = medicalTest;
      return this;
    }
    /**
     ...
     * A physical examination that can identify this sign.
     */
    public Builder identifyingExam(PhysicalExam physicalExam) {
      this.identifyingExam = physicalExam;
      return this;
    }
    /**
  ...
  protected MedicalSign(Organization recognizingAuthority, MedicalCode code, String name, StringOrCreativeWork mainEntityOfPage, MedicalTest identifyingTest, MedicalGuideline guideline, MedicalTherapy possibleTreatment, MedicalCause cause, String url, String sameAs, String additionalType, String alternateName, PhysicalExam identifyingExam, MedicalStudy study, String description, Action potentialAction, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem) {
    super(recognizingAuthority, code, name, mainEntityOfPage, guideline, possibleTreatment, cause, url, sameAs, additionalType, alternateName, study, potentialAction, description, relevantSpecialty, medicineSystem);
