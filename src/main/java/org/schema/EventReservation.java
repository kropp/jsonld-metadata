...
public class EventReservation extends Reservation {
  /**
   * Builder for {@see EventReservation}
   */
  public static final class Builder {
    public EventReservation build() {
      return new EventReservation(reservedTicket, mainEntityOfPage, priceCurrency, reservationStatus, potentialAction, alternateName, url, additionalType, modifiedTime, sameAs, underName, bookingTime, image, name, reservationFor, reservationId, broker, totalPrice, programMembershipUsed, description, provider);
    }
    /**
