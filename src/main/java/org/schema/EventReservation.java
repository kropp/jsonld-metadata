...
public class EventReservation extends Reservation {
  ...
  public static final class Builder {
    /**
     * Creates new {@link EventReservation} instance.
     */
    public EventReservation build() {
      return new EventReservation(bookingTime, reservationStatus, modifiedTime, provider, totalPrice, reservationId, priceCurrency, name, underName, mainEntityOfPage, reservedTicket, additionalType, url, sameAs, broker, programMembershipUsed, reservationFor, alternateName, description, potentialAction);
    }
    /**
