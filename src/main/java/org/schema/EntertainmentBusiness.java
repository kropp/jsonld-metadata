...
public class EntertainmentBusiness extends LocalBusiness {
  ...
  @Override public boolean equals(Object o) {
    ...
    EntertainmentBusiness entertainmentBusiness = (EntertainmentBusiness) o;
   ...
   */
  public static class Builder implements ThingBuilder<EntertainmentBusiness> {
    public EntertainmentBusiness build() {
      return new EntertainmentBusiness(parentOrganization, currenciesAccepted, openingHours, paymentAccepted, priceRange, address, aggregateRating, containedIn, event, faxNumber, geo, globalLocationNumber, isicV4, logo, hasMap, openingHoursSpecification, photo, review, telephone, additionalProperty, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
