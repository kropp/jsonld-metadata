...
public class MedicalTestPanel extends MedicalTest {
  ...
  /**
   * Builder for {@see MedicalTestPanel}
   */
  public static final class Builder {
    public MedicalTestPanel build() {
      return new MedicalTestPanel(usedToDiagnose, mainEntityOfPage, usesDevice, potentialAction, affectedBy, alternateName, subTest, additionalType, url, medicineSystem, recognizingAuthority, sameAs, study, code, normalRange, name, image, relevantSpecialty, guideline, signDetected, description);
    }
    /**
     ...
     * A component test of the panel.
     */
    public Builder subTest(MedicalTest value) {
      subTest = value;
      return this;
    }
    /**
  ...
  protected MedicalTestPanel(MedicalCondition usedToDiagnose, CreativeWork mainEntityOfPage, MedicalDevice usesDevice, Action potentialAction, Drug affectedBy, String alternateName, MedicalTest subTest, String additionalType, String url, MedicineSystem medicineSystem, Organization recognizingAuthority, String sameAs, MedicalStudy study, MedicalCode code, String normalRange, String name, Image image, MedicalSpecialty relevantSpecialty, MedicalGuideline guideline, MedicalSign signDetected, String description) {
