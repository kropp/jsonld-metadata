...
/**
 * Any collection of tests commonly ordered together.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class MedicalTestPanel extends MedicalTest {
  /**
   * A component test of the panel.
   */
  public MedicalTest getSubTest() { return mySubTest; }
   ...
   */
  public static class Builder implements ThingBuilder<MedicalTestPanel> {
