...
public class MedicalTestPanel extends MedicalTest {
   ...
   */
  static final class MedicalTestPanelThingBuilder implements Builder {
    /**
     * Creates new {@link MedicalTestPanel} instance.
     */
    public MedicalTestPanel build() {
      return new MedicalTestPanel(subTest, affectedBy, normalRange, signDetected, usedToDiagnose, usesDevice, code, guideline, medicineSystem, recognizingAuthority, relevantSpecialty, study, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A component test of the panel.
     */
    ...
    @NotNull public Builder subTest(@NotNull MedicalTest.Builder medicalTest) {
      return this.subTest(medicalTest.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("subTest".equals(key) && value instanceof MedicalTest) { subTest((MedicalTest)value); continue; }
  ...
  public interface Builder extends ThingBuilder<MedicalTestPanel> {
    @NotNull Builder subTest(@NotNull MedicalTest medicalTest);
    @NotNull Builder subTest(@NotNull MedicalTest.Builder medicalTest);
