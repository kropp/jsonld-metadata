...
public class UserPlays extends UserInteraction {
   ...
   */
  static final class UserPlaysThingBuilder implements Builder {
    /**
     * Creates new {@link UserPlays} instance.
     */
    public UserPlays build() {
      return new UserPlays(aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<UserPlays> {
  ...
  @Override public boolean equals(Object o) {
    ...
    UserPlays userPlays = (UserPlays) o;
