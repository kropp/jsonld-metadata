...
public class CheckOutAction extends CommunicateAction {
  ...
  public static final class Builder {
    ...
    public CheckOutAction build() {
      return new CheckOutAction(startTime, about, inLanguage, name, mainEntityOfPage, error, sameAs, url, additionalType, recipient, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
