...
public class CheckOutAction extends CommunicateAction {
   ...
   */
  public static final class CheckOutActionThingBuilder implements Builder {
    /**
     * Creates new {@link CheckOutAction} instance.
     */
    public CheckOutAction build() {
      return new CheckOutAction(about, inLanguage, recipient, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<CheckOutAction> {
