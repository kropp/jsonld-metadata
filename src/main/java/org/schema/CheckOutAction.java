...
public class CheckOutAction extends CommunicateAction {
  /**
   * Builder for {@see CheckOutAction}
   */
  public static final class Builder {
    public CheckOutAction build() {
      return new CheckOutAction(instrument, recipient, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, about, startTime, sameAs, actionStatus, inLanguage, result, error, name, image, target, object, location, description);
    }
