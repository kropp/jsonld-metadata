...
public class ExercisePlan extends PhysicalActivity {
   ...
   */
  public static final class ExercisePlanThingBuilder implements Builder {
    /**
     ...
     * Length of time to engage in the activity.
     */
    public Builder activityDuration(Duration.Builder duration) {
     ...
     * Quantitative measure of the physiologic output of the exercise; also referred to as energy expenditure.
     */
    public Builder workload(Energy.Builder energy) {
  ...
  Builder activityDuration(Duration duration);
  Builder activityDuration(Duration.Builder duration);
  Builder activityFrequency(String activityFrequency);
  Builder additionalVariable(String additionalVariable);
  Builder exerciseType(String exerciseType);
  Builder intensity(String intensity);
  Builder repetitions(Integer integer);
  Builder repetitions(Long repetitions);
  Builder repetitions(Float repetitions);
  Builder repetitions(Double repetitions);
  Builder repetitions(String repetitions);
  Builder restPeriods(String restPeriods);
  Builder workload(Energy energy);
  Builder workload(Energy.Builder energy);
