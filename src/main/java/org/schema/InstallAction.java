...
public class InstallAction extends ConsumeAction {
   ...
   */
  public static final class InstallActionThingBuilder implements Builder {
    /**
     ...
     */
    public Builder expectsAcceptanceOf(Offer offer) {
     ...
     * An Offer which must be accepted before the user can perform the Action. For example, the user may need to buy a movie before being able to watch it.
     */
    public Builder expectsAcceptanceOf(Offer.Builder offer) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  Builder expectsAcceptanceOf(Offer offer);
  Builder expectsAcceptanceOf(Offer.Builder offer);
