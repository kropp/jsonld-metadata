...
public class GameServer extends Intangible {
  ...
  static final class GameServerThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("serverStatus".equals(key) && value instanceof GameServerStatus) { serverStatus((GameServerStatus)value); continue; }
        if ("playersOnline".equals(key) && value instanceof Integer) { playersOnline((Integer)value); continue; }
        if ("game".equals(key) && value instanceof VideoGame) { game((VideoGame)value); continue; }
  ...
  public interface Builder extends ThingBuilder<GameServer> {
    @NotNull Builder serverStatus(@NotNull GameServerStatus gameServerStatus);
    @NotNull Builder serverStatus(@NotNull GameServerStatus.Builder gameServerStatus);
    @NotNull Builder playersOnline(@NotNull Integer integer);
    @NotNull Builder game(@NotNull VideoGame videoGame);
    @NotNull Builder game(@NotNull VideoGame.Builder videoGame);
