...
public class ChildrensEvent extends Event {
   ...
   */
  static final class ChildrensEventThingBuilder implements Builder {
    /**
     * Creates new {@link ChildrensEvent} instance.
     */
    public ChildrensEvent build() {
      return new ChildrensEvent(aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<ChildrensEvent> {
  ...
  @Override public boolean equals(Object o) {
    ...
    ChildrensEvent childrensEvent = (ChildrensEvent) o;
