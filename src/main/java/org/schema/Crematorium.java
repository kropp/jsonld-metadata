...
public class Crematorium extends CivicStructure {
  /**
   * Builder for {@see Crematorium}
   */
  public static final class Builder {
    public Crematorium build() {
      return new Crematorium(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
