...
public class DepartAction extends MoveAction {
   ...
   */
  static final class DepartActionThingBuilder implements Builder {
    /**
     * Creates new {@link DepartAction} instance.
     */
    public DepartAction build() {
      return new DepartAction(fromLocation, toLocation, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<DepartAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    DepartAction departAction = (DepartAction) o;
