...
public class DepartAction extends MoveAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link DepartAction} instance.
     */
    public DepartAction build() {
      return new DepartAction(startTime, toLocation, name, mainEntityOfPage, error, fromLocation, url, sameAs, additionalType, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
