...
public class DepartAction extends MoveAction {
  /**
   * Builder for {@see DepartAction}
   */
  public static final class Builder {
    public DepartAction build() {
      return new DepartAction(instrument, mainEntityOfPage, toLocation, agent, endTime, alternateName, potentialAction, fromLocation, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
