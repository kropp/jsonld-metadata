...
public class DepartAction extends MoveAction {
  ...
  public static final class Builder {
    ...
    public DepartAction build() {
      return new DepartAction(fromLocation, toLocation, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
