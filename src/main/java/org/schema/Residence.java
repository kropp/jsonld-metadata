...
public class Residence extends Place {
  ...
  public static final class Builder {
    /**
     * Creates new {@link Residence} instance.
     */
    public Residence build() {
      return new Residence(aggregateRating, review, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, containedIn, additionalType, sameAs, url, event, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
