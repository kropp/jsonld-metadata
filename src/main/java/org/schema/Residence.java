...
public class Residence extends Place {
  /**
   * Builder for {@see Residence}
   */
  public static final class Builder {
    public Residence build() {
      return new Residence(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, geo, additionalType, url, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
