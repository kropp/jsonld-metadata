...
public class DayOfWeek extends Enumeration {
  ...
  public static final class Builder {
    ...
    public DayOfWeek build() {
      return new DayOfWeek(sameAs, url, additionalType, alternateName, supersededBy, description, potentialAction, name, mainEntityOfPage);
    }
    /**
  ...
  protected DayOfWeek(String sameAs, String url, String additionalType, String alternateName, EnumerationOrProperty supersededBy, String description, Action potentialAction, String name, StringOrCreativeWork mainEntityOfPage) {
