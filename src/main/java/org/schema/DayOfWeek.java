...
public class DayOfWeek extends Enumeration {
  /**
   * Builder for {@see DayOfWeek}
   */
  public static final class Builder {
    public DayOfWeek build() {
      return new DayOfWeek(mainEntityOfPage, name, image, supersededBy, potentialAction, alternateName, additionalType, url, description, sameAs);
    }
    /**
  ...
  protected DayOfWeek(CreativeWork mainEntityOfPage, String name, Image image, Property supersededBy, Action potentialAction, String alternateName, String additionalType, String url, String description, String sameAs) {
