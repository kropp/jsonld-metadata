...
public class CatholicChurch extends PlaceOfWorship {
  ...
  public static final class Builder {
    ...
    public CatholicChurch build() {
      return new CatholicChurch(aggregateRating, review, openingHours, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, additionalType, event, url, sameAs, containedIn, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
