...
public class CatholicChurch extends PlaceOfWorship {
  /**
   * Builder for {@see CatholicChurch}
   */
  public static final class Builder {
    public CatholicChurch build() {
      return new CatholicChurch(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, geo, url, additionalType, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
