...
public class SearchAction extends Action {
  ...
  /**
   * Builder for {@see SearchAction}
   */
  public static final class Builder {
    public SearchAction build() {
      return new SearchAction(instrument, query, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, object, location, description);
    }
