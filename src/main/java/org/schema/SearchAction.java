...
public class SearchAction extends Action {
  ...
  public static final class Builder {
    ...
    public SearchAction build() {
      return new SearchAction(startTime, name, error, mainEntityOfPage, query, url, sameAs, additionalType, agent, alternateName, potentialAction, description, target, endTime, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected SearchAction(java.util.Date startTime, String name, Thing error, StringOrCreativeWork mainEntityOfPage, String query, String url, String sameAs, String additionalType, OrganizationOrPerson agent, String alternateName, Action potentialAction, String description, EntryPoint target, java.util.Date endTime, ActionStatusType actionStatus) {
