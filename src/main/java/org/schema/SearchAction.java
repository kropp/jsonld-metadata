...
public class SearchAction extends Action {
   ...
   */
  static final class SearchActionThingBuilder implements Builder {
    /**
     * Creates new {@link SearchAction} instance.
     */
    public SearchAction build() {
      return new SearchAction(query, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of instrument. The query used on this action.
     */
    @NotNull public Builder query(String query) {
      this.query = query;
      return this;
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<SearchAction> {
    @NotNull Builder query(String query);
  ...
  protected SearchAction(String query, OrganizationOrPerson agent, java.util.Date endTime, java.util.Date startTime, ActionStatusType actionStatus, Thing error, EntryPoint target, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
