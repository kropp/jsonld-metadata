...
public class DrugCost extends MedicalIntangible {
   ...
   */
  public StringOrNumber getCostPerUnit() {
  ...
  public static final class Builder {
    ...
    public DrugCost build() {
      return new DrugCost(recognizingAuthority, costPerUnit, drugUnit, code, costCategory, applicableLocation, costCurrency, name, mainEntityOfPage, guideline, additionalType, sameAs, url, alternateName, study, potentialAction, description, relevantSpecialty, medicineSystem, costOrigin);
    }
    /**
    ...
    private StringOrNumber costPerUnit;
  ...
  protected DrugCost(Organization recognizingAuthority, StringOrNumber costPerUnit, String drugUnit, MedicalCode code, DrugCostCategory costCategory, AdministrativeArea applicableLocation, String costCurrency, String name, StringOrCreativeWork mainEntityOfPage, MedicalGuideline guideline, String additionalType, String sameAs, String url, String alternateName, MedicalStudy study, Action potentialAction, String description, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem, String costOrigin) {
  ...
  private StringOrNumber myCostPerUnit;
