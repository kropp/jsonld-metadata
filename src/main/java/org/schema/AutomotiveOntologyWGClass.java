 ...
 */
public class AutomotiveOntologyWGClass {
  ...
  @Override public boolean equals(Object o) {
    ...
    AutomotiveOntologyWGClass automotiveOntologyWGClass = (AutomotiveOntologyWGClass) o;
   ...
   */
  public static class Builder implements ThingBuilder<AutomotiveOntologyWGClass> {
    public AutomotiveOntologyWGClass build() {
      return new AutomotiveOntologyWGClass();
    }
