...
public class WebPage extends CreativeWork {
   ...
   */
  public StringOrBreadcrumbList getBreadcrumb() {
    return myBreadcrumb;
  }
  /**
  ...
  private StringOrBreadcrumbList myBreadcrumb;
