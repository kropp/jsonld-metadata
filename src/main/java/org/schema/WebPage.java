...
public class WebPage extends CreativeWork {
   ...
   */
  public static final class WebPageThingBuilder implements Builder {
    /**
     ...
     * A set of links that can help a user understand and navigate a website hierarchy.
     */
    public Builder breadcrumb(BreadcrumbList.Builder breadcrumbList) {
     ...
     * Indicates if this web page element is the main subject of the page.
     */
    public Builder mainContentOfPage(WebPageElement.Builder webPageElement) {
     ...
     * Indicates the main image on the page.
     */
    public Builder primaryImageOfPage(ImageObject.Builder imageObject) {
     ...
     * People or organizations that have reviewed the content on this web page for accuracy and/or completeness.
     */
    public Builder reviewedBy(Organization.Builder organization) {
     ...
     * People or organizations that have reviewed the content on this web page for accuracy and/or completeness.
     */
    public Builder reviewedBy(Person.Builder person) {
     ...
     * One of the domain specialities to which this web page's content applies.
     */
    public Builder specialty(Specialty.Builder specialty) {
  ...
  Builder breadcrumb(BreadcrumbList breadcrumbList);
  Builder breadcrumb(BreadcrumbList.Builder breadcrumbList);
  Builder breadcrumb(String breadcrumb);
  Builder lastReviewed(java.util.Date date);
  Builder mainContentOfPage(WebPageElement webPageElement);
  Builder mainContentOfPage(WebPageElement.Builder webPageElement);
  Builder primaryImageOfPage(ImageObject imageObject);
  Builder primaryImageOfPage(ImageObject.Builder imageObject);
  Builder relatedLink(String relatedLink);
  Builder reviewedBy(Organization organization);
  Builder reviewedBy(Organization.Builder organization);
  Builder reviewedBy(Person person);
  Builder reviewedBy(Person.Builder person);
  Builder significantLink(String significantLink);
  Builder specialty(Specialty specialty);
  Builder specialty(Specialty.Builder specialty);
