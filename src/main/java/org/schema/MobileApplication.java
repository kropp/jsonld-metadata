...
public class MobileApplication extends SoftwareApplication {
  ...
  public static final class Builder {
    ...
    public MobileApplication build() {
      return new MobileApplication(accessibilityAPI, availableOnDevice, aggregateRating, hasPart, review, installUrl, datePublished, comment, schemaVersion, video, award, releaseNotes, editor, workExample, storageRequirements, applicationCategory, potentialAction, producer, screenshot, publisher, countriesNotSupported, sourceOrganization, learningResourceType, genre, translator, publishingPrinciples, recordedAt, commentCount, inLanguage, dateModified, softwareVersion, fileFormat, mentions, audience, headline, url, interactivityType, fileSize, associatedMedia, character, contentRating, description, permissions, offers, downloadUrl, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, applicationSubCategory, about, contentLocation, author, accessibilityHazard, version, accountablePerson, softwareRequirements, additionalType, sameAs, thumbnailUrl, publication, encoding, timeRequired, operatingSystem, carrierRequirements, softwareAddOn, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, processorRequirements, softwareHelp, mainEntity, alternativeHeadline, name, applicationSuite, license, mainEntityOfPage, discussionUrl, copyrightYear, memoryRequirements, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, featureList, countriesSupported, creator, contributor);
    }
    /**
