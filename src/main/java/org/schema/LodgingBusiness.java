...
public class LodgingBusiness extends LocalBusiness {
  ...
  public static final class Builder {
    /**
     * Creates new {@link LodgingBusiness} instance.
     */
    public LodgingBusiness build() {
      return new LodgingBusiness(aggregateRating, review, logo, parentOrganization, containedIn, event, additionalType, sameAs, priceRange, openingHoursSpecification, currenciesAccepted, potentialAction, address, additionalProperty, openingHours, globalLocationNumber, isicV4, name, paymentAccepted, mainEntityOfPage, hasMap, url, alternateName, faxNumber, geo, telephone, description, photo);
    }
    /**
