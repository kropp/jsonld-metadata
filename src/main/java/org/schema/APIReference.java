...
public class APIReference extends TechArticle {
  ...
  static final class APIReferenceThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("executableLibraryName".equals(key) && value instanceof String) { executableLibraryName((String)value); continue; }
        if ("assemblyVersion".equals(key) && value instanceof String) { assemblyVersion((String)value); continue; }
        if ("programmingModel".equals(key) && value instanceof String) { programmingModel((String)value); continue; }
        if ("targetPlatform".equals(key) && value instanceof String) { targetPlatform((String)value); continue; }
        if ("dependencies".equals(key) && value instanceof String) { dependencies((String)value); continue; }
        if ("proficiencyLevel".equals(key) && value instanceof String) { proficiencyLevel((String)value); continue; }
  ...
  public interface Builder extends ThingBuilder<APIReference> {
    @NotNull Builder executableLibraryName(@NotNull String executableLibraryName);
    @NotNull Builder assemblyVersion(@NotNull String assemblyVersion);
    @NotNull Builder programmingModel(@NotNull String programmingModel);
    @NotNull Builder targetPlatform(@NotNull String targetPlatform);
    @NotNull Builder dependencies(@NotNull String dependencies);
    @NotNull Builder proficiencyLevel(@NotNull String proficiencyLevel);
