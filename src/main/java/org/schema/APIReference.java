...
public class APIReference extends TechArticle {
   ...
   */
  public static final class APIReferenceThingBuilder implements Builder {
    /**
  ...
  Builder executableLibraryName(String executableLibraryName);
  Builder assemblyVersion(String assemblyVersion);
  Builder programmingModel(String programmingModel);
  Builder targetPlatform(String targetPlatform);
  Builder dependencies(String dependencies);
  Builder proficiencyLevel(String proficiencyLevel);
