...
public class APIReference extends TechArticle {
   ...
   */
  public String getExecutableLibraryName() { return myExecutableLibraryName; }
  /**
   * Associated product/technology version. e.g., .NET Framework 4.5.
   */
  public String getAssemblyVersion() { return myAssemblyVersion; }
  /**
   * Indicates whether API is managed or unmanaged.
   */
  public String getProgrammingModel() { return myProgrammingModel; }
  /**
   * Type of app development: phone, Metro style, desktop, XBox, etc.
   */
  public String getTargetPlatform() { return myTargetPlatform; }
   ...
   */
  public static class Builder implements ThingBuilder<APIReference> {
