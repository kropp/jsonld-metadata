...
public class APIReference extends TechArticle {
   ...
   */
  static final class APIReferenceThingBuilder implements Builder {
    /**
     ...
     * Library file name e.g., mscorlib.dll, system.web.dll.
     */
    @NotNull public Builder executableLibraryName(String executableLibraryName) {
     ...
     * Associated product/technology version. e.g., .NET Framework 4.5.
     */
    @NotNull public Builder assemblyVersion(String assemblyVersion) {
     ...
     * Indicates whether API is managed or unmanaged.
     */
    @NotNull public Builder programmingModel(String programmingModel) {
     ...
     */
    @NotNull public Builder dependencies(String dependencies) {
     ...
     */
    @NotNull public Builder proficiencyLevel(String proficiencyLevel) {
  ...
  public interface Builder extends ThingBuilder<APIReference> {
    @NotNull Builder executableLibraryName(String executableLibraryName);
    @NotNull Builder assemblyVersion(String assemblyVersion);
    @NotNull Builder programmingModel(String programmingModel);
    @NotNull Builder targetPlatform(String targetPlatform);
    @NotNull Builder dependencies(String dependencies);
    @NotNull Builder proficiencyLevel(String proficiencyLevel);
