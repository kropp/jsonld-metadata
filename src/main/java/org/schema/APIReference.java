...
public class APIReference extends TechArticle {
  ...
  public static final class Builder {
    ...
    public APIReference build() {
      return new APIReference(accessibilityAPI, aggregateRating, hasPart, review, datePublished, schemaVersion, comment, video, assemblyVersion, award, editor, workExample, wordCount, potentialAction, pageStart, producer, dependencies, publisher, sourceOrganization, genre, learningResourceType, publishingPrinciples, translator, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, articleBody, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, about, contentLocation, accessibilityHazard, author, pagination, version, accountablePerson, sameAs, additionalType, thumbnailUrl, articleSection, publication, encoding, timeRequired, programmingModel, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, executableLibraryName, alternativeHeadline, mainEntity, name, license, copyrightYear, discussionUrl, mainEntityOfPage, isBasedOnUrl, pageEnd, isFamilyFriendly, targetPlatform, exampleOfWork, alternateName, releasedEvent, proficiencyLevel, contributor, creator);
    }
    /**
     ...
     * Indicates whether API is managed or unmanaged.
     */
    public Builder programmingModel(String programmingModel) {
     ...
     * Library file name e.g., mscorlib.dll, system.web.dll.
     */
    public Builder executableLibraryName(String executableLibraryName) {
  ...
  protected APIReference(String accessibilityAPI, AggregateRating aggregateRating, HasPart hasPart, Review review, java.util.Date datePublished, String schemaVersion, Comment comment, VideoObject video, String assemblyVersion, String award, Person editor, CreativeWork workExample, Integer wordCount, Action potentialAction, IntegerOrString pageStart, OrganizationOrPerson producer, String dependencies, Organization publisher, Organization sourceOrganization, String genre, String learningResourceType, String publishingPrinciples, OrganizationOrPerson translator, Event recordedAt, Integer commentCount, LanguageOrString inLanguage, java.util.Date dateModified, Thing mentions, Audience audience, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, String contentRating, String description, String articleBody, Offer offers, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, String educationalUse, String keywords, AlignmentObject educationalAlignment, String text, Thing about, Place contentLocation, String accessibilityHazard, OrganizationOrPerson author, String pagination, Number version, Person accountablePerson, String sameAs, String additionalType, String thumbnailUrl, String articleSection, PublicationEvent publication, MediaObject encoding, Duration timeRequired, String programmingModel, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, String executableLibraryName, String alternativeHeadline, Thing mainEntity, String name, StringOrCreativeWork license, Number copyrightYear, String discussionUrl, StringOrCreativeWork mainEntityOfPage, String isBasedOnUrl, IntegerOrString pageEnd, Boolean isFamilyFriendly, String targetPlatform, CreativeWork exampleOfWork, String alternateName, PublicationEvent releasedEvent, String proficiencyLevel, OrganizationOrPerson contributor, OrganizationOrPerson creator) {
