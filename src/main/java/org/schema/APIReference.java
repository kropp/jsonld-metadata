...
public class APIReference extends TechArticle {
  ...
  public String getExecutableLibraryName() {
    return myExecutableLibraryName;
  }
  /**
   * Associated product/technology version. e.g., .NET Framework 4.5.
   */
  public String getAssemblyVersion() {
    return myAssemblyVersion;
  }
  /**
   * Indicates whether API is managed or unmanaged.
   */
  public String getProgrammingModel() {
    return myProgrammingModel;
  }
  /**
  ...
  /**
   * Builder for {@see APIReference}
   */
  public static final class Builder {
    public APIReference build() {
      return new APIReference(producer, editor, review, timeRequired, offers, creator, educationalUse, wordCount, pagination, alternativeHeadline, mentions, additionalType, position, associatedMedia, isFamilyFriendly, accessibilityControl, image, keywords, articleSection, discussionUrl, isBasedOnUrl, exampleOfWork, comment, datePublished, targetPlatform, alternateName, author, video, publisher, url, interactivityType, about, executableLibraryName, character, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, genre, potentialAction, contentRating, audience, pageStart, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, releasedEvent, accessibilityFeature, accessibilityHazard, license, description, publication, provider, educationalAlignment, recordedAt, pageEnd, mainEntityOfPage, assemblyVersion, contributor, isPartOf, workExample, articleBody, dateCreated, copyrightHolder, aggregateRating, sameAs, dependencies, programmingModel, name, proficiencyLevel, typicalAgeRange, citation, copyrightYear, translator, sourceOrganization, text, award);
    }
    /**
     ...
     */
    public Builder wordCount(Integer value) {
      wordCount = value;
      return this;
    }
    /**
     ...
     */
    public Builder pagination(String value) {
      pagination = value;
      return this;
    }
    /**
     ...
     */
    public Builder articleSection(String value) {
     ...
     * Type of app development: phone, Metro style, desktop, XBox, etc.
     */
    public Builder targetPlatform(String value) {
     ...
     * Library file name e.g., mscorlib.dll, system.web.dll.
     */
    public Builder executableLibraryName(String value) {
      executableLibraryName = value;
      return this;
    }
    /**
     ...
     */
    public Builder pageStart(Integer value) {
      pageStart = value;
      return this;
    }
    /**
     ...
     */
    public Builder pageEnd(Integer value) {
      pageEnd = value;
      return this;
    }
    /**
     ...
     * Associated product/technology version. e.g., .NET Framework 4.5.
     */
    public Builder assemblyVersion(String value) {
     ...
     */
    public Builder articleBody(String value) {
      articleBody = value;
      return this;
    }
    /**
     ...
     * Indicates whether API is managed or unmanaged.
     */
    public Builder programmingModel(String value) {
      programmingModel = value;
      return this;
    }
    /**
     ...
     */
    public Builder proficiencyLevel(String value) {
  ...
  protected APIReference(Person producer, Person editor, Review review, Duration timeRequired, Offer offers, Organization creator, String educationalUse, Integer wordCount, String pagination, String alternativeHeadline, Thing mentions, String additionalType, Position position, MediaObject associatedMedia, Boolean isFamilyFriendly, String accessibilityControl, Image image, String keywords, String articleSection, String discussionUrl, String isBasedOnUrl, CreativeWork exampleOfWork, Comment comment, java.util.Date datePublished, String targetPlatform, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, String executableLibraryName, Person character, String schemaVersion, String accessibilityAPI, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, String genre, Action potentialAction, String contentRating, Audience audience, Integer pageStart, String inLanguage, Place contentLocation, String learningResourceType, Person accountablePerson, AudioObject audio, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, String accessibilityFeature, String accessibilityHazard, CreativeWork license, String description, PublicationEvent publication, Person provider, AlignmentObject educationalAlignment, Event recordedAt, Integer pageEnd, CreativeWork mainEntityOfPage, String assemblyVersion, Organization contributor, IsPartOf isPartOf, CreativeWork workExample, String articleBody, java.util.Date dateCreated, Organization copyrightHolder, AggregateRating aggregateRating, String sameAs, String dependencies, String programmingModel, String name, String proficiencyLevel, String typicalAgeRange, CreativeWork citation, Number copyrightYear, Person translator, Organization sourceOrganization, String text, String award) {
    super(editor, producer, review, timeRequired, offers, creator, educationalUse, wordCount, alternativeHeadline, pagination, mentions, additionalType, position, associatedMedia, isFamilyFriendly, image, accessibilityControl, keywords, articleSection, discussionUrl, isBasedOnUrl, exampleOfWork, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, genre, potentialAction, contentRating, audience, pageStart, inLanguage, contentLocation, learningResourceType, audio, accountablePerson, dateModified, thumbnailUrl, releasedEvent, accessibilityHazard, accessibilityFeature, license, description, provider, publication, recordedAt, educationalAlignment, pageEnd, mainEntityOfPage, contributor, articleBody, workExample, isPartOf, dateCreated, copyrightHolder, sameAs, aggregateRating, dependencies, name, proficiencyLevel, typicalAgeRange, translator, copyrightYear, citation, sourceOrganization, text, award);
