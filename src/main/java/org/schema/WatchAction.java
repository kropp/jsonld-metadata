...
public class WatchAction extends ConsumeAction {
  ...
  public static final class Builder {
    ...
    public WatchAction build() {
      return new WatchAction(expectsAcceptanceOf, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
