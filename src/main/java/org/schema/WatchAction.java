...
public class WatchAction extends ConsumeAction {
   ...
   */
  static final class WatchActionThingBuilder implements Builder {
    /**
     * Creates new {@link WatchAction} instance.
     */
    public WatchAction build() {
      return new WatchAction(expectsAcceptanceOf, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<WatchAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    WatchAction watchAction = (WatchAction) o;
