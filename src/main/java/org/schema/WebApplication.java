...
public class WebApplication extends SoftwareApplication {
  ...
  public static final class Builder {
    /**
     * Creates new {@link WebApplication} instance.
     */
    public WebApplication build() {
      return new WebApplication(accessibilityAPI, availableOnDevice, aggregateRating, hasPart, review, installUrl, datePublished, comment, schemaVersion, video, award, releaseNotes, editor, workExample, storageRequirements, applicationCategory, potentialAction, producer, screenshot, publisher, countriesNotSupported, sourceOrganization, learningResourceType, genre, translator, publishingPrinciples, recordedAt, commentCount, inLanguage, dateModified, softwareVersion, browserRequirements, fileFormat, mentions, audience, headline, url, interactivityType, fileSize, associatedMedia, character, contentRating, description, permissions, offers, downloadUrl, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, applicationSubCategory, about, contentLocation, author, accessibilityHazard, version, accountablePerson, softwareRequirements, additionalType, sameAs, thumbnailUrl, publication, encoding, timeRequired, operatingSystem, softwareAddOn, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, processorRequirements, softwareHelp, mainEntity, alternativeHeadline, name, applicationSuite, license, mainEntityOfPage, discussionUrl, copyrightYear, memoryRequirements, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, featureList, countriesSupported, creator, contributor);
    }
    /**
     ...
     * Specifies browser requirements in human-readable text. For example,"requires HTML5 support".
     */
    public Builder browserRequirements(String browserRequirements) {
  ...
  protected WebApplication(String accessibilityAPI, String availableOnDevice, AggregateRating aggregateRating, HasPart hasPart, Review review, String installUrl, java.util.Date datePublished, Comment comment, String schemaVersion, VideoObject video, String award, String releaseNotes, Person editor, CreativeWork workExample, String storageRequirements, String applicationCategory, Action potentialAction, OrganizationOrPerson producer, ImageObjectOrString screenshot, Organization publisher, String countriesNotSupported, Organization sourceOrganization, String learningResourceType, String genre, OrganizationOrPerson translator, String publishingPrinciples, Event recordedAt, Integer commentCount, LanguageOrString inLanguage, java.util.Date dateModified, String softwareVersion, String browserRequirements, String fileFormat, Thing mentions, Audience audience, String headline, String url, String interactivityType, Integer fileSize, MediaObject associatedMedia, Person character, String contentRating, String description, String permissions, Offer offers, String downloadUrl, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, String educationalUse, String keywords, AlignmentObject educationalAlignment, String text, String applicationSubCategory, Thing about, Place contentLocation, OrganizationOrPerson author, String accessibilityHazard, Number version, Person accountablePerson, String softwareRequirements, String additionalType, String sameAs, String thumbnailUrl, PublicationEvent publication, MediaObject encoding, Duration timeRequired, String operatingSystem, SoftwareApplication softwareAddOn, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, String processorRequirements, CreativeWork softwareHelp, Thing mainEntity, String alternativeHeadline, String name, String applicationSuite, StringOrCreativeWork license, StringOrCreativeWork mainEntityOfPage, String discussionUrl, Number copyrightYear, String memoryRequirements, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, String alternateName, PublicationEvent releasedEvent, String featureList, String countriesSupported, OrganizationOrPerson creator, OrganizationOrPerson contributor) {
    super(accessibilityAPI, aggregateRating, availableOnDevice, hasPart, review, installUrl, datePublished, comment, schemaVersion, video, award, releaseNotes, editor, storageRequirements, workExample, applicationCategory, potentialAction, producer, screenshot, countriesNotSupported, publisher, sourceOrganization, learningResourceType, genre, translator, publishingPrinciples, recordedAt, commentCount, inLanguage, dateModified, softwareVersion, fileFormat, mentions, audience, headline, url, interactivityType, fileSize, associatedMedia, character, contentRating, description, permissions, offers, downloadUrl, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, about, applicationSubCategory, contentLocation, accessibilityHazard, author, version, accountablePerson, sameAs, additionalType, softwareRequirements, thumbnailUrl, publication, encoding, timeRequired, operatingSystem, accessibilityFeature, softwareAddOn, audio, typicalAgeRange, dateCreated, provider, processorRequirements, alternativeHeadline, mainEntity, softwareHelp, name, license, applicationSuite, copyrightYear, discussionUrl, mainEntityOfPage, memoryRequirements, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, featureList, countriesSupported, contributor, creator);
