...
public class WebApplication extends SoftwareApplication {
  ...
  static final class WebApplicationThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("browserRequirements".equals(key) && value instanceof String) { browserRequirements((String)value); continue; }
  ...
  public interface Builder extends ThingBuilder<WebApplication> {
    @NotNull Builder browserRequirements(@NotNull String browserRequirements);
