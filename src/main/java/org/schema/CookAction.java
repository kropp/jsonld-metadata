...
public class CookAction extends CreateAction {
   ...
   */
  public PlaceOrFoodEstablishment getFoodEstablishment() {
  ...
  public static final class Builder {
    ...
    public CookAction build() {
      return new CookAction(foodEstablishment, startTime, name, error, mainEntityOfPage, sameAs, url, additionalType, foodEvent, agent, alternateName, recipe, potentialAction, target, description, endTime, actionStatus);
    }
    /**
     * A sub property of location. The specific food establishment where the action occurred.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    private PlaceOrFoodEstablishment foodEstablishment;
  ...
  protected CookAction(PlaceOrFoodEstablishment foodEstablishment, java.util.Date startTime, String name, Thing error, StringOrCreativeWork mainEntityOfPage, String sameAs, String url, String additionalType, FoodEvent foodEvent, OrganizationOrPerson agent, String alternateName, Recipe recipe, Action potentialAction, EntryPoint target, String description, java.util.Date endTime, ActionStatusType actionStatus) {
  ...
  private PlaceOrFoodEstablishment myFoodEstablishment;
