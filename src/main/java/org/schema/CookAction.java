...
public class CookAction extends CreateAction {
   ...
   */
  public FoodEstablishmentOrPlace getFoodEstablishment() { return myFoodEstablishment; }
  /**
   * A sub property of location. The specific food event where the action occurred.
   */
  public FoodEvent getFoodEvent() { return myFoodEvent; }
  /**
   * A sub property of instrument. The recipe/instructions used to perform the action.
   */
  public Recipe getRecipe() { return myRecipe; }
   ...
   */
  public static class Builder implements ThingBuilder<CookAction> {
