...
public class CookAction extends CreateAction {
  ...
  /**
   * Builder for {@see CookAction}
   */
  public static final class Builder {
    public CookAction build() {
      return new CookAction(instrument, mainEntityOfPage, foodEvent, agent, foodEstablishment, endTime, potentialAction, alternateName, participant, additionalType, url, startTime, sameAs, actionStatus, result, image, name, error, target, object, description, location, recipe);
    }
     ...
     * A sub property of location. The specific food event where the action occurred.
     */
    public Builder foodEvent(FoodEvent value) {
      foodEvent = value;
      return this;
    }
    /**
     ...
     * A sub property of location. The specific food establishment where the action occurred.
     */
    public Builder foodEstablishment(FoodEstablishment value) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected CookAction(Instrument instrument, CreativeWork mainEntityOfPage, FoodEvent foodEvent, Organization agent, FoodEstablishment foodEstablishment, java.util.Date endTime, Action potentialAction, String alternateName, Participant participant, String additionalType, String url, java.util.Date startTime, String sameAs, ActionStatusType actionStatus, Result result, Image image, String name, Thing error, EntryPoint target, Object object, String description, Location location, Recipe recipe) {
