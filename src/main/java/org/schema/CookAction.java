...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("foodEstablishment".equals(key) && value instanceof FoodEstablishment) { foodEstablishment((FoodEstablishment)value); continue; }
        if ("foodEstablishment".equals(key) && value instanceof Place) { foodEstablishment((Place)value); continue; }
        if ("foodEvent".equals(key) && value instanceof FoodEvent) { foodEvent((FoodEvent)value); continue; }
        if ("recipe".equals(key) && value instanceof Recipe) { recipe((Recipe)value); continue; }
  ...
  public interface Builder extends ThingBuilder<CookAction> {
    @NotNull Builder foodEstablishment(@NotNull FoodEstablishment foodEstablishment);
    @NotNull Builder foodEstablishment(@NotNull FoodEstablishment.Builder foodEstablishment);
    @NotNull Builder foodEstablishment(@NotNull Place place);
    @NotNull Builder foodEstablishment(@NotNull Place.Builder place);
    @NotNull Builder foodEvent(@NotNull FoodEvent foodEvent);
    @NotNull Builder foodEvent(@NotNull FoodEvent.Builder foodEvent);
    @NotNull Builder recipe(@NotNull Recipe recipe);
    @NotNull Builder recipe(@NotNull Recipe.Builder recipe);
