...
public class DonateAction extends TradeAction {
  ...
  /**
   * Builder for {@see DonateAction}
   */
  public static final class Builder {
    public DonateAction build() {
      return new DonateAction(priceSpecification, instrument, recipient, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location, price);
    }
    /**
