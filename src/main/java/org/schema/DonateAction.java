...
public class DonateAction extends TradeAction {
  ...
  public static final class Builder {
    ...
    public DonateAction build() {
      return new DonateAction(startTime, name, mainEntityOfPage, error, price, url, sameAs, additionalType, recipient, agent, alternateName, description, priceSpecification, target, potentialAction, endTime, actionStatus);
    }
    /**
