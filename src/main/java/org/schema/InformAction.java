...
public class InformAction extends CommunicateAction {
  ...
  public static final class Builder {
    ...
    public InformAction build() {
      return new InformAction(event, about, inLanguage, recipient, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
     * Upcoming or past event associated with this place, organization, or action.
     */
