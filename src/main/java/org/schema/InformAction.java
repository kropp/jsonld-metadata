...
public class InformAction extends CommunicateAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link InformAction} instance.
     */
    public InformAction build() {
      return new InformAction(startTime, inLanguage, about, name, error, mainEntityOfPage, event, sameAs, url, additionalType, recipient, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
