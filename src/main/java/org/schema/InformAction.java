...
public class InformAction extends CommunicateAction {
   ...
   */
  static final class InformActionThingBuilder implements Builder {
    /**
     * Creates new {@link InformAction} instance.
     */
    public InformAction build() {
      return new InformAction(event, about, inLanguage, recipient, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * Upcoming or past event associated with this place, organization, or action.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<InformAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    InformAction informAction = (InformAction) o;
    if (!super.equals(o)) return false;
    if (myEvent != null ? !myEvent.equals(informAction.myEvent) : informAction.myEvent != null) return false;
    return true;
  }
