...
public class InformAction extends CommunicateAction {
  ...
  /**
   * Builder for {@see InformAction}
   */
  public static final class Builder {
    public InformAction build() {
      return new InformAction(event, instrument, recipient, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, about, sameAs, startTime, actionStatus, inLanguage, result, error, name, image, target, object, location, description);
    }
    /**
     * Upcoming or past event associated with this place, organization, or action.
     */
