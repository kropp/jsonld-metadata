...
public class MedicalWebPage extends WebPage {
  ...
  static final class MedicalWebPageThingBuilder implements Builder {
    ...
    @NotNull public Builder breadcrumb(@NotNull BreadcrumbList.Builder breadcrumbList) {
      return this.breadcrumb(breadcrumbList.build());
    }
    /**
     * A set of links that can help a user understand and navigate a website hierarchy.
     */
    ...
    @NotNull public Builder mainContentOfPage(@NotNull WebPageElement.Builder webPageElement) {
      return this.mainContentOfPage(webPageElement.build());
    }
    /**
    ...
    @NotNull public Builder primaryImageOfPage(@NotNull ImageObject.Builder imageObject) {
      return this.primaryImageOfPage(imageObject.build());
    }
    /**
    ...
    @NotNull public Builder reviewedBy(@NotNull Organization.Builder organization) {
      return this.reviewedBy(organization.build());
    }
    /**
     * People or organizations that have reviewed the content on this web page for accuracy and/or completeness.
     */
    ...
    @NotNull public Builder reviewedBy(@NotNull Person.Builder person) {
      return this.reviewedBy(person.build());
    }
    /**
    ...
    @NotNull public Builder specialty(@NotNull Specialty.Builder specialty) {
      return this.specialty(specialty.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("aspect".equals(key) && value instanceof String) { aspect((String)value); continue; }
        if ("breadcrumb".equals(key) && value instanceof BreadcrumbList) { breadcrumb((BreadcrumbList)value); continue; }
        if ("breadcrumb".equals(key) && value instanceof String) { breadcrumb((String)value); continue; }
        if ("lastReviewed".equals(key) && value instanceof java.util.Date) { lastReviewed((java.util.Date)value); continue; }
        if ("mainContentOfPage".equals(key) && value instanceof WebPageElement) { mainContentOfPage((WebPageElement)value); continue; }
        if ("primaryImageOfPage".equals(key) && value instanceof ImageObject) { primaryImageOfPage((ImageObject)value); continue; }
        if ("relatedLink".equals(key) && value instanceof String) { relatedLink((String)value); continue; }
        if ("reviewedBy".equals(key) && value instanceof Organization) { reviewedBy((Organization)value); continue; }
        if ("reviewedBy".equals(key) && value instanceof Person) { reviewedBy((Person)value); continue; }
        if ("significantLink".equals(key) && value instanceof String) { significantLink((String)value); continue; }
        if ("specialty".equals(key) && value instanceof Specialty) { specialty((Specialty)value); continue; }
  ...
  public interface Builder extends ThingBuilder<MedicalWebPage> {
    @NotNull Builder aspect(@NotNull String aspect);
    @NotNull Builder breadcrumb(@NotNull BreadcrumbList breadcrumbList);
    @NotNull Builder breadcrumb(@NotNull BreadcrumbList.Builder breadcrumbList);
    @NotNull Builder breadcrumb(@NotNull String breadcrumb);
    @NotNull Builder lastReviewed(@NotNull java.util.Date date);
    @NotNull Builder mainContentOfPage(@NotNull WebPageElement webPageElement);
    @NotNull Builder mainContentOfPage(@NotNull WebPageElement.Builder webPageElement);
    @NotNull Builder primaryImageOfPage(@NotNull ImageObject imageObject);
    @NotNull Builder primaryImageOfPage(@NotNull ImageObject.Builder imageObject);
    @NotNull Builder relatedLink(@NotNull String relatedLink);
    @NotNull Builder reviewedBy(@NotNull Organization organization);
    @NotNull Builder reviewedBy(@NotNull Organization.Builder organization);
    @NotNull Builder reviewedBy(@NotNull Person person);
    @NotNull Builder reviewedBy(@NotNull Person.Builder person);
    @NotNull Builder significantLink(@NotNull String significantLink);
    @NotNull Builder specialty(@NotNull Specialty specialty);
    @NotNull Builder specialty(@NotNull Specialty.Builder specialty);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myAspect != null ? myAspect.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    MedicalWebPage medicalWebPage = (MedicalWebPage) o;
    if (!super.equals(o)) return false;
    if (myAspect != null ? !myAspect.equals(medicalWebPage.myAspect) : medicalWebPage.myAspect != null) return false;
    return true;
  }
