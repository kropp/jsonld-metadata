...
public class MedicalWebPage extends WebPage {
   ...
   */
  @JsonIgnore public String getAspect() {
    return (String) getValue("aspect");
  }
  /**
   * An aspect of medical practice that is considered on the page, such as 'diagnosis', 'treatment', 'causes', 'prognosis', 'etiology', 'epidemiology', etc.
   */
  @JsonIgnore public Collection<String> getAspects() {
    final Object current = myData.get("aspect");
  ...
  public static class Builder extends WebPage.Builder {
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("aspect".equals(key) && value instanceof String) { aspect((String)value); return; }
