...
public class MedicalWebPage extends WebPage {
  ...
  static final class MedicalWebPageThingBuilder implements Builder {
     ...
     * An aspect of medical practice that is considered on the page, such as 'diagnosis', 'treatment', 'causes', 'prognosis', 'etiology', 'epidemiology', etc.
     */
    @NotNull public Builder aspect(String aspect) {
      this.aspect = aspect;
      return this;
    }
    /**
     ...
     */
    @NotNull public Builder breadcrumb(BreadcrumbList breadcrumbList) {
     ...
     * A set of links that can help a user understand and navigate a website hierarchy.
     */
    @NotNull public Builder breadcrumb(BreadcrumbList.Builder breadcrumbList) {
      return this.breadcrumb(breadcrumbList.build());
    }
    /**
     * A set of links that can help a user understand and navigate a website hierarchy.
     */
    @NotNull public Builder breadcrumb(String breadcrumb) {
      if (this.breadcrumb == null) this.breadcrumb = new BreadcrumbListOrString();
     ...
     */
    @NotNull public Builder lastReviewed(java.util.Date date) {
     ...
     */
    @NotNull public Builder mainContentOfPage(WebPageElement webPageElement) {
     ...
     * Indicates if this web page element is the main subject of the page.
     */
    @NotNull public Builder mainContentOfPage(WebPageElement.Builder webPageElement) {
      return this.mainContentOfPage(webPageElement.build());
    }
    /**
     * Indicates the main image on the page.
     */
    @NotNull public Builder primaryImageOfPage(ImageObject imageObject) {
     ...
     * Indicates the main image on the page.
     */
    @NotNull public Builder primaryImageOfPage(ImageObject.Builder imageObject) {
      return this.primaryImageOfPage(imageObject.build());
    }
    /**
     * A link related to this web page, for example to other related web pages.
     */
    @NotNull public Builder relatedLink(String relatedLink) {
     ...
     */
    @NotNull public Builder reviewedBy(Organization organization) {
     ...
     * People or organizations that have reviewed the content on this web page for accuracy and/or completeness.
     */
    @NotNull public Builder reviewedBy(Organization.Builder organization) {
      return this.reviewedBy(organization.build());
    }
    /**
     * People or organizations that have reviewed the content on this web page for accuracy and/or completeness.
     */
    @NotNull public Builder reviewedBy(Person person) {
      if (this.reviewedBy == null) this.reviewedBy = new OrganizationOrPerson();
     ...
     * People or organizations that have reviewed the content on this web page for accuracy and/or completeness.
     */
    @NotNull public Builder reviewedBy(Person.Builder person) {
      return this.reviewedBy(person.build());
    }
    /**
     * One of the more significant URLs on the page. Typically, these are the non-navigation links that are clicked on the most.
     */
    @NotNull public Builder significantLink(String significantLink) {
     ...
     */
    @NotNull public Builder specialty(Specialty specialty) {
     ...
     * One of the domain specialities to which this web page's content applies.
     */
    @NotNull public Builder specialty(Specialty.Builder specialty) {
  ...
  public interface Builder extends ThingBuilder<MedicalWebPage> {
    @NotNull Builder aspect(String aspect);
    @NotNull Builder breadcrumb(BreadcrumbList breadcrumbList);
    @NotNull Builder breadcrumb(BreadcrumbList.Builder breadcrumbList);
    @NotNull Builder breadcrumb(String breadcrumb);
    @NotNull Builder lastReviewed(java.util.Date date);
    @NotNull Builder mainContentOfPage(WebPageElement webPageElement);
    @NotNull Builder mainContentOfPage(WebPageElement.Builder webPageElement);
    @NotNull Builder primaryImageOfPage(ImageObject imageObject);
    @NotNull Builder primaryImageOfPage(ImageObject.Builder imageObject);
    @NotNull Builder relatedLink(String relatedLink);
    @NotNull Builder reviewedBy(Organization organization);
    @NotNull Builder reviewedBy(Organization.Builder organization);
    @NotNull Builder reviewedBy(Person person);
    @NotNull Builder reviewedBy(Person.Builder person);
    @NotNull Builder significantLink(String significantLink);
    @NotNull Builder specialty(Specialty specialty);
    @NotNull Builder specialty(Specialty.Builder specialty);
