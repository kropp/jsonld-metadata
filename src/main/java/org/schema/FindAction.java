...
public class FindAction extends Action {
  ...
  public static final class Builder {
    ...
    public FindAction build() {
      return new FindAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
