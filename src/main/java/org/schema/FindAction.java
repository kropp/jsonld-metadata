...
public class FindAction extends Action {
  ...
  public static final class Builder {
    ...
    public FindAction build() {
      return new FindAction(additionalType, url, sameAs, agent, startTime, alternateName, potentialAction, target, description, name, endTime, mainEntityOfPage, error, actionStatus);
    }
    /**
