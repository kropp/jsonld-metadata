...
public class FindAction extends Action {
  /**
   * Builder for {@see FindAction}
   */
  public static final class Builder {
    public FindAction build() {
      return new FindAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, object, location, description);
    }
