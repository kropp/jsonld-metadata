...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("deliveryMethod".equals(key) && value instanceof DeliveryMethod) { deliveryMethod((DeliveryMethod)value); continue; }
        if ("sender".equals(key) && value instanceof Audience) { sender((Audience)value); continue; }
        if ("sender".equals(key) && value instanceof Organization) { sender((Organization)value); continue; }
        if ("sender".equals(key) && value instanceof Person) { sender((Person)value); continue; }
  ...
  public interface Builder extends ThingBuilder<ReceiveAction> {
    @NotNull Builder deliveryMethod(@NotNull DeliveryMethod deliveryMethod);
    @NotNull Builder deliveryMethod(@NotNull DeliveryMethod.Builder deliveryMethod);
    @NotNull Builder sender(@NotNull Audience audience);
    @NotNull Builder sender(@NotNull Audience.Builder audience);
    @NotNull Builder sender(@NotNull Organization organization);
    @NotNull Builder sender(@NotNull Organization.Builder organization);
    @NotNull Builder sender(@NotNull Person person);
    @NotNull Builder sender(@NotNull Person.Builder person);
