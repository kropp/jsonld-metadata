...
public class ReceiveAction extends TransferAction {
   ...
   */
  public OrganizationOrPersonOrAudience getSender() {
    return mySender;
  }
  /**
  ...
  public static final class Builder {
    ...
    public ReceiveAction build() {
      return new ReceiveAction(startTime, toLocation, name, error, mainEntityOfPage, deliveryMethod, fromLocation, url, sameAs, additionalType, agent, sender, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    private OrganizationOrPersonOrAudience sender;
  ...
  protected ReceiveAction(java.util.Date startTime, Place toLocation, String name, Thing error, StringOrCreativeWork mainEntityOfPage, DeliveryMethod deliveryMethod, Place fromLocation, String url, String sameAs, String additionalType, OrganizationOrPerson agent, OrganizationOrPersonOrAudience sender, String alternateName, String description, EntryPoint target, Action potentialAction, java.util.Date endTime, ActionStatusType actionStatus) {
  ...
  private OrganizationOrPersonOrAudience mySender;
}
