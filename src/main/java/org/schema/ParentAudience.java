...
public class ParentAudience extends PeopleAudience {
  ...
  public static final class Builder {
    ...
    public ParentAudience build() {
      return new ParentAudience(childMinAge, audienceType, childMaxAge, suggestedMaxAge, requiredMaxAge, name, mainEntityOfPage, requiredGender, healthCondition, additionalType, url, sameAs, geographicArea, requiredMinAge, alternateName, suggestedGender, suggestedMinAge, potentialAction, description);
    }
    /**
     * Minimal age of the child.
     */
  ...
  protected ParentAudience(Number childMinAge, String audienceType, Number childMaxAge, Number suggestedMaxAge, Integer requiredMaxAge, String name, StringOrCreativeWork mainEntityOfPage, String requiredGender, MedicalCondition healthCondition, String additionalType, String url, String sameAs, AdministrativeArea geographicArea, Integer requiredMinAge, String alternateName, String suggestedGender, Number suggestedMinAge, Action potentialAction, String description) {
