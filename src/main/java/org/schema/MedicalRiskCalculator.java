...
public class MedicalRiskCalculator extends MedicalRiskEstimator {
  /**
   * Builder for {@see MedicalRiskCalculator}
   */
  public static final class Builder {
    public MedicalRiskCalculator build() {
      return new MedicalRiskCalculator(mainEntityOfPage, alternateName, potentialAction, url, includedRiskFactor, additionalType, medicineSystem, sameAs, recognizingAuthority, study, code, estimatesRiskOf, name, image, relevantSpecialty, guideline, description);
    }
    /**
  ...
  protected MedicalRiskCalculator(CreativeWork mainEntityOfPage, String alternateName, Action potentialAction, String url, MedicalRiskFactor includedRiskFactor, String additionalType, MedicineSystem medicineSystem, String sameAs, Organization recognizingAuthority, MedicalStudy study, MedicalCode code, MedicalEntity estimatesRiskOf, String name, Image image, MedicalSpecialty relevantSpecialty, MedicalGuideline guideline, String description) {
