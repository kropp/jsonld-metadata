...
/**
 * A complex mathematical calculation requiring an online calculator, used to assess prognosis. Note: use the url property of Thing to record any URLs for online calculators.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class MedicalRiskCalculator extends MedicalRiskEstimator {
   ...
   */
  public static class Builder implements ThingBuilder<MedicalRiskCalculator> {
