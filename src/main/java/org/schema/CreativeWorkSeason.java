...
public class CreativeWorkSeason extends CreativeWork {
   ...
   */
  public StringOrInt getSeasonNumber() {
  ...
  static final class CreativeWorkSeasonThingBuilder implements Builder {
     ...
     * Position of the season within an ordered group of seasons.
     */
    @NotNull public Builder seasonNumber(String seasonNumber) {
      if (this.seasonNumber == null) this.seasonNumber = new StringOrInt();
     ...
     * Position of the season within an ordered group of seasons.
     */
    @NotNull public Builder seasonNumber(int seasonNumber) {
      if (this.seasonNumber == null) this.seasonNumber = new StringOrInt();
      this.seasonNumber.setInt(seasonNumber);
      return this;
    }
    /**
     * The start date and time of the item (in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 date format</a>).
    ...
    private StringOrInt seasonNumber;
  ...
  public interface Builder extends ThingBuilder<CreativeWorkSeason> {
    ...
    @NotNull Builder seasonNumber(String seasonNumber);
    @NotNull Builder seasonNumber(int seasonNumber);
  ...
  private StringOrInt mySeasonNumber;
