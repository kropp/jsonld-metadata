...
public class CreativeWorkSeason extends CreativeWork {
   ...
   */
  public static final class CreativeWorkSeasonThingBuilder implements Builder {
    /**
  ...
  Builder seasonNumber(Integer integer);
  Builder seasonNumber(String seasonNumber);
