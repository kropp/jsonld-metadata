...
public class OwnershipInfo extends StructuredValue {
   ...
   */
  public static final class OwnershipInfoThingBuilder implements Builder {
    /**
     ...
     * The organization or person from which the product was acquired.
     */
    public Builder acquiredFrom(Organization.Builder organization) {
     ...
     * The organization or person from which the product was acquired.
     */
    public Builder acquiredFrom(Person.Builder person) {
  ...
  Builder acquiredFrom(Organization organization);
  Builder acquiredFrom(Organization.Builder organization);
  Builder acquiredFrom(Person person);
  Builder acquiredFrom(Person.Builder person);
  Builder ownedFrom(java.util.Date date);
  Builder ownedThrough(java.util.Date date);
