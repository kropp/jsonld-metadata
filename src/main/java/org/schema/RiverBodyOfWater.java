...
public class RiverBodyOfWater extends BodyOfWater {
  /**
   * Builder for {@see RiverBodyOfWater}
   */
  public static final class Builder {
    public RiverBodyOfWater build() {
      return new RiverBodyOfWater(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, additionalType, url, geo, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  protected RiverBodyOfWater(Event event, Review review, OpeningHoursSpecification openingHoursSpecification, String faxNumber, CreativeWork mainEntityOfPage, String globalLocationNumber, String telephone, String alternateName, Action potentialAction, ImageObject photo, String additionalType, String url, GeoCoordinates geo, AggregateRating aggregateRating, ImageObject logo, String sameAs, String name, Image image, PostalAddress address, PropertyValue additionalProperty, Place containedIn, String isicV4, String description, String hasMap) {
    super(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, url, geo, additionalType, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
  }
}
