...
public class RiverBodyOfWater extends BodyOfWater {
  ...
  public static final class Builder {
    /**
     * Creates new {@link RiverBodyOfWater} instance.
     */
    public RiverBodyOfWater build() {
      return new RiverBodyOfWater(aggregateRating, review, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, url, event, containedIn, additionalType, sameAs, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
