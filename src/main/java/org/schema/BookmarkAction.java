...
public class BookmarkAction extends OrganizeAction {
  ...
  public static final class Builder {
    ...
    public BookmarkAction build() {
      return new BookmarkAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
