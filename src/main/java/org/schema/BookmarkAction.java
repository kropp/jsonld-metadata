...
public class BookmarkAction extends OrganizeAction {
  /**
   * Builder for {@see BookmarkAction}
   */
  public static final class Builder {
    public BookmarkAction build() {
      return new BookmarkAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
