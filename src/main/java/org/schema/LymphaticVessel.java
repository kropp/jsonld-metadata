...
public class LymphaticVessel extends Vessel {
   ...
   */
  static final class LymphaticVesselThingBuilder implements Builder {
    /**
     ...
     * The vasculature the lymphatic structure originates, or afferents, from.
     */
    @NotNull public Builder originatesFrom(Vessel vessel) {
     ...
     * The vasculature the lymphatic structure originates, or afferents, from.
     */
    @NotNull public Builder originatesFrom(Vessel.Builder vessel) {
      return this.originatesFrom(vessel.build());
    }
    /**
     * The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
     */
     ...
     * The vasculature the lymphatic structure runs, or efferents, to.
     */
    @NotNull public Builder runsTo(Vessel vessel) {
      this.runsTo = vessel;
      return this;
    }
    /**
     * The vasculature the lymphatic structure runs, or efferents, to.
     */
    @NotNull public Builder runsTo(Vessel.Builder vessel) {
      return this.runsTo(vessel.build());
    }
    /**
  ...
  public interface Builder extends ThingBuilder<LymphaticVessel> {
    @NotNull Builder originatesFrom(Vessel vessel);
    @NotNull Builder originatesFrom(Vessel.Builder vessel);
    ...
    @NotNull Builder runsTo(Vessel vessel);
    @NotNull Builder runsTo(Vessel.Builder vessel);
