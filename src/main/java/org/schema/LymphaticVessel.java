...
public class LymphaticVessel extends Vessel {
   ...
   */
  public static final class LymphaticVesselThingBuilder implements Builder {
    /**
     ...
     * The vasculature the lymphatic structure originates, or afferents, from.
     */
    public Builder originatesFrom(Vessel.Builder vessel) {
     ...
     * The vasculature the lymphatic structure runs, or efferents, to.
     */
    public Builder runsTo(Vessel.Builder vessel) {
  ...
  Builder originatesFrom(Vessel vessel);
  Builder originatesFrom(Vessel.Builder vessel);
  ...
  Builder runsTo(Vessel vessel);
  Builder runsTo(Vessel.Builder vessel);
