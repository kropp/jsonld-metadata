...
public class LymphaticVessel extends Vessel {
  ...
  static final class LymphaticVesselThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("originatesFrom".equals(key) && value instanceof Vessel) { originatesFrom((Vessel)value); continue; }
        ...
        if ("runsTo".equals(key) && value instanceof Vessel) { runsTo((Vessel)value); continue; }
  ...
  public interface Builder extends ThingBuilder<LymphaticVessel> {
    @NotNull Builder originatesFrom(@NotNull Vessel vessel);
    @NotNull Builder originatesFrom(@NotNull Vessel.Builder vessel);
    ...
    @NotNull Builder runsTo(@NotNull Vessel vessel);
    @NotNull Builder runsTo(@NotNull Vessel.Builder vessel);
