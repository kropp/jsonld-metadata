...
public class PaymentMethod extends Enumeration {
  /**
   * Builder for {@see PaymentMethod}
   */
  public static final class Builder {
    public PaymentMethod build() {
      return new PaymentMethod(mainEntityOfPage, name, image, supersededBy, potentialAction, alternateName, additionalType, url, description, sameAs);
    }
    /**
  ...
  protected PaymentMethod(CreativeWork mainEntityOfPage, String name, Image image, Property supersededBy, Action potentialAction, String alternateName, String additionalType, String url, String description, String sameAs) {
