...
public class PaymentMethod extends Enumeration {
  ...
  public static final class Builder {
    ...
    public PaymentMethod build() {
      return new PaymentMethod(sameAs, url, additionalType, alternateName, supersededBy, description, potentialAction, name, mainEntityOfPage);
    }
    /**
  ...
  protected PaymentMethod(String sameAs, String url, String additionalType, String alternateName, EnumerationOrProperty supersededBy, String description, Action potentialAction, String name, StringOrCreativeWork mainEntityOfPage) {
