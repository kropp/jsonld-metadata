...
public class TVSeason extends CreativeWorkSeason {
  ...
  public static final class Builder {
    /**
     * Creates new {@link TVSeason} instance.
     */
    public TVSeason build() {
      return new TVSeason(accessibilityAPI, aggregateRating, hasPart, review, datePublished, schemaVersion, comment, video, award, editor, workExample, director, potentialAction, startDate, producer, seasonNumber, publisher, sourceOrganization, partOfSeries, genre, learningResourceType, publishingPrinciples, translator, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, endDate, about, numberOfEpisodes, contentLocation, author, accessibilityHazard, version, accountablePerson, additionalType, sameAs, thumbnailUrl, publication, actor, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, trailer, mainEntity, alternativeHeadline, name, license, mainEntityOfPage, discussionUrl, copyrightYear, isBasedOnUrl, isFamilyFriendly, exampleOfWork, episode, alternateName, releasedEvent, productionCompany, creator, contributor);
    }
    /**
  ...
  protected TVSeason(String accessibilityAPI, AggregateRating aggregateRating, HasPart hasPart, Review review, java.util.Date datePublished, String schemaVersion, Comment comment, VideoObject video, String award, Person editor, CreativeWork workExample, Person director, Action potentialAction, java.util.Date startDate, OrganizationOrPerson producer, IntegerOrString seasonNumber, Organization publisher, Organization sourceOrganization, IsPartOf partOfSeries, String genre, String learningResourceType, String publishingPrinciples, OrganizationOrPerson translator, Event recordedAt, Integer commentCount, LanguageOrString inLanguage, java.util.Date dateModified, Thing mentions, Audience audience, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, String contentRating, String description, Offer offers, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, String educationalUse, String keywords, AlignmentObject educationalAlignment, String text, java.util.Date endDate, Thing about, Integer numberOfEpisodes, Place contentLocation, OrganizationOrPerson author, String accessibilityHazard, Number version, Person accountablePerson, String additionalType, String sameAs, String thumbnailUrl, PublicationEvent publication, Person actor, MediaObject encoding, Duration timeRequired, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, VideoObject trailer, Thing mainEntity, String alternativeHeadline, String name, StringOrCreativeWork license, StringOrCreativeWork mainEntityOfPage, String discussionUrl, Number copyrightYear, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, HasPart episode, String alternateName, PublicationEvent releasedEvent, Organization productionCompany, OrganizationOrPerson creator, OrganizationOrPerson contributor) {
    super(accessibilityAPI, aggregateRating, hasPart, review, datePublished, schemaVersion, comment, video, award, editor, workExample, director, potentialAction, startDate, producer, seasonNumber, publisher, partOfSeries, sourceOrganization, learningResourceType, genre, translator, publishingPrinciples, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, endDate, about, numberOfEpisodes, contentLocation, accessibilityHazard, author, version, accountablePerson, sameAs, additionalType, thumbnailUrl, publication, actor, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, trailer, alternativeHeadline, mainEntity, name, license, copyrightYear, discussionUrl, mainEntityOfPage, isBasedOnUrl, isFamilyFriendly, exampleOfWork, episode, alternateName, releasedEvent, productionCompany, contributor, creator);
  }
}
