...
public class Muscle extends AnatomicalStructure {
   ...
   */
  public static final class MuscleThingBuilder implements Builder {
    /**
     ...
     * The muscle whose action counteracts the specified muscle.
     */
    public Builder antagonist(Muscle.Builder muscle) {
     ...
     * The blood vessel that carries blood from the heart to the muscle.
     */
    public Builder bloodSupply(Vessel.Builder vessel) {
     ...
     * The place of attachment of a muscle, or what the muscle moves.
     */
    public Builder insertion(AnatomicalStructure.Builder anatomicalStructure) {
     ...
     * The underlying innervation associated with the muscle.
     */
    public Builder nerve(Nerve.Builder nerve) {
     ...
     * The place or point where a muscle arises.
     */
    public Builder origin(AnatomicalStructure.Builder anatomicalStructure) {
  ...
  Builder muscleAction(String muscleAction);
  Builder antagonist(Muscle muscle);
  Builder antagonist(Muscle.Builder muscle);
  Builder bloodSupply(Vessel vessel);
  Builder bloodSupply(Vessel.Builder vessel);
  Builder insertion(AnatomicalStructure anatomicalStructure);
  Builder insertion(AnatomicalStructure.Builder anatomicalStructure);
  Builder nerve(Nerve nerve);
  Builder nerve(Nerve.Builder nerve);
  Builder origin(AnatomicalStructure anatomicalStructure);
  Builder origin(AnatomicalStructure.Builder anatomicalStructure);
