...
public class ReplaceAction extends UpdateAction {
  ...
  static final class ReplaceActionThingBuilder implements Builder {
     ...
     * A sub property of object. The object that is being replaced.
     */
    @NotNull public Builder replacee(Thing thing) {
      this.replacee = thing;
      return this;
    }
    /**
     * A sub property of object. The object that is being replaced.
     */
    @NotNull public Builder replacee(Thing.Builder thing) {
      return this.replacee(thing.build());
    }
    /**
     * A sub property of object. The object that replaces.
     */
    @NotNull public Builder replacer(Thing thing) {
      this.replacer = thing;
      return this;
    }
    /**
     * A sub property of object. The object that replaces.
     */
    @NotNull public Builder replacer(Thing.Builder thing) {
      return this.replacer(thing.build());
    }
    /**
     * A sub property of object. The collection target of the action.
     */
    @NotNull public Builder targetCollection(Thing thing) {
     ...
     * A sub property of object. The collection target of the action.
     */
    @NotNull public Builder targetCollection(Thing.Builder thing) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<ReplaceAction> {
    @NotNull Builder replacee(Thing thing);
    @NotNull Builder replacee(Thing.Builder thing);
    @NotNull Builder replacer(Thing thing);
    @NotNull Builder replacer(Thing.Builder thing);
    @NotNull Builder targetCollection(Thing thing);
    @NotNull Builder targetCollection(Thing.Builder thing);
