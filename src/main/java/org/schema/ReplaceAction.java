...
public class ReplaceAction extends UpdateAction {
   ...
   */
  static final class ReplaceActionThingBuilder implements Builder {
    /**
     * Creates new {@link ReplaceAction} instance.
     */
    public ReplaceAction build() {
      return new ReplaceAction(replacee, replacer, targetCollection, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of object. The object that is being replaced.
     */
    ...
    @NotNull public Builder replacee(@NotNull Thing.Builder thing) {
      return this.replacee(thing.build());
    }
    /**
     * A sub property of object. The object that replaces.
     */
    ...
    @NotNull public Builder targetCollection(@NotNull Thing.Builder thing) {
      return this.targetCollection(thing.build());
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("replacee".equals(key) && value instanceof Thing) { replacee((Thing)value); continue; }
        if ("replacer".equals(key) && value instanceof Thing) { replacer((Thing)value); continue; }
        if ("targetCollection".equals(key) && value instanceof Thing) { targetCollection((Thing)value); continue; }
  ...
  public interface Builder extends ThingBuilder<ReplaceAction> {
    @NotNull Builder replacee(@NotNull Thing thing);
    @NotNull Builder replacee(@NotNull Thing.Builder thing);
    @NotNull Builder replacer(@NotNull Thing thing);
    @NotNull Builder replacer(@NotNull Thing.Builder thing);
    @NotNull Builder targetCollection(@NotNull Thing thing);
    @NotNull Builder targetCollection(@NotNull Thing.Builder thing);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myReplacee != null ? myReplacee.hashCode() : 0);
    result = 31 * result + (myReplacer != null ? myReplacer.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    ReplaceAction replaceAction = (ReplaceAction) o;
    if (!super.equals(o)) return false;
    if (myReplacee != null ? !myReplacee.equals(replaceAction.myReplacee) : replaceAction.myReplacee != null) return false;
    if (myReplacer != null ? !myReplacer.equals(replaceAction.myReplacer) : replaceAction.myReplacer != null) return false;
    return true;
  }

  private Thing myReplacee;
  private Thing myReplacer;
}
