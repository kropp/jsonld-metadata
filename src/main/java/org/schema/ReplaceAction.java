...
public class ReplaceAction extends UpdateAction {
   ...
   */
  public static final class ReplaceActionThingBuilder implements Builder {
    /**
     ...
     * A sub property of object. The object that is being replaced.
     */
    public Builder replacee(Thing thing) {
      this.replacee = thing;
      return this;
    }
    /**
     * A sub property of object. The object that is being replaced.
     */
    public Builder replacee(Thing.Builder thing) {
      return this.replacee(thing.build());
    }
    /**
     * A sub property of object. The object that replaces.
     */
    public Builder replacer(Thing thing) {
      this.replacer = thing;
      return this;
    }
    /**
     * A sub property of object. The object that replaces.
     */
    public Builder replacer(Thing.Builder thing) {
      return this.replacer(thing.build());
    }
    /**
     * A sub property of object. The collection target of the action.
     */
    public Builder targetCollection(Thing thing) {
     ...
     * A sub property of object. The collection target of the action.
     */
    public Builder targetCollection(Thing.Builder thing) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  Builder replacee(Thing thing);
  Builder replacee(Thing.Builder thing);
  Builder replacer(Thing thing);
  Builder replacer(Thing.Builder thing);
  Builder targetCollection(Thing thing);
  Builder targetCollection(Thing.Builder thing);
