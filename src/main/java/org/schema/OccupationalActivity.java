 ...
 */
public class OccupationalActivity {
  ...
  @Override public boolean equals(Object o) {
    ...
    OccupationalActivity occupationalActivity = (OccupationalActivity) o;
   ...
   */
  public static class Builder implements ThingBuilder<OccupationalActivity> {
    public OccupationalActivity build() {
      return new OccupationalActivity();
    }
