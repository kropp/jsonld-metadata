...
public class Joint extends AnatomicalStructure {
   ...
   */
  @JsonIgnore public String getFunctionalClass() {
    return (String) getValue("functionalClass");
  }
  /**
   * The degree of mobility the joint allows.
   */
  @JsonIgnore public Collection<String> getFunctionalClasss() {
  ...
  public static class Builder extends AnatomicalStructure.Builder {
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("biomechnicalClass".equals(key) && value instanceof String) { biomechnicalClass((String)value); return; }
      if ("functionalClass".equals(key) && value instanceof String) { functionalClass((String)value); return; }
      if ("structuralClass".equals(key) && value instanceof String) { structuralClass((String)value); return; }
