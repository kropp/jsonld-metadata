...
public class Joint extends AnatomicalStructure {
  ...
  static final class JointThingBuilder implements Builder {
     ...
     * The biomechanical properties of the bone.
     */
    @NotNull public Builder biomechnicalClass(String biomechnicalClass) {
     ...
     * The degree of mobility the joint allows.
     */
    @NotNull public Builder functionalClass(String functionalClass) {
     ...
     * The name given to how bone physically connects to each other.
     */
    @NotNull public Builder structuralClass(String structuralClass) {
  ...
  public interface Builder extends ThingBuilder<Joint> {
    @NotNull Builder biomechnicalClass(String biomechnicalClass);
    @NotNull Builder functionalClass(String functionalClass);
    @NotNull Builder structuralClass(String structuralClass);
