...
public class Joint extends AnatomicalStructure {
   ...
   */
  public static final class JointThingBuilder implements Builder {
    /**
  ...
  Builder biomechnicalClass(String biomechnicalClass);
  Builder functionalClass(String functionalClass);
  Builder structuralClass(String structuralClass);
