...
public class Joint extends AnatomicalStructure {
   ...
   */
  static final class JointThingBuilder implements Builder {
    /**
  ...
  public interface Builder extends ThingBuilder<Joint> {
    @NotNull Builder biomechnicalClass(@NotNull String biomechnicalClass);
    @NotNull Builder functionalClass(@NotNull String functionalClass);
    @NotNull Builder structuralClass(@NotNull String structuralClass);
