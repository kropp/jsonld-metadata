...
public class Joint extends AnatomicalStructure {
   ...
   */
  public static class Builder implements ThingBuilder<Joint> {
    public Joint build() {
      return new Joint(biomechnicalClass, functionalClass, structuralClass, associatedPathophysiology, bodyLocation, connectedTo, diagram, function, partOfSystem, relatedCondition, relatedTherapy, subStructure, code, guideline, medicineSystem, recognizingAuthority, relevantSpecialty, study, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * The biomechanical properties of the bone.
     */
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("biomechnicalClass".equals(key) && value instanceof String) { biomechnicalClass((String)value); continue; }
        if ("functionalClass".equals(key) && value instanceof String) { functionalClass((String)value); continue; }
        if ("structuralClass".equals(key) && value instanceof String) { structuralClass((String)value); continue; }
