...
public class BusinessFunction extends Enumeration {
  ...
  public static final class Builder {
    ...
    public BusinessFunction build() {
      return new BusinessFunction(sameAs, url, additionalType, alternateName, supersededBy, description, potentialAction, name, mainEntityOfPage);
    }
    /**
  ...
  protected BusinessFunction(String sameAs, String url, String additionalType, String alternateName, EnumerationOrProperty supersededBy, String description, Action potentialAction, String name, StringOrCreativeWork mainEntityOfPage) {
