...
public class BusinessFunction extends Enumeration {
  /**
   * Builder for {@see BusinessFunction}
   */
  public static final class Builder {
    public BusinessFunction build() {
      return new BusinessFunction(mainEntityOfPage, name, image, supersededBy, potentialAction, alternateName, additionalType, url, description, sameAs);
    }
    /**
  ...
  protected BusinessFunction(CreativeWork mainEntityOfPage, String name, Image image, Property supersededBy, Action potentialAction, String alternateName, String additionalType, String url, String description, String sameAs) {
