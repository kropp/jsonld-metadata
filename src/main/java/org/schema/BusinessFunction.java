...
public class BusinessFunction extends Enumeration {
  ...
  public static final class Builder {
    ...
    public BusinessFunction build() {
      return new BusinessFunction(supersededBy, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
  ...
  protected BusinessFunction(EnumerationOrProperty supersededBy, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction) {
