...
public class MedicalGuidelineRecommendation extends MedicalGuideline {
   ...
   */
  public static final class MedicalGuidelineRecommendationThingBuilder implements Builder {
    /**
     ...
     * Strength of evidence of the data used to formulate the guideline (enumerated).
     */
    public Builder evidenceLevel(MedicalEvidenceLevel.Builder medicalEvidenceLevel) {
     ...
     * The medical conditions, treatments, etc. that are the subject of the guideline.
     */
    public Builder guidelineSubject(MedicalEntity.Builder medicalEntity) {
  ...
  Builder recommendationStrength(String recommendationStrength);
  Builder evidenceLevel(MedicalEvidenceLevel medicalEvidenceLevel);
  Builder evidenceLevel(MedicalEvidenceLevel.Builder medicalEvidenceLevel);
  Builder evidenceOrigin(String evidenceOrigin);
  Builder guidelineDate(java.util.Date date);
  Builder guidelineSubject(MedicalEntity medicalEntity);
  Builder guidelineSubject(MedicalEntity.Builder medicalEntity);
