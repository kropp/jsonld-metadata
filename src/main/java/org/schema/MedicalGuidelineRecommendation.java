...
public class MedicalGuidelineRecommendation extends MedicalGuideline {
   ...
   */
  static final class MedicalGuidelineRecommendationThingBuilder implements Builder {
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("recommendationStrength".equals(key) && value instanceof String) { recommendationStrength((String)value); continue; }
  ...
  public interface Builder extends ThingBuilder<MedicalGuidelineRecommendation> {
    @NotNull Builder recommendationStrength(@NotNull String recommendationStrength);
    @NotNull Builder evidenceLevel(@NotNull MedicalEvidenceLevel medicalEvidenceLevel);
    @NotNull Builder evidenceLevel(@NotNull MedicalEvidenceLevel.Builder medicalEvidenceLevel);
    @NotNull Builder evidenceOrigin(@NotNull String evidenceOrigin);
    @NotNull Builder guidelineDate(@NotNull java.util.Date date);
    @NotNull Builder guidelineSubject(@NotNull MedicalEntity medicalEntity);
    @NotNull Builder guidelineSubject(@NotNull MedicalEntity.Builder medicalEntity);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myRecommendationStrength != null ? myRecommendationStrength.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    MedicalGuidelineRecommendation medicalGuidelineRecommendation = (MedicalGuidelineRecommendation) o;
    if (!super.equals(o)) return false;
    if (myRecommendationStrength != null ? !myRecommendationStrength.equals(medicalGuidelineRecommendation.myRecommendationStrength) : medicalGuidelineRecommendation.myRecommendationStrength != null) return false;
    return true;
  }
