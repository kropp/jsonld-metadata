...
/**
 * A guideline recommendation that is regarded as efficacious and where quality of the data supporting the recommendation is sound.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class MedicalGuidelineRecommendation extends MedicalGuideline {
  /**
   * Strength of the guideline's recommendation (e.g. 'class I').
   */
  public String getRecommendationStrength() { return myRecommendationStrength; }
   ...
   */
  public static class Builder implements ThingBuilder<MedicalGuidelineRecommendation> {
