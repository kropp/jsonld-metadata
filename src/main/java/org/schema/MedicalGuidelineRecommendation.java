...
public class MedicalGuidelineRecommendation extends MedicalGuideline {
  ...
  static final class MedicalGuidelineRecommendationThingBuilder implements Builder {
     ...
     * Strength of the guideline's recommendation (e.g. 'class I').
     */
    @NotNull public Builder recommendationStrength(String recommendationStrength) {
     ...
     */
    @NotNull public Builder evidenceLevel(MedicalEvidenceLevel medicalEvidenceLevel) {
     ...
     * Strength of evidence of the data used to formulate the guideline (enumerated).
     */
    @NotNull public Builder evidenceLevel(MedicalEvidenceLevel.Builder medicalEvidenceLevel) {
      return this.evidenceLevel(medicalEvidenceLevel.build());
    }
    /**
     * Source of the data used to formulate the guidance, e.g. RCT, consensus opinion, etc.
     */
    @NotNull public Builder evidenceOrigin(String evidenceOrigin) {
     ...
     */
    @NotNull public Builder guidelineDate(java.util.Date date) {
     ...
     */
    @NotNull public Builder guidelineSubject(MedicalEntity medicalEntity) {
     ...
     * The medical conditions, treatments, etc. that are the subject of the guideline.
     */
    @NotNull public Builder guidelineSubject(MedicalEntity.Builder medicalEntity) {
  ...
  public interface Builder extends ThingBuilder<MedicalGuidelineRecommendation> {
    @NotNull Builder recommendationStrength(String recommendationStrength);
    @NotNull Builder evidenceLevel(MedicalEvidenceLevel medicalEvidenceLevel);
    @NotNull Builder evidenceLevel(MedicalEvidenceLevel.Builder medicalEvidenceLevel);
    @NotNull Builder evidenceOrigin(String evidenceOrigin);
    @NotNull Builder guidelineDate(java.util.Date date);
    @NotNull Builder guidelineSubject(MedicalEntity medicalEntity);
    @NotNull Builder guidelineSubject(MedicalEntity.Builder medicalEntity);
