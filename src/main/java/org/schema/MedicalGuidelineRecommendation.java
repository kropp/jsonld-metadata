...
public class MedicalGuidelineRecommendation extends MedicalGuideline {
  ...
  public static final class Builder {
    ...
    public MedicalGuidelineRecommendation build() {
      return new MedicalGuidelineRecommendation(recognizingAuthority, code, name, evidenceLevel, mainEntityOfPage, guideline, url, sameAs, additionalType, recommendationStrength, alternateName, study, description, potentialAction, relevantSpecialty, evidenceOrigin, guidelineDate, guidelineSubject, medicineSystem);
    }
    /**
     ...
     * Strength of the guideline's recommendation (e.g. 'class I').
     */
    public Builder recommendationStrength(String recommendationStrength) {
  ...
  protected MedicalGuidelineRecommendation(Organization recognizingAuthority, MedicalCode code, String name, MedicalEvidenceLevel evidenceLevel, StringOrCreativeWork mainEntityOfPage, MedicalGuideline guideline, String url, String sameAs, String additionalType, String recommendationStrength, String alternateName, MedicalStudy study, String description, Action potentialAction, MedicalSpecialty relevantSpecialty, String evidenceOrigin, java.util.Date guidelineDate, MedicalEntity guidelineSubject, MedicineSystem medicineSystem) {
    super(recognizingAuthority, code, evidenceLevel, name, mainEntityOfPage, guideline, url, sameAs, additionalType, alternateName, study, potentialAction, description, relevantSpecialty, medicineSystem, guidelineSubject, guidelineDate, evidenceOrigin);
