...
public class IndividualProduct extends Product {
  ...
  public static final class Builder {
    ...
    public IndividualProduct build() {
      return new IndividualProduct(purchaseDate, aggregateRating, review, depth, logo, isSimilarTo, gtin14, award, sameAs, additionalType, color, productID, gtin12, isAccessoryOrSparePartFor, brand, sku, manufacturer, potentialAction, additionalProperty, category, name, mpn, mainEntityOfPage, gtin8, audience, model, url, itemCondition, height, isRelatedTo, productionDate, alternateName, releaseDate, gtin13, description, offers, isConsumableFor, weight, width);
    }
    /**
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  protected IndividualProduct(java.util.Date purchaseDate, AggregateRating aggregateRating, Review review, QuantitativeValueOrDistance depth, ImageObjectOrString logo, Product isSimilarTo, String gtin14, String award, String sameAs, String additionalType, String color, String productID, String gtin12, Product isAccessoryOrSparePartFor, OrganizationOrBrand brand, String sku, Organization manufacturer, Action potentialAction, PropertyValue additionalProperty, ThingOrStringOrPhysicalActivityCategory category, String name, String mpn, StringOrCreativeWork mainEntityOfPage, String gtin8, Audience audience, ProductModelOrString model, String url, OfferItemCondition itemCondition, QuantitativeValueOrDistance height, Product isRelatedTo, java.util.Date productionDate, String alternateName, java.util.Date releaseDate, String gtin13, String description, Offer offers, Product isConsumableFor, QuantitativeValue weight, QuantitativeValueOrDistance width) {
