...
public class DrugStrength extends MedicalIntangible {
  ...
  public static final class Builder {
    ...
    public DrugStrength build() {
      return new DrugStrength(recognizingAuthority, code, activeIngredient, strengthValue, name, mainEntityOfPage, guideline, url, sameAs, additionalType, alternateName, availableIn, study, potentialAction, description, relevantSpecialty, medicineSystem, strengthUnit);
    }
    /**
  ...
  protected DrugStrength(Organization recognizingAuthority, MedicalCode code, String activeIngredient, Number strengthValue, String name, StringOrCreativeWork mainEntityOfPage, MedicalGuideline guideline, String url, String sameAs, String additionalType, String alternateName, AdministrativeArea availableIn, MedicalStudy study, Action potentialAction, String description, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem, String strengthUnit) {
