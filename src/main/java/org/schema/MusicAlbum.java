...
public class MusicAlbum extends MusicPlaylist {
  ...
  /**
   * Builder for {@see MusicAlbum}
   */
  public static final class Builder {
    public MusicAlbum build() {
      return new MusicAlbum(producer, editor, review, timeRequired, offers, creator, educationalUse, alternativeHeadline, mentions, additionalType, albumReleaseType, position, associatedMedia, isFamilyFriendly, image, accessibilityControl, keywords, discussionUrl, exampleOfWork, isBasedOnUrl, comment, numTracks, datePublished, alternateName, author, video, publisher, url, interactivityType, about, track, character, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, albumRelease, commentCount, mainEntity, genre, potentialAction, contentRating, audience, albumProductionType, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, byArtist, releasedEvent, accessibilityHazard, accessibilityFeature, license, description, provider, publication, recordedAt, educationalAlignment, mainEntityOfPage, contributor, workExample, isPartOf, dateCreated, copyrightHolder, sameAs, aggregateRating, name, typicalAgeRange, translator, copyrightYear, citation, sourceOrganization, text, award);
    }
    /**
     ...
     * The kind of release which this album is: single, EP or album.
     */
    public Builder albumReleaseType(MusicAlbumReleaseType value) {
      albumReleaseType = value;
      return this;
    }
     ...
     * A release of this album.
     */
    public Builder albumRelease(MusicRelease value) {
      albumRelease = value;
      return this;
    }
    /**
     ...
     * Classification of the album by it's type of content: soundtrack, live album, studio album, etc.
     */
    public Builder albumProductionType(MusicAlbumProductionType value) {
      albumProductionType = value;
      return this;
    }
    /**
     ...
     * The artist that performed this album or recording.
     */
    public Builder byArtist(MusicGroup value) {
      byArtist = value;
      return this;
    }
    /**
  ...
  protected MusicAlbum(Person producer, Person editor, Review review, Duration timeRequired, Offer offers, Organization creator, String educationalUse, String alternativeHeadline, Thing mentions, String additionalType, MusicAlbumReleaseType albumReleaseType, Position position, MediaObject associatedMedia, Boolean isFamilyFriendly, Image image, String accessibilityControl, String keywords, String discussionUrl, CreativeWork exampleOfWork, String isBasedOnUrl, Comment comment, Integer numTracks, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, ItemList track, Person character, String schemaVersion, String accessibilityAPI, Number version, String publishingPrinciples, String headline, MediaObject encoding, MusicRelease albumRelease, Integer commentCount, Thing mainEntity, String genre, Action potentialAction, String contentRating, Audience audience, MusicAlbumProductionType albumProductionType, String inLanguage, Place contentLocation, String learningResourceType, Person accountablePerson, AudioObject audio, java.util.Date dateModified, String thumbnailUrl, MusicGroup byArtist, PublicationEvent releasedEvent, String accessibilityHazard, String accessibilityFeature, CreativeWork license, String description, Person provider, PublicationEvent publication, Event recordedAt, AlignmentObject educationalAlignment, CreativeWork mainEntityOfPage, Organization contributor, CreativeWork workExample, IsPartOf isPartOf, java.util.Date dateCreated, Organization copyrightHolder, String sameAs, AggregateRating aggregateRating, String name, String typicalAgeRange, Person translator, Number copyrightYear, CreativeWork citation, Organization sourceOrganization, String text, String award) {
