...
public class MusicAlbum extends MusicPlaylist {
  ...
  public static final class Builder {
    /**
     * Creates new {@link MusicAlbum} instance.
     */
    public MusicAlbum build() {
      return new MusicAlbum(accessibilityAPI, aggregateRating, hasPart, numTracks, review, datePublished, comment, schemaVersion, video, byArtist, award, editor, albumProductionType, workExample, track, potentialAction, albumReleaseType, producer, publisher, sourceOrganization, learningResourceType, genre, publishingPrinciples, translator, recordedAt, inLanguage, commentCount, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, about, contentLocation, accessibilityHazard, author, version, accountablePerson, additionalType, sameAs, thumbnailUrl, publication, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, mainEntity, alternativeHeadline, name, license, mainEntityOfPage, discussionUrl, copyrightYear, isBasedOnUrl, isFamilyFriendly, albumRelease, exampleOfWork, alternateName, releasedEvent, creator, contributor);
    }
    /**
     ...
     * The artist that performed this album or recording.
     */
    public Builder byArtist(MusicGroup musicGroup) {
      this.byArtist = musicGroup;
      return this;
    }
    /**
     ...
     * Classification of the album by it's type of content: soundtrack, live album, studio album, etc.
     */
    public Builder albumProductionType(MusicAlbumProductionType musicAlbumProductionType) {
      this.albumProductionType = musicAlbumProductionType;
      return this;
    }
    /**
     ...
     * The kind of release which this album is: single, EP or album.
     */
    public Builder albumReleaseType(MusicAlbumReleaseType musicAlbumReleaseType) {
      this.albumReleaseType = musicAlbumReleaseType;
      return this;
    }
    /**
     ...
     * A release of this album.
     */
    public Builder albumRelease(MusicRelease musicRelease) {
      this.albumRelease = musicRelease;
      return this;
    }
    /**
    ...
    private MusicRecordingOrItemList track;
  ...
  private MusicRelease myAlbumRelease;
}
