...
public class MusicAlbum extends MusicPlaylist {
   ...
   */
  public static final class MusicAlbumThingBuilder implements Builder {
    /**
     ...
     * The artist that performed this album or recording.
     */
    public Builder byArtist(MusicGroup.Builder musicGroup) {
     ...
     * Classification of the album by it's type of content: soundtrack, live album, studio album, etc.
     */
    public Builder albumProductionType(MusicAlbumProductionType.Builder musicAlbumProductionType) {
     ...
     * The kind of release which this album is: single, EP or album.
     */
    public Builder albumReleaseType(MusicAlbumReleaseType.Builder musicAlbumReleaseType) {
     ...
     * A release of this album.
     */
    public Builder albumRelease(MusicRelease.Builder musicRelease) {
     ...
     * A music recording (track)&#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
     */
    public Builder track(ItemList.Builder itemList) {
     ...
     * A music recording (track)&#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
     */
    public Builder track(MusicRecording.Builder musicRecording) {
  ...
  Builder byArtist(MusicGroup musicGroup);
  Builder byArtist(MusicGroup.Builder musicGroup);
  Builder albumProductionType(MusicAlbumProductionType musicAlbumProductionType);
  Builder albumProductionType(MusicAlbumProductionType.Builder musicAlbumProductionType);
  Builder albumReleaseType(MusicAlbumReleaseType musicAlbumReleaseType);
  Builder albumReleaseType(MusicAlbumReleaseType.Builder musicAlbumReleaseType);
  Builder albumRelease(MusicRelease musicRelease);
  Builder albumRelease(MusicRelease.Builder musicRelease);
  Builder numTracks(Integer integer);
  Builder track(ItemList itemList);
  Builder track(ItemList.Builder itemList);
  Builder track(MusicRecording musicRecording);
  Builder track(MusicRecording.Builder musicRecording);
