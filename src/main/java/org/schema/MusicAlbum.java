...
public class MusicAlbum extends MusicPlaylist {
  ...
  static final class MusicAlbumThingBuilder implements Builder {
     ...
     * The artist that performed this album or recording.
     */
    @NotNull public Builder byArtist(MusicGroup.Builder musicGroup) {
      return this.byArtist(musicGroup.build());
    }
    /**
     * Classification of the album by it's type of content: soundtrack, live album, studio album, etc.
     */
    @NotNull public Builder albumProductionType(MusicAlbumProductionType musicAlbumProductionType) {
     ...
     * Classification of the album by it's type of content: soundtrack, live album, studio album, etc.
     */
    @NotNull public Builder albumProductionType(MusicAlbumProductionType.Builder musicAlbumProductionType) {
      return this.albumProductionType(musicAlbumProductionType.build());
    }
    /**
     * The kind of release which this album is: single, EP or album.
     */
    @NotNull public Builder albumReleaseType(MusicAlbumReleaseType musicAlbumReleaseType) {
     ...
     * The kind of release which this album is: single, EP or album.
     */
    @NotNull public Builder albumReleaseType(MusicAlbumReleaseType.Builder musicAlbumReleaseType) {
      return this.albumReleaseType(musicAlbumReleaseType.build());
    }
    /**
     * A release of this album.
     */
    @NotNull public Builder albumRelease(MusicRelease musicRelease) {
     ...
     * A release of this album.
     */
    @NotNull public Builder albumRelease(MusicRelease.Builder musicRelease) {
      return this.albumRelease(musicRelease.build());
    }
    /**
     * The number of tracks in this album or playlist.
     */
    @NotNull public Builder numTracks(int numTracks) {
     ...
     */
    @NotNull public Builder track(ItemList itemList) {
     ...
     * A music recording (track)&#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
     */
    @NotNull public Builder track(ItemList.Builder itemList) {
      return this.track(itemList.build());
    }
    /**
     * A music recording (track)&#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
     */
    @NotNull public Builder track(MusicRecording musicRecording) {
      if (this.track == null) this.track = new ItemListOrMusicRecording();
     ...
     * A music recording (track)&#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
     */
    @NotNull public Builder track(MusicRecording.Builder musicRecording) {
      return this.track(musicRecording.build());
    }
    /**
  ...
  public interface Builder extends ThingBuilder<MusicAlbum> {
    @NotNull Builder byArtist(MusicGroup musicGroup);
    @NotNull Builder byArtist(MusicGroup.Builder musicGroup);
    @NotNull Builder albumProductionType(MusicAlbumProductionType musicAlbumProductionType);
    @NotNull Builder albumProductionType(MusicAlbumProductionType.Builder musicAlbumProductionType);
    @NotNull Builder albumReleaseType(MusicAlbumReleaseType musicAlbumReleaseType);
    @NotNull Builder albumReleaseType(MusicAlbumReleaseType.Builder musicAlbumReleaseType);
    @NotNull Builder albumRelease(MusicRelease musicRelease);
    @NotNull Builder albumRelease(MusicRelease.Builder musicRelease);
    @NotNull Builder numTracks(int numTracks);
    @NotNull Builder track(ItemList itemList);
    @NotNull Builder track(ItemList.Builder itemList);
    @NotNull Builder track(MusicRecording musicRecording);
    @NotNull Builder track(MusicRecording.Builder musicRecording);
