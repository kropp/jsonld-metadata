...
public class MusicAlbum extends MusicPlaylist {
  ...
  static final class MusicAlbumThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("byArtist".equals(key) && value instanceof MusicGroup) { byArtist((MusicGroup)value); continue; }
        if ("albumProductionType".equals(key) && value instanceof MusicAlbumProductionType) { albumProductionType((MusicAlbumProductionType)value); continue; }
        if ("albumReleaseType".equals(key) && value instanceof MusicAlbumReleaseType) { albumReleaseType((MusicAlbumReleaseType)value); continue; }
        if ("albumRelease".equals(key) && value instanceof MusicRelease) { albumRelease((MusicRelease)value); continue; }
        if ("numTracks".equals(key) && value instanceof Integer) { numTracks((Integer)value); continue; }
        if ("track".equals(key) && value instanceof ItemList) { track((ItemList)value); continue; }
        if ("track".equals(key) && value instanceof MusicRecording) { track((MusicRecording)value); continue; }
  ...
  public interface Builder extends ThingBuilder<MusicAlbum> {
    ...
    @NotNull Builder albumProductionType(@NotNull MusicAlbumProductionType musicAlbumProductionType);
    @NotNull Builder albumProductionType(@NotNull MusicAlbumProductionType.Builder musicAlbumProductionType);
    @NotNull Builder albumReleaseType(@NotNull MusicAlbumReleaseType musicAlbumReleaseType);
    @NotNull Builder albumReleaseType(@NotNull MusicAlbumReleaseType.Builder musicAlbumReleaseType);
    @NotNull Builder albumRelease(@NotNull MusicRelease musicRelease);
    @NotNull Builder albumRelease(@NotNull MusicRelease.Builder musicRelease);
    @NotNull Builder numTracks(@NotNull Integer integer);
    @NotNull Builder track(@NotNull ItemList itemList);
    @NotNull Builder track(@NotNull ItemList.Builder itemList);
    @NotNull Builder track(@NotNull MusicRecording musicRecording);
    @NotNull Builder track(@NotNull MusicRecording.Builder musicRecording);
