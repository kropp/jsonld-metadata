...
public class SteeringPositionValue extends QualitativeValue {
  /**
   * Builder for {@see SteeringPositionValue}
   */
  public static final class Builder {
    public SteeringPositionValue build() {
      return new SteeringPositionValue(mainEntityOfPage, nonEqual, valueReference, potentialAction, alternateName, equal, lesserOrEqual, additionalType, url, sameAs, greaterOrEqual, name, image, greater, supersededBy, lesser, additionalProperty, description);
    }
    /**
