...
public class PerformanceRole extends Role {
   ...
   */
  static final class PerformanceRoleThingBuilder implements Builder {
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("characterName".equals(key) && value instanceof String) { characterName((String)value); continue; }
  ...
  public interface Builder extends ThingBuilder<PerformanceRole> {
    @NotNull Builder characterName(@NotNull String characterName);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myCharacterName != null ? myCharacterName.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    PerformanceRole performanceRole = (PerformanceRole) o;
    if (!super.equals(o)) return false;
    if (myCharacterName != null ? !myCharacterName.equals(performanceRole.myCharacterName) : performanceRole.myCharacterName != null) return false;
    return true;
  }
