...
public class ReservationPackage extends Reservation {
  ...
  static final class ReservationPackageThingBuilder implements Builder {
     ...
     * The individual reservations included in the package. Typically a repeated property.
     */
    @NotNull public Builder subReservation(Reservation reservation) {
     ...
     * The individual reservations included in the package. Typically a repeated property.
     */
    @NotNull public Builder subReservation(Reservation.Builder reservation) {
  ...
  public interface Builder extends ThingBuilder<ReservationPackage> {
    @NotNull Builder subReservation(Reservation reservation);
    @NotNull Builder subReservation(Reservation.Builder reservation);
