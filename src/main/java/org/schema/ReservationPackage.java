...
public class ReservationPackage extends Reservation {
   ...
   */
  public static final class ReservationPackageThingBuilder implements Builder {
    /**
     ...
     * The individual reservations included in the package. Typically a repeated property.
     */
    public Builder subReservation(Reservation.Builder reservation) {
  ...
  Builder subReservation(Reservation reservation);
  Builder subReservation(Reservation.Builder reservation);
