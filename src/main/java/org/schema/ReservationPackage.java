...
public class ReservationPackage extends Reservation {
  ...
  public static final class Builder {
    ...
    public ReservationPackage build() {
      return new ReservationPackage(bookingTime, modifiedTime, reservationStatus, provider, reservationId, totalPrice, priceCurrency, name, underName, mainEntityOfPage, reservedTicket, additionalType, url, sameAs, broker, programMembershipUsed, reservationFor, alternateName, description, potentialAction, subReservation);
    }
    /**
     ...
     * The individual reservations included in the package. Typically a repeated property.
     */
    public Builder subReservation(Reservation reservation) {
  ...
  protected ReservationPackage(java.util.Date bookingTime, java.util.Date modifiedTime, ReservationStatusType reservationStatus, OrganizationOrPerson provider, String reservationId, PriceSpecificationOrStringOrNumber totalPrice, String priceCurrency, String name, OrganizationOrPerson underName, StringOrCreativeWork mainEntityOfPage, Ticket reservedTicket, String additionalType, String url, String sameAs, OrganizationOrPerson broker, ProgramMembership programMembershipUsed, Thing reservationFor, String alternateName, String description, Action potentialAction, Reservation subReservation) {
