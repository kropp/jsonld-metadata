...
public class RegisterAction extends InteractAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link RegisterAction} instance.
     */
    public RegisterAction build() {
      return new RegisterAction(startTime, name, error, mainEntityOfPage, url, additionalType, sameAs, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
