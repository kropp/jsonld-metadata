...
public class RegisterAction extends InteractAction {
  /**
   * Builder for {@see RegisterAction}
   */
  public static final class Builder {
    public RegisterAction build() {
      return new RegisterAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
