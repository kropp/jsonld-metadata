...
public class OrderStatus extends Enumeration {
  ...
  public static final class Builder {
    ...
    public OrderStatus build() {
      return new OrderStatus(supersededBy, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
  ...
  protected OrderStatus(EnumerationOrProperty supersededBy, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction) {
