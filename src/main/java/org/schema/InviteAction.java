...
public class InviteAction extends CommunicateAction {
  ...
  /**
   * Builder for {@see InviteAction}
   */
  public static final class Builder {
    public InviteAction build() {
      return new InviteAction(event, instrument, recipient, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, about, sameAs, startTime, actionStatus, inLanguage, result, error, name, image, target, object, location, description);
    }
    /**
     * Upcoming or past event associated with this place, organization, or action.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected InviteAction(Event event, Instrument instrument, Audience recipient, CreativeWork mainEntityOfPage, Organization agent, java.util.Date endTime, Action potentialAction, String alternateName, Participant participant, String additionalType, String url, Thing about, String sameAs, java.util.Date startTime, ActionStatusType actionStatus, String inLanguage, Result result, Thing error, String name, Image image, EntryPoint target, Object object, Location location, String description) {
