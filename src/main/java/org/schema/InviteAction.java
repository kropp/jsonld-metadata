...
public class InviteAction extends CommunicateAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link InviteAction} instance.
     */
    public InviteAction build() {
      return new InviteAction(startTime, inLanguage, about, name, error, mainEntityOfPage, event, sameAs, url, additionalType, recipient, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
