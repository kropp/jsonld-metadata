...
public class InviteAction extends CommunicateAction {
   ...
   */
  static final class InviteActionThingBuilder implements Builder {
    /**
     * Creates new {@link InviteAction} instance.
     */
    public InviteAction build() {
      return new InviteAction(event, about, inLanguage, recipient, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * Upcoming or past event associated with this place, organization, or action.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<InviteAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    InviteAction inviteAction = (InviteAction) o;
    if (!super.equals(o)) return false;
    if (myEvent != null ? !myEvent.equals(inviteAction.myEvent) : inviteAction.myEvent != null) return false;
    return true;
  }
