...
public class Ligament extends AnatomicalStructure {
  /**
   * Builder for {@see Ligament}
   */
  public static final class Builder {
    public Ligament build() {
      return new Ligament(function, mainEntityOfPage, relatedCondition, subStructure, alternateName, potentialAction, url, additionalType, connectedTo, medicineSystem, associatedPathophysiology, partOfSystem, sameAs, recognizingAuthority, study, code, diagram, bodyLocation, name, image, relevantSpecialty, guideline, relatedTherapy, description);
    }
    /**
