...
public class Ligament extends AnatomicalStructure {
  ...
  public static final class Builder {
    /**
     * Creates new {@link Ligament} instance.
     */
    public Ligament build() {
      return new Ligament(recognizingAuthority, bodyLocation, code, relatedTherapy, connectedTo, name, mainEntityOfPage, diagram, guideline, additionalType, sameAs, url, partOfSystem, relatedCondition, function, alternateName, associatedPathophysiology, subStructure, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
  ...
  protected Ligament(Organization recognizingAuthority, String bodyLocation, MedicalCode code, MedicalTherapy relatedTherapy, AnatomicalStructure connectedTo, String name, StringOrCreativeWork mainEntityOfPage, ImageObject diagram, MedicalGuideline guideline, String additionalType, String sameAs, String url, IsPartOf partOfSystem, MedicalCondition relatedCondition, String function, String alternateName, String associatedPathophysiology, AnatomicalStructure subStructure, MedicalStudy study, String description, Action potentialAction, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem) {
