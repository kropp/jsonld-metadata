...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  protected TelevisionStation(String videoFormat, Review review, OpeningHoursSpecification openingHoursSpecification, String openingHours, Action potentialAction, String additionalType, ImageObject logo, String currenciesAccepted, Organization parentOrganization, Image image, Place containedIn, String description, String hasMap, Event event, String faxNumber, CreativeWork mainEntityOfPage, String globalLocationNumber, String priceRange, String telephone, String alternateName, ImageObject photo, String url, GeoCoordinates geo, AggregateRating aggregateRating, String sameAs, String name, PostalAddress address, String paymentAccepted, PropertyValue additionalProperty, String isicV4) {
