...
public class TelevisionStation extends LocalBusiness {
  ...
  public static final class Builder {
    /**
     * Creates new {@link TelevisionStation} instance.
     */
    public TelevisionStation build() {
      return new TelevisionStation(aggregateRating, videoFormat, review, logo, parentOrganization, containedIn, event, sameAs, additionalType, priceRange, openingHoursSpecification, currenciesAccepted, potentialAction, address, additionalProperty, openingHours, globalLocationNumber, isicV4, name, paymentAccepted, mainEntityOfPage, hasMap, url, faxNumber, alternateName, geo, telephone, description, photo);
    }
    /**
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  protected TelevisionStation(AggregateRating aggregateRating, String videoFormat, Review review, ImageObjectOrString logo, Organization parentOrganization, Place containedIn, Event event, String sameAs, String additionalType, String priceRange, OpeningHoursSpecification openingHoursSpecification, String currenciesAccepted, Action potentialAction, PostalAddress address, PropertyValue additionalProperty, String openingHours, String globalLocationNumber, String isicV4, String name, String paymentAccepted, StringOrCreativeWork mainEntityOfPage, MapOrString hasMap, String url, String faxNumber, String alternateName, GeoCoordinatesOrGeoShape geo, String telephone, String description, ImageObjectOrPhotograph photo) {
