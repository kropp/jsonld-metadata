 ...
 * Equivalent class: http://purl.org/dc/dcmitype/Dataset
 */
public class Dataset extends CreativeWork {
   ...
   */
  public java.util.Date getDatasetTimeInterval() {
    return myDatasetTimeInterval;
  }
  /**
   * Builder for {@see Dataset}
   */
  public static final class Builder {
    public Dataset build() {
      return new Dataset(producer, review, editor, timeRequired, offers, creator, educationalUse, alternativeHeadline, mentions, additionalType, position, associatedMedia, isFamilyFriendly, accessibilityControl, image, keywords, discussionUrl, isBasedOnUrl, exampleOfWork, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, datasetTimeInterval, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, genre, potentialAction, contentRating, audience, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, releasedEvent, spatial, accessibilityFeature, accessibilityHazard, license, description, publication, provider, educationalAlignment, recordedAt, mainEntityOfPage, contributor, isPartOf, workExample, dateCreated, copyrightHolder, aggregateRating, sameAs, name, typicalAgeRange, citation, copyrightYear, translator, distribution, sourceOrganization, text, award, includedDataCatalog);
    }
    /**
     ...
     * The range of temporal applicability of a dataset, e.g. for a 2011 census dataset, the year 2011 (in ISO 8601 time interval format).
     */
    public Builder datasetTimeInterval(java.util.Date value) {
      datasetTimeInterval = value;
      return this;
    }
    /**
     ...
     * The range of spatial applicability of a dataset, e.g. for a dataset of New York weather, the state of New York.
     */
    public Builder spatial(Place value) {
      spatial = value;
      return this;
    }
    /**
     ...
     * A downloadable form of this dataset, at a specific location, in a specific format.
     */
    public Builder distribution(DataDownload value) {
      distribution = value;
      return this;
    }
    /**
     ...
     * A data catalog contained in the dataset.
     */
    public Builder includedDataCatalog(DataCatalog value) {
      includedDataCatalog = value;
      return this;
    }
    ...
    private java.util.Date datasetTimeInterval;
  ...
  protected Dataset(Person producer, Review review, Person editor, Duration timeRequired, Offer offers, Organization creator, String educationalUse, String alternativeHeadline, Thing mentions, String additionalType, Position position, MediaObject associatedMedia, Boolean isFamilyFriendly, String accessibilityControl, Image image, String keywords, String discussionUrl, String isBasedOnUrl, CreativeWork exampleOfWork, Comment comment, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, Person character, String schemaVersion, String accessibilityAPI, java.util.Date datasetTimeInterval, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, String genre, Action potentialAction, String contentRating, Audience audience, String inLanguage, Place contentLocation, String learningResourceType, Person accountablePerson, AudioObject audio, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, Place spatial, String accessibilityFeature, String accessibilityHazard, CreativeWork license, String description, PublicationEvent publication, Person provider, AlignmentObject educationalAlignment, Event recordedAt, CreativeWork mainEntityOfPage, Organization contributor, IsPartOf isPartOf, CreativeWork workExample, java.util.Date dateCreated, Organization copyrightHolder, AggregateRating aggregateRating, String sameAs, String name, String typicalAgeRange, CreativeWork citation, Number copyrightYear, Person translator, DataDownload distribution, Organization sourceOrganization, String text, String award, DataCatalog includedDataCatalog) {
    ...
    myIncludedDataCatalog = includedDataCatalog;
  ...
  private java.util.Date myDatasetTimeInterval;
}
