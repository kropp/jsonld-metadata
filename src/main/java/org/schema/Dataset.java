...
public class Dataset extends CreativeWork {
  ...
  static final class DatasetThingBuilder implements Builder {
     ...
     * A data catalog contained in the dataset.
     */
    @NotNull public Builder includedDataCatalog(DataCatalog dataCatalog) {
     ...
     * A data catalog contained in the dataset.
     */
    @NotNull public Builder includedDataCatalog(DataCatalog.Builder dataCatalog) {
      return this.includedDataCatalog(dataCatalog.build());
    }
    /**
     * A downloadable form of this dataset, at a specific location, in a specific format.
     */
    @NotNull public Builder distribution(DataDownload dataDownload) {
     ...
     * A downloadable form of this dataset, at a specific location, in a specific format.
     */
    @NotNull public Builder distribution(DataDownload.Builder dataDownload) {
      return this.distribution(dataDownload.build());
    }
    /**
     * The range of spatial applicability of a dataset, e.g. for a dataset of New York weather, the state of New York.
     */
    @NotNull public Builder spatial(Place place) {
      this.spatial = place;
      return this;
    }
    /**
     * The range of spatial applicability of a dataset, e.g. for a dataset of New York weather, the state of New York.
     */
    @NotNull public Builder spatial(Place.Builder place) {
      return this.spatial(place.build());
    }
    /**
     * The range of temporal applicability of a dataset, e.g. for a 2011 census dataset, the year 2011 (in ISO 8601 time interval format).
     */
    @NotNull public Builder datasetTimeInterval(java.util.Date date) {
  ...
  public interface Builder extends ThingBuilder<Dataset> {
    @NotNull Builder includedDataCatalog(DataCatalog dataCatalog);
    @NotNull Builder includedDataCatalog(DataCatalog.Builder dataCatalog);
    @NotNull Builder distribution(DataDownload dataDownload);
    @NotNull Builder distribution(DataDownload.Builder dataDownload);
    @NotNull Builder spatial(Place place);
    @NotNull Builder spatial(Place.Builder place);
    @NotNull Builder datasetTimeInterval(java.util.Date date);
