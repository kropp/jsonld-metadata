...
public class Dataset extends CreativeWork {
  ...
  public static final class Builder {
    ...
    public Dataset build() {
      return new Dataset(accessibilityAPI, aggregateRating, hasPart, review, datePublished, comment, schemaVersion, video, award, includedDataCatalog, editor, workExample, potentialAction, spatial, producer, publisher, sourceOrganization, genre, learningResourceType, publishingPrinciples, translator, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, distribution, educationalAlignment, text, about, contentLocation, author, accessibilityHazard, version, accountablePerson, sameAs, additionalType, thumbnailUrl, publication, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, alternativeHeadline, mainEntity, name, license, datasetTimeInterval, copyrightYear, discussionUrl, mainEntityOfPage, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, contributor, creator);
    }
    /**
     ...
     * A data catalog contained in the dataset.
     */
    public Builder includedDataCatalog(DataCatalog dataCatalog) {
      this.includedDataCatalog = dataCatalog;
      return this;
    }
    /**
     ...
     * The range of spatial applicability of a dataset, e.g. for a dataset of New York weather, the state of New York.
     */
    public Builder spatial(Place place) {
      this.spatial = place;
      return this;
    }
    /**
     ...
     * A downloadable form of this dataset, at a specific location, in a specific format.
     */
    public Builder distribution(DataDownload dataDownload) {
      this.distribution = dataDownload;
      return this;
    }
    /**
     ...
     * The range of temporal applicability of a dataset, e.g. for a 2011 census dataset, the year 2011 (in ISO 8601 time interval format).
     */
    public Builder datasetTimeInterval(java.util.Date date) {
      this.datasetTimeInterval = date;
      return this;
    }
    /**
  ...
  protected Dataset(String accessibilityAPI, AggregateRating aggregateRating, HasPart hasPart, Review review, java.util.Date datePublished, Comment comment, String schemaVersion, VideoObject video, String award, DataCatalog includedDataCatalog, Person editor, CreativeWork workExample, Action potentialAction, Place spatial, OrganizationOrPerson producer, Organization publisher, Organization sourceOrganization, String genre, String learningResourceType, String publishingPrinciples, OrganizationOrPerson translator, Event recordedAt, Integer commentCount, LanguageOrString inLanguage, java.util.Date dateModified, Thing mentions, Audience audience, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, String contentRating, String description, Offer offers, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, String educationalUse, String keywords, DataDownload distribution, AlignmentObject educationalAlignment, String text, Thing about, Place contentLocation, OrganizationOrPerson author, String accessibilityHazard, Number version, Person accountablePerson, String sameAs, String additionalType, String thumbnailUrl, PublicationEvent publication, MediaObject encoding, Duration timeRequired, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, String alternativeHeadline, Thing mainEntity, String name, StringOrCreativeWork license, java.util.Date datasetTimeInterval, Number copyrightYear, String discussionUrl, StringOrCreativeWork mainEntityOfPage, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, String alternateName, PublicationEvent releasedEvent, OrganizationOrPerson contributor, OrganizationOrPerson creator) {
