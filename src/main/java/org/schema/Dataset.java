...
public class Dataset extends CreativeWork {
   ...
   */
  public static final class DatasetThingBuilder implements Builder {
    /**
     ...
     * A data catalog contained in the dataset.
     */
    public Builder includedDataCatalog(DataCatalog.Builder dataCatalog) {
     ...
     * A downloadable form of this dataset, at a specific location, in a specific format.
     */
    public Builder distribution(DataDownload.Builder dataDownload) {
     ...
     * The range of spatial applicability of a dataset, e.g. for a dataset of New York weather, the state of New York.
     */
    public Builder spatial(Place.Builder place) {
  ...
  Builder includedDataCatalog(DataCatalog dataCatalog);
  Builder includedDataCatalog(DataCatalog.Builder dataCatalog);
  Builder distribution(DataDownload dataDownload);
  Builder distribution(DataDownload.Builder dataDownload);
  Builder spatial(Place place);
  Builder spatial(Place.Builder place);
  Builder datasetTimeInterval(java.util.Date date);
