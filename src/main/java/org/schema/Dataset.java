...
public class Dataset extends CreativeWork {
   ...
   */
  @JsonIgnore public DataCatalog getIncludedDataCatalog() {
    return (DataCatalog) getValue("includedDataCatalog");
  }
  /**
   * A data catalog contained in the dataset.
   */
  @JsonIgnore public Collection<DataCatalog> getIncludedDataCatalogs() {
    final Object current = myData.get("includedDataCatalog");
   ...
   */
  @JsonIgnore public java.util.Date getDatasetTimeInterval() {
    return (java.util.Date) getValue("datasetTimeInterval");
  }
  /**
   * The range of temporal applicability of a dataset, e.g. for a 2011 census dataset, the year 2011 (in ISO 8601 time interval format).
   */
  @JsonIgnore public Collection<java.util.Date> getDatasetTimeIntervals() {
    final Object current = myData.get("datasetTimeInterval");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @NotNull public Builder includedDataCatalog(@NotNull DataCatalog dataCatalog) {
      putValue("includedDataCatalog", dataCatalog);
      return this;
    }
    /**
     * A data catalog contained in the dataset.
    ...
    @NotNull public Builder includedDataCatalog(@NotNull DataCatalog.Builder dataCatalog) {
      putValue("includedDataCatalog", dataCatalog.build());
      return this;
    }
    /**
     * A downloadable form of this dataset, at a specific location, in a specific format.
    ...
    @NotNull public Builder datasetTimeInterval(@NotNull java.util.Date date) {
      putValue("datasetTimeInterval", date);
      return this;
    }
    /**
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("includedDataCatalog".equals(key) && value instanceof DataCatalog) { includedDataCatalog((DataCatalog)value); return; }
      ...
      if ("datasetTimeInterval".equals(key) && value instanceof java.util.Date) { datasetTimeInterval((java.util.Date)value); return; }
