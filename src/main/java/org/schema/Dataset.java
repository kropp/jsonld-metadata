...
public class Dataset extends CreativeWork {
   ...
   */
  static final class DatasetThingBuilder implements Builder {
    /**
     ...
     * A data catalog contained in the dataset.
     */
    @NotNull public Builder includedDataCatalog(@NotNull DataCatalog dataCatalog) {
     ...
     * A data catalog contained in the dataset.
     */
    @NotNull public Builder includedDataCatalog(@NotNull DataCatalog.Builder dataCatalog) {
      return this.includedDataCatalog(dataCatalog.build());
    }
    /**
     * A downloadable form of this dataset, at a specific location, in a specific format.
     */
    ...
    @NotNull public Builder distribution(@NotNull DataDownload.Builder dataDownload) {
      return this.distribution(dataDownload.build());
    }
    /**
     * The range of spatial applicability of a dataset, e.g. for a dataset of New York weather, the state of New York.
     */
    ...
    @NotNull public Builder spatial(@NotNull Place.Builder place) {
      return this.spatial(place.build());
    }
    /**
     * The range of temporal applicability of a dataset, e.g. for a 2011 census dataset, the year 2011 (in ISO 8601 time interval format).
     */
    @NotNull public Builder datasetTimeInterval(@NotNull java.util.Date date) {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("includedDataCatalog".equals(key) && value instanceof DataCatalog) { includedDataCatalog((DataCatalog)value); continue; }
        if ("distribution".equals(key) && value instanceof DataDownload) { distribution((DataDownload)value); continue; }
        if ("spatial".equals(key) && value instanceof Place) { spatial((Place)value); continue; }
        if ("datasetTimeInterval".equals(key) && value instanceof java.util.Date) { datasetTimeInterval((java.util.Date)value); continue; }
  ...
  public interface Builder extends ThingBuilder<Dataset> {
    @NotNull Builder includedDataCatalog(@NotNull DataCatalog dataCatalog);
    @NotNull Builder includedDataCatalog(@NotNull DataCatalog.Builder dataCatalog);
    @NotNull Builder distribution(@NotNull DataDownload dataDownload);
    @NotNull Builder distribution(@NotNull DataDownload.Builder dataDownload);
    @NotNull Builder spatial(@NotNull Place place);
    @NotNull Builder spatial(@NotNull Place.Builder place);
    @NotNull Builder datasetTimeInterval(@NotNull java.util.Date date);
