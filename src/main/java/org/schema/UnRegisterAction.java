...
public class UnRegisterAction extends InteractAction {
  /**
   * Builder for {@see UnRegisterAction}
   */
  public static final class Builder {
    public UnRegisterAction build() {
      return new UnRegisterAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
