...
public class UnRegisterAction extends InteractAction {
   ...
   */
  static final class UnRegisterActionThingBuilder implements Builder {
    /**
     * Creates new {@link UnRegisterAction} instance.
     */
    public UnRegisterAction build() {
      return new UnRegisterAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<UnRegisterAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    UnRegisterAction unRegisterAction = (UnRegisterAction) o;
