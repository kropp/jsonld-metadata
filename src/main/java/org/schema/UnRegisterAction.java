...
public class UnRegisterAction extends InteractAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link UnRegisterAction} instance.
     */
    public UnRegisterAction build() {
      return new UnRegisterAction(startTime, name, error, mainEntityOfPage, url, additionalType, sameAs, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
