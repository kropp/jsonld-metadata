...
public class LandmarksOrHistoricalBuildings extends Place {
  /**
   * Builder for {@see LandmarksOrHistoricalBuildings}
   */
  public static final class Builder {
    public LandmarksOrHistoricalBuildings build() {
      return new LandmarksOrHistoricalBuildings(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, geo, additionalType, url, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
