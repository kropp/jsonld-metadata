...
public class LandmarksOrHistoricalBuildings extends Place {
  ...
  public static final class Builder {
    /**
     * Creates new {@link LandmarksOrHistoricalBuildings} instance.
     */
    public LandmarksOrHistoricalBuildings build() {
      return new LandmarksOrHistoricalBuildings(aggregateRating, review, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, containedIn, additionalType, sameAs, url, event, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  protected LandmarksOrHistoricalBuildings(AggregateRating aggregateRating, Review review, String globalLocationNumber, String isicV4, ImageObjectOrString logo, String name, StringOrCreativeWork mainEntityOfPage, MapOrString hasMap, Place containedIn, String additionalType, String sameAs, String url, Event event, String faxNumber, OpeningHoursSpecification openingHoursSpecification, String alternateName, GeoCoordinatesOrGeoShape geo, String telephone, Action potentialAction, String description, PostalAddress address, ImageObjectOrPhotograph photo, PropertyValue additionalProperty) {
