...
public class TreatmentIndication extends MedicalIndication {
  ...
  public static final class Builder {
    ...
    public TreatmentIndication build() {
      return new TreatmentIndication(recognizingAuthority, code, name, mainEntityOfPage, guideline, url, sameAs, additionalType, alternateName, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
