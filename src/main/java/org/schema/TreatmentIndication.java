...
public class TreatmentIndication extends MedicalIndication {
  /**
   * Builder for {@see TreatmentIndication}
   */
  public static final class Builder {
    public TreatmentIndication build() {
      return new TreatmentIndication(mainEntityOfPage, potentialAction, alternateName, additionalType, url, medicineSystem, sameAs, recognizingAuthority, study, code, name, image, relevantSpecialty, guideline, description);
    }
    /**
