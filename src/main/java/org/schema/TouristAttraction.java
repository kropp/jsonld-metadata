...
public class TouristAttraction extends Place {
  ...
  public static final class Builder {
    ...
    public TouristAttraction build() {
      return new TouristAttraction(address, aggregateRating, containedIn, event, faxNumber, geo, globalLocationNumber, isicV4, logo, hasMap, openingHoursSpecification, photo, review, telephone, additionalProperty, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
