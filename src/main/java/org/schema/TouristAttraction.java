...
public class TouristAttraction extends Place {
  ...
  public static final class Builder {
    /**
     * Creates new {@link TouristAttraction} instance.
     */
    public TouristAttraction build() {
      return new TouristAttraction(aggregateRating, review, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, containedIn, additionalType, sameAs, url, event, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
