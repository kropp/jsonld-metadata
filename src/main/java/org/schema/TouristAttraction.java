...
public class TouristAttraction extends Place {
  /**
   * Builder for {@see TouristAttraction}
   */
  public static final class Builder {
    public TouristAttraction build() {
      return new TouristAttraction(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, geo, additionalType, url, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
