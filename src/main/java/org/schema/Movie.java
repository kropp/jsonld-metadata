...
public class Movie extends CreativeWork {
  ...
  /**
   * Builder for {@see Movie}
   */
  public static final class Builder {
    public Movie build() {
      return new Movie(review, producer, editor, timeRequired, creator, offers, educationalUse, alternativeHeadline, mentions, duration, additionalType, position, associatedMedia, isFamilyFriendly, accessibilityControl, image, keywords, discussionUrl, trailer, exampleOfWork, isBasedOnUrl, comment, subtitleLanguage, datePublished, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, musicBy, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, actor, genre, potentialAction, director, contentRating, audience, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, releasedEvent, accessibilityFeature, accessibilityHazard, productionCompany, license, description, publication, provider, educationalAlignment, recordedAt, mainEntityOfPage, contributor, isPartOf, workExample, dateCreated, copyrightHolder, aggregateRating, sameAs, name, typicalAgeRange, citation, copyrightYear, translator, sourceOrganization, text, award);
    }
    /**
  ...
  protected Movie(Review review, Person producer, Person editor, Duration timeRequired, Organization creator, Offer offers, String educationalUse, String alternativeHeadline, Thing mentions, Duration duration, String additionalType, Position position, MediaObject associatedMedia, Boolean isFamilyFriendly, String accessibilityControl, Image image, String keywords, String discussionUrl, VideoObject trailer, CreativeWork exampleOfWork, String isBasedOnUrl, Comment comment, String subtitleLanguage, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, Person character, String schemaVersion, String accessibilityAPI, MusicGroup musicBy, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, Person actor, String genre, Action potentialAction, Person director, String contentRating, Audience audience, String inLanguage, Place contentLocation, String learningResourceType, Person accountablePerson, AudioObject audio, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, String accessibilityFeature, String accessibilityHazard, Organization productionCompany, CreativeWork license, String description, PublicationEvent publication, Person provider, AlignmentObject educationalAlignment, Event recordedAt, CreativeWork mainEntityOfPage, Organization contributor, IsPartOf isPartOf, CreativeWork workExample, java.util.Date dateCreated, Organization copyrightHolder, AggregateRating aggregateRating, String sameAs, String name, String typicalAgeRange, CreativeWork citation, Number copyrightYear, Person translator, Organization sourceOrganization, String text, String award) {
