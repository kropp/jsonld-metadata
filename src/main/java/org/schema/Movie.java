...
public class Movie extends CreativeWork {
  ...
  public static final class Builder {
     ...
     */
    public Movie build() {
      return new Movie(accessibilityAPI, aggregateRating, hasPart, subtitleLanguage, review, datePublished, schemaVersion, comment, video, award, editor, workExample, director, potentialAction, producer, publisher, sourceOrganization, genre, learningResourceType, translator, publishingPrinciples, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, about, contentLocation, musicBy, accessibilityHazard, author, version, accountablePerson, sameAs, additionalType, thumbnailUrl, publication, actor, encoding, timeRequired, duration, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, trailer, alternativeHeadline, mainEntity, name, license, copyrightYear, discussionUrl, mainEntityOfPage, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, productionCompany, contributor, creator);
    }
    /**
