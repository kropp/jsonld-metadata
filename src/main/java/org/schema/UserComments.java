...
public class UserComments extends UserInteraction {
   ...
   */
  public static final class UserCommentsThingBuilder implements Builder {
    /**
     ...
     * Specifies the CreativeWork associated with the UserComment.
     */
    public Builder discusses(CreativeWork.Builder creativeWork) {
  ...
  Builder commentText(String commentText);
  Builder commentTime(java.util.Date date);
  ...
  Builder discusses(CreativeWork creativeWork);
  Builder discusses(CreativeWork.Builder creativeWork);
  Builder replyToUrl(String replyToUrl);
