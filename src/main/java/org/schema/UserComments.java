  ...
  static final class UserCommentsThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("commentText".equals(key) && value instanceof String) { commentText((String)value); continue; }
        if ("commentTime".equals(key) && value instanceof java.util.Date) { commentTime((java.util.Date)value); continue; }
        ...
        if ("discusses".equals(key) && value instanceof CreativeWork) { discusses((CreativeWork)value); continue; }
        if ("replyToUrl".equals(key) && value instanceof String) { replyToUrl((String)value); continue; }
