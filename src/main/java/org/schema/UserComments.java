...
public class UserComments extends UserInteraction {
  ...
  /**
   * Builder for {@see UserComments}
   */
  public static final class Builder {
    public UserComments build() {
      return new UserComments(performer, review, offers, creator, endDate, potentialAction, duration, additionalType, inLanguage, image, workPerformed, attendee, commentText, discusses, previousStartDate, description, commentTime, mainEntityOfPage, organizer, doorTime, alternateName, eventStatus, url, superEvent, aggregateRating, sameAs, replyToUrl, startDate, subEvent, name, recordedIn, typicalAgeRange, location);
    }
    /**
     ...
     * The text of the UserComment.
     */
    public Builder commentText(String value) {
      commentText = value;
      return this;
    }
    /**
     * Specifies the CreativeWork associated with the UserComment.
     */
    public Builder discusses(CreativeWork value) {
      discusses = value;
      return this;
    }
    /**
     ...
     * The time at which the UserComment was made.
     */
    public Builder commentTime(java.util.Date value) {
      commentTime = value;
      return this;
    }
    /**
     ...
     * The URL at which a reply may be posted to the specified UserComment.
     */
    public Builder replyToUrl(String value) {
      replyToUrl = value;
      return this;
    }
    /**
  ...
  protected UserComments(Organization performer, Review review, Offer offers, Organization creator, java.util.Date endDate, Action potentialAction, Duration duration, String additionalType, String inLanguage, Image image, CreativeWork workPerformed, Organization attendee, String commentText, CreativeWork discusses, java.util.Date previousStartDate, String description, java.util.Date commentTime, CreativeWork mainEntityOfPage, Person organizer, java.util.Date doorTime, String alternateName, EventStatusType eventStatus, String url, Event superEvent, AggregateRating aggregateRating, String sameAs, String replyToUrl, java.util.Date startDate, Event subEvent, String name, CreativeWork recordedIn, String typicalAgeRange, Location location) {
