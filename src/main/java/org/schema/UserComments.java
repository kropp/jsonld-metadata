...
public class UserComments extends UserInteraction {
  ...
  static final class UserCommentsThingBuilder implements Builder {
     ...
     * The text of the UserComment.
     */
    @NotNull public Builder commentText(String commentText) {
     ...
     * The time at which the UserComment was made.
     */
    @NotNull public Builder commentTime(java.util.Date date) {
     ...
     * Specifies the CreativeWork associated with the UserComment.
     */
    @NotNull public Builder discusses(CreativeWork creativeWork) {
     ...
     * Specifies the CreativeWork associated with the UserComment.
     */
    @NotNull public Builder discusses(CreativeWork.Builder creativeWork) {
      return this.discusses(creativeWork.build());
    }
    /**
     * The URL at which a reply may be posted to the specified UserComment.
     */
  ...
  public interface Builder extends ThingBuilder<UserComments> {
    @NotNull Builder commentText(String commentText);
    @NotNull Builder commentTime(java.util.Date date);
    ...
    @NotNull Builder discusses(CreativeWork creativeWork);
    @NotNull Builder discusses(CreativeWork.Builder creativeWork);
    @NotNull Builder replyToUrl(String replyToUrl);
