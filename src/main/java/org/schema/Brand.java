...
public class Brand extends Intangible {
  ...
  /**
   * Builder for {@see Brand}
   */
  public static final class Builder {
    public Brand build() {
      return new Brand(review, mainEntityOfPage, image, name, alternateName, potentialAction, url, additionalType, description, sameAs, logo, aggregateRating);
    }
    /**
     * A review of the item.
     */
  ...
  protected Brand(Review review, CreativeWork mainEntityOfPage, Image image, String name, String alternateName, Action potentialAction, String url, String additionalType, String description, String sameAs, ImageObject logo, AggregateRating aggregateRating) {
