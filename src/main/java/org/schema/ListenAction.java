...
public class ListenAction extends ConsumeAction {
   ...
   */
  static final class ListenActionThingBuilder implements Builder {
    /**
     * Creates new {@link ListenAction} instance.
     */
    public ListenAction build() {
      return new ListenAction(expectsAcceptanceOf, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<ListenAction> {
  ...
  protected ListenAction(Offer expectsAcceptanceOf, OrganizationOrPerson agent, java.util.Date endTime, java.util.Date startTime, ActionStatusType actionStatus, Thing error, EntryPoint target, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
    super(expectsAcceptanceOf, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    ListenAction listenAction = (ListenAction) o;
