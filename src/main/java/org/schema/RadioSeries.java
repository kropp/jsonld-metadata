...
public class RadioSeries extends CreativeWorkSeries {
  ...
  /**
   * Builder for {@see RadioSeries}
   */
  public static final class Builder {
    public RadioSeries build() {
      return new RadioSeries(editor, producer, review, timeRequired, creator, offers, educationalUse, alternativeHeadline, mentions, additionalType, numberOfSeasons, position, associatedMedia, isFamilyFriendly, image, accessibilityControl, keywords, discussionUrl, trailer, isBasedOnUrl, exampleOfWork, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, musicBy, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, actor, episode, genre, endDate, potentialAction, audience, contentRating, director, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, releasedEvent, accessibilityHazard, accessibilityFeature, productionCompany, license, description, provider, publication, recordedAt, educationalAlignment, containsSeason, mainEntityOfPage, contributor, workExample, isPartOf, dateCreated, copyrightHolder, sameAs, aggregateRating, startDate, name, numberOfEpisodes, typicalAgeRange, translator, copyrightYear, citation, sourceOrganization, text, award);
    }
    /**
