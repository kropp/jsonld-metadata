...
public class RadioSeries extends CreativeWorkSeries {
   ...
   */
  static final class RadioSeriesThingBuilder implements Builder {
    /**
     * Creates new {@link RadioSeries} instance.
     */
  ...
  public interface Builder extends ThingBuilder<RadioSeries> {
  ...
  @Override public boolean equals(Object o) {
    ...
    RadioSeries radioSeries = (RadioSeries) o;
    if (!super.equals(o)) return false;
    if (myActor != null ? !myActor.equals(radioSeries.myActor) : radioSeries.myActor != null) return false;
    if (myDirector != null ? !myDirector.equals(radioSeries.myDirector) : radioSeries.myDirector != null) return false;
    if (myEpisode != null ? !myEpisode.equals(radioSeries.myEpisode) : radioSeries.myEpisode != null) return false;
    if (myMusicBy != null ? !myMusicBy.equals(radioSeries.myMusicBy) : radioSeries.myMusicBy != null) return false;
    if (myNumberOfEpisodes != null ? !myNumberOfEpisodes.equals(radioSeries.myNumberOfEpisodes) : radioSeries.myNumberOfEpisodes != null) return false;
    if (myNumberOfSeasons != null ? !myNumberOfSeasons.equals(radioSeries.myNumberOfSeasons) : radioSeries.myNumberOfSeasons != null) return false;
    if (myProductionCompany != null ? !myProductionCompany.equals(radioSeries.myProductionCompany) : radioSeries.myProductionCompany != null) return false;
    if (myContainsSeason != null ? !myContainsSeason.equals(radioSeries.myContainsSeason) : radioSeries.myContainsSeason != null) return false;
    if (myTrailer != null ? !myTrailer.equals(radioSeries.myTrailer) : radioSeries.myTrailer != null) return false;
    return true;
  }
