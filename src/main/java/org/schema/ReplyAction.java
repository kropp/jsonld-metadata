...
public class ReplyAction extends CommunicateAction {
  ...
  public static final class Builder {
    ...
    public ReplyAction build() {
      return new ReplyAction(startTime, resultComment, inLanguage, about, name, error, mainEntityOfPage, sameAs, url, additionalType, recipient, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
