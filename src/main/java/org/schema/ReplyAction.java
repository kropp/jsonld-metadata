...
public class ReplyAction extends CommunicateAction {
  ...
  public static final class Builder {
    ...
    public ReplyAction build() {
      return new ReplyAction(resultComment, about, inLanguage, recipient, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
     * A sub property of result. The Comment created or sent as a result of this action.
     */
