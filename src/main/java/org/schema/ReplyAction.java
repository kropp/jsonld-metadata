...
public class ReplyAction extends CommunicateAction {
  ...
  /**
   * Builder for {@see ReplyAction}
   */
  public static final class Builder {
    public ReplyAction build() {
      return new ReplyAction(instrument, recipient, mainEntityOfPage, agent, resultComment, endTime, potentialAction, alternateName, participant, additionalType, url, about, sameAs, startTime, actionStatus, inLanguage, result, error, name, image, target, object, location, description);
    }
     ...
     * A sub property of result. The Comment created or sent as a result of this action.
     */
    public Builder resultComment(Comment value) {
      resultComment = value;
      return this;
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected ReplyAction(Instrument instrument, Audience recipient, CreativeWork mainEntityOfPage, Organization agent, Comment resultComment, java.util.Date endTime, Action potentialAction, String alternateName, Participant participant, String additionalType, String url, Thing about, String sameAs, java.util.Date startTime, ActionStatusType actionStatus, String inLanguage, Result result, Thing error, String name, Image image, EntryPoint target, Object object, Location location, String description) {
