...
public class FollowAction extends InteractAction {
  ...
  static final class FollowActionThingBuilder implements Builder {
     ...
     * A sub property of object. The person or organization being followed.
     */
    @NotNull public Builder followee(Organization organization) {
     ...
     * A sub property of object. The person or organization being followed.
     */
    @NotNull public Builder followee(Organization.Builder organization) {
      return this.followee(organization.build());
    }
    /**
     * A sub property of object. The person or organization being followed.
     */
    @NotNull public Builder followee(Person person) {
      if (this.followee == null) this.followee = new OrganizationOrPerson();
     ...
     * A sub property of object. The person or organization being followed.
     */
    @NotNull public Builder followee(Person.Builder person) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<FollowAction> {
    @NotNull Builder followee(Organization organization);
    @NotNull Builder followee(Organization.Builder organization);
    @NotNull Builder followee(Person person);
    @NotNull Builder followee(Person.Builder person);
