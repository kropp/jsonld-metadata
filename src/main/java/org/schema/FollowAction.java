...
public class FollowAction extends InteractAction {
  ...
  public static final class Builder {
    ...
    public FollowAction build() {
      return new FollowAction(followee, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
     * A sub property of object. The person or organization being followed.
     */
