...
public class FollowAction extends InteractAction {
  ...
  /**
   * Builder for {@see FollowAction}
   */
  public static final class Builder {
    public FollowAction build() {
      return new FollowAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, followee, image, name, error, target, object, description, location);
    }
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
     ...
     * A sub property of object. The person or organization being followed.
     */
    public Builder followee(Organization value) {
      followee = value;
      return this;
    }
  ...
  private Organization myFollowee;
}
