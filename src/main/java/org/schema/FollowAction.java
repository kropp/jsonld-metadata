...
public class FollowAction extends InteractAction {
  ...
  public static final class Builder {
    ...
    public FollowAction build() {
      return new FollowAction(startTime, followee, name, error, mainEntityOfPage, sameAs, additionalType, url, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
     ...
     * A sub property of object. The person or organization being followed.
     */
    public Builder followee(Organization organization) {
     ...
     * A sub property of object. The person or organization being followed.
     */
    public Builder followee(Person person) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected FollowAction(java.util.Date startTime, OrganizationOrPerson followee, String name, Thing error, StringOrCreativeWork mainEntityOfPage, String sameAs, String additionalType, String url, OrganizationOrPerson agent, String alternateName, Action potentialAction, EntryPoint target, String description, java.util.Date endTime, ActionStatusType actionStatus) {
    super(additionalType, url, sameAs, agent, startTime, alternateName, potentialAction, target, description, name, endTime, mainEntityOfPage, error, actionStatus);
    myFollowee = followee;
  }
