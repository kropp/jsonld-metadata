...
public class MedicalCause extends MedicalEntity {
   ...
   */
  public static final class MedicalCauseThingBuilder implements Builder {
    /**
     ...
     * The condition, complication, symptom, sign, etc. caused.
     */
    public Builder causeOf(MedicalEntity medicalEntity) {
     ...
     * The condition, complication, symptom, sign, etc. caused.
     */
    public Builder causeOf(MedicalEntity.Builder medicalEntity) {
  ...
  Builder causeOf(MedicalEntity medicalEntity);
  Builder causeOf(MedicalEntity.Builder medicalEntity);
