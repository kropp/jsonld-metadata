...
public class MedicalCause extends MedicalEntity {
  ...
  public static final class Builder {
    ...
    public MedicalCause build() {
      return new MedicalCause(causeOf, recognizingAuthority, code, name, mainEntityOfPage, guideline, url, sameAs, additionalType, alternateName, study, potentialAction, description, relevantSpecialty, medicineSystem);
    }
    /**
     * The condition, complication, symptom, sign, etc. caused.
     */
