...
public class MedicalCause extends MedicalEntity {
  ...
  /**
   * Builder for {@see MedicalCause}
   */
  public static final class Builder {
    public MedicalCause build() {
      return new MedicalCause(causeOf, mainEntityOfPage, alternateName, potentialAction, url, additionalType, medicineSystem, sameAs, recognizingAuthority, study, code, image, name, relevantSpecialty, guideline, description);
    }
    /**
     * The condition, complication, symptom, sign, etc. caused.
     */
    public Builder causeOf(MedicalEntity value) {
      causeOf = value;
      return this;
    }
    /**
