...
public class WarrantyScope extends Enumeration {
  /**
   * Builder for {@see WarrantyScope}
   */
  public static final class Builder {
    public WarrantyScope build() {
      return new WarrantyScope(mainEntityOfPage, name, image, supersededBy, potentialAction, alternateName, additionalType, url, description, sameAs);
    }
    /**
  ...
  protected WarrantyScope(CreativeWork mainEntityOfPage, String name, Image image, Property supersededBy, Action potentialAction, String alternateName, String additionalType, String url, String description, String sameAs) {
