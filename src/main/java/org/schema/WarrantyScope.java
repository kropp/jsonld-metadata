...
public class WarrantyScope extends Enumeration {
  ...
  public static final class Builder {
    ...
    public WarrantyScope build() {
      return new WarrantyScope(sameAs, url, additionalType, alternateName, supersededBy, description, potentialAction, name, mainEntityOfPage);
    }
    /**
  ...
  protected WarrantyScope(String sameAs, String url, String additionalType, String alternateName, EnumerationOrProperty supersededBy, String description, Action potentialAction, String name, StringOrCreativeWork mainEntityOfPage) {
