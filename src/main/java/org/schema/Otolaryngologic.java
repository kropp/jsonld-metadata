...
public class Otolaryngologic {
  ...
  @Override public boolean equals(Object o) {
    ...
    Otolaryngologic otolaryngologic = (Otolaryngologic) o;
   ...
   */
  public static class Builder implements ThingBuilder<Otolaryngologic> {
    public Otolaryngologic build() {
      return new Otolaryngologic();
    }
