...
public class Volcano extends Landform {
  ...
  public static final class Builder {
    /**
     * Creates new {@link Volcano} instance.
     */
    public Volcano build() {
      return new Volcano(aggregateRating, review, logo, isicV4, globalLocationNumber, name, mainEntityOfPage, hasMap, event, containedIn, additionalType, sameAs, url, alternateName, openingHoursSpecification, faxNumber, telephone, geo, description, potentialAction, additionalProperty, photo, address);
    }
    /**
