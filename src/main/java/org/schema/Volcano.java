...
public class Volcano extends Landform {
  /**
   * Builder for {@see Volcano}
   */
  public static final class Builder {
    public Volcano build() {
      return new Volcano(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, url, geo, additionalType, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
