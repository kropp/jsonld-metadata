...
public class CancelAction extends PlanAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link CancelAction} instance.
     */
    public CancelAction build() {
      return new CancelAction(startTime, name, mainEntityOfPage, error, scheduledTime, sameAs, additionalType, url, agent, alternateName, description, potentialAction, target, endTime, actionStatus);
    }
    /**
