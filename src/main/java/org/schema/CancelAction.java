...
public class CancelAction extends PlanAction {
   ...
   */
  static final class CancelActionThingBuilder implements Builder {
    /**
     * Creates new {@link CancelAction} instance.
     */
    public CancelAction build() {
      return new CancelAction(scheduledTime, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<CancelAction> {
