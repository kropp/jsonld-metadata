...
public class MusicAlbumProductionType extends Enumeration {
  ...
  public static final class Builder {
    ...
    public MusicAlbumProductionType build() {
      return new MusicAlbumProductionType(supersededBy, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
  ...
  protected MusicAlbumProductionType(EnumerationOrProperty supersededBy, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction) {
