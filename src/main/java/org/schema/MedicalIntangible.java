...
public class MedicalIntangible extends MedicalEntity {
  /**
   * Builder for {@see MedicalIntangible}
   */
  public static final class Builder {
    public MedicalIntangible build() {
      return new MedicalIntangible(mainEntityOfPage, potentialAction, alternateName, url, additionalType, medicineSystem, sameAs, recognizingAuthority, study, code, name, image, relevantSpecialty, guideline, description);
    }
    /**
