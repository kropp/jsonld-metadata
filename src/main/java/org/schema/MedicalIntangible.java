...
public class MedicalIntangible extends MedicalEntity {
  ...
  public static final class Builder {
    ...
    public MedicalIntangible build() {
      return new MedicalIntangible(recognizingAuthority, code, name, mainEntityOfPage, guideline, url, sameAs, additionalType, alternateName, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
