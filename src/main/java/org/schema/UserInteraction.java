...
public class UserInteraction extends Event {
   ...
   */
  static final class UserInteractionThingBuilder implements Builder {
    /**
     * Creates new {@link UserInteraction} instance.
     */
    public UserInteraction build() {
      return new UserInteraction(aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<UserInteraction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    UserInteraction userInteraction = (UserInteraction) o;
