...
public class UserInteraction extends Event {
  ...
  public static final class Builder {
    /**
     * Creates new {@link UserInteraction} instance.
     */
    public UserInteraction build() {
      return new UserInteraction(aggregateRating, review, endDate, attendee, sameAs, additionalType, subEvent, workPerformed, potentialAction, eventStatus, duration, startDate, typicalAgeRange, organizer, doorTime, inLanguage, superEvent, name, mainEntityOfPage, recordedIn, previousStartDate, url, performer, alternateName, description, offers);
    }
    /**
