...
public class PerformingArtsTheater extends CivicStructure {
  /**
   * Builder for {@see PerformingArtsTheater}
   */
  public static final class Builder {
    public PerformingArtsTheater build() {
      return new PerformingArtsTheater(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  protected PerformingArtsTheater(Event event, OpeningHoursSpecification openingHoursSpecification, Review review, String faxNumber, CreativeWork mainEntityOfPage, String globalLocationNumber, String openingHours, String telephone, String alternateName, Action potentialAction, ImageObject photo, String additionalType, String url, GeoCoordinates geo, String sameAs, ImageObject logo, AggregateRating aggregateRating, Image image, String name, PostalAddress address, PropertyValue additionalProperty, String isicV4, Place containedIn, String description, String hasMap) {
