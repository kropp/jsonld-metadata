...
public class MedicalTrial extends MedicalStudy {
  ...
  public interface Builder extends ThingBuilder<MedicalTrial> {
    @NotNull Builder phase(@NotNull String phase);
    @NotNull Builder trialDesign(@NotNull MedicalTrialDesign medicalTrialDesign);
    @NotNull Builder trialDesign(@NotNull MedicalTrialDesign.Builder medicalTrialDesign);
