...
public class RentAction extends TradeAction {
  ...
  /**
   * Builder for {@see RentAction}
   */
  public static final class Builder {
    public RentAction build() {
      return new RentAction(instrument, priceSpecification, mainEntityOfPage, agent, endTime, alternateName, potentialAction, realEstateAgent, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location, price, landlord);
    }
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
     ...
     * A sub property of participant. The real estate agent involved in the action.
     */
    public Builder realEstateAgent(RealEstateAgent value) {
...
<li>
     ...
     * A sub property of participant. The owner of the real estate property.
     */
    public Builder landlord(Organization value) {
      landlord = value;
      return this;
    }
  ...
  protected RentAction(Instrument instrument, PriceSpecification priceSpecification, CreativeWork mainEntityOfPage, Organization agent, java.util.Date endTime, String alternateName, Action potentialAction, RealEstateAgent realEstateAgent, Participant participant, String additionalType, String url, String sameAs, java.util.Date startTime, ActionStatusType actionStatus, Result result, Image image, String name, Thing error, EntryPoint target, Object object, String description, Location location, Number price, Organization landlord) {
  ...
  private Organization myLandlord;
