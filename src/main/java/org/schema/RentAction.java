...
public class RentAction extends TradeAction {
  ...
  public static final class Builder {
    ...
    public RentAction build() {
      return new RentAction(startTime, name, mainEntityOfPage, error, price, realEstateAgent, url, sameAs, additionalType, agent, alternateName, description, priceSpecification, target, potentialAction, endTime, landlord, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected RentAction(java.util.Date startTime, String name, StringOrCreativeWork mainEntityOfPage, Thing error, StringOrNumber price, RealEstateAgent realEstateAgent, String url, String sameAs, String additionalType, OrganizationOrPerson agent, String alternateName, String description, PriceSpecification priceSpecification, EntryPoint target, Action potentialAction, java.util.Date endTime, OrganizationOrPerson landlord, ActionStatusType actionStatus) {
    super(startTime, name, error, mainEntityOfPage, price, url, sameAs, additionalType, agent, alternateName, potentialAction, target, priceSpecification, description, endTime, actionStatus);
    myLandlord = landlord;
