...
public class RentAction extends TradeAction {
   ...
   */
  public OrganizationOrPerson getLandlord() {
    return myLandlord;
  }
  /**
  ...
  public RealEstateAgent getRealEstateAgent() {
    return myRealEstateAgent;
  }
  /**
   * Builder for {@link RentAction}
   */
  static final class RentActionThingBuilder implements Builder {
    /**
     * Creates new {@link RentAction} instance.
     */
    public RentAction build() {
      return new RentAction(landlord, realEstateAgent, price, priceSpecification, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of participant. The owner of the real estate property.
     */
    @NotNull public Builder landlord(@NotNull Organization organization) {
      if (this.landlord == null) this.landlord = new OrganizationOrPerson();
      this.landlord.setOrganization(organization);
      return this;
    }
    /**
     * A sub property of participant. The owner of the real estate property.
    ...
    @NotNull public Builder landlord(@NotNull Organization.Builder organization) {
      return this.landlord(organization.build());
    }
    /**
     * A sub property of participant. The owner of the real estate property.
     */
    @NotNull public Builder landlord(@NotNull Person person) {
      if (this.landlord == null) this.landlord = new OrganizationOrPerson();
      this.landlord.setPerson(person);
      return this;
    }
    /**
     * A sub property of participant. The owner of the real estate property.
    ...
    @NotNull public Builder landlord(@NotNull Person.Builder person) {
      return this.landlord(person.build());
    }
    /**
     * A sub property of participant. The real estate agent involved in the action.
     */
    ...
    @NotNull public Builder realEstateAgent(@NotNull RealEstateAgent.Builder realEstateAgent) {
      return this.realEstateAgent(realEstateAgent.build());
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("landlord".equals(key) && value instanceof Organization) { landlord((Organization)value); continue; }
        if ("landlord".equals(key) && value instanceof Person) { landlord((Person)value); continue; }
        if ("realEstateAgent".equals(key) && value instanceof RealEstateAgent) { realEstateAgent((RealEstateAgent)value); continue; }
    ...
    private OrganizationOrPerson landlord;
  ...
  public interface Builder extends ThingBuilder<RentAction> {
    @NotNull Builder landlord(@NotNull Organization organization);
    @NotNull Builder landlord(@NotNull Organization.Builder organization);
    @NotNull Builder landlord(@NotNull Person person);
    @NotNull Builder landlord(@NotNull Person.Builder person);
    @NotNull Builder realEstateAgent(@NotNull RealEstateAgent realEstateAgent);
    @NotNull Builder realEstateAgent(@NotNull RealEstateAgent.Builder realEstateAgent);
  ...
  protected RentAction(OrganizationOrPerson landlord, RealEstateAgent realEstateAgent, Number price, PriceSpecification priceSpecification, OrganizationOrPerson agent, java.util.Date endTime, java.util.Date startTime, ActionStatusType actionStatus, Thing error, EntryPoint target, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
    ...
    myLandlord = landlord;
    myRealEstateAgent = realEstateAgent;
  }

  @Override public int hashCode() {
    int result = super.hashCode();
    result = 31 * result + (myLandlord != null ? myLandlord.hashCode() : 0);
    result = 31 * result + (myRealEstateAgent != null ? myRealEstateAgent.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    RentAction rentAction = (RentAction) o;
    if (!super.equals(o)) return false;
    if (myLandlord != null ? !myLandlord.equals(rentAction.myLandlord) : rentAction.myLandlord != null) return false;
    if (myRealEstateAgent != null ? !myRealEstateAgent.equals(rentAction.myRealEstateAgent) : rentAction.myRealEstateAgent != null) return false;
    return true;
  }

  private OrganizationOrPerson myLandlord;
  private RealEstateAgent myRealEstateAgent;
}
