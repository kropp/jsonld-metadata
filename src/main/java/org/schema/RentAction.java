...
public class RentAction extends TradeAction {
   ...
   */
  public OrganizationOrPerson getLandlord() { return myLandlord; }
  /**
   * A sub property of participant. The real estate agent involved in the action.
   */
  public RealEstateAgent getRealEstateAgent() { return myRealEstateAgent; }
   ...
   */
  public static class Builder implements ThingBuilder<RentAction> {
