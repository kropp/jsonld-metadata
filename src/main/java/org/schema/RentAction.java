...
public class RentAction extends TradeAction {
   ...
   */
  public static final class RentActionThingBuilder implements Builder {
    /**
     ...
     * A sub property of participant. The owner of the real estate property.
     */
    public Builder landlord(Organization organization) {
     ...
     * A sub property of participant. The owner of the real estate property.
     */
    public Builder landlord(Organization.Builder organization) {
      return this.landlord(organization.build());
    }
    /**
     * A sub property of participant. The owner of the real estate property.
     */
    public Builder landlord(Person person) {
      if (this.landlord == null) this.landlord = new OrganizationOrPerson();
     ...
     * A sub property of participant. The owner of the real estate property.
     */
    public Builder landlord(Person.Builder person) {
      return this.landlord(person.build());
    }
    /**
     * A sub property of participant. The real estate agent involved in the action.
     */
    public Builder realEstateAgent(RealEstateAgent realEstateAgent) {
     ...
     * A sub property of participant. The real estate agent involved in the action.
     */
    public Builder realEstateAgent(RealEstateAgent.Builder realEstateAgent) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  Builder landlord(Organization organization);
  Builder landlord(Organization.Builder organization);
  Builder landlord(Person person);
  Builder landlord(Person.Builder person);
  Builder realEstateAgent(RealEstateAgent realEstateAgent);
  Builder realEstateAgent(RealEstateAgent.Builder realEstateAgent);
