...
public class VideoGame extends Game {
  ...
  public static final class Builder {
    ...
    public VideoGame build() {
      return new VideoGame(accessibilityAPI, gameTip, gameServer, aggregateRating, hasPart, review, datePublished, schemaVersion, comment, video, award, characterAttribute, editor, workExample, director, potentialAction, producer, numberOfPlayers, cheatCode, publisher, sourceOrganization, genre, learningResourceType, publishingPrinciples, translator, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, gameLocation, playMode, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, gameItem, keywords, educationalAlignment, text, about, contentLocation, musicBy, author, accessibilityHazard, version, accountablePerson, additionalType, sameAs, thumbnailUrl, publication, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, trailer, mainEntity, alternativeHeadline, name, license, mainEntityOfPage, discussionUrl, copyrightYear, gamePlatform, isBasedOnUrl, isFamilyFriendly, exampleOfWork, quest, alternateName, releasedEvent, creator, contributor);
    }
    /**
     ...
     * Links to tips, tactics, etc.
     */
    public Builder gameTip(CreativeWork creativeWork) {
     ...
     * The server on which  it is possible to play the game.
     */
    public Builder gameServer(GameServer gameServer) {
  ...
  protected VideoGame(String accessibilityAPI, CreativeWork gameTip, GameServer gameServer, AggregateRating aggregateRating, HasPart hasPart, Review review, java.util.Date datePublished, String schemaVersion, Comment comment, VideoObject video, String award, Thing characterAttribute, Person editor, CreativeWork workExample, Person director, Action potentialAction, OrganizationOrPerson producer, QuantitativeValue numberOfPlayers, CreativeWork cheatCode, Organization publisher, Organization sourceOrganization, String genre, String learningResourceType, String publishingPrinciples, OrganizationOrPerson translator, Event recordedAt, Integer commentCount, LanguageOrString inLanguage, java.util.Date dateModified, Thing mentions, Audience audience, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, String contentRating, PlaceOrPostalAddressOrString gameLocation, GamePlayMode playMode, String description, Offer offers, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, String educationalUse, Thing gameItem, String keywords, AlignmentObject educationalAlignment, String text, Thing about, Place contentLocation, MusicGroupOrPerson musicBy, OrganizationOrPerson author, String accessibilityHazard, Number version, Person accountablePerson, String additionalType, String sameAs, String thumbnailUrl, PublicationEvent publication, MediaObject encoding, Duration timeRequired, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, VideoObject trailer, Thing mainEntity, String alternativeHeadline, String name, StringOrCreativeWork license, StringOrCreativeWork mainEntityOfPage, String discussionUrl, Number copyrightYear, ThingOrString gamePlatform, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, Thing quest, String alternateName, PublicationEvent releasedEvent, OrganizationOrPerson creator, OrganizationOrPerson contributor) {
    super(accessibilityAPI, aggregateRating, hasPart, review, datePublished, comment, schemaVersion, video, award, characterAttribute, editor, workExample, potentialAction, producer, numberOfPlayers, publisher, sourceOrganization, genre, learningResourceType, publishingPrinciples, translator, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, gameLocation, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, gameItem, keywords, educationalAlignment, text, about, contentLocation, accessibilityHazard, author, version, accountablePerson, sameAs, additionalType, thumbnailUrl, publication, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, alternativeHeadline, mainEntity, name, license, copyrightYear, discussionUrl, mainEntityOfPage, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, quest, releasedEvent, contributor, creator);
    myDirector = director;
    myMusicBy = musicBy;
    myTrailer = trailer;
    myPlayMode = playMode;
