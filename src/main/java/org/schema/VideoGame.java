...
public class VideoGame extends Game {
  ...
  static final class VideoGameThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("director".equals(key) && value instanceof Person) { director((Person)value); continue; }
        if ("musicBy".equals(key) && value instanceof MusicGroup) { musicBy((MusicGroup)value); continue; }
        if ("musicBy".equals(key) && value instanceof Person) { musicBy((Person)value); continue; }
        if ("trailer".equals(key) && value instanceof VideoObject) { trailer((VideoObject)value); continue; }
        if ("playMode".equals(key) && value instanceof GamePlayMode) { playMode((GamePlayMode)value); continue; }
        if ("cheatCode".equals(key) && value instanceof CreativeWork) { cheatCode((CreativeWork)value); continue; }
        if ("gameTip".equals(key) && value instanceof CreativeWork) { gameTip((CreativeWork)value); continue; }
        if ("gamePlatform".equals(key) && value instanceof String) { gamePlatform((String)value); continue; }
        if ("gamePlatform".equals(key) && value instanceof Thing) { gamePlatform((Thing)value); continue; }
        if ("gameServer".equals(key) && value instanceof GameServer) { gameServer((GameServer)value); continue; }
        if ("numberOfPlayers".equals(key) && value instanceof QuantitativeValue) { numberOfPlayers((QuantitativeValue)value); continue; }
        if ("quest".equals(key) && value instanceof Thing) { quest((Thing)value); continue; }
        if ("gameItem".equals(key) && value instanceof Thing) { gameItem((Thing)value); continue; }
        if ("characterAttribute".equals(key) && value instanceof Thing) { characterAttribute((Thing)value); continue; }
        if ("gameLocation".equals(key) && value instanceof Place) { gameLocation((Place)value); continue; }
        if ("gameLocation".equals(key) && value instanceof PostalAddress) { gameLocation((PostalAddress)value); continue; }
        if ("gameLocation".equals(key) && value instanceof String) { gameLocation((String)value); continue; }
  ...
  public interface Builder extends ThingBuilder<VideoGame> {
    @NotNull Builder director(@NotNull Person person);
    @NotNull Builder director(@NotNull Person.Builder person);
    @NotNull Builder musicBy(@NotNull MusicGroup musicGroup);
    @NotNull Builder musicBy(@NotNull MusicGroup.Builder musicGroup);
    @NotNull Builder musicBy(@NotNull Person person);
    @NotNull Builder musicBy(@NotNull Person.Builder person);
    @NotNull Builder trailer(@NotNull VideoObject videoObject);
    @NotNull Builder trailer(@NotNull VideoObject.Builder videoObject);
    @NotNull Builder playMode(@NotNull GamePlayMode gamePlayMode);
    @NotNull Builder playMode(@NotNull GamePlayMode.Builder gamePlayMode);
    @NotNull Builder cheatCode(@NotNull CreativeWork creativeWork);
    @NotNull Builder cheatCode(@NotNull CreativeWork.Builder creativeWork);
    @NotNull Builder gameTip(@NotNull CreativeWork creativeWork);
    @NotNull Builder gameTip(@NotNull CreativeWork.Builder creativeWork);
    @NotNull Builder gamePlatform(@NotNull String gamePlatform);
    @NotNull Builder gamePlatform(@NotNull Thing thing);
    @NotNull Builder gamePlatform(@NotNull Thing.Builder thing);
    @NotNull Builder gameServer(@NotNull GameServer gameServer);
    @NotNull Builder gameServer(@NotNull GameServer.Builder gameServer);
    @NotNull Builder numberOfPlayers(@NotNull QuantitativeValue quantitativeValue);
    @NotNull Builder numberOfPlayers(@NotNull QuantitativeValue.Builder quantitativeValue);
    @NotNull Builder quest(@NotNull Thing thing);
    @NotNull Builder quest(@NotNull Thing.Builder thing);
    @NotNull Builder gameItem(@NotNull Thing thing);
    @NotNull Builder gameItem(@NotNull Thing.Builder thing);
    @NotNull Builder characterAttribute(@NotNull Thing thing);
    @NotNull Builder characterAttribute(@NotNull Thing.Builder thing);
    @NotNull Builder gameLocation(@NotNull Place place);
    @NotNull Builder gameLocation(@NotNull Place.Builder place);
    @NotNull Builder gameLocation(@NotNull PostalAddress postalAddress);
    @NotNull Builder gameLocation(@NotNull PostalAddress.Builder postalAddress);
    @NotNull Builder gameLocation(@NotNull String gameLocation);
