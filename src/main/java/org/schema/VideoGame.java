...
public class VideoGame extends Game {
  ...
  static final class VideoGameThingBuilder implements Builder {
     ...
     * Links to tips, tactics, etc.
     */
    @NotNull public Builder gameTip(CreativeWork creativeWork) {
      this.gameTip = creativeWork;
      return this;
    }
    /**
     * Links to tips, tactics, etc.
     */
    @NotNull public Builder gameTip(CreativeWork.Builder creativeWork) {
      return this.gameTip(creativeWork.build());
    }
    /**
     * The electronic systems used to play <a href="http://en.wikipedia.org/wiki/Category:Video_game_platforms">video games</a>.
     */
     ...
     * The server on which  it is possible to play the game.
     */
    @NotNull public Builder gameServer(GameServer gameServer) {
     ...
     * The server on which  it is possible to play the game.
     */
    @NotNull public Builder gameServer(GameServer.Builder gameServer) {
      return this.gameServer(gameServer.build());
    }
    /**
  ...
  public interface Builder extends ThingBuilder<VideoGame> {
    ...
    @NotNull Builder gameTip(CreativeWork creativeWork);
    @NotNull Builder gameTip(CreativeWork.Builder creativeWork);
    ...
    @NotNull Builder gameServer(GameServer gameServer);
    @NotNull Builder gameServer(GameServer.Builder gameServer);
