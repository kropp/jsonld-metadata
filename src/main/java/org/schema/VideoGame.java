...
public class VideoGame extends Game {
   ...
   */
  public static final class VideoGameThingBuilder implements Builder {
    /**
     ...
     * Links to tips, tactics, etc.
     */
    public Builder gameTip(CreativeWork.Builder creativeWork) {
     ...
     * The server on which  it is possible to play the game.
     */
    public Builder gameServer(GameServer.Builder gameServer) {
  ...
  Builder gameTip(CreativeWork creativeWork);
  Builder gameTip(CreativeWork.Builder creativeWork);
  ...
  Builder gameServer(GameServer.Builder gameServer);
