...
public class SportsEvent extends Event {
  ...
  static final class SportsEventThingBuilder implements Builder {
     ...
     * The home team in a sports event.
     */
    @NotNull public Builder homeTeam(Competitor competitor) {
     ...
     * The away team in a sports event.
     */
    @NotNull public Builder awayTeam(Competitor competitor) {
     ...
     * A competitor in a sports event.
     */
    @NotNull public Builder competitor(Competitor competitor) {
  ...
  public interface Builder extends ThingBuilder<SportsEvent> {
    @NotNull Builder homeTeam(Competitor competitor);
    @NotNull Builder awayTeam(Competitor competitor);
    @NotNull Builder competitor(Competitor competitor);
