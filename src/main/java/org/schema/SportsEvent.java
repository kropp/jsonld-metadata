...
public class SportsEvent extends Event {
   ...
   */
  public static final class SportsEventThingBuilder implements Builder {
    /**
  ...
  Builder homeTeam(Competitor competitor);
  Builder awayTeam(Competitor competitor);
  Builder competitor(Competitor competitor);
