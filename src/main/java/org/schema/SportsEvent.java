...
public class SportsEvent extends Event {
  ...
  /**
   * Builder for {@see SportsEvent}
   */
  public static final class Builder {
    public SportsEvent build() {
      return new SportsEvent(performer, review, offers, endDate, potentialAction, duration, additionalType, inLanguage, image, workPerformed, attendee, previousStartDate, description, competitor, mainEntityOfPage, organizer, doorTime, alternateName, eventStatus, url, awayTeam, superEvent, aggregateRating, sameAs, homeTeam, startDate, name, subEvent, recordedIn, typicalAgeRange, location);
    }
    /**
     ...
     * A competitor in a sports event.
     */
    public Builder competitor(Competitor value) {
      competitor = value;
      return this;
    }
    /**
     ...
     * The away team in a sports event.
     */
    public Builder awayTeam(Competitor value) {
      awayTeam = value;
      return this;
    }
    /**
     ...
     * The home team in a sports event.
     */
    public Builder homeTeam(Competitor value) {
      homeTeam = value;
      return this;
    }
    /**
  ...
  protected SportsEvent(Organization performer, Review review, Offer offers, java.util.Date endDate, Action potentialAction, Duration duration, String additionalType, String inLanguage, Image image, CreativeWork workPerformed, Organization attendee, java.util.Date previousStartDate, String description, Competitor competitor, CreativeWork mainEntityOfPage, Person organizer, java.util.Date doorTime, String alternateName, EventStatusType eventStatus, String url, Competitor awayTeam, Event superEvent, AggregateRating aggregateRating, String sameAs, Competitor homeTeam, java.util.Date startDate, String name, Event subEvent, CreativeWork recordedIn, String typicalAgeRange, Location location) {
