...
public class SportsEvent extends Event {
  ...
  public static final class Builder {
    ...
    public SportsEvent build() {
      return new SportsEvent(aggregateRating, review, endDate, attendee, awayTeam, homeTeam, additionalType, sameAs, subEvent, workPerformed, potentialAction, eventStatus, duration, startDate, typicalAgeRange, organizer, doorTime, inLanguage, superEvent, name, mainEntityOfPage, recordedIn, previousStartDate, url, performer, competitor, alternateName, description, offers);
    }
    /**
     ...
     * The away team in a sports event.
     */
    public Builder awayTeam(Competitor competitor) {
     ...
     * The home team in a sports event.
     */
    public Builder homeTeam(Competitor competitor) {
     ...
     * A competitor in a sports event.
     */
    public Builder competitor(Competitor competitor) {
  ...
  protected SportsEvent(AggregateRating aggregateRating, Review review, java.util.Date endDate, OrganizationOrPerson attendee, Competitor awayTeam, Competitor homeTeam, String additionalType, String sameAs, Event subEvent, CreativeWork workPerformed, Action potentialAction, EventStatusType eventStatus, Duration duration, java.util.Date startDate, String typicalAgeRange, OrganizationOrPerson organizer, java.util.Date doorTime, LanguageOrString inLanguage, Event superEvent, String name, StringOrCreativeWork mainEntityOfPage, CreativeWork recordedIn, java.util.Date previousStartDate, String url, OrganizationOrPerson performer, Competitor competitor, String alternateName, String description, Offer offers) {
