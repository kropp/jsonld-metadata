...
public class TakeAction extends TransferAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link TakeAction} instance.
     */
    public TakeAction build() {
      return new TakeAction(startTime, toLocation, name, mainEntityOfPage, error, fromLocation, url, sameAs, additionalType, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
