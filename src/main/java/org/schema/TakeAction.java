...
public class TakeAction extends TransferAction {
  ...
  public static final class Builder {
    ...
    public TakeAction build() {
      return new TakeAction(fromLocation, toLocation, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
