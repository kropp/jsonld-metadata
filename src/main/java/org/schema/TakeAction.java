...
public class TakeAction extends TransferAction {
  /**
   * Builder for {@see TakeAction}
   */
  public static final class Builder {
    public TakeAction build() {
      return new TakeAction(instrument, mainEntityOfPage, toLocation, agent, endTime, alternateName, potentialAction, fromLocation, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
