...
public class TakeAction extends TransferAction {
   ...
   */
  static final class TakeActionThingBuilder implements Builder {
    /**
     * Creates new {@link TakeAction} instance.
     */
    public TakeAction build() {
      return new TakeAction(fromLocation, toLocation, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<TakeAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    TakeAction takeAction = (TakeAction) o;
