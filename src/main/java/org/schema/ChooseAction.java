...
public class ChooseAction extends AssessAction {
  ...
  /**
   * Builder for {@see ChooseAction}
   */
  public static final class Builder {
    public ChooseAction build() {
      return new ChooseAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location, actionOption);
    }
