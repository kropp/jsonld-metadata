...
public class ChooseAction extends AssessAction {
   ...
   */
  public StringOrThing getActionOption() {
    return myActionOption;
  }
  /**
   * Builder for {@link ChooseAction}
   */
  static final class ChooseActionThingBuilder implements Builder {
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<ChooseAction> {
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myActionOption != null ? myActionOption.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    ChooseAction chooseAction = (ChooseAction) o;
    if (!super.equals(o)) return false;
    if (myActionOption != null ? !myActionOption.equals(chooseAction.myActionOption) : chooseAction.myActionOption != null) return false;
    return true;
  }
