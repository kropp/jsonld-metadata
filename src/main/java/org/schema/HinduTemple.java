...
public class HinduTemple extends PlaceOfWorship {
  /**
   * Builder for {@see HinduTemple}
   */
  public static final class Builder {
    public HinduTemple build() {
      return new HinduTemple(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, geo, url, additionalType, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
