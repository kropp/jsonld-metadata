...
public class GatedResidenceCommunity extends Residence {
  ...
  public static final class Builder {
    /**
     * Creates new {@link GatedResidenceCommunity} instance.
     */
    public GatedResidenceCommunity build() {
      return new GatedResidenceCommunity(aggregateRating, review, logo, isicV4, globalLocationNumber, name, mainEntityOfPage, hasMap, event, containedIn, additionalType, sameAs, url, alternateName, openingHoursSpecification, faxNumber, telephone, geo, description, potentialAction, additionalProperty, photo, address);
    }
    /**
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  protected GatedResidenceCommunity(AggregateRating aggregateRating, Review review, ImageObjectOrString logo, String isicV4, String globalLocationNumber, String name, StringOrCreativeWork mainEntityOfPage, MapOrString hasMap, Event event, Place containedIn, String additionalType, String sameAs, String url, String alternateName, OpeningHoursSpecification openingHoursSpecification, String faxNumber, String telephone, GeoCoordinatesOrGeoShape geo, String description, Action potentialAction, PropertyValue additionalProperty, ImageObjectOrPhotograph photo, PostalAddress address) {
    super(aggregateRating, review, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, containedIn, additionalType, sameAs, url, event, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
  }
}
