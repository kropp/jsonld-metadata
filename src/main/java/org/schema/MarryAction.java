...
public class MarryAction extends InteractAction {
  /**
   * Builder for {@see MarryAction}
   */
  public static final class Builder {
    public MarryAction build() {
      return new MarryAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
