...
public class AskAction extends CommunicateAction {
   ...
   */
  static final class AskActionThingBuilder implements Builder {
    /**
     * Creates new {@link AskAction} instance.
     */
    public AskAction build() {
      return new AskAction(question, about, inLanguage, recipient, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of object. A question.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myQuestion != null ? myQuestion.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    AskAction askAction = (AskAction) o;
    if (!super.equals(o)) return false;
    if (myQuestion != null ? !myQuestion.equals(askAction.myQuestion) : askAction.myQuestion != null) return false;
    return true;
  }
