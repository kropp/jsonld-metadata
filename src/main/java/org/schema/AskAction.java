...
public class AskAction extends CommunicateAction {
  ...
  /**
   * Builder for {@see AskAction}
   */
  public static final class Builder {
    public AskAction build() {
      return new AskAction(instrument, recipient, mainEntityOfPage, agent, endTime, potentialAction, alternateName, question, participant, additionalType, url, about, sameAs, startTime, actionStatus, inLanguage, result, error, name, image, target, object, location, description);
    }
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected AskAction(Instrument instrument, Audience recipient, CreativeWork mainEntityOfPage, Organization agent, java.util.Date endTime, Action potentialAction, String alternateName, Question question, Participant participant, String additionalType, String url, Thing about, String sameAs, java.util.Date startTime, ActionStatusType actionStatus, String inLanguage, Result result, Thing error, String name, Image image, EntryPoint target, Object object, Location location, String description) {
