...
public class OrganizeAction extends Action {
  ...
  public static final class Builder {
    ...
    public OrganizeAction build() {
      return new OrganizeAction(additionalType, url, sameAs, agent, startTime, alternateName, potentialAction, target, description, name, endTime, mainEntityOfPage, error, actionStatus);
    }
    /**
