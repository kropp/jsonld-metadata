...
public class OrganizeAction extends Action {
  /**
   * Builder for {@see OrganizeAction}
   */
  public static final class Builder {
    public OrganizeAction build() {
      return new OrganizeAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, object, location, description);
    }
