...
public class OrganizeAction extends Action {
  ...
  public static final class Builder {
    ...
    public OrganizeAction build() {
      return new OrganizeAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
