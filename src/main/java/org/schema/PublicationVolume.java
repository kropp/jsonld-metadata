...
public class PublicationVolume extends CreativeWork {
  ...
  static final class PublicationVolumeThingBuilder implements Builder {
     ...
     * Identifies the volume of publication or multi-part work; for example, "iii" or "2".
     */
    @NotNull public Builder volumeNumber(String volumeNumber) {
      if (this.volumeNumber == null) this.volumeNumber = new StringOrInt();
     ...
     * Identifies the volume of publication or multi-part work; for example, "iii" or "2".
     */
    @NotNull public Builder volumeNumber(int volumeNumber) {
      if (this.volumeNumber == null) this.volumeNumber = new StringOrInt();
      this.volumeNumber.setInt(volumeNumber);
      return this;
    }
    /**
    ...
    private StringOrInt volumeNumber;
  ...
  public interface Builder extends ThingBuilder<PublicationVolume> {
    ...
    @NotNull Builder volumeNumber(String volumeNumber);
    @NotNull Builder volumeNumber(int volumeNumber);
  ...
  private StringOrInt myVolumeNumber;
}
