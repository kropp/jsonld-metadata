...
public class PublicationVolume extends CreativeWork {
  ...
  public Integer getVolumeNumber() {
    return myVolumeNumber;
  }
  /**
   * Builder for {@see PublicationVolume}
   */
  public static final class Builder {
    public PublicationVolume build() {
      return new PublicationVolume(producer, review, editor, timeRequired, offers, creator, educationalUse, pagination, alternativeHeadline, mentions, additionalType, position, associatedMedia, isFamilyFriendly, accessibilityControl, image, keywords, volumeNumber, discussionUrl, isBasedOnUrl, exampleOfWork, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, genre, potentialAction, contentRating, audience, pageStart, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, releasedEvent, accessibilityFeature, accessibilityHazard, license, description, publication, provider, educationalAlignment, recordedAt, pageEnd, mainEntityOfPage, contributor, isPartOf, workExample, dateCreated, copyrightHolder, aggregateRating, sameAs, name, typicalAgeRange, citation, copyrightYear, translator, sourceOrganization, text, award);
    }
    /**
     ...
     * Identifies the volume of publication or multi-part work; for example, "iii" or "2".
     */
    public Builder volumeNumber(Integer value) {
      volumeNumber = value;
      return this;
    }
    /**
  ...
  private Integer myVolumeNumber;
}
