...
public class PublicationVolume extends CreativeWork {
   ...
   */
  public static final class PublicationVolumeThingBuilder implements Builder {
    /**
    ...
    public Builder volumeNumber(Integer integer) {
      if (this.volumeNumber == null) this.volumeNumber = new IntegerOrString();
  ...
  Builder volumeNumber(Integer integer);
  Builder volumeNumber(String volumeNumber);
