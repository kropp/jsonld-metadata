...
public class PublicationVolume extends CreativeWork {
  ...
  static final class PublicationVolumeThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("volumeNumber".equals(key) && value instanceof Integer) { volumeNumber((Integer)value); continue; }
        if ("volumeNumber".equals(key) && value instanceof String) { volumeNumber((String)value); continue; }
  ...
  public interface Builder extends ThingBuilder<PublicationVolume> {
    ...
    @NotNull Builder volumeNumber(@NotNull Integer integer);
    @NotNull Builder volumeNumber(@NotNull String volumeNumber);
