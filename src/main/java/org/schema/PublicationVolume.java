...
public class PublicationVolume extends CreativeWork {
   ...
   */
  public IntegerOrString getVolumeNumber() {
  ...
  public static final class Builder {
     ...
     * Identifies the volume of publication or multi-part work; for example, "iii" or "2".
     */
    public Builder volumeNumber(Integer integer) {
      this.volumeNumber.setInteger(integer);
      return this;
    }
    /**
     * Identifies the volume of publication or multi-part work; for example, "iii" or "2".
     */
    public Builder volumeNumber(String volumeNumber) {
      this.volumeNumber.setString(volumeNumber);
      return this;
    }
    /**
     * The page on which the work starts; for example "135" or "xiii".
    ...
    private IntegerOrString volumeNumber;
  ...
  private IntegerOrString myVolumeNumber;
}
