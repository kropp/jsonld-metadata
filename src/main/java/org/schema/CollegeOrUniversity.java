...
public class CollegeOrUniversity extends EducationalOrganization {
  ...
  static final class CollegeOrUniversityThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("alumni".equals(key) && value instanceof Person) { alumni((Person)value); continue; }
  ...
  public interface Builder extends ThingBuilder<CollegeOrUniversity> {
    @NotNull Builder alumni(@NotNull Person person);
    @NotNull Builder alumni(@NotNull Person.Builder person);
  ...
  @Override public boolean equals(Object o) {
    ...
    CollegeOrUniversity collegeOrUniversity = (CollegeOrUniversity) o;
