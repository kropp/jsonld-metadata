...
public class CollegeOrUniversity extends EducationalOrganization {
  ...
  public static final class Builder {
    /**
     * Creates new {@link CollegeOrUniversity} instance.
     */
    public CollegeOrUniversity build() {
      return new CollegeOrUniversity(aggregateRating, review, logo, duns, department, subOrganization, additionalType, sameAs, event, award, foundingDate, numberOfEmployees, seeks, brand, naics, potentialAction, dissolutionDate, foundingLocation, address, founder, owns, email, makesOffer, member, employee, isicV4, globalLocationNumber, taxID, name, vatID, mainEntityOfPage, legalName, memberOf, url, contactPoint, hasPOS, alumni, alternateName, faxNumber, telephone, description);
    }
    /**
  ...
  protected CollegeOrUniversity(AggregateRating aggregateRating, Review review, ImageObjectOrString logo, String duns, Organization department, Organization subOrganization, String additionalType, String sameAs, Event event, String award, java.util.Date foundingDate, QuantitativeValue numberOfEmployees, Demand seeks, OrganizationOrBrand brand, String naics, Action potentialAction, java.util.Date dissolutionDate, Place foundingLocation, PostalAddress address, Person founder, ProductOrOwnershipInfo owns, String email, Offer makesOffer, OrganizationOrPerson member, Person employee, String isicV4, String globalLocationNumber, String taxID, String name, String vatID, StringOrCreativeWork mainEntityOfPage, String legalName, OrganizationOrProgramMembership memberOf, String url, ContactPoint contactPoint, Place hasPOS, Person alumni, String alternateName, String faxNumber, String telephone, String description) {
    super(aggregateRating, review, logo, duns, department, subOrganization, award, event, sameAs, additionalType, foundingDate, numberOfEmployees, seeks, brand, naics, potentialAction, dissolutionDate, foundingLocation, address, founder, owns, email, makesOffer, member, employee, globalLocationNumber, isicV4, taxID, vatID, name, legalName, mainEntityOfPage, memberOf, url, contactPoint, hasPOS, faxNumber, alternateName, alumni, telephone, description);
  }
}
