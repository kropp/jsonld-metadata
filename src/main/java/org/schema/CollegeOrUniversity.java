...
public class CollegeOrUniversity extends EducationalOrganization {
  ...
  static final class CollegeOrUniversityThingBuilder implements Builder {
     ...
     */
    @NotNull public Builder alumni(Person person) {
      this.alumni = person;
      return this;
    }
    /**
     * Alumni of educational organization.
     */
    @NotNull public Builder alumni(Person.Builder person) {
  ...
  public interface Builder extends ThingBuilder<CollegeOrUniversity> {
    @NotNull Builder alumni(Person person);
    @NotNull Builder alumni(Person.Builder person);
