  ...
  static final class AnatomicalSystemThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("comprisedOf".equals(key) && value instanceof AnatomicalStructure) { comprisedOf((AnatomicalStructure)value); continue; }
        if ("comprisedOf".equals(key) && value instanceof AnatomicalSystem) { comprisedOf((AnatomicalSystem)value); continue; }
        if ("relatedCondition".equals(key) && value instanceof MedicalCondition) { relatedCondition((MedicalCondition)value); continue; }
        if ("relatedStructure".equals(key) && value instanceof AnatomicalStructure) { relatedStructure((AnatomicalStructure)value); continue; }
