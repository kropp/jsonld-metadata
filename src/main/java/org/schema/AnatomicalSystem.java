...
public class AnatomicalSystem extends MedicalEntity {
  ...
  static final class AnatomicalSystemThingBuilder implements Builder {
     ...
     * The underlying anatomical structures, such as organs, that comprise the anatomical system.
     */
    @NotNull public Builder comprisedOf(AnatomicalStructure anatomicalStructure) {
     ...
     * The underlying anatomical structures, such as organs, that comprise the anatomical system.
     */
    @NotNull public Builder comprisedOf(AnatomicalStructure.Builder anatomicalStructure) {
      return this.comprisedOf(anatomicalStructure.build());
    }
    /**
     * The underlying anatomical structures, such as organs, that comprise the anatomical system.
     */
    @NotNull public Builder comprisedOf(AnatomicalSystem anatomicalSystem) {
      if (this.comprisedOf == null) this.comprisedOf = new AnatomicalStructureOrAnatomicalSystem();
     ...
     * The underlying anatomical structures, such as organs, that comprise the anatomical system.
     */
    @NotNull public Builder comprisedOf(AnatomicalSystem.Builder anatomicalSystem) {
     ...
     * Related anatomical structure(s) that are not part of the system but relate or connect to it, such as vascular bundles associated with an organ system.
     */
    @NotNull public Builder relatedStructure(AnatomicalStructure anatomicalStructure) {
  ...
  public interface Builder extends ThingBuilder<AnatomicalSystem> {
    ...
    @NotNull Builder comprisedOf(AnatomicalStructure anatomicalStructure);
    @NotNull Builder comprisedOf(AnatomicalStructure.Builder anatomicalStructure);
    @NotNull Builder comprisedOf(AnatomicalSystem anatomicalSystem);
    @NotNull Builder comprisedOf(AnatomicalSystem.Builder anatomicalSystem);
    ...
    @NotNull Builder relatedStructure(AnatomicalStructure anatomicalStructure);
    @NotNull Builder relatedStructure(AnatomicalStructure.Builder anatomicalStructure);
