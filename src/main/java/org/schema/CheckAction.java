...
public class CheckAction extends FindAction {
  ...
  public static final class Builder {
    ...
    public CheckAction build() {
      return new CheckAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
