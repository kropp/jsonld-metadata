...
public class CheckAction extends FindAction {
  /**
   * Builder for {@see CheckAction}
   */
  public static final class Builder {
    public CheckAction build() {
      return new CheckAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
