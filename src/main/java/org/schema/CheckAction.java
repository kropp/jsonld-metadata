...
public class CheckAction extends FindAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link CheckAction} instance.
     */
    public CheckAction build() {
      return new CheckAction(startTime, name, error, mainEntityOfPage, url, additionalType, sameAs, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
