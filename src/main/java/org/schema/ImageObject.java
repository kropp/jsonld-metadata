...
/**
 * An image file.
 * Equivalent class: http://purl.org/dc/dcmitype/Image
 */
public class ImageObject extends MediaObject {
   ...
   */
  public PropertyValueOrString getExifData() {
    return myExifData;
  }
  /**
  ...
  static final class ImageObjectThingBuilder implements Builder {
    ...
    @NotNull public Builder exifData(@NotNull PropertyValue propertyValue) {
      if (this.exifData == null) this.exifData = new PropertyValueOrString();
      this.exifData.setPropertyValue(propertyValue);
      return this;
    }
    /**
     * exif data for this object.
    ...
    @NotNull public Builder exifData(@NotNull PropertyValue.Builder propertyValue) {
      return this.exifData(propertyValue.build());
    }
    /**
     * exif data for this object.
     */
    @NotNull public Builder exifData(@NotNull String exifData) {
      if (this.exifData == null) this.exifData = new PropertyValueOrString();
      this.exifData.setString(exifData);
      return this;
    }
    /**
     * Indicates whether this image is representative of the content of the page.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("exifData".equals(key) && value instanceof PropertyValue) { exifData((PropertyValue)value); continue; }
        if ("exifData".equals(key) && value instanceof String) { exifData((String)value); continue; }
        if ("representativeOfPage".equals(key) && value instanceof Boolean) { representativeOfPage((Boolean)value); continue; }
    ...
    private PropertyValueOrString exifData;
  ...
  public interface Builder extends ThingBuilder<ImageObject> {
    @NotNull Builder caption(@NotNull String caption);
    @NotNull Builder exifData(@NotNull PropertyValue propertyValue);
    @NotNull Builder exifData(@NotNull PropertyValue.Builder propertyValue);
    @NotNull Builder exifData(@NotNull String exifData);
    @NotNull Builder representativeOfPage(@NotNull Boolean representativeOfPage);
