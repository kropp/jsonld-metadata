...
public class ImageObject extends MediaObject {
   ...
   */
  public static final class ImageObjectThingBuilder implements Builder {
    /**
     ...
     * exif data for this object.
     */
    public Builder exifData(PropertyValue.Builder propertyValue) {
     ...
     * Thumbnail image for an image or video.
     */
    public Builder thumbnail(ImageObject.Builder imageObject) {
     ...
     * A NewsArticle associated with the Media Object.
     */
    public Builder associatedArticle(NewsArticle.Builder newsArticle) {
     ...
     * The CreativeWork encoded by this media object.
     */
    public Builder encodesCreativeWork(CreativeWork.Builder creativeWork) {
     ...
     * The regions where the media is allowed. If not specified, then it's assumed to be allowed everywhere. Specify the countries in <a href='http://en.wikipedia.org/wiki/ISO_3166'>ISO 3166 format</a>.
     */
    public Builder regionsAllowed(Place.Builder place) {
  ...
  Builder exifData(PropertyValue propertyValue);
  Builder exifData(PropertyValue.Builder propertyValue);
  Builder exifData(String exifData);
  Builder representativeOfPage(Boolean representativeOfPage);
  Builder thumbnail(ImageObject imageObject);
  Builder thumbnail(ImageObject.Builder imageObject);
  Builder associatedArticle(NewsArticle newsArticle);
  Builder associatedArticle(NewsArticle.Builder newsArticle);
  Builder bitrate(String bitrate);
  Builder contentSize(String contentSize);
  Builder contentUrl(String contentUrl);
  Builder duration(Duration duration);
  Builder duration(Duration.Builder duration);
  Builder embedUrl(String embedUrl);
  Builder encodesCreativeWork(CreativeWork creativeWork);
  Builder encodesCreativeWork(CreativeWork.Builder creativeWork);
  Builder encodingFormat(String encodingFormat);
  Builder expires(java.util.Date date);
  ...
  Builder playerType(String playerType);
  Builder productionCompany(Organization organization);
  Builder productionCompany(Organization.Builder organization);
  Builder regionsAllowed(Place place);
  Builder regionsAllowed(Place.Builder place);
  Builder requiresSubscription(Boolean requiresSubscription);
  Builder uploadDate(java.util.Date date);
