...
public class ImageObject extends MediaObject {
  ...
  /**
   * Builder for {@see ImageObject}
   */
  public static final class Builder {
    public ImageObject build() {
      return new ImageObject(producer, editor, review, timeRequired, creator, offers, educationalUse, alternativeHeadline, mentions, duration, additionalType, contentUrl, position, associatedMedia, associatedArticle, isFamilyFriendly, accessibilityControl, image, playerType, keywords, embedUrl, discussionUrl, encodingFormat, exampleOfWork, isBasedOnUrl, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, bitrate, representativeOfPage, regionsAllowed, character, schemaVersion, accessibilityAPI, exifData, contentSize, encoding, headline, publishingPrinciples, version, commentCount, mainEntity, width, genre, requiresSubscription, potentialAction, contentRating, audience, inLanguage, contentLocation, learningResourceType, audio, accountablePerson, dateModified, thumbnailUrl, releasedEvent, caption, productionCompany, accessibilityHazard, accessibilityFeature, license, description, uploadDate, provider, publication, recordedAt, educationalAlignment, mainEntityOfPage, contributor, workExample, isPartOf, dateCreated, copyrightHolder, sameAs, aggregateRating, expires, height, name, encodesCreativeWork, typicalAgeRange, translator, copyrightYear, citation, sourceOrganization, text, thumbnail, award);
    }
    /**
     ...
     * Indicates whether this image is representative of the content of the page.
     */
    public Builder representativeOfPage(Boolean value) {
     ...
     * exif data for this object.
     */
    public Builder exifData(String value) {
      exifData = value;
      return this;
    }
    /**
  ...
  protected ImageObject(Person producer, Person editor, Review review, Duration timeRequired, Organization creator, Offer offers, String educationalUse, String alternativeHeadline, Thing mentions, Duration duration, String additionalType, String contentUrl, Position position, MediaObject associatedMedia, NewsArticle associatedArticle, Boolean isFamilyFriendly, String accessibilityControl, Image image, String playerType, String keywords, String embedUrl, String discussionUrl, String encodingFormat, CreativeWork exampleOfWork, String isBasedOnUrl, Comment comment, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, String bitrate, Boolean representativeOfPage, Place regionsAllowed, Person character, String schemaVersion, String accessibilityAPI, String exifData, String contentSize, MediaObject encoding, String headline, String publishingPrinciples, Number version, Integer commentCount, Thing mainEntity, Distance width, String genre, Boolean requiresSubscription, Action potentialAction, String contentRating, Audience audience, String inLanguage, Place contentLocation, String learningResourceType, AudioObject audio, Person accountablePerson, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, String caption, Organization productionCompany, String accessibilityHazard, String accessibilityFeature, CreativeWork license, String description, java.util.Date uploadDate, Person provider, PublicationEvent publication, Event recordedAt, AlignmentObject educationalAlignment, CreativeWork mainEntityOfPage, Organization contributor, CreativeWork workExample, IsPartOf isPartOf, java.util.Date dateCreated, Organization copyrightHolder, String sameAs, AggregateRating aggregateRating, java.util.Date expires, Distance height, String name, CreativeWork encodesCreativeWork, String typicalAgeRange, Person translator, Number copyrightYear, CreativeWork citation, Organization sourceOrganization, String text, ImageObject thumbnail, String award) {
