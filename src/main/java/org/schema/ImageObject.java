...
public class ImageObject extends MediaObject {
  ...
  public static final class Builder {
    ...
    public ImageObject build() {
      return new ImageObject(requiresSubscription, accessibilityAPI, aggregateRating, hasPart, review, thumbnail, datePublished, schemaVersion, comment, video, award, expires, editor, workExample, potentialAction, producer, publisher, contentSize, sourceOrganization, genre, learningResourceType, regionsAllowed, translator, publishingPrinciples, recordedAt, commentCount, inLanguage, dateModified, contentUrl, mentions, audience, embedUrl, url, headline, interactivityType, character, associatedMedia, encodesCreativeWork, contentRating, description, offers, copyrightHolder, width, associatedArticle, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, about, contentLocation, author, accessibilityHazard, version, accountablePerson, additionalType, sameAs, bitrate, thumbnailUrl, publication, encoding, playerType, uploadDate, timeRequired, duration, caption, accessibilityFeature, audio, typicalAgeRange, dateCreated, exifData, provider, mainEntity, alternativeHeadline, name, license, mainEntityOfPage, discussionUrl, copyrightYear, encodingFormat, isBasedOnUrl, isFamilyFriendly, representativeOfPage, exampleOfWork, height, alternateName, releasedEvent, productionCompany, creator, contributor);
    }
    /**
     ...
     * exif data for this object.
     */
    public Builder exifData(PropertyValue propertyValue) {
     ...
     * exif data for this object.
     */
    public Builder exifData(String exifData) {
     ...
     * Indicates whether this image is representative of the content of the page.
     */
    public Builder representativeOfPage(Boolean representativeOfPage) {
