...
public class ImageObject extends MediaObject {
   ...
   */
  public PropertyValueOrString getExifData() { return myExifData; }
  /**
   * Indicates whether this image is representative of the content of the page.
   */
  public Boolean getRepresentativeOfPage() { return myRepresentativeOfPage; }
  /**
   ...
   */
  public static class Builder implements ThingBuilder<ImageObject> {
