...
public class BusinessEvent extends Event {
   ...
   */
  public static final class BusinessEventThingBuilder implements Builder {
    /**
     * Creates new {@link BusinessEvent} instance.
     */
    public BusinessEvent build() {
      return new BusinessEvent(aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<BusinessEvent> {
