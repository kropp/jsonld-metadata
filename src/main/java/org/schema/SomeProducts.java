...
public class SomeProducts extends Product {
  ...
  /**
   * Builder for {@see SomeProducts}
   */
  public static final class Builder {
    public SomeProducts build() {
      return new SomeProducts(review, productionDate, width, productID, offers, itemCondition, weight, potentialAction, audience, additionalType, logo, isRelatedTo, image, inventoryLevel, description, isAccessoryOrSparePartFor, gtin12, model, brand, mainEntityOfPage, manufacturer, gtin13, color, purchaseDate, alternateName, isConsumableFor, gtin14, url, gtin8, aggregateRating, sameAs, isSimilarTo, height, releaseDate, depth, name, category, sku, additionalProperty, mpn, award);
    }
    /**
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  protected SomeProducts(Review review, java.util.Date productionDate, Distance width, String productID, Offer offers, OfferItemCondition itemCondition, QuantitativeValue weight, Action potentialAction, Audience audience, String additionalType, ImageObject logo, Product isRelatedTo, Image image, QuantitativeValue inventoryLevel, String description, Product isAccessoryOrSparePartFor, String gtin12, ProductModel model, Brand brand, CreativeWork mainEntityOfPage, Organization manufacturer, String gtin13, String color, java.util.Date purchaseDate, String alternateName, Product isConsumableFor, String gtin14, String url, String gtin8, AggregateRating aggregateRating, String sameAs, Product isSimilarTo, Distance height, java.util.Date releaseDate, Distance depth, String name, PhysicalActivityCategory category, String sku, PropertyValue additionalProperty, String mpn, String award) {
