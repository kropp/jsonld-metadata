...
public class Recipe extends CreativeWork {
  ...
  /**
   * Builder for {@see Recipe}
   */
  public static final class Builder {
    public Recipe build() {
      return new Recipe(editor, review, producer, timeRequired, creator, offers, educationalUse, alternativeHeadline, mentions, additionalType, nutrition, position, cookTime, associatedMedia, isFamilyFriendly, image, accessibilityControl, keywords, discussionUrl, exampleOfWork, isBasedOnUrl, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, recipeCategory, character, schemaVersion, accessibilityAPI, recipeInstructions, recipeIngredient, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, genre, potentialAction, prepTime, audience, contentRating, cookingMethod, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, releasedEvent, accessibilityFeature, accessibilityHazard, license, description, publication, provider, educationalAlignment, recordedAt, mainEntityOfPage, contributor, isPartOf, workExample, dateCreated, recipeYield, copyrightHolder, aggregateRating, sameAs, name, typicalAgeRange, citation, copyrightYear, translator, sourceOrganization, text, award, recipeCuisine, totalTime);
    }
    /**
     ...
     * Nutrition information about the recipe.
     */
    public Builder nutrition(NutritionInformation value) {
      nutrition = value;
      return this;
    }
     ...
     * The time it takes to actually cook the dish, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    public Builder cookTime(Duration value) {
      cookTime = value;
      return this;
    }
    /**
     ...
     * The category of the recipe&#x2014;for example, appetizer, entree, etc.
     */
    public Builder recipeCategory(String value) {
     ...
     * A step or instruction involved in making the recipe.
     */
    public Builder recipeInstructions(String value) {
     ...
     * A single ingredient used in the recipe, e.g. sugar, flour or garlic.
     */
    public Builder recipeIngredient(String value) {
     ...
     * The length of time it takes to prepare the recipe, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    public Builder prepTime(Duration value) {
      prepTime = value;
      return this;
    }
    /**
     ...
     * The method of cooking, such as Frying, Steaming, ...
     */
    public Builder cookingMethod(String value) {
      cookingMethod = value;
      return this;
    }
    /**
     ...
     * The quantity produced by the recipe (for example, number of people served, number of servings, etc).
     */
    public Builder recipeYield(String value) {
      recipeYield = value;
      return this;
    }
    /**
     ...
     * The cuisine of the recipe (for example, French or Ethiopian).
     */
    public Builder recipeCuisine(String value) {
      recipeCuisine = value;
      return this;
    }
    /**
     * The total time it takes to prepare and cook the recipe, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    public Builder totalTime(Duration value) {
      totalTime = value;
      return this;
    }
  ...
  protected Recipe(Person editor, Review review, Person producer, Duration timeRequired, Organization creator, Offer offers, String educationalUse, String alternativeHeadline, Thing mentions, String additionalType, NutritionInformation nutrition, Position position, Duration cookTime, MediaObject associatedMedia, Boolean isFamilyFriendly, Image image, String accessibilityControl, String keywords, String discussionUrl, CreativeWork exampleOfWork, String isBasedOnUrl, Comment comment, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, String recipeCategory, Person character, String schemaVersion, String accessibilityAPI, String recipeInstructions, String recipeIngredient, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, String genre, Action potentialAction, Duration prepTime, Audience audience, String contentRating, String cookingMethod, String inLanguage, Place contentLocation, String learningResourceType, Person accountablePerson, AudioObject audio, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, String accessibilityFeature, String accessibilityHazard, CreativeWork license, String description, PublicationEvent publication, Person provider, AlignmentObject educationalAlignment, Event recordedAt, CreativeWork mainEntityOfPage, Organization contributor, IsPartOf isPartOf, CreativeWork workExample, java.util.Date dateCreated, String recipeYield, Organization copyrightHolder, AggregateRating aggregateRating, String sameAs, String name, String typicalAgeRange, CreativeWork citation, Number copyrightYear, Person translator, Organization sourceOrganization, String text, String award, String recipeCuisine, Duration totalTime) {
