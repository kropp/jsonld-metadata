  ...
  static final class RecipeThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("cookingMethod".equals(key) && value instanceof String) { cookingMethod((String)value); continue; }
        if ("cookTime".equals(key) && value instanceof Duration) { cookTime((Duration)value); continue; }
        if ("recipeIngredient".equals(key) && value instanceof String) { recipeIngredient((String)value); continue; }
        if ("nutrition".equals(key) && value instanceof NutritionInformation) { nutrition((NutritionInformation)value); continue; }
        if ("prepTime".equals(key) && value instanceof Duration) { prepTime((Duration)value); continue; }
        if ("recipeCategory".equals(key) && value instanceof String) { recipeCategory((String)value); continue; }
        if ("recipeCuisine".equals(key) && value instanceof String) { recipeCuisine((String)value); continue; }
        if ("recipeInstructions".equals(key) && value instanceof ItemList) { recipeInstructions((ItemList)value); continue; }
        if ("recipeInstructions".equals(key) && value instanceof String) { recipeInstructions((String)value); continue; }
        if ("recipeYield".equals(key) && value instanceof String) { recipeYield((String)value); continue; }
        if ("totalTime".equals(key) && value instanceof Duration) { totalTime((Duration)value); continue; }
