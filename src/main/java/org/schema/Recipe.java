...
public class Recipe extends CreativeWork {
   ...
   */
  public StringOrItemList getRecipeInstructions() {
  ...
  public static final class Builder {
     ...
     */
    public Recipe build() {
      return new Recipe(accessibilityAPI, aggregateRating, hasPart, review, datePublished, schemaVersion, comment, video, award, prepTime, editor, workExample, potentialAction, producer, publisher, cookTime, sourceOrganization, learningResourceType, genre, translator, publishingPrinciples, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, totalTime, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, recipeYield, educationalAlignment, text, about, contentLocation, recipeCategory, accessibilityHazard, author, version, accountablePerson, sameAs, additionalType, thumbnailUrl, publication, encoding, timeRequired, cookingMethod, recipeIngredient, recipeCuisine, accessibilityFeature, audio, typicalAgeRange, recipeInstructions, dateCreated, provider, alternativeHeadline, mainEntity, name, license, copyrightYear, discussionUrl, mainEntityOfPage, nutrition, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, contributor, creator);
    }
    /**
     ...
     * The length of time it takes to prepare the recipe, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    public Builder prepTime(Duration duration) {
     ...
     * The time it takes to actually cook the dish, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    public Builder cookTime(Duration duration) {
      this.cookTime = duration;
      return this;
    }
    /**
     ...
     * The total time it takes to prepare and cook the recipe, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    public Builder totalTime(Duration duration) {
     ...
     * The quantity produced by the recipe (for example, number of people served, number of servings, etc).
     */
    public Builder recipeYield(String recipeYield) {
     ...
     * The category of the recipe&#x2014;for example, appetizer, entree, etc.
     */
    public Builder recipeCategory(String recipeCategory) {
     ...
     * A single ingredient used in the recipe, e.g. sugar, flour or garlic.
     */
    public Builder recipeIngredient(String recipeIngredient) {
     ...
     * The cuisine of the recipe (for example, French or Ethiopian).
     */
    public Builder recipeCuisine(String recipeCuisine) {
     ...
     * A step or instruction involved in making the recipe.
     */
    public Builder recipeInstructions(String recipeInstructions) {
      this.recipeInstructions.setString(recipeInstructions);
      return this;
    }
    /**
     * A step or instruction involved in making the recipe.
     */
    public Builder recipeInstructions(ItemList itemList) {
      this.recipeInstructions.setItemList(itemList);
      return this;
    }
    /**
     ...
     * Nutrition information about the recipe.
     */
    public Builder nutrition(NutritionInformation nutritionInformation) {
    ...
    private StringOrItemList recipeInstructions;
  ...
  protected Recipe(String accessibilityAPI, AggregateRating aggregateRating, HasPart hasPart, Review review, java.util.Date datePublished, String schemaVersion, Comment comment, VideoObject video, String award, Duration prepTime, Person editor, CreativeWork workExample, Action potentialAction, OrganizationOrPerson producer, Organization publisher, Duration cookTime, Organization sourceOrganization, String learningResourceType, String genre, OrganizationOrPerson translator, String publishingPrinciples, Event recordedAt, Integer commentCount, LanguageOrString inLanguage, java.util.Date dateModified, Thing mentions, Audience audience, Duration totalTime, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, String contentRating, String description, Offer offers, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, String educationalUse, String keywords, String recipeYield, AlignmentObject educationalAlignment, String text, Thing about, Place contentLocation, String recipeCategory, String accessibilityHazard, OrganizationOrPerson author, Number version, Person accountablePerson, String sameAs, String additionalType, String thumbnailUrl, PublicationEvent publication, MediaObject encoding, Duration timeRequired, String cookingMethod, String recipeIngredient, String recipeCuisine, String accessibilityFeature, AudioObject audio, String typicalAgeRange, StringOrItemList recipeInstructions, java.util.Date dateCreated, OrganizationOrPerson provider, String alternativeHeadline, Thing mainEntity, String name, StringOrCreativeWork license, Number copyrightYear, String discussionUrl, StringOrCreativeWork mainEntityOfPage, NutritionInformation nutrition, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, String alternateName, PublicationEvent releasedEvent, OrganizationOrPerson contributor, OrganizationOrPerson creator) {
  ...
  private NutritionInformation myNutrition;
  private Duration myPrepTime;
  private String myRecipeCategory;
  private String myRecipeCuisine;
  private StringOrItemList myRecipeInstructions;
  private String myRecipeYield;
  private Duration myTotalTime;
}
