...
public class Recipe extends CreativeWork {
   ...
   */
  public static final class RecipeThingBuilder implements Builder {
    /**
     ...
     * The time it takes to actually cook the dish, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    public Builder cookTime(Duration.Builder duration) {
     ...
     * Nutrition information about the recipe.
     */
    public Builder nutrition(NutritionInformation.Builder nutritionInformation) {
     ...
     * The length of time it takes to prepare the recipe, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    public Builder prepTime(Duration.Builder duration) {
     ...
     * A step or instruction involved in making the recipe.
     */
    public Builder recipeInstructions(ItemList.Builder itemList) {
     ...
     * The total time it takes to prepare and cook the recipe, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    public Builder totalTime(Duration.Builder duration) {
  ...
  Builder cookingMethod(String cookingMethod);
  Builder cookTime(Duration duration);
  Builder cookTime(Duration.Builder duration);
  Builder recipeIngredient(String recipeIngredient);
  Builder nutrition(NutritionInformation nutritionInformation);
  Builder nutrition(NutritionInformation.Builder nutritionInformation);
  Builder prepTime(Duration duration);
  Builder prepTime(Duration.Builder duration);
  Builder recipeCategory(String recipeCategory);
  Builder recipeCuisine(String recipeCuisine);
  Builder recipeInstructions(ItemList itemList);
  Builder recipeInstructions(ItemList.Builder itemList);
  Builder recipeInstructions(String recipeInstructions);
  Builder recipeYield(String recipeYield);
  Builder totalTime(Duration duration);
  Builder totalTime(Duration.Builder duration);
