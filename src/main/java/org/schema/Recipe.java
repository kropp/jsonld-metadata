...
public class Recipe extends CreativeWork {
  ...
  static final class RecipeThingBuilder implements Builder {
     ...
     * The method of cooking, such as Frying, Steaming, ...
     */
    @NotNull public Builder cookingMethod(String cookingMethod) {
     ...
     * The time it takes to actually cook the dish, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    @NotNull public Builder cookTime(Duration duration) {
     ...
     * The time it takes to actually cook the dish, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    @NotNull public Builder cookTime(Duration.Builder duration) {
      return this.cookTime(duration.build());
    }
    /**
     * A single ingredient used in the recipe, e.g. sugar, flour or garlic.
     */
    @NotNull public Builder recipeIngredient(String recipeIngredient) {
     ...
     * Nutrition information about the recipe.
     */
    @NotNull public Builder nutrition(NutritionInformation nutritionInformation) {
     ...
     * Nutrition information about the recipe.
     */
    @NotNull public Builder nutrition(NutritionInformation.Builder nutritionInformation) {
      return this.nutrition(nutritionInformation.build());
    }
    /**
     * The length of time it takes to prepare the recipe, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    @NotNull public Builder prepTime(Duration duration) {
     ...
     * The length of time it takes to prepare the recipe, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    @NotNull public Builder prepTime(Duration.Builder duration) {
      return this.prepTime(duration.build());
    }
    /**
     * The category of the recipe&#x2014;for example, appetizer, entree, etc.
     */
    @NotNull public Builder recipeCategory(String recipeCategory) {
     ...
     * The cuisine of the recipe (for example, French or Ethiopian).
     */
    @NotNull public Builder recipeCuisine(String recipeCuisine) {
     ...
     * A step or instruction involved in making the recipe.
     */
    @NotNull public Builder recipeInstructions(ItemList itemList) {
      if (this.recipeInstructions == null) this.recipeInstructions = new ItemListOrString();
     ...
     * A step or instruction involved in making the recipe.
     */
    @NotNull public Builder recipeInstructions(ItemList.Builder itemList) {
      return this.recipeInstructions(itemList.build());
    }
    /**
     * A step or instruction involved in making the recipe.
     */
    @NotNull public Builder recipeInstructions(String recipeInstructions) {
      if (this.recipeInstructions == null) this.recipeInstructions = new ItemListOrString();
     ...
     * The quantity produced by the recipe (for example, number of people served, number of servings, etc).
     */
    @NotNull public Builder recipeYield(String recipeYield) {
     ...
     * The total time it takes to prepare and cook the recipe, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    @NotNull public Builder totalTime(Duration duration) {
     ...
     * The total time it takes to prepare and cook the recipe, in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 duration format</a>.
     */
    @NotNull public Builder totalTime(Duration.Builder duration) {
      return this.totalTime(duration.build());
    }
    /**
    ...
    private ItemListOrString recipeInstructions;
  ...
  public interface Builder extends ThingBuilder<Recipe> {
    @NotNull Builder cookingMethod(String cookingMethod);
    @NotNull Builder cookTime(Duration duration);
    @NotNull Builder cookTime(Duration.Builder duration);
    @NotNull Builder recipeIngredient(String recipeIngredient);
    @NotNull Builder nutrition(NutritionInformation nutritionInformation);
    @NotNull Builder nutrition(NutritionInformation.Builder nutritionInformation);
    @NotNull Builder prepTime(Duration duration);
    @NotNull Builder prepTime(Duration.Builder duration);
    @NotNull Builder recipeCategory(String recipeCategory);
    @NotNull Builder recipeCuisine(String recipeCuisine);
    @NotNull Builder recipeInstructions(ItemList itemList);
    @NotNull Builder recipeInstructions(ItemList.Builder itemList);
    @NotNull Builder recipeInstructions(String recipeInstructions);
    @NotNull Builder recipeYield(String recipeYield);
    @NotNull Builder totalTime(Duration duration);
    @NotNull Builder totalTime(Duration.Builder duration);
  ...
  private ItemListOrString myRecipeInstructions;
