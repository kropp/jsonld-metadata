...
public class SeaBodyOfWater extends BodyOfWater {
  ...
  public static final class Builder {
    ...
    public SeaBodyOfWater build() {
      return new SeaBodyOfWater(address, aggregateRating, containedIn, event, faxNumber, geo, globalLocationNumber, isicV4, logo, hasMap, openingHoursSpecification, photo, review, telephone, additionalProperty, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
