...
public class SeaBodyOfWater extends BodyOfWater {
  ...
  public static final class Builder {
    /**
     * Creates new {@link SeaBodyOfWater} instance.
     */
    public SeaBodyOfWater build() {
      return new SeaBodyOfWater(aggregateRating, review, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, url, event, containedIn, additionalType, sameAs, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
