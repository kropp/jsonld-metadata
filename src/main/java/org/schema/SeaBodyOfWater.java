...
public class SeaBodyOfWater extends BodyOfWater {
  /**
   * Builder for {@see SeaBodyOfWater}
   */
  public static final class Builder {
    public SeaBodyOfWater build() {
      return new SeaBodyOfWater(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, additionalType, url, geo, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
