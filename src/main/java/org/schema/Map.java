...
public class Map extends CreativeWork {
  ...
  static final class MapThingBuilder implements Builder {
    ...
    @NotNull public Builder mapType(@NotNull MapCategoryType.Builder mapCategoryType) {
      return this.mapType(mapCategoryType.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("mapType".equals(key) && value instanceof MapCategoryType) { mapType((MapCategoryType)value); continue; }
  ...
  public interface Builder extends ThingBuilder<Map> {
    @NotNull Builder mapType(@NotNull MapCategoryType mapCategoryType);
    @NotNull Builder mapType(@NotNull MapCategoryType.Builder mapCategoryType);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myMapType != null ? myMapType.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myMapType != null ? !myMapType.equals(map.myMapType) : map.myMapType != null) return false;
    return true;
  }
