...
public class Map extends CreativeWork {
   ...
   */
  public static final class MapThingBuilder implements Builder {
    /**
     ...
     * Indicates the kind of Map, from the MapCategoryType Enumeration.
     */
    public Builder mapType(MapCategoryType.Builder mapCategoryType) {
  ...
  Builder mapType(MapCategoryType mapCategoryType);
  Builder mapType(MapCategoryType.Builder mapCategoryType);
