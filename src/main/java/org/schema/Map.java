...
public class Map extends CreativeWork {
  ...
  static final class MapThingBuilder implements Builder {
     ...
     * Indicates the kind of Map, from the MapCategoryType Enumeration.
     */
    @NotNull public Builder mapType(MapCategoryType.Builder mapCategoryType) {
  ...
  public interface Builder extends ThingBuilder<Map> {
    @NotNull Builder mapType(MapCategoryType mapCategoryType);
    @NotNull Builder mapType(MapCategoryType.Builder mapCategoryType);
