...
public class MovieTheater extends EntertainmentBusiness {
  ...
  public Number getScreenCount() {
    return myScreenCount;
  }
  /**
   * Builder for {@link MovieTheater}
   */
  static final class MovieTheaterThingBuilder implements Builder {
    /**
     * Creates new {@link MovieTheater} instance.
     */
    ...
    @NotNull public Builder screenCount(@NotNull String screenCount) {
      if (this.screenCount == null) this.screenCount = new Number();
      this.screenCount.setString(screenCount);
      return this;
    }
    /**
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("screenCount".equals(key) && value instanceof Integer) { screenCount((Integer)value); continue; }
        if ("screenCount".equals(key) && value instanceof Long) { screenCount((Long)value); continue; }
        if ("screenCount".equals(key) && value instanceof Float) { screenCount((Float)value); continue; }
        if ("screenCount".equals(key) && value instanceof Double) { screenCount((Double)value); continue; }
        if ("screenCount".equals(key) && value instanceof String) { screenCount((String)value); continue; }
  ...
  public interface Builder extends ThingBuilder<MovieTheater> {
    @NotNull Builder screenCount(@NotNull Integer integer);
    @NotNull Builder screenCount(@NotNull Long screenCount);
    @NotNull Builder screenCount(@NotNull Float screenCount);
    @NotNull Builder screenCount(@NotNull Double screenCount);
    @NotNull Builder screenCount(@NotNull String screenCount);
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myScreenCount != null ? !myScreenCount.equals(movieTheater.myScreenCount) : movieTheater.myScreenCount != null) return false;
    return true;
  }

  private Number myScreenCount;
}
