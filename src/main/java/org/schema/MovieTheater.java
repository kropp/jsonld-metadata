...
public class MovieTheater extends EntertainmentBusiness {
  ...
  static final class MovieTheaterThingBuilder implements Builder {
     ...
     * The number of screens in the movie theater.
     */
    @NotNull public Builder screenCount(int screenCount) {
      if (this.screenCount == null) this.screenCount = new Number();
      this.screenCount.setInt(screenCount);
      return this;
    }
    /**
     * The number of screens in the movie theater.
     */
    @NotNull public Builder screenCount(long screenCount) {
      if (this.screenCount == null) this.screenCount = new Number();
     ...
     * The number of screens in the movie theater.
     */
    @NotNull public Builder screenCount(float screenCount) {
      if (this.screenCount == null) this.screenCount = new Number();
     ...
     * The number of screens in the movie theater.
     */
    @NotNull public Builder screenCount(double screenCount) {
      if (this.screenCount == null) this.screenCount = new Number();
     ...
     * The number of screens in the movie theater.
     */
    @NotNull public Builder screenCount(String screenCount) {
      if (this.screenCount == null) this.screenCount = new Number();
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  public interface Builder extends ThingBuilder<MovieTheater> {
    @NotNull Builder screenCount(int screenCount);
    @NotNull Builder screenCount(long screenCount);
    @NotNull Builder screenCount(float screenCount);
    @NotNull Builder screenCount(double screenCount);
    @NotNull Builder screenCount(String screenCount);
