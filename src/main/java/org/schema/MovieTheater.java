...
public class MovieTheater extends EntertainmentBusiness {
  ...
  /**
   * Builder for {@see MovieTheater}
   */
  public static final class Builder {
    public MovieTheater build() {
      return new MovieTheater(review, openingHoursSpecification, openingHours, potentialAction, additionalType, logo, parentOrganization, currenciesAccepted, screenCount, image, containedIn, description, hasMap, event, faxNumber, mainEntityOfPage, globalLocationNumber, priceRange, telephone, alternateName, photo, url, geo, aggregateRating, sameAs, name, paymentAccepted, address, additionalProperty, isicV4);
    }
    /**
     ...
     * The number of screens in the movie theater.
     */
    public Builder screenCount(Number value) {
      screenCount = value;
      return this;
    }
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  protected MovieTheater(Review review, OpeningHoursSpecification openingHoursSpecification, String openingHours, Action potentialAction, String additionalType, ImageObject logo, Organization parentOrganization, String currenciesAccepted, Number screenCount, Image image, Place containedIn, String description, String hasMap, Event event, String faxNumber, CreativeWork mainEntityOfPage, String globalLocationNumber, String priceRange, String telephone, String alternateName, ImageObject photo, String url, GeoCoordinates geo, AggregateRating aggregateRating, String sameAs, String name, String paymentAccepted, PostalAddress address, PropertyValue additionalProperty, String isicV4) {
