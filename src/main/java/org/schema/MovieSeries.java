...
public class MovieSeries extends CreativeWorkSeries {
  ...
  public static final class Builder {
    /**
     * Creates new {@link MovieSeries} instance.
     */
    public MovieSeries build() {
      return new MovieSeries(accessibilityAPI, aggregateRating, hasPart, review, datePublished, comment, schemaVersion, video, award, editor, workExample, director, potentialAction, startDate, producer, publisher, sourceOrganization, learningResourceType, genre, translator, publishingPrinciples, recordedAt, inLanguage, commentCount, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, endDate, text, about, contentLocation, musicBy, accessibilityHazard, author, version, accountablePerson, additionalType, sameAs, thumbnailUrl, publication, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, trailer, mainEntity, alternativeHeadline, name, license, mainEntityOfPage, discussionUrl, copyrightYear, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, productionCompany, creator, contributor);
    }
    /**
