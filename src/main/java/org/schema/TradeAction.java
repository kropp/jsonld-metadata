...
<li>
   ...
   */
  static final class TradeActionThingBuilder implements Builder {
    /**
     * Creates new {@link TradeAction} instance.
     */
    public TradeAction build() {
      return new TradeAction(price, priceSpecification, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * The offer price of a product, or of a price component when attached to PriceSpecification and its subtypes.
<br />
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<TradeAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    TradeAction tradeAction = (TradeAction) o;
    if (!super.equals(o)) return false;
    if (myPrice != null ? !myPrice.equals(tradeAction.myPrice) : tradeAction.myPrice != null) return false;
    if (myPriceSpecification != null ? !myPriceSpecification.equals(tradeAction.myPriceSpecification) : tradeAction.myPriceSpecification != null) return false;
    return true;
  }
