...
<li>
  ...
  /**
   * Builder for {@see TradeAction}
   */
  public static final class Builder {
    public TradeAction build() {
      return new TradeAction(priceSpecification, instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, startTime, sameAs, actionStatus, result, error, name, image, target, object, location, description, price);
    }
    /**
     * One or more detailed price specifications, indicating the unit price and delivery or payment charges.
     */
