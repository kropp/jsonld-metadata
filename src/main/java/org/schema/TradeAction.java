...
<li>
  ...
  public static final class Builder {
    ...
    public TradeAction build() {
      return new TradeAction(startTime, name, error, mainEntityOfPage, price, url, sameAs, additionalType, agent, alternateName, potentialAction, target, priceSpecification, description, endTime, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected TradeAction(java.util.Date startTime, String name, Thing error, StringOrCreativeWork mainEntityOfPage, StringOrNumber price, String url, String sameAs, String additionalType, OrganizationOrPerson agent, String alternateName, Action potentialAction, EntryPoint target, PriceSpecification priceSpecification, String description, java.util.Date endTime, ActionStatusType actionStatus) {
