...
public class VoteAction extends ChooseAction {
  ...
  static final class VoteActionThingBuilder implements Builder {
     ...
     * A sub property of object. The candidate subject of this action.
     */
    @NotNull public Builder candidate(Person person) {
     ...
     * A sub property of object. The candidate subject of this action.
     */
    @NotNull public Builder candidate(Person.Builder person) {
      return this.candidate(person.build());
    }
    /**
     * A sub property of object. The options subject to this action.
     */
    @NotNull public Builder actionOption(String actionOption) {
     ...
     * A sub property of object. The options subject to this action.
     */
    @NotNull public Builder actionOption(Thing thing) {
      if (this.actionOption == null) this.actionOption = new StringOrThing();
     ...
     * A sub property of object. The options subject to this action.
     */
    @NotNull public Builder actionOption(Thing.Builder thing) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<VoteAction> {
    @NotNull Builder candidate(Person person);
    @NotNull Builder candidate(Person.Builder person);
    @NotNull Builder actionOption(String actionOption);
    @NotNull Builder actionOption(Thing thing);
    @NotNull Builder actionOption(Thing.Builder thing);
