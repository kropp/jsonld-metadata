...
public class VoteAction extends ChooseAction {
   ...
   */
  public static final class VoteActionThingBuilder implements Builder {
    /**
     ...
     * A sub property of object. The candidate subject of this action.
     */
    public Builder candidate(Person person) {
     ...
     * A sub property of object. The candidate subject of this action.
     */
    public Builder candidate(Person.Builder person) {
      return this.candidate(person.build());
    }
    /**
     * A sub property of object. The options subject to this action.
     */
    public Builder actionOption(String actionOption) {
     ...
     * A sub property of object. The options subject to this action.
     */
    public Builder actionOption(Thing thing) {
      if (this.actionOption == null) this.actionOption = new StringOrThing();
     ...
     * A sub property of object. The options subject to this action.
     */
    public Builder actionOption(Thing.Builder thing) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  Builder candidate(Person person);
  Builder candidate(Person.Builder person);
  Builder actionOption(String actionOption);
  Builder actionOption(Thing thing);
  Builder actionOption(Thing.Builder thing);
