...
public class VoteAction extends ChooseAction {
   ...
   */
  static final class VoteActionThingBuilder implements Builder {
    /**
     * Creates new {@link VoteAction} instance.
     */
    public VoteAction build() {
      return new VoteAction(candidate, actionOption, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of object. The candidate subject of this action.
     */
    ...
    @NotNull public Builder candidate(@NotNull Person.Builder person) {
      return this.candidate(person.build());
    }
    /**
     * A sub property of object. The options subject to this action.
     */
    @NotNull public Builder actionOption(@NotNull String actionOption) {
      if (this.actionOption == null) this.actionOption = new StringOrThing();
      this.actionOption.setString(actionOption);
      return this;
    }
    /**
     * A sub property of object. The options subject to this action.
    ...
    @NotNull public Builder actionOption(@NotNull Thing thing) {
      if (this.actionOption == null) this.actionOption = new StringOrThing();
      this.actionOption.setThing(thing);
      return this;
    }
    /**
     * A sub property of object. The options subject to this action.
    ...
    @NotNull public Builder actionOption(@NotNull Thing.Builder thing) {
      return this.actionOption(thing.build());
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("candidate".equals(key) && value instanceof Person) { candidate((Person)value); continue; }
        if ("actionOption".equals(key) && value instanceof String) { actionOption((String)value); continue; }
        if ("actionOption".equals(key) && value instanceof Thing) { actionOption((Thing)value); continue; }
  ...
  public interface Builder extends ThingBuilder<VoteAction> {
    @NotNull Builder candidate(@NotNull Person person);
    @NotNull Builder candidate(@NotNull Person.Builder person);
    @NotNull Builder actionOption(@NotNull String actionOption);
    @NotNull Builder actionOption(@NotNull Thing thing);
    @NotNull Builder actionOption(@NotNull Thing.Builder thing);
  ...
  protected VoteAction(Person candidate, StringOrThing actionOption, OrganizationOrPerson agent, java.util.Date endTime, java.util.Date startTime, ActionStatusType actionStatus, Thing error, EntryPoint target, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
    super(actionOption, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
  ...
  @Override public boolean equals(Object o) {
    ...
    VoteAction voteAction = (VoteAction) o;
    if (!super.equals(o)) return false;
    if (myCandidate != null ? !myCandidate.equals(voteAction.myCandidate) : voteAction.myCandidate != null) return false;
    return true;
  }

  private Person myCandidate;
}
