...
public class SellAction extends TradeAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link SellAction} instance.
     */
    public SellAction build() {
      return new SellAction(buyer, startTime, name, mainEntityOfPage, error, price, url, sameAs, additionalType, agent, alternateName, description, priceSpecification, target, potentialAction, endTime, actionStatus);
    }
    /**
     * A sub property of participant. The participant/person/organization that bought the object.
     */
    public Builder buyer(Person person) {
      this.buyer = person;
      return this;
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected SellAction(Person buyer, java.util.Date startTime, String name, StringOrCreativeWork mainEntityOfPage, Thing error, StringOrNumber price, String url, String sameAs, String additionalType, OrganizationOrPerson agent, String alternateName, String description, PriceSpecification priceSpecification, EntryPoint target, Action potentialAction, java.util.Date endTime, ActionStatusType actionStatus) {
