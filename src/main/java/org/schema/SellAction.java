...
public class SellAction extends TradeAction {
   ...
   */
  static final class SellActionThingBuilder implements Builder {
    /**
     * Creates new {@link SellAction} instance.
     */
    public SellAction build() {
      return new SellAction(buyer, price, priceSpecification, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of participant. The participant/person/organization that bought the object.
     */
    ...
    @NotNull public Builder buyer(@NotNull Person.Builder person) {
      return this.buyer(person.build());
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("buyer".equals(key) && value instanceof Person) { buyer((Person)value); continue; }
  ...
  public interface Builder extends ThingBuilder<SellAction> {
    @NotNull Builder buyer(@NotNull Person person);
    @NotNull Builder buyer(@NotNull Person.Builder person);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myBuyer != null ? myBuyer.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    SellAction sellAction = (SellAction) o;
    if (!super.equals(o)) return false;
    if (myBuyer != null ? !myBuyer.equals(sellAction.myBuyer) : sellAction.myBuyer != null) return false;
    return true;
  }
