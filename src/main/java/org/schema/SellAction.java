...
public class SellAction extends TradeAction {
  ...
  /**
   * Builder for {@see SellAction}
   */
  public static final class Builder {
    public SellAction build() {
      return new SellAction(priceSpecification, instrument, mainEntityOfPage, agent, endTime, buyer, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location, price);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
     ...
     * A sub property of participant. The participant/person/organization that bought the object.
     */
    public Builder buyer(Person value) {
      buyer = value;
      return this;
    }
    /**
...
<li>
  ...
  protected SellAction(PriceSpecification priceSpecification, Instrument instrument, CreativeWork mainEntityOfPage, Organization agent, java.util.Date endTime, Person buyer, String alternateName, Action potentialAction, Participant participant, String additionalType, String url, String sameAs, java.util.Date startTime, ActionStatusType actionStatus, Result result, Image image, String name, Thing error, EntryPoint target, Object object, String description, Location location, Number price) {
