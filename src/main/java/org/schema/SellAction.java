...
public class SellAction extends TradeAction {
  ...
  static final class SellActionThingBuilder implements Builder {
     ...
     * A sub property of participant. The participant/person/organization that bought the object.
     */
    @NotNull public Builder buyer(Person person) {
      this.buyer = person;
      return this;
    }
    /**
     * A sub property of participant. The participant/person/organization that bought the object.
     */
    @NotNull public Builder buyer(Person.Builder person) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<SellAction> {
    @NotNull Builder buyer(Person person);
    @NotNull Builder buyer(Person.Builder person);
