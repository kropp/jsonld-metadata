...
public class VisualArtwork extends CreativeWork {
   ...
   */
  public String getArtform() { return myArtform; }
  /**
   * The material used. (e.g. Oil, Watercolour, Acrylic, Linoprint, Marble, Cyanotype, Digital, Lithograph, DryPoint, Intaglio, Pastel, Woodcut, Pencil, Mixed Media, etc.)
   */
  public String getArtMedium() { return myArtMedium; }
  /**
   * The supporting materials for the artwork, e.g. Canvas, Paper, Wood, Board, etc.
   */
  public String getArtworkSurface() { return myArtworkSurface; }
  /**
   ...
   */
  public IntegerOrString getArtEdition() { return myArtEdition; }
   ...
   */
  public static class Builder implements ThingBuilder<VisualArtwork> {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("artform".equals(key) && value instanceof String) { artform((String)value); continue; }
        if ("artMedium".equals(key) && value instanceof String) { artMedium((String)value); continue; }
        if ("artworkSurface".equals(key) && value instanceof String) { artworkSurface((String)value); continue; }
        ...
        if ("artEdition".equals(key) && value instanceof Integer) { artEdition((Integer)value); continue; }
        if ("artEdition".equals(key) && value instanceof String) { artEdition((String)value); continue; }
