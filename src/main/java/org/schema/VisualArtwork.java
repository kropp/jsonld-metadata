...
public class VisualArtwork extends CreativeWork {
  ...
  public static final class Builder {
    ...
    public VisualArtwork build() {
      return new VisualArtwork(accessibilityAPI, aggregateRating, hasPart, review, datePublished, schemaVersion, comment, video, award, artform, editor, workExample, artworkSurface, potentialAction, producer, publisher, sourceOrganization, genre, learningResourceType, translator, publishingPrinciples, recordedAt, commentCount, inLanguage, dateModified, artEdition, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, width, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, depth, text, about, contentLocation, artMedium, accessibilityHazard, author, version, accountablePerson, sameAs, additionalType, thumbnailUrl, publication, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, alternativeHeadline, mainEntity, name, license, copyrightYear, discussionUrl, mainEntityOfPage, isBasedOnUrl, isFamilyFriendly, exampleOfWork, height, alternateName, releasedEvent, contributor, creator);
    }
    /**
  ...
  protected VisualArtwork(String accessibilityAPI, AggregateRating aggregateRating, HasPart hasPart, Review review, java.util.Date datePublished, String schemaVersion, Comment comment, VideoObject video, String award, String artform, Person editor, CreativeWork workExample, String artworkSurface, Action potentialAction, OrganizationOrPerson producer, Organization publisher, Organization sourceOrganization, String genre, String learningResourceType, OrganizationOrPerson translator, String publishingPrinciples, Event recordedAt, Integer commentCount, LanguageOrString inLanguage, java.util.Date dateModified, IntegerOrString artEdition, Thing mentions, Audience audience, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, String contentRating, String description, Offer offers, QuantitativeValueOrDistance width, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, String educationalUse, String keywords, AlignmentObject educationalAlignment, QuantitativeValueOrDistance depth, String text, Thing about, Place contentLocation, String artMedium, String accessibilityHazard, OrganizationOrPerson author, Number version, Person accountablePerson, String sameAs, String additionalType, String thumbnailUrl, PublicationEvent publication, MediaObject encoding, Duration timeRequired, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, String alternativeHeadline, Thing mainEntity, String name, StringOrCreativeWork license, Number copyrightYear, String discussionUrl, StringOrCreativeWork mainEntityOfPage, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, QuantitativeValueOrDistance height, String alternateName, PublicationEvent releasedEvent, OrganizationOrPerson contributor, OrganizationOrPerson creator) {
