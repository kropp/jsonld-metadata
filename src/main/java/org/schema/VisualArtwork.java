...
public class VisualArtwork extends CreativeWork {
  ...
  /**
   * Builder for {@see VisualArtwork}
   */
  public static final class Builder {
    public VisualArtwork build() {
      return new VisualArtwork(review, producer, editor, timeRequired, creator, offers, educationalUse, alternativeHeadline, mentions, additionalType, artEdition, position, associatedMedia, artform, isFamilyFriendly, accessibilityControl, image, keywords, discussionUrl, exampleOfWork, isBasedOnUrl, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, depth, character, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, width, genre, potentialAction, contentRating, audience, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, artMedium, dateModified, artworkSurface, thumbnailUrl, releasedEvent, accessibilityFeature, accessibilityHazard, license, description, publication, provider, educationalAlignment, recordedAt, mainEntityOfPage, contributor, isPartOf, workExample, dateCreated, copyrightHolder, aggregateRating, sameAs, height, name, typicalAgeRange, citation, copyrightYear, translator, sourceOrganization, text, award);
    }
    /**
     ...
     * The number of copies when multiple copies of a piece of artwork are produced - e.g. for a limited edition of 20 prints, 'artEdition' refers to the total number of copies (in this example "20").
     */
    public Builder artEdition(String value) {
      artEdition = value;
      return this;
    }
     ...
     * e.g. Painting, Drawing, Sculpture, Print, Photograph, Assemblage, Collage, etc.
     */
    public Builder artform(String value) {
      artform = value;
      return this;
    }
    /**
     ...
     * The material used. (e.g. Oil, Watercolour, Acrylic, Linoprint, Marble, Cyanotype, Digital, Lithograph, DryPoint, Intaglio, Pastel, Woodcut, Pencil, Mixed Media, etc.)
     */
    public Builder artMedium(String value) {
      artMedium = value;
      return this;
    }
    /**
     ...
     * The supporting materials for the artwork, e.g. Canvas, Paper, Wood, Board, etc.
     */
    public Builder artworkSurface(String value) {
      artworkSurface = value;
      return this;
    }
    /**
  ...
  protected VisualArtwork(Review review, Person producer, Person editor, Duration timeRequired, Organization creator, Offer offers, String educationalUse, String alternativeHeadline, Thing mentions, String additionalType, String artEdition, Position position, MediaObject associatedMedia, String artform, Boolean isFamilyFriendly, String accessibilityControl, Image image, String keywords, String discussionUrl, CreativeWork exampleOfWork, String isBasedOnUrl, Comment comment, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, Distance depth, Person character, String schemaVersion, String accessibilityAPI, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, Distance width, String genre, Action potentialAction, String contentRating, Audience audience, String inLanguage, Place contentLocation, String learningResourceType, Person accountablePerson, AudioObject audio, String artMedium, java.util.Date dateModified, String artworkSurface, String thumbnailUrl, PublicationEvent releasedEvent, String accessibilityFeature, String accessibilityHazard, CreativeWork license, String description, PublicationEvent publication, Person provider, AlignmentObject educationalAlignment, Event recordedAt, CreativeWork mainEntityOfPage, Organization contributor, IsPartOf isPartOf, CreativeWork workExample, java.util.Date dateCreated, Organization copyrightHolder, AggregateRating aggregateRating, String sameAs, Distance height, String name, String typicalAgeRange, CreativeWork citation, Number copyrightYear, Person translator, Organization sourceOrganization, String text, String award) {
