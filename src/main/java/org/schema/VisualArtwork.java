...
public class VisualArtwork extends CreativeWork {
  ...
  public interface Builder extends ThingBuilder<VisualArtwork> {
    @NotNull Builder artform(@NotNull String artform);
    @NotNull Builder artMedium(@NotNull String artMedium);
    @NotNull Builder artworkSurface(@NotNull String artworkSurface);
    ...
    @NotNull Builder artEdition(@NotNull Integer integer);
    @NotNull Builder artEdition(@NotNull String artEdition);
