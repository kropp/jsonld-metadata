...
public class TravelAction extends MoveAction {
  ...
  /**
   * Builder for {@see TravelAction}
   */
  public static final class Builder {
    public TravelAction build() {
      return new TravelAction(instrument, toLocation, mainEntityOfPage, distance, agent, endTime, alternateName, potentialAction, fromLocation, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
