...
public class TravelAction extends MoveAction {
   ...
   */
  static final class TravelActionThingBuilder implements Builder {
    /**
     * Creates new {@link TravelAction} instance.
     */
    public TravelAction build() {
      return new TravelAction(distance, fromLocation, toLocation, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * The distance travelled, e.g. exercising or travelling.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<TravelAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    TravelAction travelAction = (TravelAction) o;
    if (!super.equals(o)) return false;
    if (myDistance != null ? !myDistance.equals(travelAction.myDistance) : travelAction.myDistance != null) return false;
    return true;
  }
