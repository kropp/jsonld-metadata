...
public class TravelAction extends MoveAction {
  ...
  public static final class Builder {
    ...
    public TravelAction build() {
      return new TravelAction(startTime, toLocation, name, mainEntityOfPage, error, fromLocation, distance, url, sameAs, additionalType, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
