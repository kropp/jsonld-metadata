...
public class InteractAction extends Action {
  /**
   * Builder for {@see InteractAction}
   */
  public static final class Builder {
    public InteractAction build() {
      return new InteractAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, object, location, description);
    }
