...
public class InteractAction extends Action {
  ...
  public static final class Builder {
    ...
    public InteractAction build() {
      return new InteractAction(additionalType, url, sameAs, agent, startTime, alternateName, potentialAction, target, description, name, endTime, mainEntityOfPage, error, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected InteractAction(String additionalType, String url, String sameAs, OrganizationOrPerson agent, java.util.Date startTime, String alternateName, Action potentialAction, EntryPoint target, String description, String name, java.util.Date endTime, StringOrCreativeWork mainEntityOfPage, Thing error, ActionStatusType actionStatus) {
