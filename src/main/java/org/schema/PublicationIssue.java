...
public class PublicationIssue extends CreativeWork {
   ...
   */
  public StringOrInt getIssueNumber() {
  ...
  static final class PublicationIssueThingBuilder implements Builder {
     ...
     * Identifies the issue of publication; for example, "iii" or "2".
     */
    @NotNull public Builder issueNumber(String issueNumber) {
      if (this.issueNumber == null) this.issueNumber = new StringOrInt();
     ...
     * Identifies the issue of publication; for example, "iii" or "2".
     */
    @NotNull public Builder issueNumber(int issueNumber) {
      if (this.issueNumber == null) this.issueNumber = new StringOrInt();
      this.issueNumber.setInt(issueNumber);
      return this;
    }
    /**
     * The page on which the work ends; for example "138" or "xvi".
    ...
    private StringOrInt issueNumber;
  ...
  public interface Builder extends ThingBuilder<PublicationIssue> {
    @NotNull Builder issueNumber(String issueNumber);
    @NotNull Builder issueNumber(int issueNumber);
  ...
  private StringOrInt myIssueNumber;
