...
public class PublicationIssue extends CreativeWork {
  ...
  public static final class Builder {
     ...
     * Identifies the issue of publication; for example, "iii" or "2".
     */
    public Builder issueNumber(Integer integer) {
