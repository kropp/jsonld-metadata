...
public class SportsOrganization extends Organization {
  ...
  static final class SportsOrganizationThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("sport".equals(key) && value instanceof String) { sport((String)value); continue; }
  ...
  public interface Builder extends ThingBuilder<SportsOrganization> {
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (mySport != null ? mySport.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    SportsOrganization sportsOrganization = (SportsOrganization) o;
    if (!super.equals(o)) return false;
    if (mySport != null ? !mySport.equals(sportsOrganization.mySport) : sportsOrganization.mySport != null) return false;
    return true;
  }
