...
public class DDxElement extends MedicalIntangible {
  ...
  public MedicalSignOrSymptom getDistinguishingSign() {
    return myDistinguishingSign;
  }
  /**
   * Builder for {@link DDxElement}
   */
  static final class DDxElementThingBuilder implements Builder {
    /**
     ...
     * One or more alternative conditions considered in the differential diagnosis process.
     */
    @NotNull public Builder diagnosis(MedicalCondition medicalCondition) {
      this.diagnosis = medicalCondition;
      return this;
    }
    /**
     * One or more alternative conditions considered in the differential diagnosis process.
     */
    @NotNull public Builder diagnosis(MedicalCondition.Builder medicalCondition) {
      return this.diagnosis(medicalCondition.build());
    }
    /**
     * One of a set of signs and symptoms that can be used to distinguish this diagnosis from others in the differential diagnosis.
     */
    @NotNull public Builder distinguishingSign(MedicalSignOrSymptom medicalSignOrSymptom) {
      this.distinguishingSign = medicalSignOrSymptom;
      return this;
    }
    /**
     * One of a set of signs and symptoms that can be used to distinguish this diagnosis from others in the differential diagnosis.
     */
    @NotNull public Builder distinguishingSign(MedicalSignOrSymptom.Builder medicalSignOrSymptom) {
      return this.distinguishingSign(medicalSignOrSymptom.build());
    }
    /**
  ...
  public interface Builder extends ThingBuilder<DDxElement> {
    @NotNull Builder diagnosis(MedicalCondition medicalCondition);
    @NotNull Builder diagnosis(MedicalCondition.Builder medicalCondition);
    @NotNull Builder distinguishingSign(MedicalSignOrSymptom medicalSignOrSymptom);
    @NotNull Builder distinguishingSign(MedicalSignOrSymptom.Builder medicalSignOrSymptom);
