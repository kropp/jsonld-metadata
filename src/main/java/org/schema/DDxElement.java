...
/**
 * An alternative, closely-related condition typically considered later in the differential diagnosis process along with the signs that are used to distinguish it.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class DDxElement extends MedicalIntangible {
   ...
   */
  public MedicalCondition getDiagnosis() { return myDiagnosis; }
  /**
   * One of a set of signs and symptoms that can be used to distinguish this diagnosis from others in the differential diagnosis.
   */
  public MedicalSignOrSymptom getDistinguishingSign() { return myDistinguishingSign; }
   ...
   */
  public static class Builder implements ThingBuilder<DDxElement> {
