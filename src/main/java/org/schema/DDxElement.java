...
public class DDxElement extends MedicalIntangible {
   ...
   */
  public static final class DDxElementThingBuilder implements Builder {
    /**
     ...
     * One or more alternative conditions considered in the differential diagnosis process.
     */
    public Builder diagnosis(MedicalCondition medicalCondition) {
     ...
     * One or more alternative conditions considered in the differential diagnosis process.
     */
    public Builder diagnosis(MedicalCondition.Builder medicalCondition) {
      return this.diagnosis(medicalCondition.build());
    }
    /**
     * One of a set of signs and symptoms that can be used to distinguish this diagnosis from others in the differential diagnosis.
     */
    public Builder distinguishingSign(MedicalSignOrSymptom medicalSignOrSymptom) {
     ...
     * One of a set of signs and symptoms that can be used to distinguish this diagnosis from others in the differential diagnosis.
     */
    public Builder distinguishingSign(MedicalSignOrSymptom.Builder medicalSignOrSymptom) {
  ...
  Builder diagnosis(MedicalCondition medicalCondition);
  Builder diagnosis(MedicalCondition.Builder medicalCondition);
  Builder distinguishingSign(MedicalSignOrSymptom medicalSignOrSymptom);
  Builder distinguishingSign(MedicalSignOrSymptom.Builder medicalSignOrSymptom);
