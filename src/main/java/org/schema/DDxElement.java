...
public class DDxElement extends MedicalIntangible {
  ...
  public static final class Builder {
    ...
    public DDxElement build() {
      return new DDxElement(recognizingAuthority, code, name, mainEntityOfPage, guideline, url, sameAs, additionalType, distinguishingSign, alternateName, diagnosis, study, potentialAction, description, relevantSpecialty, medicineSystem);
    }
    /**
  ...
  protected DDxElement(Organization recognizingAuthority, MedicalCode code, String name, StringOrCreativeWork mainEntityOfPage, MedicalGuideline guideline, String url, String sameAs, String additionalType, MedicalSignOrSymptom distinguishingSign, String alternateName, MedicalCondition diagnosis, MedicalStudy study, Action potentialAction, String description, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem) {
