...
public class DDxElement extends MedicalIntangible {
  ...
  /**
   * Builder for {@see DDxElement}
   */
  public static final class Builder {
    public DDxElement build() {
      return new DDxElement(mainEntityOfPage, alternateName, potentialAction, url, additionalType, medicineSystem, sameAs, recognizingAuthority, study, code, diagnosis, distinguishingSign, image, name, relevantSpecialty, guideline, description);
    }
    /**
     ...
     * One or more alternative conditions considered in the differential diagnosis process.
     */
    public Builder diagnosis(MedicalCondition value) {
      diagnosis = value;
      return this;
    }
    /**
     * One of a set of signs and symptoms that can be used to distinguish this diagnosis from others in the differential diagnosis.
     */
    public Builder distinguishingSign(MedicalSignOrSymptom value) {
      distinguishingSign = value;
      return this;
    }
