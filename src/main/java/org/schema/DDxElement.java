...
public class DDxElement extends MedicalIntangible {
  ...
  public static class Builder extends MedicalIntangible.Builder {
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("diagnosis".equals(key) && value instanceof MedicalCondition) { diagnosis((MedicalCondition)value); return; }
      if ("distinguishingSign".equals(key) && value instanceof MedicalSignOrSymptom) { distinguishingSign((MedicalSignOrSymptom)value); return; }
