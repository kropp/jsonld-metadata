...
public class DDxElement extends MedicalIntangible {
  ...
  static final class DDxElementThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("diagnosis".equals(key) && value instanceof MedicalCondition) { diagnosis((MedicalCondition)value); continue; }
        if ("distinguishingSign".equals(key) && value instanceof MedicalSignOrSymptom) { distinguishingSign((MedicalSignOrSymptom)value); continue; }
  ...
  public interface Builder extends ThingBuilder<DDxElement> {
    @NotNull Builder diagnosis(@NotNull MedicalCondition medicalCondition);
    @NotNull Builder diagnosis(@NotNull MedicalCondition.Builder medicalCondition);
    @NotNull Builder distinguishingSign(@NotNull MedicalSignOrSymptom medicalSignOrSymptom);
    @NotNull Builder distinguishingSign(@NotNull MedicalSignOrSymptom.Builder medicalSignOrSymptom);
