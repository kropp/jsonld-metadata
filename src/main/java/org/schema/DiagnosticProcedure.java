...
public class DiagnosticProcedure extends MedicalTest {
  /**
   * Builder for {@see DiagnosticProcedure}
   */
  public static final class Builder {
    public DiagnosticProcedure build() {
      return new DiagnosticProcedure(usedToDiagnose, mainEntityOfPage, usesDevice, alternateName, potentialAction, affectedBy, additionalType, url, medicineSystem, recognizingAuthority, sameAs, study, code, normalRange, name, image, relevantSpecialty, guideline, signDetected, description);
    }
    /**
