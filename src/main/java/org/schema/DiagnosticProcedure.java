...
public class DiagnosticProcedure extends MedicalTest {
  ...
  public static final class Builder {
    ...
    public DiagnosticProcedure build() {
      return new DiagnosticProcedure(recognizingAuthority, code, usesDevice, name, usedToDiagnose, mainEntityOfPage, guideline, additionalType, url, sameAs, affectedBy, normalRange, alternateName, signDetected, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
