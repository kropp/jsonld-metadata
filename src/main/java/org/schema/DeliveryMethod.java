...
public class DeliveryMethod extends Enumeration {
  /**
   * Builder for {@see DeliveryMethod}
   */
  public static final class Builder {
    public DeliveryMethod build() {
      return new DeliveryMethod(mainEntityOfPage, name, image, supersededBy, potentialAction, alternateName, additionalType, url, description, sameAs);
    }
    /**
  ...
  protected DeliveryMethod(CreativeWork mainEntityOfPage, String name, Image image, Property supersededBy, Action potentialAction, String alternateName, String additionalType, String url, String description, String sameAs) {
