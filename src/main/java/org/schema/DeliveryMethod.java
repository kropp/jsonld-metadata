...
public class DeliveryMethod extends Enumeration {
  ...
  public static final class Builder {
    ...
    public DeliveryMethod build() {
      return new DeliveryMethod(sameAs, url, additionalType, alternateName, supersededBy, description, potentialAction, name, mainEntityOfPage);
    }
    /**
  ...
  protected DeliveryMethod(String sameAs, String url, String additionalType, String alternateName, EnumerationOrProperty supersededBy, String description, Action potentialAction, String name, StringOrCreativeWork mainEntityOfPage) {
