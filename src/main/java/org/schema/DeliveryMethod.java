...
public class DeliveryMethod extends Enumeration {
  /**
   * Builder for {@link DeliveryMethod}
   */
  static final class DeliveryMethodThingBuilder implements Builder {
    /**
  ...
  public interface Builder extends ThingBuilder<DeliveryMethod> {
