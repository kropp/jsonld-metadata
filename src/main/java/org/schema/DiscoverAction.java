...
public class DiscoverAction extends FindAction {
  ...
  public static final class Builder {
    ...
    public DiscoverAction build() {
      return new DiscoverAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
