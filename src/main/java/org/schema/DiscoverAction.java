...
public class DiscoverAction extends FindAction {
  /**
   * Builder for {@see DiscoverAction}
   */
  public static final class Builder {
    public DiscoverAction build() {
      return new DiscoverAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
