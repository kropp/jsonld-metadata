...
public class DiscoverAction extends FindAction {
   ...
   */
  static final class DiscoverActionThingBuilder implements Builder {
    /**
     * Creates new {@link DiscoverAction} instance.
     */
    public DiscoverAction build() {
      return new DiscoverAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<DiscoverAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    DiscoverAction discoverAction = (DiscoverAction) o;
