...
public class AddAction extends UpdateAction {
  ...
  public static final class Builder {
    ...
    public AddAction build() {
      return new AddAction(targetCollection, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
