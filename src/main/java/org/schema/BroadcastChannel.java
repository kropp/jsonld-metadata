...
public class BroadcastChannel extends Intangible {
  ...
  /**
   * Builder for {@see BroadcastChannel}
   */
  public static final class Builder {
    public BroadcastChannel build() {
      return new BroadcastChannel(broadcastChannelId, mainEntityOfPage, name, image, providesBroadcastService, alternateName, potentialAction, broadcastServiceTier, url, additionalType, description, inBroadcastLineup, sameAs);
    }
    /**
     * The unique address by which the BroadcastService can be identified in a provider lineup. In US, this is typically a number.
     */
  ...
  protected BroadcastChannel(String broadcastChannelId, CreativeWork mainEntityOfPage, String name, Image image, BroadcastService providesBroadcastService, String alternateName, Action potentialAction, String broadcastServiceTier, String url, String additionalType, String description, CableOrSatelliteService inBroadcastLineup, String sameAs) {
