...
public class MusicEvent extends Event {
   ...
   */
  static final class MusicEventThingBuilder implements Builder {
    /**
     * Creates new {@link MusicEvent} instance.
     */
    public MusicEvent build() {
      return new MusicEvent(aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<MusicEvent> {
  ...
  @Override public boolean equals(Object o) {
    ...
    MusicEvent musicEvent = (MusicEvent) o;
