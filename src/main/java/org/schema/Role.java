...
public class Role extends Intangible {
   ...
   */
  static final class RoleThingBuilder implements Builder {
    /**
  ...
  public interface Builder extends ThingBuilder<Role> {
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myRoleName != null ? myRoleName.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myStartDate != null ? !myStartDate.equals(role.myStartDate) : role.myStartDate != null) return false;
    if (myRoleName != null ? !myRoleName.equals(role.myRoleName) : role.myRoleName != null) return false;
    return true;
  }
