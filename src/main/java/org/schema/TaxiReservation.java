...
public class TaxiReservation extends Reservation {
  ...
  public static final class Builder {
    ...
    public TaxiReservation build() {
      return new TaxiReservation(bookingTime, modifiedTime, reservationStatus, provider, reservationId, totalPrice, priceCurrency, name, underName, reservedTicket, mainEntityOfPage, pickupTime, additionalType, url, sameAs, broker, partySize, programMembershipUsed, reservationFor, alternateName, description, potentialAction, pickupLocation);
    }
    /**
  ...
  protected TaxiReservation(java.util.Date bookingTime, java.util.Date modifiedTime, ReservationStatusType reservationStatus, OrganizationOrPerson provider, String reservationId, PriceSpecificationOrStringOrNumber totalPrice, String priceCurrency, String name, OrganizationOrPerson underName, Ticket reservedTicket, StringOrCreativeWork mainEntityOfPage, java.util.Date pickupTime, String additionalType, String url, String sameAs, OrganizationOrPerson broker, IntegerOrQuantitativeValue partySize, ProgramMembership programMembershipUsed, Thing reservationFor, String alternateName, String description, Action potentialAction, Place pickupLocation) {
