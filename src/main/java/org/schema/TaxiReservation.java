...
public class TaxiReservation extends Reservation {
   ...
   */
  public QuantitativeValueOrInt getPartySize() {
    return myPartySize;
  }
  /**
  ...
  static final class TaxiReservationThingBuilder implements Builder {
     ...
     * Number of people the reservation should accommodate.
     */
    @NotNull public Builder partySize(QuantitativeValue quantitativeValue) {
      if (this.partySize == null) this.partySize = new QuantitativeValueOrInt();
     ...
     * Number of people the reservation should accommodate.
     */
    @NotNull public Builder partySize(QuantitativeValue.Builder quantitativeValue) {
      return this.partySize(quantitativeValue.build());
    }
    /**
     * Number of people the reservation should accommodate.
     */
    @NotNull public Builder partySize(int partySize) {
      if (this.partySize == null) this.partySize = new QuantitativeValueOrInt();
      this.partySize.setInt(partySize);
      return this;
    }
    /**
     * Where a taxi will pick up a passenger or a rental car can be picked up.
     */
    @NotNull public Builder pickupLocation(Place place) {
     ...
     * Where a taxi will pick up a passenger or a rental car can be picked up.
     */
    @NotNull public Builder pickupLocation(Place.Builder place) {
      return this.pickupLocation(place.build());
    }
    /**
     * When a taxi will pickup a passenger or a rental car can be picked up.
     */
    @NotNull public Builder pickupTime(java.util.Date date) {
    ...
    private QuantitativeValueOrInt partySize;
  ...
  public interface Builder extends ThingBuilder<TaxiReservation> {
    @NotNull Builder partySize(QuantitativeValue quantitativeValue);
    @NotNull Builder partySize(QuantitativeValue.Builder quantitativeValue);
    @NotNull Builder partySize(int partySize);
    @NotNull Builder pickupLocation(Place place);
    @NotNull Builder pickupLocation(Place.Builder place);
    @NotNull Builder pickupTime(java.util.Date date);
  ...
  private QuantitativeValueOrInt myPartySize;
