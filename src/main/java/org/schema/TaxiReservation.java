...
public class TaxiReservation extends Reservation {
   ...
   */
  public static final class TaxiReservationThingBuilder implements Builder {
    /**
     ...
     * Number of people the reservation should accommodate.
     */
    public Builder partySize(QuantitativeValue.Builder quantitativeValue) {
     ...
     * Where a taxi will pick up a passenger or a rental car can be picked up.
     */
    public Builder pickupLocation(Place.Builder place) {
  ...
  Builder partySize(Integer integer);
  Builder partySize(QuantitativeValue quantitativeValue);
  Builder partySize(QuantitativeValue.Builder quantitativeValue);
  Builder pickupLocation(Place place);
  Builder pickupLocation(Place.Builder place);
  Builder pickupTime(java.util.Date date);
