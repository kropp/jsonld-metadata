...
public class TaxiReservation extends Reservation {
  ...
  /**
   * Builder for {@see TaxiReservation}
   */
  public static final class Builder {
    public TaxiReservation build() {
      return new TaxiReservation(reservedTicket, mainEntityOfPage, priceCurrency, reservationStatus, alternateName, potentialAction, partySize, url, additionalType, modifiedTime, sameAs, bookingTime, underName, pickupLocation, image, name, reservationFor, reservationId, pickupTime, broker, totalPrice, programMembershipUsed, description, provider);
    }
    /**
     ...
     * Number of people the reservation should accommodate.
     */
    public Builder partySize(Integer value) {
      partySize = value;
      return this;
    }
    /**
  ...
  protected TaxiReservation(Ticket reservedTicket, CreativeWork mainEntityOfPage, String priceCurrency, ReservationStatusType reservationStatus, String alternateName, Action potentialAction, Integer partySize, String url, String additionalType, java.util.Date modifiedTime, String sameAs, java.util.Date bookingTime, Person underName, Place pickupLocation, Image image, String name, Thing reservationFor, String reservationId, java.util.Date pickupTime, Person broker, Number totalPrice, ProgramMembership programMembershipUsed, String description, Person provider) {
