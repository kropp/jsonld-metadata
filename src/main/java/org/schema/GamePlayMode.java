...
public class GamePlayMode extends Enumeration {
  ...
  public static final class Builder {
    ...
    public GamePlayMode build() {
      return new GamePlayMode(supersededBy, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
  ...
  protected GamePlayMode(EnumerationOrProperty supersededBy, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction) {
