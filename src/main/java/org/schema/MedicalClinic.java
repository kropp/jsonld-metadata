...
public class MedicalClinic extends MedicalOrganization {
  ...
  public static final class Builder {
    ...
    public MedicalClinic build() {
      return new MedicalClinic(aggregateRating, review, logo, parentOrganization, sameAs, additionalType, event, containedIn, priceRange, openingHoursSpecification, currenciesAccepted, availableService, potentialAction, address, additionalProperty, openingHours, globalLocationNumber, isicV4, name, paymentAccepted, mainEntityOfPage, hasMap, url, faxNumber, alternateName, telephone, geo, medicalSpecialty, description, photo);
    }
    /**
