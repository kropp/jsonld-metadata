...
public class MedicalClinic extends MedicalOrganization {
  ...
  /**
   * Builder for {@see MedicalClinic}
   */
  public static final class Builder {
    public MedicalClinic build() {
      return new MedicalClinic(openingHoursSpecification, review, availableService, openingHours, potentialAction, additionalType, logo, parentOrganization, currenciesAccepted, image, containedIn, description, hasMap, event, faxNumber, mainEntityOfPage, globalLocationNumber, priceRange, telephone, alternateName, photo, url, geo, aggregateRating, sameAs, name, paymentAccepted, address, medicalSpecialty, additionalProperty, isicV4);
    }
    /**
