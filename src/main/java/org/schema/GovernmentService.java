...
public class GovernmentService extends Service {
  ...
  public Organization getServiceOperator() {
    return myServiceOperator;
  }
  /**
   * Builder for {@see GovernmentService}
   */
  public static final class Builder {
    public GovernmentService build() {
      return new GovernmentService(review, availableChannel, mainEntityOfPage, alternateName, potentialAction, serviceOperator, url, additionalType, serviceArea, sameAs, aggregateRating, serviceOutput, name, image, serviceType, description, provider);
    }
    /**
     ...
     * The operating organization, if different from the provider.  This enables the representation of services that are provided by an organization, but operated by another organization like a subcontractor.
     */
    public Builder serviceOperator(Organization value) {
  ...
  protected GovernmentService(Review review, ServiceChannel availableChannel, CreativeWork mainEntityOfPage, String alternateName, Action potentialAction, Organization serviceOperator, String url, String additionalType, AdministrativeArea serviceArea, String sameAs, AggregateRating aggregateRating, Thing serviceOutput, String name, Image image, String serviceType, String description, Person provider) {
