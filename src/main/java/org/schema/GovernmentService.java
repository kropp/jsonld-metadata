...
public class GovernmentService extends Service {
   ...
   */
  static final class GovernmentServiceThingBuilder implements Builder {
    /**
     ...
     * The operating organization, if different from the provider.  This enables the representation of services that are provided by an organization, but operated by another organization like a subcontractor.
     */
    @NotNull public Builder serviceOperator(Organization organization) {
     ...
     * The operating organization, if different from the provider.  This enables the representation of services that are provided by an organization, but operated by another organization like a subcontractor.
     */
    @NotNull public Builder serviceOperator(Organization.Builder organization) {
  ...
  public interface Builder extends ThingBuilder<GovernmentService> {
    @NotNull Builder serviceOperator(Organization organization);
    @NotNull Builder serviceOperator(Organization.Builder organization);
