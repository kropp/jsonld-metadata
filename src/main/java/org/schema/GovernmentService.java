...
public class GovernmentService extends Service {
   ...
   */
  public static final class GovernmentServiceThingBuilder implements Builder {
    /**
     ...
     * The operating organization, if different from the provider.  This enables the representation of services that are provided by an organization, but operated by another organization like a subcontractor.
     */
    public Builder serviceOperator(Organization organization) {
     ...
     * The operating organization, if different from the provider.  This enables the representation of services that are provided by an organization, but operated by another organization like a subcontractor.
     */
    public Builder serviceOperator(Organization.Builder organization) {
  ...
  Builder serviceOperator(Organization organization);
  Builder serviceOperator(Organization.Builder organization);
