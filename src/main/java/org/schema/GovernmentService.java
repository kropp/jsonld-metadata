...
public class GovernmentService extends Service {
  ...
  public static final class Builder {
    ...
    public GovernmentService build() {
      return new GovernmentService(aggregateRating, serviceType, provider, review, name, serviceOperator, serviceOutput, mainEntityOfPage, availableChannel, additionalType, url, sameAs, alternateName, serviceArea, description, potentialAction);
    }
    /**
  ...
  protected GovernmentService(AggregateRating aggregateRating, String serviceType, OrganizationOrPerson provider, Review review, String name, Organization serviceOperator, Thing serviceOutput, StringOrCreativeWork mainEntityOfPage, ServiceChannel availableChannel, String additionalType, String url, String sameAs, String alternateName, AdministrativeArea serviceArea, String description, Action potentialAction) {
