...
public class Canal extends BodyOfWater {
  ...
  public static final class Builder {
    /**
     * Creates new {@link Canal} instance.
     */
    public Canal build() {
      return new Canal(aggregateRating, review, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, url, event, containedIn, additionalType, sameAs, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
