...
public class Canal extends BodyOfWater {
  /**
   * Builder for {@see Canal}
   */
  public static final class Builder {
    public Canal build() {
      return new Canal(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, additionalType, url, geo, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
