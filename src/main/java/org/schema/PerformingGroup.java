...
public class PerformingGroup extends Organization {
   ...
   */
  static final class PerformingGroupThingBuilder implements Builder {
    /**
     * Creates new {@link PerformingGroup} instance.
     */
    public PerformingGroup build() {
      return new PerformingGroup(address, aggregateRating, award, brand, contactPoint, department, duns, email, employee, event, faxNumber, founder, dissolutionDate, foundingDate, globalLocationNumber, hasPOS, isicV4, legalName, logo, makesOffer, member, memberOf, naics, numberOfEmployees, owns, review, seeks, subOrganization, taxID, telephone, vatID, foundingLocation, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<PerformingGroup> {
  ...
  @Override public boolean equals(Object o) {
    ...
    PerformingGroup performingGroup = (PerformingGroup) o;
