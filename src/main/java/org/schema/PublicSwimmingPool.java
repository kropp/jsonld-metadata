...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  protected PublicSwimmingPool(OpeningHoursSpecification openingHoursSpecification, Review review, String openingHours, Action potentialAction, String additionalType, ImageObject logo, Organization parentOrganization, String currenciesAccepted, Image image, Place containedIn, String description, String hasMap, Event event, String faxNumber, CreativeWork mainEntityOfPage, String globalLocationNumber, String priceRange, String telephone, String alternateName, ImageObject photo, String url, GeoCoordinates geo, String sameAs, AggregateRating aggregateRating, String name, String paymentAccepted, PostalAddress address, PropertyValue additionalProperty, String isicV4) {
