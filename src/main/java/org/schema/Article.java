...
public class Article extends CreativeWork {
   ...
   */
  public StringOrInt getPageEnd() {
    return myPageEnd;
  }
  /**
   * The page on which the work starts; for example "135" or "xiii".
   */
  public StringOrInt getPageStart() {
    return myPageStart;
  }
  /**
  ...
  public interface Builder extends ThingBuilder<Article> {
  ...
  private StringOrInt myPageEnd;
  private StringOrInt myPageStart;
