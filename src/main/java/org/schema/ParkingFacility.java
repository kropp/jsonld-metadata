...
public class ParkingFacility extends CivicStructure {
  /**
   * Builder for {@see ParkingFacility}
   */
  public static final class Builder {
    public ParkingFacility build() {
      return new ParkingFacility(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
