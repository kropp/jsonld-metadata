...
public class TVEpisode extends Episode {
  ...
  static final class TVEpisodeThingBuilder implements Builder {
     ...
     * Languages in which subtitles/captions are available, in <a href='http://tools.ietf.org/html/bcp47'>IETF BCP 47 standard format.</a>
     */
    @NotNull public Builder subtitleLanguage(Language language) {
     ...
     * Languages in which subtitles/captions are available, in <a href='http://tools.ietf.org/html/bcp47'>IETF BCP 47 standard format.</a>
     */
    @NotNull public Builder subtitleLanguage(Language.Builder language) {
      return this.subtitleLanguage(language.build());
    }
    /**
     * Languages in which subtitles/captions are available, in <a href='http://tools.ietf.org/html/bcp47'>IETF BCP 47 standard format.</a>
     */
    @NotNull public Builder subtitleLanguage(String subtitleLanguage) {
      if (this.subtitleLanguage == null) this.subtitleLanguage = new LanguageOrString();
     ...
     */
    @NotNull public Builder episodeNumber(String episodeNumber) {
      if (this.episodeNumber == null) this.episodeNumber = new StringOrInt();
     ...
     * Position of the episode within an ordered group of episodes.
     */
    @NotNull public Builder episodeNumber(int episodeNumber) {
      if (this.episodeNumber == null) this.episodeNumber = new StringOrInt();
      this.episodeNumber.setInt(episodeNumber);
      return this;
    }
    /**
     ...
     */
    @NotNull public Builder partOfSeason(IsPartOf isPartOf) {
     ...
     */
    @NotNull public Builder partOfSeries(IsPartOf isPartOf) {
    ...
    private StringOrInt episodeNumber;
  ...
  public interface Builder extends ThingBuilder<TVEpisode> {
    @NotNull Builder subtitleLanguage(Language language);
    @NotNull Builder subtitleLanguage(Language.Builder language);
    @NotNull Builder subtitleLanguage(String subtitleLanguage);
    ...
    @NotNull Builder episodeNumber(String episodeNumber);
    @NotNull Builder episodeNumber(int episodeNumber);
    ...
    @NotNull Builder partOfSeason(IsPartOf isPartOf);
    @NotNull Builder partOfSeries(IsPartOf isPartOf);
