...
public class TVEpisode extends Episode {
  ...
  public static final class Builder {
    ...
    public TVEpisode build() {
      return new TVEpisode(accessibilityAPI, aggregateRating, hasPart, review, subtitleLanguage, datePublished, schemaVersion, comment, video, award, editor, director, workExample, potentialAction, producer, publisher, partOfSeries, sourceOrganization, genre, learningResourceType, publishingPrinciples, translator, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, about, contentLocation, musicBy, accessibilityHazard, author, version, accountablePerson, additionalType, sameAs, thumbnailUrl, publication, actor, encoding, timeRequired, episodeNumber, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, trailer, mainEntity, alternativeHeadline, name, license, mainEntityOfPage, discussionUrl, copyrightYear, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, partOfSeason, productionCompany, creator, contributor);
    }
    /**
     ...
     */
    public Builder episodeNumber(Integer integer) {
  ...
  protected TVEpisode(String accessibilityAPI, AggregateRating aggregateRating, HasPart hasPart, Review review, LanguageOrString subtitleLanguage, java.util.Date datePublished, String schemaVersion, Comment comment, VideoObject video, String award, Person editor, Person director, CreativeWork workExample, Action potentialAction, OrganizationOrPerson producer, Organization publisher, IsPartOf partOfSeries, Organization sourceOrganization, String genre, String learningResourceType, String publishingPrinciples, OrganizationOrPerson translator, Event recordedAt, Integer commentCount, LanguageOrString inLanguage, java.util.Date dateModified, Thing mentions, Audience audience, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, String contentRating, String description, Offer offers, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, String educationalUse, String keywords, AlignmentObject educationalAlignment, String text, Thing about, Place contentLocation, MusicGroupOrPerson musicBy, String accessibilityHazard, OrganizationOrPerson author, Number version, Person accountablePerson, String additionalType, String sameAs, String thumbnailUrl, PublicationEvent publication, Person actor, MediaObject encoding, Duration timeRequired, IntegerOrString episodeNumber, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, VideoObject trailer, Thing mainEntity, String alternativeHeadline, String name, StringOrCreativeWork license, StringOrCreativeWork mainEntityOfPage, String discussionUrl, Number copyrightYear, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, String alternateName, PublicationEvent releasedEvent, IsPartOf partOfSeason, Organization productionCompany, OrganizationOrPerson creator, OrganizationOrPerson contributor) {
    super(accessibilityAPI, aggregateRating, hasPart, review, datePublished, schemaVersion, comment, video, award, editor, workExample, director, potentialAction, producer, publisher, sourceOrganization, partOfSeries, learningResourceType, genre, translator, publishingPrinciples, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, about, contentLocation, musicBy, accessibilityHazard, author, version, accountablePerson, sameAs, additionalType, thumbnailUrl, publication, actor, encoding, timeRequired, episodeNumber, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, trailer, alternativeHeadline, mainEntity, name, license, copyrightYear, discussionUrl, mainEntityOfPage, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, partOfSeason, productionCompany, contributor, creator);
