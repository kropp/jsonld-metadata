...
public class TVEpisode extends Episode {
  ...
  /**
   * Builder for {@see TVEpisode}
   */
  public static final class Builder {
    public TVEpisode build() {
      return new TVEpisode(editor, review, producer, timeRequired, creator, offers, educationalUse, alternativeHeadline, mentions, additionalType, position, associatedMedia, isFamilyFriendly, image, accessibilityControl, keywords, discussionUrl, isBasedOnUrl, exampleOfWork, trailer, comment, subtitleLanguage, episodeNumber, datePublished, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, musicBy, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, actor, genre, partOfSeries, potentialAction, audience, director, contentRating, partOfSeason, inLanguage, contentLocation, learningResourceType, audio, accountablePerson, dateModified, thumbnailUrl, releasedEvent, productionCompany, accessibilityHazard, accessibilityFeature, license, description, provider, publication, recordedAt, educationalAlignment, mainEntityOfPage, contributor, workExample, isPartOf, dateCreated, copyrightHolder, sameAs, aggregateRating, name, typicalAgeRange, translator, copyrightYear, citation, sourceOrganization, text, award);
    }
    /**
     ...
     * Languages in which subtitles/captions are available, in <a href='http://tools.ietf.org/html/bcp47'>IETF BCP 47 standard format.</a>
     */
    public Builder subtitleLanguage(String value) {
     ...
     */
    public Builder episodeNumber(Integer value) {
      episodeNumber = value;
      return this;
    }
    /**
     ...
     */
    public Builder partOfSeason(IsPartOf value) {
      partOfSeason = value;
      return this;
    }
    /**
  ...
  protected TVEpisode(Person editor, Review review, Person producer, Duration timeRequired, Organization creator, Offer offers, String educationalUse, String alternativeHeadline, Thing mentions, String additionalType, Position position, MediaObject associatedMedia, Boolean isFamilyFriendly, Image image, String accessibilityControl, String keywords, String discussionUrl, String isBasedOnUrl, CreativeWork exampleOfWork, VideoObject trailer, Comment comment, String subtitleLanguage, Integer episodeNumber, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, Person character, String schemaVersion, String accessibilityAPI, MusicGroup musicBy, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, Person actor, String genre, IsPartOf partOfSeries, Action potentialAction, Audience audience, Person director, String contentRating, IsPartOf partOfSeason, String inLanguage, Place contentLocation, String learningResourceType, AudioObject audio, Person accountablePerson, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, Organization productionCompany, String accessibilityHazard, String accessibilityFeature, CreativeWork license, String description, Person provider, PublicationEvent publication, Event recordedAt, AlignmentObject educationalAlignment, CreativeWork mainEntityOfPage, Organization contributor, CreativeWork workExample, IsPartOf isPartOf, java.util.Date dateCreated, Organization copyrightHolder, String sameAs, AggregateRating aggregateRating, String name, String typicalAgeRange, Person translator, Number copyrightYear, CreativeWork citation, Organization sourceOrganization, String text, String award) {
    super(review, producer, editor, timeRequired, creator, offers, educationalUse, alternativeHeadline, mentions, additionalType, position, associatedMedia, isFamilyFriendly, accessibilityControl, image, keywords, discussionUrl, trailer, exampleOfWork, isBasedOnUrl, comment, episodeNumber, datePublished, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, musicBy, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, actor, genre, partOfSeries, potentialAction, audience, director, contentRating, partOfSeason, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, releasedEvent, accessibilityFeature, accessibilityHazard, productionCompany, license, description, publication, provider, educationalAlignment, recordedAt, mainEntityOfPage, contributor, isPartOf, workExample, dateCreated, copyrightHolder, aggregateRating, sameAs, name, typicalAgeRange, citation, copyrightYear, translator, sourceOrganization, text, award);
    mySubtitleLanguage = subtitleLanguage;
  }
  private String mySubtitleLanguage;
}
