...
public class TVEpisode extends Episode {
   ...
   */
  public static final class TVEpisodeThingBuilder implements Builder {
    /**
     ...
     * Languages in which subtitles/captions are available, in <a href='http://tools.ietf.org/html/bcp47'>IETF BCP 47 standard format.</a>
     */
    public Builder subtitleLanguage(Language.Builder language) {
  ...
  Builder subtitleLanguage(Language language);
  Builder subtitleLanguage(Language.Builder language);
  Builder subtitleLanguage(String subtitleLanguage);
  ...
  Builder episodeNumber(Integer integer);
  Builder episodeNumber(String episodeNumber);
  ...
  Builder partOfSeason(IsPartOf isPartOf);
  Builder partOfSeries(IsPartOf isPartOf);
