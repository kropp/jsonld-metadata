...
public class TVEpisode extends Episode {
  ...
  static final class TVEpisodeThingBuilder implements Builder {
    ...
    @NotNull public Builder subtitleLanguage(@NotNull Language.Builder language) {
      return this.subtitleLanguage(language.build());
    }
    /**
     * Languages in which subtitles/captions are available, in <a href='http://tools.ietf.org/html/bcp47'>IETF BCP 47 standard format.</a>
     */
    ...
    @NotNull public Builder episodeNumber(@NotNull Integer integer) {
      if (this.episodeNumber == null) this.episodeNumber = new IntegerOrString();
      this.episodeNumber.setInteger(integer);
      return this;
    }
    /**
     * Position of the episode within an ordered group of episodes.
    ...
    @NotNull public Builder episodeNumber(@NotNull String episodeNumber) {
      if (this.episodeNumber == null) this.episodeNumber = new IntegerOrString();
      this.episodeNumber.setString(episodeNumber);
      return this;
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("subtitleLanguage".equals(key) && value instanceof Language) { subtitleLanguage((Language)value); continue; }
        if ("subtitleLanguage".equals(key) && value instanceof String) { subtitleLanguage((String)value); continue; }
        ...
        if ("episodeNumber".equals(key) && value instanceof Integer) { episodeNumber((Integer)value); continue; }
        if ("episodeNumber".equals(key) && value instanceof String) { episodeNumber((String)value); continue; }
        ...
        if ("partOfSeason".equals(key) && value instanceof IsPartOf) { partOfSeason((IsPartOf)value); continue; }
        if ("partOfSeries".equals(key) && value instanceof IsPartOf) { partOfSeries((IsPartOf)value); continue; }
    ...
    private IntegerOrString episodeNumber;
  ...
  public interface Builder extends ThingBuilder<TVEpisode> {
    @NotNull Builder subtitleLanguage(@NotNull Language language);
    @NotNull Builder subtitleLanguage(@NotNull Language.Builder language);
    @NotNull Builder subtitleLanguage(@NotNull String subtitleLanguage);
    ...
    @NotNull Builder episodeNumber(@NotNull Integer integer);
    @NotNull Builder episodeNumber(@NotNull String episodeNumber);
    ...
    @NotNull Builder partOfSeason(@NotNull IsPartOf isPartOf);
    @NotNull Builder partOfSeries(@NotNull IsPartOf isPartOf);
  ...
  @Override public boolean equals(Object o) {
    ...
    if (mySubtitleLanguage != null ? !mySubtitleLanguage.equals(tVEpisode.mySubtitleLanguage) : tVEpisode.mySubtitleLanguage != null) return false;
    return true;
  }
