...
public class TVSeries extends CreativeWorkSeries {
  ...
  protected TVSeries(String accessibilityAPI, AggregateRating aggregateRating, HasPart hasPart, Review review, java.util.Date datePublished, String schemaVersion, Comment comment, VideoObject video, String award, Person editor, CreativeWork workExample, Person director, Action potentialAction, java.util.Date startDate, OrganizationOrPerson producer, Organization publisher, Organization sourceOrganization, String genre, String learningResourceType, String publishingPrinciples, OrganizationOrPerson translator, Event recordedAt, LanguageOrString inLanguage, Integer commentCount, java.util.Date dateModified, Thing mentions, Audience audience, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, String contentRating, HasPart containsSeason, String description, Offer offers, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, String educationalUse, String keywords, AlignmentObject educationalAlignment, String text, java.util.Date endDate, Thing about, Integer numberOfEpisodes, Place contentLocation, MusicGroupOrPerson musicBy, String accessibilityHazard, OrganizationOrPerson author, Number version, Person accountablePerson, String additionalType, String sameAs, String thumbnailUrl, PublicationEvent publication, Person actor, MediaObject encoding, Duration timeRequired, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, VideoObject trailer, Thing mainEntity, String alternativeHeadline, String name, StringOrCreativeWork license, StringOrCreativeWork mainEntityOfPage, String discussionUrl, Number copyrightYear, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, HasPart episode, String alternateName, PublicationEvent releasedEvent, Integer numberOfSeasons, Organization productionCompany, OrganizationOrPerson creator, OrganizationOrPerson contributor) {
