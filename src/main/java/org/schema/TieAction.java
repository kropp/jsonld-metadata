...
public class TieAction extends AchieveAction {
  /**
   * Builder for {@see TieAction}
   */
  public static final class Builder {
    public TieAction build() {
      return new TieAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
