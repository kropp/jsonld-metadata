...
public class TieAction extends AchieveAction {
  ...
  public static final class Builder {
    ...
    public TieAction build() {
      return new TieAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
