...
public class WriteAction extends CreateAction {
  ...
  public static final class Builder {
    ...
    public WriteAction build() {
      return new WriteAction(startTime, inLanguage, name, error, mainEntityOfPage, sameAs, additionalType, url, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
