...
public class RecommendedDoseSchedule extends DoseSchedule {
  /**
   * Builder for {@see RecommendedDoseSchedule}
   */
  public static final class Builder {
    public RecommendedDoseSchedule build() {
      return new RecommendedDoseSchedule(frequency, mainEntityOfPage, alternateName, potentialAction, additionalType, url, medicineSystem, sameAs, recognizingAuthority, code, study, doseValue, name, image, relevantSpecialty, targetPopulation, guideline, doseUnit, description);
    }
    /**
