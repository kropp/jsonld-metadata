...
public class FlightReservation extends Reservation {
  ...
  /**
   * Builder for {@see FlightReservation}
   */
  public static final class Builder {
    public FlightReservation build() {
      return new FlightReservation(reservedTicket, mainEntityOfPage, priceCurrency, reservationStatus, alternateName, potentialAction, url, additionalType, modifiedTime, sameAs, securityScreening, bookingTime, underName, image, name, passengerSequenceNumber, boardingGroup, reservationFor, reservationId, broker, passengerPriorityStatus, totalPrice, programMembershipUsed, description, provider);
    }
    /**
     ...
     * The type of security screening the passenger is subject to.
     */
    public Builder securityScreening(String value) {
     ...
     * The passenger's sequence number as assigned by the airline.
     */
    public Builder passengerSequenceNumber(String value) {
      passengerSequenceNumber = value;
      return this;
    }
    /**
     * The airline-specific indicator of boarding order / preference.
     */
    public Builder boardingGroup(String value) {
      boardingGroup = value;
      return this;
    }
    /**
     ...
     * The priority status assigned to a passenger for security or boarding (e.g. FastTrack or Priority).
     */
    public Builder passengerPriorityStatus(String value) {
      passengerPriorityStatus = value;
      return this;
    }
    /**
  ...
  protected FlightReservation(Ticket reservedTicket, CreativeWork mainEntityOfPage, String priceCurrency, ReservationStatusType reservationStatus, String alternateName, Action potentialAction, String url, String additionalType, java.util.Date modifiedTime, String sameAs, String securityScreening, java.util.Date bookingTime, Person underName, Image image, String name, String passengerSequenceNumber, String boardingGroup, Thing reservationFor, String reservationId, Person broker, String passengerPriorityStatus, Number totalPrice, ProgramMembership programMembershipUsed, String description, Person provider) {
  ...
  private String myPassengerPriorityStatus;
}
