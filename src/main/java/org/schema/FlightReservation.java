...
public class FlightReservation extends Reservation {
  ...
  static final class FlightReservationThingBuilder implements Builder {
     ...
     * The airline-specific indicator of boarding order / preference.
     */
    @NotNull public Builder boardingGroup(String boardingGroup) {
     ...
     * The passenger's sequence number as assigned by the airline.
     */
    @NotNull public Builder passengerSequenceNumber(String passengerSequenceNumber) {
     ...
     * The type of security screening the passenger is subject to.
     */
    @NotNull public Builder securityScreening(String securityScreening) {
     ...
     * The priority status assigned to a passenger for security or boarding (e.g. FastTrack or Priority).
     */
    @NotNull public Builder passengerPriorityStatus(QualitativeValue qualitativeValue) {
     ...
     * The priority status assigned to a passenger for security or boarding (e.g. FastTrack or Priority).
     */
    @NotNull public Builder passengerPriorityStatus(QualitativeValue.Builder qualitativeValue) {
      return this.passengerPriorityStatus(qualitativeValue.build());
    }
    /**
     * The priority status assigned to a passenger for security or boarding (e.g. FastTrack or Priority).
     */
    @NotNull public Builder passengerPriorityStatus(String passengerPriorityStatus) {
      if (this.passengerPriorityStatus == null) this.passengerPriorityStatus = new QualitativeValueOrString();
  ...
  public interface Builder extends ThingBuilder<FlightReservation> {
    @NotNull Builder boardingGroup(String boardingGroup);
    @NotNull Builder passengerSequenceNumber(String passengerSequenceNumber);
    @NotNull Builder securityScreening(String securityScreening);
    @NotNull Builder passengerPriorityStatus(QualitativeValue qualitativeValue);
    @NotNull Builder passengerPriorityStatus(QualitativeValue.Builder qualitativeValue);
    @NotNull Builder passengerPriorityStatus(String passengerPriorityStatus);
