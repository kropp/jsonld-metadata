...
public class Reservation extends Intangible {
   ...
   */
  public PriceSpecificationOrStringOrNumber getTotalPrice() {
    return myTotalPrice;
  }
  /**
  ...
  public static final class Builder {
    ...
    public Reservation build() {
      return new Reservation(bookingTime, reservationStatus, modifiedTime, provider, reservationId, totalPrice, priceCurrency, name, underName, mainEntityOfPage, reservedTicket, sameAs, url, additionalType, broker, reservationFor, programMembershipUsed, alternateName, potentialAction, description);
    }
    /**
     * The date and time the reservation was booked.
     */
  ...
  protected Reservation(java.util.Date bookingTime, ReservationStatusType reservationStatus, java.util.Date modifiedTime, OrganizationOrPerson provider, String reservationId, PriceSpecificationOrStringOrNumber totalPrice, String priceCurrency, String name, OrganizationOrPerson underName, StringOrCreativeWork mainEntityOfPage, Ticket reservedTicket, String sameAs, String url, String additionalType, OrganizationOrPerson broker, Thing reservationFor, ProgramMembership programMembershipUsed, String alternateName, Action potentialAction, String description) {
  ...
  private PriceSpecificationOrStringOrNumber myTotalPrice;
