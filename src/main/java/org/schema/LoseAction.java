...
public class LoseAction extends AchieveAction {
   ...
   */
  static final class LoseActionThingBuilder implements Builder {
    /**
     * Creates new {@link LoseAction} instance.
     */
    public LoseAction build() {
      return new LoseAction(winner, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of participant. The winner of the action.
     */
    ...
    @NotNull public Builder winner(@NotNull Person.Builder person) {
      return this.winner(person.build());
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("winner".equals(key) && value instanceof Person) { winner((Person)value); continue; }
  ...
  public interface Builder extends ThingBuilder<LoseAction> {
    @NotNull Builder winner(@NotNull Person person);
    @NotNull Builder winner(@NotNull Person.Builder person);
  ...
  protected LoseAction(Person winner, OrganizationOrPerson agent, java.util.Date endTime, java.util.Date startTime, ActionStatusType actionStatus, Thing error, EntryPoint target, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myWinner != null ? myWinner.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    LoseAction loseAction = (LoseAction) o;
    if (!super.equals(o)) return false;
    if (myWinner != null ? !myWinner.equals(loseAction.myWinner) : loseAction.myWinner != null) return false;
    return true;
  }

  private Person myWinner;
}
