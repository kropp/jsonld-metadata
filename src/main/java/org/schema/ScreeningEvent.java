...
public class ScreeningEvent extends Event {
   ...
   */
  static final class ScreeningEventThingBuilder implements Builder {
    /**
     * Creates new {@link ScreeningEvent} instance.
     */
    public ScreeningEvent build() {
      return new ScreeningEvent(videoFormat, subtitleLanguage, workPresented, aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * The type of screening or video broadcast used (e.g. IMAX, 3D, SD, HD, etc.).
     */
    ...
    @NotNull public Builder workPresented(@NotNull Movie.Builder movie) {
      return this.workPresented(movie.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("videoFormat".equals(key) && value instanceof String) { videoFormat((String)value); continue; }
        ...
        if ("workPresented".equals(key) && value instanceof Movie) { workPresented((Movie)value); continue; }
  ...
  public interface Builder extends ThingBuilder<ScreeningEvent> {
    @NotNull Builder videoFormat(@NotNull String videoFormat);
    ...
    @NotNull Builder workPresented(@NotNull Movie movie);
    @NotNull Builder workPresented(@NotNull Movie.Builder movie);
