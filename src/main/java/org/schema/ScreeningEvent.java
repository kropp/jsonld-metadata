...
public class ScreeningEvent extends Event {
  ...
  static final class ScreeningEventThingBuilder implements Builder {
     ...
     * The type of screening or video broadcast used (e.g. IMAX, 3D, SD, HD, etc.).
     */
    @NotNull public Builder videoFormat(String videoFormat) {
     ...
     * The movie presented during this event.
     */
    @NotNull public Builder workPresented(Movie movie) {
     ...
     * The movie presented during this event.
     */
    @NotNull public Builder workPresented(Movie.Builder movie) {
  ...
  public interface Builder extends ThingBuilder<ScreeningEvent> {
    @NotNull Builder videoFormat(String videoFormat);
    ...
    @NotNull Builder workPresented(Movie movie);
    @NotNull Builder workPresented(Movie.Builder movie);
