...
public class ScreeningEvent extends Event {
  ...
  /**
   * Builder for {@see ScreeningEvent}
   */
  public static final class Builder {
    public ScreeningEvent build() {
      return new ScreeningEvent(videoFormat, performer, review, offers, endDate, potentialAction, duration, additionalType, inLanguage, image, workPresented, workPerformed, attendee, previousStartDate, description, subtitleLanguage, mainEntityOfPage, organizer, doorTime, alternateName, eventStatus, url, superEvent, aggregateRating, sameAs, startDate, name, subEvent, recordedIn, typicalAgeRange, location);
    }
    /**
     * The type of screening or video broadcast used (e.g. IMAX, 3D, SD, HD, etc.).
     */
    public Builder videoFormat(String value) {
      videoFormat = value;
      return this;
    }
    /**
     ...
     * The movie presented during this event.
     */
    public Builder workPresented(Movie value) {
      workPresented = value;
      return this;
    }
    /**
  ...
  protected ScreeningEvent(String videoFormat, Organization performer, Review review, Offer offers, java.util.Date endDate, Action potentialAction, Duration duration, String additionalType, String inLanguage, Image image, Movie workPresented, CreativeWork workPerformed, Organization attendee, java.util.Date previousStartDate, String description, String subtitleLanguage, CreativeWork mainEntityOfPage, Person organizer, java.util.Date doorTime, String alternateName, EventStatusType eventStatus, String url, Event superEvent, AggregateRating aggregateRating, String sameAs, java.util.Date startDate, String name, Event subEvent, CreativeWork recordedIn, String typicalAgeRange, Location location) {
