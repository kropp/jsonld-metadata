...
public class ScreeningEvent extends Event {
   ...
   */
  public String getVideoFormat() { return myVideoFormat; }
  /**
   ...
   */
  public Movie getWorkPresented() { return myWorkPresented; }
   ...
   */
  public static class Builder implements ThingBuilder<ScreeningEvent> {
