...
public class ScreeningEvent extends Event {
   ...
   */
  public static final class ScreeningEventThingBuilder implements Builder {
    /**
     ...
     * The movie presented during this event.
     */
    public Builder workPresented(Movie.Builder movie) {
  ...
  Builder workPresented(Movie movie);
  Builder workPresented(Movie.Builder movie);
