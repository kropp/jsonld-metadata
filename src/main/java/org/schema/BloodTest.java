...
/**
 * A medical test performed on a sample of a patient's blood.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class BloodTest extends MedicalTest {
   ...
   */
  public static class Builder implements ThingBuilder<BloodTest> {
