...
public class RadioClip extends Clip {
  ...
  static final class RadioClipThingBuilder implements Builder {
     ...
     */
    @NotNull public Builder clipNumber(Position position) {
     ...
     */
    @NotNull public Builder partOfEpisode(IsPartOf isPartOf) {
  ...
  public interface Builder extends ThingBuilder<RadioClip> {
    ...
    @NotNull Builder clipNumber(Position position);
    ...
    @NotNull Builder partOfEpisode(IsPartOf isPartOf);
