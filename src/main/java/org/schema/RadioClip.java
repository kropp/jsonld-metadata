...
public class RadioClip extends Clip {
  ...
  static final class RadioClipThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("clipNumber".equals(key) && value instanceof Position) { clipNumber((Position)value); continue; }
        ...
        if ("partOfEpisode".equals(key) && value instanceof IsPartOf) { partOfEpisode((IsPartOf)value); continue; }
  ...
  public interface Builder extends ThingBuilder<RadioClip> {
    @NotNull Builder actor(@NotNull Person person);
    @NotNull Builder actor(@NotNull Person.Builder person);
    @NotNull Builder clipNumber(@NotNull Position position);
    ...
    @NotNull Builder partOfEpisode(@NotNull IsPartOf isPartOf);
  ...
  @Override public boolean equals(Object o) {
    ...
    RadioClip radioClip = (RadioClip) o;
