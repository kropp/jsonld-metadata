...
public class WPSideBar extends WebPageElement {
  ...
  public interface Builder extends ThingBuilder<WPSideBar> {
  ...
  @Override public boolean equals(Object o) {
    ...
    WPSideBar wPSideBar = (WPSideBar) o;
