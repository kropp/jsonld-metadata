...
public class PaymentChargeSpecification extends PriceSpecification {
  ...
  static final class PaymentChargeSpecificationThingBuilder implements Builder {
     ...
     * The payment method(s) to which the payment charge specification applies.
     */
    @NotNull public Builder appliesToPaymentMethod(PaymentMethod paymentMethod) {
...
<li>
  ...
  public interface Builder extends ThingBuilder<PaymentChargeSpecification> {
    ...
    @NotNull Builder appliesToPaymentMethod(PaymentMethod paymentMethod);
    @NotNull Builder appliesToPaymentMethod(PaymentMethod.Builder paymentMethod);
