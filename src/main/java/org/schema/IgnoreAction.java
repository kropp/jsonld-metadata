...
public class IgnoreAction extends AssessAction {
  /**
   * Builder for {@see IgnoreAction}
   */
  public static final class Builder {
    public IgnoreAction build() {
      return new IgnoreAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
