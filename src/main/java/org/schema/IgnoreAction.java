...
public class IgnoreAction extends AssessAction {
  ...
  public static final class Builder {
    ...
    public IgnoreAction build() {
      return new IgnoreAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
