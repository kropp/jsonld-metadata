...
public class MusicVenue extends CivicStructure {
  /**
   * Builder for {@see MusicVenue}
   */
  public static final class Builder {
    public MusicVenue build() {
      return new MusicVenue(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
