...
public class MusicRelease extends MusicPlaylist {
  ...
  /**
   * Builder for {@see MusicRelease}
   */
  public static final class Builder {
    public MusicRelease build() {
      return new MusicRelease(editor, producer, review, timeRequired, offers, creator, educationalUse, alternativeHeadline, mentions, duration, additionalType, position, associatedMedia, isFamilyFriendly, image, accessibilityControl, keywords, discussionUrl, isBasedOnUrl, exampleOfWork, comment, numTracks, datePublished, alternateName, author, video, publisher, url, creditedTo, interactivityType, about, track, character, catalogNumber, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, recordLabel, genre, potentialAction, audience, contentRating, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, musicReleaseFormat, thumbnailUrl, releasedEvent, accessibilityHazard, accessibilityFeature, license, description, provider, publication, recordedAt, educationalAlignment, mainEntityOfPage, contributor, workExample, isPartOf, dateCreated, copyrightHolder, sameAs, aggregateRating, releaseOf, name, typicalAgeRange, translator, copyrightYear, citation, sourceOrganization, text, award);
    }
    /**
     ...
     */
    public Builder numTracks(Integer value) {
      numTracks = value;
      return this;
    }
    /**
     ...
     * The group the release is credited to if different than the byArtist. For example, Red and Blue is credited to "Stefani Germanotta Band", but by Lady Gaga.
     */
    public Builder creditedTo(Person value) {
      creditedTo = value;
      return this;
    }
    /**
     ...
     */
    public Builder track(ItemList value) {
      track = value;
      return this;
    }
    /**
     ...
     * The catalog number for the release.
     */
    public Builder catalogNumber(String value) {
      catalogNumber = value;
      return this;
    }
    /**
     ...
     * The label that issued the release.
     */
    public Builder recordLabel(Organization value) {
      recordLabel = value;
      return this;
    }
    /**
     ...
     * Format of this release (the type of recording media used, ie. compact disc, digital media, LP, etc.).
     */
    public Builder musicReleaseFormat(MusicReleaseFormatType value) {
      musicReleaseFormat = value;
      return this;
    }
    /**
     ...
     * The album this is a release of.
     */
    public Builder releaseOf(MusicAlbum value) {
      releaseOf = value;
      return this;
    }
    /**
  ...
  protected MusicRelease(Person editor, Person producer, Review review, Duration timeRequired, Offer offers, Organization creator, String educationalUse, String alternativeHeadline, Thing mentions, Duration duration, String additionalType, Position position, MediaObject associatedMedia, Boolean isFamilyFriendly, Image image, String accessibilityControl, String keywords, String discussionUrl, String isBasedOnUrl, CreativeWork exampleOfWork, Comment comment, Integer numTracks, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, Person creditedTo, String interactivityType, Thing about, ItemList track, Person character, String catalogNumber, String schemaVersion, String accessibilityAPI, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, Organization recordLabel, String genre, Action potentialAction, Audience audience, String contentRating, String inLanguage, Place contentLocation, String learningResourceType, Person accountablePerson, AudioObject audio, java.util.Date dateModified, MusicReleaseFormatType musicReleaseFormat, String thumbnailUrl, PublicationEvent releasedEvent, String accessibilityHazard, String accessibilityFeature, CreativeWork license, String description, Person provider, PublicationEvent publication, Event recordedAt, AlignmentObject educationalAlignment, CreativeWork mainEntityOfPage, Organization contributor, CreativeWork workExample, IsPartOf isPartOf, java.util.Date dateCreated, Organization copyrightHolder, String sameAs, AggregateRating aggregateRating, MusicAlbum releaseOf, String name, String typicalAgeRange, Person translator, Number copyrightYear, CreativeWork citation, Organization sourceOrganization, String text, String award) {
    super(editor, producer, review, timeRequired, offers, creator, educationalUse, alternativeHeadline, mentions, additionalType, position, associatedMedia, isFamilyFriendly, accessibilityControl, image, keywords, discussionUrl, isBasedOnUrl, exampleOfWork, comment, numTracks, datePublished, alternateName, author, video, publisher, url, interactivityType, about, track, character, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, genre, potentialAction, contentRating, audience, inLanguage, contentLocation, learningResourceType, audio, accountablePerson, dateModified, thumbnailUrl, releasedEvent, accessibilityFeature, accessibilityHazard, license, description, publication, provider, educationalAlignment, recordedAt, mainEntityOfPage, contributor, isPartOf, workExample, dateCreated, copyrightHolder, aggregateRating, sameAs, name, typicalAgeRange, citation, copyrightYear, translator, sourceOrganization, text, award);
