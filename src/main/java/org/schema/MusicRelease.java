...
public class MusicRelease extends MusicPlaylist {
   ...
   */
  public static final class MusicReleaseThingBuilder implements Builder {
    /**
     ...
     * The group the release is credited to if different than the byArtist. For example, Red and Blue is credited to "Stefani Germanotta Band", but by Lady Gaga.
     */
    public Builder creditedTo(Organization.Builder organization) {
     ...
     * The group the release is credited to if different than the byArtist. For example, Red and Blue is credited to "Stefani Germanotta Band", but by Lady Gaga.
     */
    public Builder creditedTo(Person.Builder person) {
     ...
     * Format of this release (the type of recording media used, ie. compact disc, digital media, LP, etc.).
     */
    public Builder musicReleaseFormat(MusicReleaseFormatType.Builder musicReleaseFormatType) {
     ...
     * The label that issued the release.
     */
    public Builder recordLabel(Organization.Builder organization) {
     ...
     * The album this is a release of.
     */
    public Builder releaseOf(MusicAlbum.Builder musicAlbum) {
  ...
  Builder catalogNumber(String catalogNumber);
  Builder creditedTo(Organization organization);
  Builder creditedTo(Organization.Builder organization);
  Builder creditedTo(Person person);
  Builder creditedTo(Person.Builder person);
  Builder duration(Duration duration);
  Builder duration(Duration.Builder duration);
  Builder musicReleaseFormat(MusicReleaseFormatType musicReleaseFormatType);
  Builder musicReleaseFormat(MusicReleaseFormatType.Builder musicReleaseFormatType);
  Builder recordLabel(Organization organization);
  Builder recordLabel(Organization.Builder organization);
  Builder releaseOf(MusicAlbum musicAlbum);
  Builder releaseOf(MusicAlbum.Builder musicAlbum);
