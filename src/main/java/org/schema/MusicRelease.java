...
public class MusicRelease extends MusicPlaylist {
   ...
   */
  public String getCatalogNumber() { return myCatalogNumber; }
  /**
   * The group the release is credited to if different than the byArtist. For example, Red and Blue is credited to "Stefani Germanotta Band", but by Lady Gaga.
   */
  public OrganizationOrPerson getCreditedTo() { return myCreditedTo; }
  /**
   ...
   */
  public MusicReleaseFormatType getMusicReleaseFormat() { return myMusicReleaseFormat; }
  /**
   * The label that issued the release.
   */
  public Organization getRecordLabel() { return myRecordLabel; }
  /**
   * The album this is a release of.
   */
  public MusicAlbum getReleaseOf() { return myReleaseOf; }
   ...
   */
  public static class Builder implements ThingBuilder<MusicRelease> {
