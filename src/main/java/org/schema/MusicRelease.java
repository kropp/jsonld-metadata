...
public class MusicRelease extends MusicPlaylist {
  ...
  static final class MusicReleaseThingBuilder implements Builder {
     ...
     * The group the release is credited to if different than the byArtist. For example, Red and Blue is credited to "Stefani Germanotta Band", but by Lady Gaga.
     */
    @NotNull public Builder creditedTo(Organization organization) {
     ...
     * The group the release is credited to if different than the byArtist. For example, Red and Blue is credited to "Stefani Germanotta Band", but by Lady Gaga.
     */
    @NotNull public Builder creditedTo(Organization.Builder organization) {
      return this.creditedTo(organization.build());
    }
    /**
     * The group the release is credited to if different than the byArtist. For example, Red and Blue is credited to "Stefani Germanotta Band", but by Lady Gaga.
     */
    @NotNull public Builder creditedTo(Person person) {
      if (this.creditedTo == null) this.creditedTo = new OrganizationOrPerson();
     ...
     * The group the release is credited to if different than the byArtist. For example, Red and Blue is credited to "Stefani Germanotta Band", but by Lady Gaga.
     */
    @NotNull public Builder creditedTo(Person.Builder person) {
     ...
     * Format of this release (the type of recording media used, ie. compact disc, digital media, LP, etc.).
     */
    @NotNull public Builder musicReleaseFormat(MusicReleaseFormatType musicReleaseFormatType) {
     ...
     * Format of this release (the type of recording media used, ie. compact disc, digital media, LP, etc.).
     */
    @NotNull public Builder musicReleaseFormat(MusicReleaseFormatType.Builder musicReleaseFormatType) {
      return this.musicReleaseFormat(musicReleaseFormatType.build());
    }
    /**
     * The label that issued the release.
     */
    @NotNull public Builder recordLabel(Organization organization) {
     ...
     * The label that issued the release.
     */
    @NotNull public Builder recordLabel(Organization.Builder organization) {
      return this.recordLabel(organization.build());
    }
    /**
     * The album this is a release of.
     */
    @NotNull public Builder releaseOf(MusicAlbum musicAlbum) {
     ...
     * The album this is a release of.
     */
    @NotNull public Builder releaseOf(MusicAlbum.Builder musicAlbum) {
  ...
  public interface Builder extends ThingBuilder<MusicRelease> {
    @NotNull Builder catalogNumber(String catalogNumber);
    @NotNull Builder creditedTo(Organization organization);
    @NotNull Builder creditedTo(Organization.Builder organization);
    @NotNull Builder creditedTo(Person person);
    @NotNull Builder creditedTo(Person.Builder person);
    @NotNull Builder duration(Duration duration);
    @NotNull Builder duration(Duration.Builder duration);
    @NotNull Builder musicReleaseFormat(MusicReleaseFormatType musicReleaseFormatType);
    @NotNull Builder musicReleaseFormat(MusicReleaseFormatType.Builder musicReleaseFormatType);
    @NotNull Builder recordLabel(Organization organization);
    @NotNull Builder recordLabel(Organization.Builder organization);
    @NotNull Builder releaseOf(MusicAlbum musicAlbum);
    @NotNull Builder releaseOf(MusicAlbum.Builder musicAlbum);
