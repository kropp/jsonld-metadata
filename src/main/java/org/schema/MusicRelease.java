...
public class MusicRelease extends MusicPlaylist {
   ...
   */
  static final class MusicReleaseThingBuilder implements Builder {
    /**
    ...
    @NotNull public Builder creditedTo(@NotNull Organization.Builder organization) {
      return this.creditedTo(organization.build());
    }
    /**
     * The group the release is credited to if different than the byArtist. For example, Red and Blue is credited to "Stefani Germanotta Band", but by Lady Gaga.
     */
    ...
    @NotNull public Builder creditedTo(@NotNull Person.Builder person) {
      return this.creditedTo(person.build());
    }
    /**
     * The duration of the item (movie, audio recording, event, etc.) in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601 date format</a>.
     */
    ...
    @NotNull public Builder musicReleaseFormat(@NotNull MusicReleaseFormatType.Builder musicReleaseFormatType) {
      return this.musicReleaseFormat(musicReleaseFormatType.build());
    }
    /**
     * The label that issued the release.
     */
    ...
    @NotNull public Builder recordLabel(@NotNull Organization.Builder organization) {
      return this.recordLabel(organization.build());
    }
    /**
     * The album this is a release of.
     */
    ...
    @NotNull public Builder releaseOf(@NotNull MusicAlbum.Builder musicAlbum) {
      return this.releaseOf(musicAlbum.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("catalogNumber".equals(key) && value instanceof String) { catalogNumber((String)value); continue; }
        if ("creditedTo".equals(key) && value instanceof Organization) { creditedTo((Organization)value); continue; }
        if ("creditedTo".equals(key) && value instanceof Person) { creditedTo((Person)value); continue; }
        if ("duration".equals(key) && value instanceof Duration) { duration((Duration)value); continue; }
        if ("musicReleaseFormat".equals(key) && value instanceof MusicReleaseFormatType) { musicReleaseFormat((MusicReleaseFormatType)value); continue; }
        if ("recordLabel".equals(key) && value instanceof Organization) { recordLabel((Organization)value); continue; }
        if ("releaseOf".equals(key) && value instanceof MusicAlbum) { releaseOf((MusicAlbum)value); continue; }
  ...
  public interface Builder extends ThingBuilder<MusicRelease> {
    @NotNull Builder catalogNumber(@NotNull String catalogNumber);
    @NotNull Builder creditedTo(@NotNull Organization organization);
    @NotNull Builder creditedTo(@NotNull Organization.Builder organization);
    @NotNull Builder creditedTo(@NotNull Person person);
    @NotNull Builder creditedTo(@NotNull Person.Builder person);
    @NotNull Builder duration(@NotNull Duration duration);
    @NotNull Builder duration(@NotNull Duration.Builder duration);
    @NotNull Builder musicReleaseFormat(@NotNull MusicReleaseFormatType musicReleaseFormatType);
    @NotNull Builder musicReleaseFormat(@NotNull MusicReleaseFormatType.Builder musicReleaseFormatType);
    @NotNull Builder recordLabel(@NotNull Organization organization);
    @NotNull Builder recordLabel(@NotNull Organization.Builder organization);
    @NotNull Builder releaseOf(@NotNull MusicAlbum musicAlbum);
    @NotNull Builder releaseOf(@NotNull MusicAlbum.Builder musicAlbum);
