...
public class MusicRelease extends MusicPlaylist {
  ...
  public static final class Builder {
    ...
    public MusicRelease build() {
      return new MusicRelease(accessibilityAPI, aggregateRating, hasPart, numTracks, review, datePublished, schemaVersion, comment, video, award, editor, creditedTo, workExample, track, potentialAction, catalogNumber, producer, publisher, sourceOrganization, genre, learningResourceType, publishingPrinciples, translator, recordedAt, inLanguage, commentCount, dateModified, releaseOf, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, copyrightHolder, accessibilityControl, citation, musicReleaseFormat, educationalUse, keywords, educationalAlignment, text, about, contentLocation, accessibilityHazard, author, version, accountablePerson, additionalType, sameAs, thumbnailUrl, publication, recordLabel, encoding, timeRequired, duration, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, mainEntity, alternativeHeadline, name, license, mainEntityOfPage, discussionUrl, copyrightYear, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, creator, contributor);
    }
    /**
  ...
  protected MusicRelease(String accessibilityAPI, AggregateRating aggregateRating, HasPart hasPart, Integer numTracks, Review review, java.util.Date datePublished, String schemaVersion, Comment comment, VideoObject video, String award, Person editor, OrganizationOrPerson creditedTo, CreativeWork workExample, MusicRecordingOrItemList track, Action potentialAction, String catalogNumber, OrganizationOrPerson producer, Organization publisher, Organization sourceOrganization, String genre, String learningResourceType, String publishingPrinciples, OrganizationOrPerson translator, Event recordedAt, LanguageOrString inLanguage, Integer commentCount, java.util.Date dateModified, MusicAlbum releaseOf, Thing mentions, Audience audience, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, String contentRating, String description, Offer offers, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, MusicReleaseFormatType musicReleaseFormat, String educationalUse, String keywords, AlignmentObject educationalAlignment, String text, Thing about, Place contentLocation, String accessibilityHazard, OrganizationOrPerson author, Number version, Person accountablePerson, String additionalType, String sameAs, String thumbnailUrl, PublicationEvent publication, Organization recordLabel, MediaObject encoding, Duration timeRequired, Duration duration, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, Thing mainEntity, String alternativeHeadline, String name, StringOrCreativeWork license, StringOrCreativeWork mainEntityOfPage, String discussionUrl, Number copyrightYear, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, String alternateName, PublicationEvent releasedEvent, OrganizationOrPerson creator, OrganizationOrPerson contributor) {
