...
public class BusTrip extends Intangible {
  ...
  static final class BusTripThingBuilder implements Builder {
     ...
     * The unique identifier for the bus.
     */
    @NotNull public Builder busNumber(String busNumber) {
     ...
     * The name of the bus (e.g. Bolt Express).
     */
    @NotNull public Builder busName(String busName) {
     ...
     * The stop or station from which the bus departs.
     */
    @NotNull public Builder departureBusStop(BusStation busStation) {
     ...
     * The stop or station from which the bus departs.
     */
    @NotNull public Builder departureBusStop(BusStation.Builder busStation) {
      return this.departureBusStop(busStation.build());
    }
    /**
     * The stop or station from which the bus departs.
     */
    @NotNull public Builder departureBusStop(BusStop busStop) {
      if (this.departureBusStop == null) this.departureBusStop = new BusStationOrBusStop();
     ...
     * The stop or station from which the bus departs.
     */
    @NotNull public Builder departureBusStop(BusStop.Builder busStop) {
      return this.departureBusStop(busStop.build());
    }
    /**
     * The stop or station from which the bus arrives.
     */
    @NotNull public Builder arrivalBusStop(BusStation busStation) {
     ...
     * The stop or station from which the bus arrives.
     */
    @NotNull public Builder arrivalBusStop(BusStation.Builder busStation) {
      return this.arrivalBusStop(busStation.build());
    }
    /**
     * The stop or station from which the bus arrives.
     */
    @NotNull public Builder arrivalBusStop(BusStop busStop) {
      if (this.arrivalBusStop == null) this.arrivalBusStop = new BusStationOrBusStop();
     ...
     * The stop or station from which the bus arrives.
     */
    @NotNull public Builder arrivalBusStop(BusStop.Builder busStop) {
  ...
  public interface Builder extends ThingBuilder<BusTrip> {
    ...
    @NotNull Builder busNumber(String busNumber);
    @NotNull Builder busName(String busName);
    @NotNull Builder departureBusStop(BusStation busStation);
    @NotNull Builder departureBusStop(BusStation.Builder busStation);
    @NotNull Builder departureBusStop(BusStop busStop);
    @NotNull Builder departureBusStop(BusStop.Builder busStop);
    @NotNull Builder arrivalBusStop(BusStation busStation);
    @NotNull Builder arrivalBusStop(BusStation.Builder busStation);
    @NotNull Builder arrivalBusStop(BusStop busStop);
    @NotNull Builder arrivalBusStop(BusStop.Builder busStop);
