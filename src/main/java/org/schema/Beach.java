...
public class Beach extends CivicStructure {
  /**
   * Builder for {@see Beach}
   */
  public static final class Builder {
    public Beach build() {
      return new Beach(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
