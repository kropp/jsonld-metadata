...
public class AssessAction extends Action {
   ...
   */
  static final class AssessActionThingBuilder implements Builder {
    /**
     * Creates new {@link AssessAction} instance.
     */
    public AssessAction build() {
      return new AssessAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<AssessAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    AssessAction assessAction = (AssessAction) o;
