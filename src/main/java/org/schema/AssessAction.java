...
public class AssessAction extends Action {
  /**
   * Builder for {@see AssessAction}
   */
  public static final class Builder {
    public AssessAction build() {
      return new AssessAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, object, location, description);
    }
