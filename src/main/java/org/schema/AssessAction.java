...
public class AssessAction extends Action {
  ...
  public static final class Builder {
    /**
     * Creates new {@link AssessAction} instance.
     */
    public AssessAction build() {
      return new AssessAction(additionalType, url, sameAs, agent, startTime, alternateName, potentialAction, target, description, name, endTime, mainEntityOfPage, error, actionStatus);
    }
    /**
