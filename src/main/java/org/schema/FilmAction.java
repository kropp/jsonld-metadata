...
public class FilmAction extends CreateAction {
   ...
   */
  static final class FilmActionThingBuilder implements Builder {
    /**
     * Creates new {@link FilmAction} instance.
     */
    public FilmAction build() {
      return new FilmAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<FilmAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    FilmAction filmAction = (FilmAction) o;
