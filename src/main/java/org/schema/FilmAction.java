...
public class FilmAction extends CreateAction {
  /**
   * Builder for {@see FilmAction}
   */
  public static final class Builder {
    public FilmAction build() {
      return new FilmAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
