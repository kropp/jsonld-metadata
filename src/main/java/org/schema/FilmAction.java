...
public class FilmAction extends CreateAction {
  ...
  public static final class Builder {
    ...
    public FilmAction build() {
      return new FilmAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
