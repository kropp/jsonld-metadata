...
public class RejectAction extends AllocateAction {
  ...
  public static final class Builder {
    ...
    public RejectAction build() {
      return new RejectAction(purpose, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
