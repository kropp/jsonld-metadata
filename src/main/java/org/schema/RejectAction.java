...
public class RejectAction extends AllocateAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link RejectAction} instance.
     */
    public RejectAction build() {
      return new RejectAction(purpose, startTime, name, mainEntityOfPage, error, sameAs, additionalType, url, agent, alternateName, description, potentialAction, target, endTime, actionStatus);
    }
    /**
