...
public class RejectAction extends AllocateAction {
   ...
   */
  static final class RejectActionThingBuilder implements Builder {
    /**
     * Creates new {@link RejectAction} instance.
     */
    public RejectAction build() {
      return new RejectAction(purpose, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<RejectAction> {
  ...
  protected RejectAction(MedicalDevicePurposeOrThing purpose, OrganizationOrPerson agent, java.util.Date endTime, java.util.Date startTime, ActionStatusType actionStatus, Thing error, EntryPoint target, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
  ...
  @Override public boolean equals(Object o) {
    ...
    RejectAction rejectAction = (RejectAction) o;
