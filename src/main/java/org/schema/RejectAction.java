...
public class RejectAction extends AllocateAction {
  /**
   * Builder for {@see RejectAction}
   */
  public static final class Builder {
    public RejectAction build() {
      return new RejectAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, purpose, object, location, description);
    }
