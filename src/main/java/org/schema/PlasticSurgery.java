...
public class PlasticSurgery {
  ...
  @Override public boolean equals(Object o) {
    ...
    PlasticSurgery plasticSurgery = (PlasticSurgery) o;
   ...
   */
  public static class Builder implements ThingBuilder<PlasticSurgery> {
    public PlasticSurgery build() {
      return new PlasticSurgery();
    }
