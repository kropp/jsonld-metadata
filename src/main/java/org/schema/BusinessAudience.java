...
public class BusinessAudience extends Audience {
  ...
  public QuantitativeValue getYearlyRevenue() {
    return myYearlyRevenue;
  }
  /**
   * The age of the business.
   */
  public QuantitativeValue getYearsInOperation() {
    return myYearsInOperation;
  }
  /**
   * Builder for {@link BusinessAudience}
   */
  public static final class BusinessAudienceThingBuilder implements Builder {
    /**
     ...
     * The size of the business in annual revenue.
     */
    public Builder yearlyRevenue(QuantitativeValue quantitativeValue) {
     ...
     * The size of the business in annual revenue.
     */
    public Builder yearlyRevenue(QuantitativeValue.Builder quantitativeValue) {
      return this.yearlyRevenue(quantitativeValue.build());
    }
    /**
     * The age of the business.
     */
    public Builder yearsInOperation(QuantitativeValue quantitativeValue) {
     ...
     * The age of the business.
     */
    public Builder yearsInOperation(QuantitativeValue.Builder quantitativeValue) {
  ...
  public interface Builder extends ThingBuilder<BusinessAudience> {
  ...
  Builder yearlyRevenue(QuantitativeValue quantitativeValue);
  Builder yearlyRevenue(QuantitativeValue.Builder quantitativeValue);
  Builder yearsInOperation(QuantitativeValue quantitativeValue);
  Builder yearsInOperation(QuantitativeValue.Builder quantitativeValue);
