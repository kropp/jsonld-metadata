...
public class BusinessAudience extends Audience {
  ...
  public static final class Builder {
    ...
    public BusinessAudience build() {
      return new BusinessAudience(additionalType, url, sameAs, audienceType, geographicArea, numberOfEmployees, alternateName, yearsInOperation, yearlyRevenue, description, potentialAction, name, mainEntityOfPage);
    }
    /**
  ...
  protected BusinessAudience(String additionalType, String url, String sameAs, String audienceType, AdministrativeArea geographicArea, QuantitativeValue numberOfEmployees, String alternateName, QuantitativeValue yearsInOperation, QuantitativeValue yearlyRevenue, String description, Action potentialAction, String name, StringOrCreativeWork mainEntityOfPage) {
