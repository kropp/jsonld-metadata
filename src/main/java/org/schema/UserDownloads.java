...
public class UserDownloads extends UserInteraction {
   ...
   */
  static final class UserDownloadsThingBuilder implements Builder {
    /**
     * Creates new {@link UserDownloads} instance.
     */
    public UserDownloads build() {
      return new UserDownloads(aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<UserDownloads> {
  ...
  @Override public boolean equals(Object o) {
    ...
    UserDownloads userDownloads = (UserDownloads) o;
