...
public class Vessel extends AnatomicalStructure {
  /**
   * Builder for {@see Vessel}
   */
  public static final class Builder {
    public Vessel build() {
      return new Vessel(function, mainEntityOfPage, relatedCondition, subStructure, alternateName, potentialAction, url, additionalType, connectedTo, medicineSystem, associatedPathophysiology, partOfSystem, sameAs, recognizingAuthority, study, code, diagram, bodyLocation, name, image, relevantSpecialty, guideline, relatedTherapy, description);
    }
    /**
