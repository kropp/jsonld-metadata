...
public class SendAction extends TransferAction {
   ...
   */
  static final class SendActionThingBuilder implements Builder {
    /**
     * Creates new {@link SendAction} instance.
     */
    public SendAction build() {
      return new SendAction(deliveryMethod, recipient, fromLocation, toLocation, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of instrument. The method of delivery.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<SendAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myDeliveryMethod != null ? !myDeliveryMethod.equals(sendAction.myDeliveryMethod) : sendAction.myDeliveryMethod != null) return false;
    if (myRecipient != null ? !myRecipient.equals(sendAction.myRecipient) : sendAction.myRecipient != null) return false;
    return true;
  }
