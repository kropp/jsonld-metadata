...
public class SendAction extends TransferAction {
  ...
  /**
   * Builder for {@see SendAction}
   */
  public static final class Builder {
    public SendAction build() {
      return new SendAction(instrument, recipient, toLocation, mainEntityOfPage, agent, endTime, alternateName, potentialAction, fromLocation, participant, url, additionalType, sameAs, startTime, actionStatus, result, deliveryMethod, image, name, error, target, object, description, location);
    }
