...
public class DrawAction extends CreateAction {
  /**
   * Builder for {@see DrawAction}
   */
  public static final class Builder {
    public DrawAction build() {
      return new DrawAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
