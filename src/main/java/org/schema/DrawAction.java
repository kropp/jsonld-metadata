...
public class DrawAction extends CreateAction {
  ...
  public static final class Builder {
    ...
    public DrawAction build() {
      return new DrawAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
