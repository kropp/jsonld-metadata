 ...
 * 
 *       <br/><br/>See also <a href="http://blog.schema.org/2014/09/schemaorg-support-for-bibliographic_2.html">blog post</a>.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_bibexEquivalent class: http://purl.org/ontology/bibo/Periodical
 */
public class Periodical extends CreativeWorkSeries {
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myIssn != null ? myIssn.hashCode() : 0);
    return result;
  }
  @Override public boolean equals(Object o) {
    ...
    if (myIssn != null ? !myIssn.equals(periodical.myIssn) : periodical.myIssn != null) return false;
    return true;
  }
   ...
   */
  public static class Builder implements ThingBuilder<Periodical> {
    public Periodical build() {
      return new Periodical(issn, endDate, startDate, schemaVersion, about, accessibilityAPI, accessibilityControl, accessibilityFeature, accessibilityHazard, accountablePerson, aggregateRating, alternativeHeadline, associatedMedia, audience, audio, author, award, citation, comment, contentLocation, contentRating, contributor, copyrightHolder, copyrightYear, creator, dateCreated, dateModified, datePublished, discussionUrl, editor, educationalAlignment, educationalUse, encoding, genre, headline, inLanguage, interactivityType, isBasedOnUrl, isFamilyFriendly, keywords, license, learningResourceType, mainEntity, mentions, offers, producer, publication, publisher, publishingPrinciples, recordedAt, review, sourceOrganization, text, thumbnailUrl, timeRequired, typicalAgeRange, version, video, provider, commentCount, hasPart, workExample, exampleOfWork, character, translator, releasedEvent, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * The International Standard Serial Number (ISSN) that identifies this periodical. You can repeat this property to (for example) identify different formats of this periodical.
     */
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("issn".equals(key) && value instanceof String) { issn((String)value); continue; }
