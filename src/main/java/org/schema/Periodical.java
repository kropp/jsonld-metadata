...
public class Periodical extends CreativeWorkSeries {
   ...
   */
  static final class PeriodicalThingBuilder implements Builder {
    /**
  ...
  public interface Builder extends ThingBuilder<Periodical> {
    @NotNull Builder issn(@NotNull String issn);
