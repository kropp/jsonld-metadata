...
public class ReturnAction extends TransferAction {
  ...
  /**
   * Builder for {@see ReturnAction}
   */
  public static final class Builder {
    public ReturnAction build() {
      return new ReturnAction(instrument, recipient, toLocation, mainEntityOfPage, agent, endTime, alternateName, potentialAction, fromLocation, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
