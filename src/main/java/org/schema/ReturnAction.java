...
public class ReturnAction extends TransferAction {
  ...
  public static final class Builder {
    ...
    public ReturnAction build() {
      return new ReturnAction(startTime, toLocation, name, mainEntityOfPage, error, fromLocation, url, sameAs, additionalType, recipient, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
