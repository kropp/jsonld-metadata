...
public class ReturnAction extends TransferAction {
   ...
   */
  static final class ReturnActionThingBuilder implements Builder {
    /**
     * Creates new {@link ReturnAction} instance.
     */
    public ReturnAction build() {
      return new ReturnAction(recipient, fromLocation, toLocation, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of participant. The participant who is at the receiving end of the action.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<ReturnAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myRecipient != null ? !myRecipient.equals(returnAction.myRecipient) : returnAction.myRecipient != null) return false;
    return true;
  }
