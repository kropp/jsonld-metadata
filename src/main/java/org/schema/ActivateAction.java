...
public class ActivateAction extends ControlAction {
  /**
   * Builder for {@see ActivateAction}
   */
  public static final class Builder {
    public ActivateAction build() {
      return new ActivateAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
