...
public class ActivateAction extends ControlAction {
  ...
  public static final class Builder {
    ...
    public ActivateAction build() {
      return new ActivateAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
