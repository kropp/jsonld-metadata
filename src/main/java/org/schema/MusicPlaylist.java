...
public class MusicPlaylist extends CreativeWork {
   ...
   */
  public MusicRecordingOrItemList getTrack() {
    return myTrack;
  }
  /**
  ...
  private MusicRecordingOrItemList myTrack;
}
