...
public class TherapeuticProcedure extends MedicalTherapy {
  ...
  public static final class Builder {
    /**
     * Creates new {@link TherapeuticProcedure} instance.
     */
    public TherapeuticProcedure build() {
      return new TherapeuticProcedure(recognizingAuthority, indication, code, name, adverseOutcome, mainEntityOfPage, seriousAdverseOutcome, guideline, additionalType, url, sameAs, duplicateTherapy, contraindication, alternateName, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
