...
public class TherapeuticProcedure extends MedicalTherapy {
  /**
   * Builder for {@see TherapeuticProcedure}
   */
  public static final class Builder {
    public TherapeuticProcedure build() {
      return new TherapeuticProcedure(indication, adverseOutcome, mainEntityOfPage, contraindication, alternateName, potentialAction, additionalType, url, medicineSystem, recognizingAuthority, sameAs, study, code, name, image, duplicateTherapy, relevantSpecialty, seriousAdverseOutcome, guideline, description);
    }
    /**
