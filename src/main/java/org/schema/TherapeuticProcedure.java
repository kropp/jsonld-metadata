...
public class TherapeuticProcedure extends MedicalTherapy {
  ...
  @Override public boolean equals(Object o) {
    ...
    TherapeuticProcedure therapeuticProcedure = (TherapeuticProcedure) o;
   ...
   */
  public static class Builder implements ThingBuilder<TherapeuticProcedure> {
    public TherapeuticProcedure build() {
      return new TherapeuticProcedure(adverseOutcome, contraindication, duplicateTherapy, indication, seriousAdverseOutcome, code, guideline, medicineSystem, recognizingAuthority, relevantSpecialty, study, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
