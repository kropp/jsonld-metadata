...
public class TechArticle extends Article {
  ...
  protected TechArticle(Person editor, Person producer, Review review, Duration timeRequired, Offer offers, Organization creator, String educationalUse, Integer wordCount, String alternativeHeadline, String pagination, Thing mentions, String additionalType, Position position, MediaObject associatedMedia, Boolean isFamilyFriendly, Image image, String accessibilityControl, String keywords, String articleSection, String discussionUrl, String isBasedOnUrl, CreativeWork exampleOfWork, Comment comment, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, Person character, String schemaVersion, String accessibilityAPI, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, String genre, Action potentialAction, String contentRating, Audience audience, Integer pageStart, String inLanguage, Place contentLocation, String learningResourceType, AudioObject audio, Person accountablePerson, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, String accessibilityHazard, String accessibilityFeature, CreativeWork license, String description, Person provider, PublicationEvent publication, Event recordedAt, AlignmentObject educationalAlignment, Integer pageEnd, CreativeWork mainEntityOfPage, Organization contributor, String articleBody, CreativeWork workExample, IsPartOf isPartOf, java.util.Date dateCreated, Organization copyrightHolder, String sameAs, AggregateRating aggregateRating, String dependencies, String name, String proficiencyLevel, String typicalAgeRange, Person translator, Number copyrightYear, CreativeWork citation, Organization sourceOrganization, String text, String award) {
