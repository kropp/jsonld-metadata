...
public class TechArticle extends Article {
   ...
   */
  public String getDependencies() { return myDependencies; }
  /**
   * Proficiency needed for this content; expected values: 'Beginner', 'Expert'.
   */
  public String getProficiencyLevel() { return myProficiencyLevel; }
   ...
   */
  public static class Builder implements ThingBuilder<TechArticle> {
