...
public class BefriendAction extends InteractAction {
  /**
   * Builder for {@see BefriendAction}
   */
  public static final class Builder {
    public BefriendAction build() {
      return new BefriendAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
