...
public class BefriendAction extends InteractAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link BefriendAction} instance.
     */
    public BefriendAction build() {
      return new BefriendAction(startTime, name, error, mainEntityOfPage, url, additionalType, sameAs, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
