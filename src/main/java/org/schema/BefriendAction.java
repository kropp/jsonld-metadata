...
public class BefriendAction extends InteractAction {
  ...
  public static final class Builder {
    ...
    public BefriendAction build() {
      return new BefriendAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
