...
public class LendAction extends TransferAction {
  ...
  public static final class Builder {
    ...
    public LendAction build() {
      return new LendAction(startTime, toLocation, name, mainEntityOfPage, error, fromLocation, url, sameAs, additionalType, agent, alternateName, description, target, potentialAction, endTime, borrower, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected LendAction(java.util.Date startTime, Place toLocation, String name, StringOrCreativeWork mainEntityOfPage, Thing error, Place fromLocation, String url, String sameAs, String additionalType, OrganizationOrPerson agent, String alternateName, String description, EntryPoint target, Action potentialAction, java.util.Date endTime, Person borrower, ActionStatusType actionStatus) {
