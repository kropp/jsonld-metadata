...
public class LendAction extends TransferAction {
   ...
   */
  static final class LendActionThingBuilder implements Builder {
    /**
     * Creates new {@link LendAction} instance.
     */
    public LendAction build() {
      return new LendAction(borrower, fromLocation, toLocation, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of participant. The person that borrows the object being lent.
     */
    @NotNull public Builder borrower(Person person) {
     ...
     * A sub property of participant. The person that borrows the object being lent.
     */
    @NotNull public Builder borrower(Person.Builder person) {
      return this.borrower(person.build());
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<LendAction> {
    @NotNull Builder borrower(Person person);
    @NotNull Builder borrower(Person.Builder person);
