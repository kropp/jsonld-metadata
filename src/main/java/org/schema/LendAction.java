...
public class LendAction extends TransferAction {
  ...
  /**
   * Builder for {@see LendAction}
   */
  public static final class Builder {
    public LendAction build() {
      return new LendAction(instrument, toLocation, mainEntityOfPage, agent, endTime, alternateName, potentialAction, fromLocation, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location, borrower);
    }
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
     ...
     * A sub property of participant. The person that borrows the object being lent.
     */
    public Builder borrower(Person value) {
      borrower = value;
      return this;
    }
