...
public class AnatomicalStructure extends MedicalEntity {
   ...
   */
  public String getBodyLocation() { return myBodyLocation; }
  /**
   * Other anatomical structures to which this structure is connected.
   */
  public AnatomicalStructure getConnectedTo() { return myConnectedTo; }
  /**
   * An image containing a diagram that illustrates the structure and/or its component substructures and/or connections with other structures.
   */
  public ImageObject getDiagram() { return myDiagram; }
  /**
   * Function of the anatomical structure.
   */
  public String getFunction() { return myFunction; }
  /**
   * The anatomical or organ system that this structure is part of.
   */
  public IsPartOf getPartOfSystem() { return myPartOfSystem; }
  /**
   ...
   */
  public AnatomicalStructure getSubStructure() { return mySubStructure; }
   ...
   */
  public static class Builder implements ThingBuilder<AnatomicalStructure> {
