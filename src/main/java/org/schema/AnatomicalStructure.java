...
public class AnatomicalStructure extends MedicalEntity {
  ...
  public static final class Builder {
    /**
     * Creates new {@link AnatomicalStructure} instance.
     */
    public AnatomicalStructure build() {
      return new AnatomicalStructure(recognizingAuthority, bodyLocation, code, relatedTherapy, connectedTo, name, mainEntityOfPage, diagram, guideline, additionalType, sameAs, url, partOfSystem, function, relatedCondition, alternateName, associatedPathophysiology, study, subStructure, potentialAction, description, relevantSpecialty, medicineSystem);
    }
    /**
  ...
  protected AnatomicalStructure(Organization recognizingAuthority, String bodyLocation, MedicalCode code, MedicalTherapy relatedTherapy, AnatomicalStructure connectedTo, String name, StringOrCreativeWork mainEntityOfPage, ImageObject diagram, MedicalGuideline guideline, String additionalType, String sameAs, String url, IsPartOf partOfSystem, String function, MedicalCondition relatedCondition, String alternateName, String associatedPathophysiology, MedicalStudy study, AnatomicalStructure subStructure, Action potentialAction, String description, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem) {
