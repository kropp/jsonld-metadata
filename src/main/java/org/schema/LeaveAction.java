...
public class LeaveAction extends InteractAction {
  ...
  public static final class Builder {
    ...
    public LeaveAction build() {
      return new LeaveAction(startTime, name, error, mainEntityOfPage, sameAs, event, additionalType, url, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected LeaveAction(java.util.Date startTime, String name, Thing error, StringOrCreativeWork mainEntityOfPage, String sameAs, Event event, String additionalType, String url, OrganizationOrPerson agent, String alternateName, Action potentialAction, EntryPoint target, String description, java.util.Date endTime, ActionStatusType actionStatus) {
