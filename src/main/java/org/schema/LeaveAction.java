...
public class LeaveAction extends InteractAction {
   ...
   */
  static final class LeaveActionThingBuilder implements Builder {
    /**
     * Creates new {@link LeaveAction} instance.
     */
    public LeaveAction build() {
      return new LeaveAction(event, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * Upcoming or past event associated with this place, organization, or action.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<LeaveAction> {
  ...
  protected LeaveAction(Event event, OrganizationOrPerson agent, java.util.Date endTime, java.util.Date startTime, ActionStatusType actionStatus, Thing error, EntryPoint target, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
  ...
  @Override public boolean equals(Object o) {
    ...
    LeaveAction leaveAction = (LeaveAction) o;
    if (!super.equals(o)) return false;
    if (myEvent != null ? !myEvent.equals(leaveAction.myEvent) : leaveAction.myEvent != null) return false;
    return true;
  }
