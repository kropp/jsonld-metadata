...
public class LeaveAction extends InteractAction {
  ...
  /**
   * Builder for {@see LeaveAction}
   */
  public static final class Builder {
    public LeaveAction build() {
      return new LeaveAction(event, instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
    /**
     * Upcoming or past event associated with this place, organization, or action.
     */
