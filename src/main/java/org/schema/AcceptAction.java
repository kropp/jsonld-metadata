...
public class AcceptAction extends AllocateAction {
  ...
  public static final class Builder {
    ...
    public AcceptAction build() {
      return new AcceptAction(purpose, startTime, name, mainEntityOfPage, error, sameAs, additionalType, url, agent, alternateName, description, potentialAction, target, endTime, actionStatus);
    }
    /**
