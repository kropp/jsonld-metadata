...
public class MedicalIndication extends MedicalEntity {
  /**
   * Builder for {@see MedicalIndication}
   */
  public static final class Builder {
    public MedicalIndication build() {
      return new MedicalIndication(mainEntityOfPage, potentialAction, alternateName, url, additionalType, medicineSystem, sameAs, recognizingAuthority, study, code, name, image, relevantSpecialty, guideline, description);
    }
    /**
