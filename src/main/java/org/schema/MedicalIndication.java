...
public class MedicalIndication extends MedicalEntity {
  ...
  public static final class Builder {
    ...
    public MedicalIndication build() {
      return new MedicalIndication(recognizingAuthority, code, name, mainEntityOfPage, guideline, url, sameAs, additionalType, alternateName, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
