...
public class TheaterEvent extends Event {
   ...
   */
  static final class TheaterEventThingBuilder implements Builder {
    /**
  ...
  public interface Builder extends ThingBuilder<TheaterEvent> {
  ...
  @Override public boolean equals(Object o) {
    ...
    TheaterEvent theaterEvent = (TheaterEvent) o;
