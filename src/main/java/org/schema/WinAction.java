...
public class WinAction extends AchieveAction {
   ...
   */
  static final class WinActionThingBuilder implements Builder {
    /**
     * Creates new {@link WinAction} instance.
     */
    public WinAction build() {
      return new WinAction(loser, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of participant. The loser of the action.
     */
    ...
    @NotNull public Builder loser(@NotNull Person.Builder person) {
      return this.loser(person.build());
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("loser".equals(key) && value instanceof Person) { loser((Person)value); continue; }
  ...
  public interface Builder extends ThingBuilder<WinAction> {
    @NotNull Builder loser(@NotNull Person person);
    @NotNull Builder loser(@NotNull Person.Builder person);
  ...
  protected WinAction(Person loser, OrganizationOrPerson agent, java.util.Date endTime, java.util.Date startTime, ActionStatusType actionStatus, Thing error, EntryPoint target, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myLoser != null ? myLoser.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    WinAction winAction = (WinAction) o;
    if (!super.equals(o)) return false;
    if (myLoser != null ? !myLoser.equals(winAction.myLoser) : winAction.myLoser != null) return false;
    return true;
  }

  private Person myLoser;
}
