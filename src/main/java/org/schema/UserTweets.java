...
public class UserTweets extends UserInteraction {
  ...
  protected UserTweets(Organization performer, Review review, Offer offers, java.util.Date endDate, Action potentialAction, Duration duration, String additionalType, String inLanguage, Image image, CreativeWork workPerformed, Organization attendee, java.util.Date previousStartDate, String description, CreativeWork mainEntityOfPage, Person organizer, java.util.Date doorTime, String alternateName, EventStatusType eventStatus, String url, Event superEvent, String sameAs, AggregateRating aggregateRating, java.util.Date startDate, Event subEvent, String name, CreativeWork recordedIn, String typicalAgeRange, Location location) {
