...
public class WearAction extends UseAction {
  /**
   * Builder for {@see WearAction}
   */
  public static final class Builder {
    public WearAction build() {
      return new WearAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, expectsAcceptanceOf, object, location, description);
    }
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected WearAction(Instrument instrument, CreativeWork mainEntityOfPage, Organization agent, java.util.Date endTime, String alternateName, Action potentialAction, Participant participant, String additionalType, String url, String sameAs, java.util.Date startTime, ActionStatusType actionStatus, Result result, Thing error, String name, Image image, EntryPoint target, Offer expectsAcceptanceOf, Object object, Location location, String description) {
    super(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, expectsAcceptanceOf, target, object, description, location);
  }
}
