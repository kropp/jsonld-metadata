...
public class WearAction extends UseAction {
   ...
   */
  static final class WearActionThingBuilder implements Builder {
    /**
     * Creates new {@link WearAction} instance.
     */
    public WearAction build() {
      return new WearAction(expectsAcceptanceOf, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<WearAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    WearAction wearAction = (WearAction) o;
