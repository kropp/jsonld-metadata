...
public class WearAction extends UseAction {
  ...
  public static final class Builder {
    ...
    public WearAction build() {
      return new WearAction(startTime, name, error, mainEntityOfPage, url, sameAs, additionalType, agent, expectsAcceptanceOf, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected WearAction(java.util.Date startTime, String name, Thing error, StringOrCreativeWork mainEntityOfPage, String url, String sameAs, String additionalType, OrganizationOrPerson agent, Offer expectsAcceptanceOf, String alternateName, String description, EntryPoint target, Action potentialAction, java.util.Date endTime, ActionStatusType actionStatus) {
    super(startTime, name, mainEntityOfPage, error, sameAs, url, additionalType, agent, expectsAcceptanceOf, alternateName, target, potentialAction, description, endTime, actionStatus);
  }
}
