...
public class SuspendAction extends ControlAction {
  /**
   * Builder for {@see SuspendAction}
   */
  public static final class Builder {
    public SuspendAction build() {
      return new SuspendAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
