...
public class SuspendAction extends ControlAction {
  ...
  public static final class Builder {
    ...
    public SuspendAction build() {
      return new SuspendAction(startTime, name, error, mainEntityOfPage, url, additionalType, sameAs, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
