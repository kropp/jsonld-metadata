...
public class SuspendAction extends ControlAction {
  ...
  @Override public boolean equals(Object o) {
    ...
    SuspendAction suspendAction = (SuspendAction) o;
   ...
   */
  public static class Builder implements ThingBuilder<SuspendAction> {
    public SuspendAction build() {
      return new SuspendAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
