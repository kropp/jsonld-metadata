...
public class SuspendAction extends ControlAction {
  ...
  public static final class Builder {
    ...
    public SuspendAction build() {
      return new SuspendAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
