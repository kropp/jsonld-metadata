...
public class DisagreeAction extends ReactAction {
  /**
   * Builder for {@see DisagreeAction}
   */
  public static final class Builder {
    public DisagreeAction build() {
      return new DisagreeAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, object, location, description);
    }
