...
public class DisagreeAction extends ReactAction {
  ...
  public static final class Builder {
    ...
    public DisagreeAction build() {
      return new DisagreeAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
