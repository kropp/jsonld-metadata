...
Typical unit code(s): C62
   ...
   */
  public StringOrNumber getNumberOfAirbags() {
...
Note: You can use <a href="minValue">minValue</a> and <a href="maxValue">maxValue</a> to indicate ranges.
   ...
   */
  public StringOrDriveWheelConfigurationValue getDriveWheelConfiguration() {
    return myDriveWheelConfiguration;
  }
  /**
   * The type of fuel suitable for the engine or engines of the vehicle. If the vehicle has only one engine, this property can be attached directly to the vehicle.
   */
  public StringOrQualitativeValue getFuelType() {
    return myFuelType;
  }
  /**
...
Typical unit code(s): C62 for persons 
   ...
   */
  public StringOrQualitativeValue getVehicleTransmission() {
...
Typical unit code(s): KMT for kilometers, SMI for statute miles
  ...
  protected Vehicle(java.util.Date purchaseDate, AggregateRating aggregateRating, Review review, String vehicleInteriorColor, Product isSimilarTo, String gtin14, String vin, String award, StringOrDriveWheelConfigurationValue driveWheelConfiguration, String color, String gtin12, String sku, String knownVehicleDamages, Action potentialAction, NumberOrQuantitativeValue vehicleSeatingCapacity, QuantitativeValue fuelEfficiency, QuantitativeValue cargoVolume, ThingOrStringOrPhysicalActivityCategory category, SteeringPositionValue steeringPosition, NumberOrQuantitativeValue numberOfAxles, java.util.Date vehicleModelDate, String mpn, String gtin8, Audience audience, String url, OfferItemCondition itemCondition, Product isRelatedTo, EngineSpecification vehicleEngine, String gtin13, String description, Offer offers, Product isConsumableFor, QuantitativeValue weight, QuantitativeValueOrDistance width, QuantitativeValueOrDistance depth, ImageObjectOrString logo, String additionalType, String sameAs, NumberOrQuantitativeValue numberOfDoors, String productID, QuantitativeValue fuelConsumption, NumberOrQuantitativeValue numberOfForwardGears, Product isAccessoryOrSparePartFor, OrganizationOrBrand brand, StringOrQualitativeValue vehicleTransmission, Organization manufacturer, PropertyValue additionalProperty, String name, java.util.Date dateVehicleFirstRegistered, StringOrCreativeWork mainEntityOfPage, NumberOrQuantitativeValue numberOfPreviousOwners, ProductModelOrString model, QuantitativeValueOrDistance height, java.util.Date productionDate, QuantitativeValue mileageFromOdometer, String alternateName, java.util.Date releaseDate, StringOrQualitativeValue fuelType, String vehicleInteriorType, StringOrNumber numberOfAirbags, String vehicleConfiguration) {
  ...
  private StringOrNumber myNumberOfAirbags;
  ...
  private StringOrDriveWheelConfigurationValue myDriveWheelConfiguration;
  private StringOrQualitativeValue myFuelType;
  ...
  private StringOrQualitativeValue myVehicleTransmission;
