...
public class MusicReleaseFormatType extends Enumeration {
  ...
  public static final class Builder {
    ...
    public MusicReleaseFormatType build() {
      return new MusicReleaseFormatType(supersededBy, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
  ...
  protected MusicReleaseFormatType(EnumerationOrProperty supersededBy, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction) {
