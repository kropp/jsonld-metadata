...
public class BibExTerm {
  ...
  @Override public boolean equals(Object o) {
    ...
    BibExTerm bibExTerm = (BibExTerm) o;
   ...
   */
  public static class Builder implements ThingBuilder<BibExTerm> {
    public BibExTerm build() {
      return new BibExTerm();
    }
