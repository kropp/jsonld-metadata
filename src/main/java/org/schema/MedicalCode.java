...
public class MedicalCode extends MedicalIntangible {
  ...
  static final class MedicalCodeThingBuilder implements Builder {
     ...
     * The actual code.
     */
    @NotNull public Builder codeValue(String codeValue) {
     ...
     * The coding system, e.g. 'ICD-10'.
     */
    @NotNull public Builder codingSystem(String codingSystem) {
  ...
  public interface Builder extends ThingBuilder<MedicalCode> {
    @NotNull Builder codeValue(String codeValue);
    @NotNull Builder codingSystem(String codingSystem);
