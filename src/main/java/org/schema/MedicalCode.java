...
public class MedicalCode extends MedicalIntangible {
  ...
  public static class Builder extends MedicalIntangible.Builder {
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("codeValue".equals(key) && value instanceof String) { codeValue((String)value); return; }
      if ("codingSystem".equals(key) && value instanceof String) { codingSystem((String)value); return; }
