...
/**
 * A code for a medical entity.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class MedicalCode extends MedicalIntangible {
  /**
   * The actual code.
   */
  public String getCodeValue() { return myCodeValue; }
  /**
   * The coding system, e.g. 'ICD-10'.
   */
  public String getCodingSystem() { return myCodingSystem; }
   ...
   */
  public static class Builder implements ThingBuilder<MedicalCode> {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("codeValue".equals(key) && value instanceof String) { codeValue((String)value); continue; }
        if ("codingSystem".equals(key) && value instanceof String) { codingSystem((String)value); continue; }
