...
public class MedicalCode extends MedicalIntangible {
  ...
  /**
   * Builder for {@see MedicalCode}
   */
  public static final class Builder {
    public MedicalCode build() {
      return new MedicalCode(codeValue, mainEntityOfPage, codingSystem, alternateName, potentialAction, url, additionalType, medicineSystem, sameAs, recognizingAuthority, study, code, image, name, relevantSpecialty, guideline, description);
    }
    /**
     * The actual code.
     */
    public Builder codeValue(String value) {
      codeValue = value;
      return this;
    }
    /**
     ...
     * The coding system, e.g. 'ICD-10'.
     */
    public Builder codingSystem(String value) {
      codingSystem = value;
      return this;
    }
    /**
  ...
  protected MedicalCode(String codeValue, CreativeWork mainEntityOfPage, String codingSystem, String alternateName, Action potentialAction, String url, String additionalType, MedicineSystem medicineSystem, String sameAs, Organization recognizingAuthority, MedicalStudy study, MedicalCode code, Image image, String name, MedicalSpecialty relevantSpecialty, MedicalGuideline guideline, String description) {
