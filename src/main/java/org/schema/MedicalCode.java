...
public class MedicalCode extends MedicalIntangible {
  ...
  public static final class Builder {
    ...
    public MedicalCode build() {
      return new MedicalCode(recognizingAuthority, code, name, mainEntityOfPage, guideline, url, sameAs, additionalType, codingSystem, alternateName, study, potentialAction, description, codeValue, relevantSpecialty, medicineSystem);
    }
    /**
     ...
     * The coding system, e.g. 'ICD-10'.
     */
    public Builder codingSystem(String codingSystem) {
  ...
  protected MedicalCode(Organization recognizingAuthority, MedicalCode code, String name, StringOrCreativeWork mainEntityOfPage, MedicalGuideline guideline, String url, String sameAs, String additionalType, String codingSystem, String alternateName, MedicalStudy study, Action potentialAction, String description, String codeValue, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem) {
