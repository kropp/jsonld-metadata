...
public class Mosque extends PlaceOfWorship {
  /**
   * Builder for {@see Mosque}
   */
  public static final class Builder {
    public Mosque build() {
      return new Mosque(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, geo, url, additionalType, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
