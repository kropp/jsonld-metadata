...
public class WantAction extends ReactAction {
  /**
   * Builder for {@see WantAction}
   */
  public static final class Builder {
    public WantAction build() {
      return new WantAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, object, location, description);
    }
