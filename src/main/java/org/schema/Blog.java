...
public class Blog extends CreativeWork {
   ...
   */
  public static final class BlogThingBuilder implements Builder {
    /**
     ...
     * A posting that is part of this blog.
     */
    public Builder blogPost(BlogPosting.Builder blogPosting) {
  ...
  Builder blogPost(BlogPosting blogPosting);
  Builder blogPost(BlogPosting.Builder blogPosting);
