...
public class Blog extends CreativeWork {
  ...
  /**
   * Builder for {@see Blog}
   */
  public static final class Builder {
    public Blog build() {
      return new Blog(editor, review, producer, timeRequired, offers, creator, educationalUse, alternativeHeadline, mentions, additionalType, position, associatedMedia, isFamilyFriendly, accessibilityControl, image, keywords, discussionUrl, isBasedOnUrl, exampleOfWork, comment, datePublished, author, alternateName, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, genre, potentialAction, contentRating, audience, inLanguage, contentLocation, learningResourceType, audio, accountablePerson, dateModified, thumbnailUrl, releasedEvent, accessibilityFeature, accessibilityHazard, license, description, publication, provider, educationalAlignment, recordedAt, mainEntityOfPage, contributor, isPartOf, workExample, dateCreated, copyrightHolder, aggregateRating, sameAs, blogPost, name, typicalAgeRange, citation, copyrightYear, translator, sourceOrganization, text, award);
    }
    /**
     ...
     * A posting that is part of this blog.
     */
    public Builder blogPost(BlogPosting value) {
      blogPost = value;
      return this;
    }
    /**
