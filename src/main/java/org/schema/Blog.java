...
public class Blog extends CreativeWork {
  ...
  static final class BlogThingBuilder implements Builder {
     ...
     * A posting that is part of this blog.
     */
    @NotNull public Builder blogPost(BlogPosting blogPosting) {
     ...
     * A posting that is part of this blog.
     */
    @NotNull public Builder blogPost(BlogPosting.Builder blogPosting) {
  ...
  public interface Builder extends ThingBuilder<Blog> {
    @NotNull Builder blogPost(BlogPosting blogPosting);
    @NotNull Builder blogPost(BlogPosting.Builder blogPosting);
