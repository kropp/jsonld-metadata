...
public class Blog extends CreativeWork {
  ...
  static final class BlogThingBuilder implements Builder {
    ...
    @NotNull public Builder blogPost(@NotNull BlogPosting.Builder blogPosting) {
      return this.blogPost(blogPosting.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("blogPost".equals(key) && value instanceof BlogPosting) { blogPost((BlogPosting)value); continue; }
  ...
  public interface Builder extends ThingBuilder<Blog> {
    @NotNull Builder blogPost(@NotNull BlogPosting blogPosting);
    @NotNull Builder blogPost(@NotNull BlogPosting.Builder blogPosting);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myBlogPost != null ? myBlogPost.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myBlogPost != null ? !myBlogPost.equals(blog.myBlogPost) : blog.myBlogPost != null) return false;
    return true;
  }
