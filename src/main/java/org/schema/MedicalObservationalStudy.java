...
public class MedicalObservationalStudy extends MedicalStudy {
  ...
  /**
   * Builder for {@see MedicalObservationalStudy}
   */
  public static final class Builder {
    public MedicalObservationalStudy build() {
      return new MedicalObservationalStudy(studyLocation, sponsor, mainEntityOfPage, status, potentialAction, alternateName, additionalType, url, studyDesign, medicineSystem, recognizingAuthority, sameAs, outcome, study, code, studySubject, name, image, relevantSpecialty, guideline, description, population);
    }
    /**
     ...
     * Specifics about the observational study design (enumerated).
     */
    public Builder studyDesign(MedicalObservationalStudyDesign value) {
      studyDesign = value;
      return this;
    }
    /**
  ...
  protected MedicalObservationalStudy(AdministrativeArea studyLocation, Organization sponsor, CreativeWork mainEntityOfPage, MedicalStudyStatus status, Action potentialAction, String alternateName, String additionalType, String url, MedicalObservationalStudyDesign studyDesign, MedicineSystem medicineSystem, Organization recognizingAuthority, String sameAs, String outcome, MedicalStudy study, MedicalCode code, MedicalEntity studySubject, String name, Image image, MedicalSpecialty relevantSpecialty, MedicalGuideline guideline, String description, String population) {
