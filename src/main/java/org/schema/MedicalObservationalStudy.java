...
public class MedicalObservationalStudy extends MedicalStudy {
  ...
  static final class MedicalObservationalStudyThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("studyDesign".equals(key) && value instanceof MedicalObservationalStudyDesign) { studyDesign((MedicalObservationalStudyDesign)value); continue; }
  ...
  public interface Builder extends ThingBuilder<MedicalObservationalStudy> {
    @NotNull Builder studyDesign(@NotNull MedicalObservationalStudyDesign medicalObservationalStudyDesign);
    @NotNull Builder studyDesign(@NotNull MedicalObservationalStudyDesign.Builder medicalObservationalStudyDesign);
