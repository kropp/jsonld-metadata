...
public class Diet extends LifestyleModification {
   ...
   */
  public static final class DietThingBuilder implements Builder {
    /**
     ...
     * People or organizations that endorse the plan.
     */
    public Builder endorsers(Organization.Builder organization) {
     ...
     * People or organizations that endorse the plan.
     */
    public Builder endorsers(Person.Builder person) {
  ...
  Builder dietFeatures(String dietFeatures);
  Builder endorsers(Organization organization);
  Builder endorsers(Organization.Builder organization);
  Builder endorsers(Person person);
  Builder endorsers(Person.Builder person);
  Builder expertConsiderations(String expertConsiderations);
  Builder overview(String overview);
  Builder physiologicalBenefits(String physiologicalBenefits);
  Builder proprietaryName(String proprietaryName);
  Builder risks(String risks);
