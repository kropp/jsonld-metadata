...
public class SoftwareSourceCode extends CreativeWork {
   ...
   */
  @JsonIgnore public Language getProgrammingLanguage() {
    return (Language) getValue("programmingLanguage");
  }
  /**
   * The computer programming language.
   */
  @JsonIgnore public Collection<Language> getProgrammingLanguages() {
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @NotNull public Builder programmingLanguage(@NotNull Language language) {
      putValue("programmingLanguage", language);
      return this;
    }
    /**
     * The computer programming language.
    ...
    @NotNull public Builder programmingLanguage(@NotNull Language.Builder language) {
      putValue("programmingLanguage", language.build());
      return this;
    }
    /**
     * Runtime platform or script interpreter dependencies (Example - Java v1, Python2.3, .Net Framework 3.0).
    ...
    @Override protected void fromMap(String key, Object value) {
      ...
      if ("programmingLanguage".equals(key) && value instanceof Language) { programmingLanguage((Language)value); return; }
