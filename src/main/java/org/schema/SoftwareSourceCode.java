...
public class SoftwareSourceCode extends CreativeWork {
  ...
  public static final class Builder {
    /**
     * Creates new {@link SoftwareSourceCode} instance.
     */
    public SoftwareSourceCode build() {
      return new SoftwareSourceCode(accessibilityAPI, targetProduct, aggregateRating, hasPart, review, datePublished, comment, schemaVersion, video, award, editor, workExample, codeSampleType, potentialAction, producer, publisher, sourceOrganization, genre, learningResourceType, publishingPrinciples, translator, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, runtimePlatform, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, about, contentLocation, accessibilityHazard, author, version, accountablePerson, sameAs, additionalType, thumbnailUrl, publication, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, alternativeHeadline, mainEntity, name, license, copyrightYear, discussionUrl, mainEntityOfPage, isBasedOnUrl, isFamilyFriendly, exampleOfWork, codeRepository, alternateName, releasedEvent, programmingLanguage, contributor, creator);
    }
    /**
     ...
     * Target Operating System / Product to which the code applies.  If applies to several versions, just the product name can be used.
     */
    public Builder targetProduct(SoftwareApplication softwareApplication) {
      this.targetProduct = softwareApplication;
      return this;
    }
    /**
     ...
     * Full (compile ready) solution, code snippet, inline code, scripts, template.
     */
    public Builder codeSampleType(String codeSampleType) {
     ...
     * Runtime platform or script interpreter dependencies (Example - Java v1, Python2.3, .Net Framework 3.0).
     */
    public Builder runtimePlatform(String runtimePlatform) {
     ...
     * Link to the repository where the un-compiled, human readable code and related code is located (SVN, github, CodePlex).
     */
    public Builder codeRepository(String codeRepository) {
     ...
     * The computer programming language.
     */
    public Builder programmingLanguage(Language language) {
  ...
  protected SoftwareSourceCode(String accessibilityAPI, SoftwareApplication targetProduct, AggregateRating aggregateRating, HasPart hasPart, Review review, java.util.Date datePublished, Comment comment, String schemaVersion, VideoObject video, String award, Person editor, CreativeWork workExample, String codeSampleType, Action potentialAction, OrganizationOrPerson producer, Organization publisher, Organization sourceOrganization, String genre, String learningResourceType, String publishingPrinciples, OrganizationOrPerson translator, Event recordedAt, Integer commentCount, LanguageOrString inLanguage, java.util.Date dateModified, Thing mentions, Audience audience, String runtimePlatform, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, String contentRating, String description, Offer offers, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, String educationalUse, String keywords, AlignmentObject educationalAlignment, String text, Thing about, Place contentLocation, String accessibilityHazard, OrganizationOrPerson author, Number version, Person accountablePerson, String sameAs, String additionalType, String thumbnailUrl, PublicationEvent publication, MediaObject encoding, Duration timeRequired, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, String alternativeHeadline, Thing mainEntity, String name, StringOrCreativeWork license, Number copyrightYear, String discussionUrl, StringOrCreativeWork mainEntityOfPage, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, String codeRepository, String alternateName, PublicationEvent releasedEvent, Language programmingLanguage, OrganizationOrPerson contributor, OrganizationOrPerson creator) {
    ...
    myCodeRepository = codeRepository;
    myProgrammingLanguage = programmingLanguage;
    myRuntimePlatform = runtimePlatform;
  ...
  private String myCodeSampleType;
  private SoftwareApplication myTargetProduct;
}
