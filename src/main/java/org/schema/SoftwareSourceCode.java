...
public class SoftwareSourceCode extends CreativeWork {
  ...
  static final class SoftwareSourceCodeThingBuilder implements Builder {
     ...
     * Link to the repository where the un-compiled, human readable code and related code is located (SVN, github, CodePlex).
     */
    @NotNull public Builder codeRepository(String codeRepository) {
     ...
     * The computer programming language.
     */
    @NotNull public Builder programmingLanguage(Language language) {
     ...
     * The computer programming language.
     */
    @NotNull public Builder programmingLanguage(Language.Builder language) {
      return this.programmingLanguage(language.build());
    }
    /**
     * Runtime platform or script interpreter dependencies (Example - Java v1, Python2.3, .Net Framework 3.0).
     */
    @NotNull public Builder runtimePlatform(String runtimePlatform) {
     ...
     * Full (compile ready) solution, code snippet, inline code, scripts, template.
     */
    @NotNull public Builder codeSampleType(String codeSampleType) {
  ...
  public interface Builder extends ThingBuilder<SoftwareSourceCode> {
    @NotNull Builder codeRepository(String codeRepository);
    @NotNull Builder programmingLanguage(Language language);
    @NotNull Builder programmingLanguage(Language.Builder language);
    @NotNull Builder runtimePlatform(String runtimePlatform);
    @NotNull Builder codeSampleType(String codeSampleType);
    @NotNull Builder targetProduct(SoftwareApplication softwareApplication);
