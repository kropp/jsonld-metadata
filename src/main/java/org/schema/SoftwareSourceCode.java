...
public class SoftwareSourceCode extends CreativeWork {
  ...
  /**
   * Builder for {@see SoftwareSourceCode}
   */
  public static final class Builder {
    public SoftwareSourceCode build() {
      return new SoftwareSourceCode(review, producer, editor, timeRequired, offers, creator, educationalUse, alternativeHeadline, mentions, additionalType, position, associatedMedia, isFamilyFriendly, accessibilityControl, image, keywords, discussionUrl, isBasedOnUrl, exampleOfWork, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, genre, potentialAction, contentRating, audience, codeRepository, codeSampleType, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, releasedEvent, accessibilityFeature, accessibilityHazard, license, description, publication, provider, programmingLanguage, educationalAlignment, recordedAt, mainEntityOfPage, contributor, targetProduct, isPartOf, workExample, dateCreated, copyrightHolder, aggregateRating, sameAs, name, typicalAgeRange, runtimePlatform, citation, copyrightYear, translator, sourceOrganization, text, award);
    }
    /**
     ...
     * Link to the repository where the un-compiled, human readable code and related code is located (SVN, github, CodePlex).
     */
    public Builder codeRepository(String value) {
      codeRepository = value;
      return this;
    }
    /**
     * Full (compile ready) solution, code snippet, inline code, scripts, template.
     */
    public Builder codeSampleType(String value) {
      codeSampleType = value;
      return this;
    }
    /**
     ...
     * The computer programming language.
     */
    public Builder programmingLanguage(Language value) {
     ...
     * Target Operating System / Product to which the code applies.  If applies to several versions, just the product name can be used.
     */
    public Builder targetProduct(SoftwareApplication value) {
      targetProduct = value;
      return this;
    }
     ...
     * Runtime platform or script interpreter dependencies (Example - Java v1, Python2.3, .Net Framework 3.0).
     */
    public Builder runtimePlatform(String value) {
  ...
  protected SoftwareSourceCode(Review review, Person producer, Person editor, Duration timeRequired, Offer offers, Organization creator, String educationalUse, String alternativeHeadline, Thing mentions, String additionalType, Position position, MediaObject associatedMedia, Boolean isFamilyFriendly, String accessibilityControl, Image image, String keywords, String discussionUrl, String isBasedOnUrl, CreativeWork exampleOfWork, Comment comment, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, Person character, String schemaVersion, String accessibilityAPI, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, String genre, Action potentialAction, String contentRating, Audience audience, String codeRepository, String codeSampleType, String inLanguage, Place contentLocation, String learningResourceType, Person accountablePerson, AudioObject audio, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, String accessibilityFeature, String accessibilityHazard, CreativeWork license, String description, PublicationEvent publication, Person provider, Language programmingLanguage, AlignmentObject educationalAlignment, Event recordedAt, CreativeWork mainEntityOfPage, Organization contributor, SoftwareApplication targetProduct, IsPartOf isPartOf, CreativeWork workExample, java.util.Date dateCreated, Organization copyrightHolder, AggregateRating aggregateRating, String sameAs, String name, String typicalAgeRange, String runtimePlatform, CreativeWork citation, Number copyrightYear, Person translator, Organization sourceOrganization, String text, String award) {
