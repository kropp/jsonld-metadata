...
public class SoftwareSourceCode extends CreativeWork {
  ...
  static final class SoftwareSourceCodeThingBuilder implements Builder {
     ...
     * The computer programming language.
     */
    @NotNull public Builder programmingLanguage(@NotNull Language language) {
     ...
     * The computer programming language.
     */
    @NotNull public Builder programmingLanguage(@NotNull Language.Builder language) {
      return this.programmingLanguage(language.build());
    }
    /**
     * Runtime platform or script interpreter dependencies (Example - Java v1, Python2.3, .Net Framework 3.0).
     */
    ...
    @NotNull public Builder targetProduct(@NotNull SoftwareApplication.Builder softwareApplication) {
      return this.targetProduct(softwareApplication.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("codeRepository".equals(key) && value instanceof String) { codeRepository((String)value); continue; }
        if ("programmingLanguage".equals(key) && value instanceof Language) { programmingLanguage((Language)value); continue; }
        if ("runtimePlatform".equals(key) && value instanceof String) { runtimePlatform((String)value); continue; }
        if ("codeSampleType".equals(key) && value instanceof String) { codeSampleType((String)value); continue; }
        if ("targetProduct".equals(key) && value instanceof SoftwareApplication) { targetProduct((SoftwareApplication)value); continue; }
  ...
  public interface Builder extends ThingBuilder<SoftwareSourceCode> {
    @NotNull Builder codeRepository(@NotNull String codeRepository);
    @NotNull Builder programmingLanguage(@NotNull Language language);
    @NotNull Builder programmingLanguage(@NotNull Language.Builder language);
    @NotNull Builder runtimePlatform(@NotNull String runtimePlatform);
    @NotNull Builder codeSampleType(@NotNull String codeSampleType);
    @NotNull Builder targetProduct(@NotNull SoftwareApplication softwareApplication);
    @NotNull Builder targetProduct(@NotNull SoftwareApplication.Builder softwareApplication);
