...
public class SoftwareSourceCode extends CreativeWork {
   ...
   */
  public static final class SoftwareSourceCodeThingBuilder implements Builder {
    /**
     ...
     * The computer programming language.
     */
    public Builder programmingLanguage(Language.Builder language) {
     ...
     * Target Operating System / Product to which the code applies.  If applies to several versions, just the product name can be used.
     */
    public Builder targetProduct(SoftwareApplication.Builder softwareApplication) {
  ...
  Builder codeRepository(String codeRepository);
  Builder programmingLanguage(Language language);
  Builder programmingLanguage(Language.Builder language);
  Builder runtimePlatform(String runtimePlatform);
  Builder codeSampleType(String codeSampleType);
  Builder targetProduct(SoftwareApplication softwareApplication);
