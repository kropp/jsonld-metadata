...
public class HomeAndConstructionBusiness extends LocalBusiness {
  ...
  public static final class Builder {
    /**
     * Creates new {@link HomeAndConstructionBusiness} instance.
     */
    public HomeAndConstructionBusiness build() {
      return new HomeAndConstructionBusiness(aggregateRating, review, logo, parentOrganization, containedIn, event, additionalType, sameAs, priceRange, openingHoursSpecification, currenciesAccepted, potentialAction, address, additionalProperty, openingHours, globalLocationNumber, isicV4, name, paymentAccepted, mainEntityOfPage, hasMap, url, alternateName, faxNumber, geo, telephone, description, photo);
    }
    /**
