...
public class MedicalContraindication extends MedicalEntity {
   ...
   */
  static final class MedicalContraindicationThingBuilder implements Builder {
    /**
     * Creates new {@link MedicalContraindication} instance.
     */
    public MedicalContraindication build() {
      return new MedicalContraindication(code, guideline, medicineSystem, recognizingAuthority, relevantSpecialty, study, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<MedicalContraindication> {
  ...
  protected MedicalContraindication(MedicalCode code, MedicalGuideline guideline, MedicineSystem medicineSystem, Organization recognizingAuthority, MedicalSpecialty relevantSpecialty, MedicalStudy study, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
  ...
  @Override public boolean equals(Object o) {
    ...
    MedicalContraindication medicalContraindication = (MedicalContraindication) o;
