...
public class VideoGameSeries extends CreativeWorkSeries {
   ...
   */
  public ThingOrString getGamePlatform() {
  ...
  public static final class Builder {
    ...
    public VideoGameSeries build() {
      return new VideoGameSeries(accessibilityAPI, aggregateRating, hasPart, review, datePublished, schemaVersion, comment, video, award, characterAttribute, editor, director, workExample, potentialAction, startDate, producer, cheatCode, numberOfPlayers, publisher, sourceOrganization, genre, learningResourceType, publishingPrinciples, translator, recordedAt, inLanguage, commentCount, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, gameLocation, playMode, containsSeason, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, gameItem, keywords, educationalAlignment, text, endDate, about, numberOfEpisodes, contentLocation, musicBy, accessibilityHazard, author, version, accountablePerson, additionalType, sameAs, thumbnailUrl, publication, actor, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, trailer, mainEntity, alternativeHeadline, name, license, mainEntityOfPage, discussionUrl, copyrightYear, gamePlatform, isBasedOnUrl, isFamilyFriendly, exampleOfWork, episode, alternateName, quest, releasedEvent, numberOfSeasons, productionCompany, creator, contributor);
    }
    /**
     ...
     * A piece of data that represents a particular aspect of a fictional character (skill, power, character points, advantage, disadvantage).
     */
    public Builder characterAttribute(Thing thing) {
     ...
     * Cheat codes to the game.
     */
    public Builder cheatCode(CreativeWork creativeWork) {
     ...
     * The task that a player-controlled character, or group of characters may complete in order to gain a reward.
     */
    public Builder quest(Thing thing) {
      this.quest = thing;
      return this;
    }
    /**
    ...
    private ThingOrString gamePlatform;
  ...
  protected VideoGameSeries(String accessibilityAPI, AggregateRating aggregateRating, HasPart hasPart, Review review, java.util.Date datePublished, String schemaVersion, Comment comment, VideoObject video, String award, Thing characterAttribute, Person editor, Person director, CreativeWork workExample, Action potentialAction, java.util.Date startDate, OrganizationOrPerson producer, CreativeWork cheatCode, QuantitativeValue numberOfPlayers, Organization publisher, Organization sourceOrganization, String genre, String learningResourceType, String publishingPrinciples, OrganizationOrPerson translator, Event recordedAt, LanguageOrString inLanguage, Integer commentCount, java.util.Date dateModified, Thing mentions, Audience audience, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, String contentRating, PlaceOrPostalAddressOrString gameLocation, GamePlayMode playMode, HasPart containsSeason, String description, Offer offers, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, String educationalUse, Thing gameItem, String keywords, AlignmentObject educationalAlignment, String text, java.util.Date endDate, Thing about, Integer numberOfEpisodes, Place contentLocation, MusicGroupOrPerson musicBy, String accessibilityHazard, OrganizationOrPerson author, Number version, Person accountablePerson, String additionalType, String sameAs, String thumbnailUrl, PublicationEvent publication, Person actor, MediaObject encoding, Duration timeRequired, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, VideoObject trailer, Thing mainEntity, String alternativeHeadline, String name, StringOrCreativeWork license, StringOrCreativeWork mainEntityOfPage, String discussionUrl, Number copyrightYear, ThingOrString gamePlatform, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, HasPart episode, String alternateName, Thing quest, PublicationEvent releasedEvent, Integer numberOfSeasons, Organization productionCompany, OrganizationOrPerson creator, OrganizationOrPerson contributor) {
    super(accessibilityAPI, aggregateRating, hasPart, review, datePublished, comment, schemaVersion, video, award, editor, workExample, potentialAction, startDate, producer, publisher, sourceOrganization, genre, learningResourceType, publishingPrinciples, translator, recordedAt, inLanguage, commentCount, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, endDate, text, about, contentLocation, author, accessibilityHazard, version, accountablePerson, sameAs, additionalType, thumbnailUrl, publication, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, alternativeHeadline, mainEntity, name, license, copyrightYear, discussionUrl, mainEntityOfPage, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, contributor, creator);
    myActor = actor;
    myDirector = director;
    myEpisode = episode;
    myMusicBy = musicBy;
  ...
  private ThingOrString myGamePlatform;
