...
public class VideoGameSeries extends CreativeWorkSeries {
  ...
  static final class VideoGameSeriesThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("actor".equals(key) && value instanceof Person) { actor((Person)value); continue; }
        if ("director".equals(key) && value instanceof Person) { director((Person)value); continue; }
        if ("episode".equals(key) && value instanceof HasPart) { episode((HasPart)value); continue; }
        ...
        if ("numberOfEpisodes".equals(key) && value instanceof Integer) { numberOfEpisodes((Integer)value); continue; }
        if ("numberOfSeasons".equals(key) && value instanceof Integer) { numberOfSeasons((Integer)value); continue; }
        if ("productionCompany".equals(key) && value instanceof Organization) { productionCompany((Organization)value); continue; }
        if ("containsSeason".equals(key) && value instanceof HasPart) { containsSeason((HasPart)value); continue; }
  ...
  public interface Builder extends ThingBuilder<VideoGameSeries> {
    @NotNull Builder actor(@NotNull Person person);
    @NotNull Builder actor(@NotNull Person.Builder person);
    @NotNull Builder director(@NotNull Person person);
    @NotNull Builder director(@NotNull Person.Builder person);
    @NotNull Builder episode(@NotNull HasPart hasPart);
    ...
    @NotNull Builder numberOfEpisodes(@NotNull Integer integer);
    @NotNull Builder numberOfSeasons(@NotNull Integer integer);
    @NotNull Builder productionCompany(@NotNull Organization organization);
    @NotNull Builder productionCompany(@NotNull Organization.Builder organization);
    @NotNull Builder containsSeason(@NotNull HasPart hasPart);
