...
public class VideoGameSeries extends CreativeWorkSeries {
  ...
  static final class VideoGameSeriesThingBuilder implements Builder {
     ...
     * An actor, e.g. in tv, radio, movie, video games etc. Actors can be associated with individual items or with a series, episode, clip.
     */
    @NotNull public Builder actor(Person.Builder person) {
      return this.actor(person.build());
    }
    /**
     * A director of e.g. tv, radio, movie, video games etc. content. Directors can be associated with individual items or with a series, episode, clip.
     */
    @NotNull public Builder director(Person person) {
     ...
     * A director of e.g. tv, radio, movie, video games etc. content. Directors can be associated with individual items or with a series, episode, clip.
     */
    @NotNull public Builder director(Person.Builder person) {
      return this.director(person.build());
    }
    /**
     * An episode of a tv, radio or game media within a series or season.
     */
    @NotNull public Builder episode(HasPart hasPart) {
     ...
     * The composer of the soundtrack.
     */
    @NotNull public Builder musicBy(MusicGroup musicGroup) {
     ...
     * The composer of the soundtrack.
     */
    @NotNull public Builder musicBy(MusicGroup.Builder musicGroup) {
      return this.musicBy(musicGroup.build());
    }
    /**
     * The composer of the soundtrack.
     */
    @NotNull public Builder musicBy(Person person) {
      if (this.musicBy == null) this.musicBy = new MusicGroupOrPerson();
     ...
     * The composer of the soundtrack.
     */
    @NotNull public Builder musicBy(Person.Builder person) {
      return this.musicBy(person.build());
    }
    /**
     * The number of episodes in this season or series.
     */
    @NotNull public Builder numberOfEpisodes(int numberOfEpisodes) {
     ...
     * The number of seasons in this series.
     */
    @NotNull public Builder numberOfSeasons(int numberOfSeasons) {
     ...
     * The production company or studio responsible for the item e.g. series, video game, episode etc.
     */
    @NotNull public Builder productionCompany(Organization organization) {
     ...
     * The production company or studio responsible for the item e.g. series, video game, episode etc.
     */
    @NotNull public Builder productionCompany(Organization.Builder organization) {
      return this.productionCompany(organization.build());
    }
    /**
     * A season that is part of the media series.
     */
    @NotNull public Builder containsSeason(HasPart hasPart) {
     ...
     * The trailer of a movie or tv/radio series, season, episode, etc.
     */
    @NotNull public Builder trailer(VideoObject videoObject) {
     ...
     * The trailer of a movie or tv/radio series, season, episode, etc.
     */
    @NotNull public Builder trailer(VideoObject.Builder videoObject) {
      return this.trailer(videoObject.build());
    }
    /**
     * Indicate how many people can play this game (minimum, maximum, or range).
     */
    @NotNull public Builder numberOfPlayers(QuantitativeValue quantitativeValue) {
     ...
     * The task that a player-controlled character, or group of characters may complete in order to gain a reward.
     */
    @NotNull public Builder quest(Thing thing) {
      this.quest = thing;
      return this;
    }
    /**
     * The task that a player-controlled character, or group of characters may complete in order to gain a reward.
     */
    @NotNull public Builder quest(Thing.Builder thing) {
      return this.quest(thing.build());
    }
    /**
     * An item is an object within the game world that can be collected by a player or, occasionally, a non-player character.
     */
    @NotNull public Builder gameItem(Thing thing) {
      this.gameItem = thing;
      return this;
    }
    /**
     * An item is an object within the game world that can be collected by a player or, occasionally, a non-player character.
     */
    @NotNull public Builder gameItem(Thing.Builder thing) {
      return this.gameItem(thing.build());
    }
    /**
     * A piece of data that represents a particular aspect of a fictional character (skill, power, character points, advantage, disadvantage).
     */
    @NotNull public Builder characterAttribute(Thing thing) {
      this.characterAttribute = thing;
      return this;
    }
    /**
     * A piece of data that represents a particular aspect of a fictional character (skill, power, character points, advantage, disadvantage).
     */
    @NotNull public Builder characterAttribute(Thing.Builder thing) {
      return this.characterAttribute(thing.build());
    }
    /**
     * Indicates whether this game is multi-player, co-op or single-player.  The game can be marked as multi-player, co-op and single-player at the same time.
     */
    @NotNull public Builder playMode(GamePlayMode gamePlayMode) {
     ...
     * Indicates whether this game is multi-player, co-op or single-player.  The game can be marked as multi-player, co-op and single-player at the same time.
     */
    @NotNull public Builder playMode(GamePlayMode.Builder gamePlayMode) {
      return this.playMode(gamePlayMode.build());
    }
    /**
     * Cheat codes to the game.
     */
    @NotNull public Builder cheatCode(CreativeWork creativeWork) {
      this.cheatCode = creativeWork;
      return this;
    }
    /**
     * Cheat codes to the game.
     */
    @NotNull public Builder cheatCode(CreativeWork.Builder creativeWork) {
      return this.cheatCode(creativeWork.build());
    }
    /**
     * The electronic systems used to play <a href="http://en.wikipedia.org/wiki/Category:Video_game_platforms">video games</a>.
     */
    @NotNull public Builder gamePlatform(String gamePlatform) {
     ...
     * The electronic systems used to play <a href="http://en.wikipedia.org/wiki/Category:Video_game_platforms">video games</a>.
     */
    @NotNull public Builder gamePlatform(Thing thing) {
      if (this.gamePlatform == null) this.gamePlatform = new StringOrThing();
     ...
     * The electronic systems used to play <a href="http://en.wikipedia.org/wiki/Category:Video_game_platforms">video games</a>.
     */
    @NotNull public Builder gamePlatform(Thing.Builder thing) {
      return this.gamePlatform(thing.build());
    }
    /**
     * Real or fictional location of the game (or part of game).
     */
    @NotNull public Builder gameLocation(Place place) {
     ...
     * Real or fictional location of the game (or part of game).
     */
    @NotNull public Builder gameLocation(Place.Builder place) {
      return this.gameLocation(place.build());
    }
    /**
     * Real or fictional location of the game (or part of game).
     */
    @NotNull public Builder gameLocation(PostalAddress postalAddress) {
      if (this.gameLocation == null) this.gameLocation = new PlaceOrPostalAddressOrString();
     ...
     * Real or fictional location of the game (or part of game).
     */
    @NotNull public Builder gameLocation(PostalAddress.Builder postalAddress) {
      return this.gameLocation(postalAddress.build());
    }
    /**
     * Real or fictional location of the game (or part of game).
     */
    @NotNull public Builder gameLocation(String gameLocation) {
      if (this.gameLocation == null) this.gameLocation = new PlaceOrPostalAddressOrString();
    ...
    private StringOrThing gamePlatform;
    private PlaceOrPostalAddressOrString gameLocation;
  ...
  public interface Builder extends ThingBuilder<VideoGameSeries> {
    @NotNull Builder actor(Person person);
    @NotNull Builder actor(Person.Builder person);
    @NotNull Builder director(Person person);
    @NotNull Builder director(Person.Builder person);
    @NotNull Builder episode(HasPart hasPart);
    @NotNull Builder musicBy(MusicGroup musicGroup);
    @NotNull Builder musicBy(MusicGroup.Builder musicGroup);
    @NotNull Builder musicBy(Person person);
    @NotNull Builder musicBy(Person.Builder person);
    @NotNull Builder numberOfEpisodes(int numberOfEpisodes);
    @NotNull Builder numberOfSeasons(int numberOfSeasons);
    @NotNull Builder productionCompany(Organization organization);
    @NotNull Builder productionCompany(Organization.Builder organization);
    @NotNull Builder containsSeason(HasPart hasPart);
    @NotNull Builder trailer(VideoObject videoObject);
    @NotNull Builder trailer(VideoObject.Builder videoObject);
    @NotNull Builder numberOfPlayers(QuantitativeValue quantitativeValue);
    @NotNull Builder numberOfPlayers(QuantitativeValue.Builder quantitativeValue);
    @NotNull Builder quest(Thing thing);
    @NotNull Builder quest(Thing.Builder thing);
    @NotNull Builder gameItem(Thing thing);
    @NotNull Builder gameItem(Thing.Builder thing);
    @NotNull Builder characterAttribute(Thing thing);
    @NotNull Builder characterAttribute(Thing.Builder thing);
    @NotNull Builder playMode(GamePlayMode gamePlayMode);
    @NotNull Builder playMode(GamePlayMode.Builder gamePlayMode);
    @NotNull Builder cheatCode(CreativeWork creativeWork);
    @NotNull Builder cheatCode(CreativeWork.Builder creativeWork);
    @NotNull Builder gamePlatform(String gamePlatform);
    @NotNull Builder gamePlatform(Thing thing);
    @NotNull Builder gamePlatform(Thing.Builder thing);
    @NotNull Builder gameLocation(Place place);
    @NotNull Builder gameLocation(Place.Builder place);
    @NotNull Builder gameLocation(PostalAddress postalAddress);
    @NotNull Builder gameLocation(PostalAddress.Builder postalAddress);
    @NotNull Builder gameLocation(String gameLocation);
  ...
  protected VideoGameSeries(Person actor, Person director, HasPart episode, MusicGroupOrPerson musicBy, int numberOfEpisodes, int numberOfSeasons, Organization productionCompany, HasPart containsSeason, VideoObject trailer, QuantitativeValue numberOfPlayers, Thing quest, Thing gameItem, Thing characterAttribute, GamePlayMode playMode, CreativeWork cheatCode, StringOrThing gamePlatform, PlaceOrPostalAddressOrString gameLocation, java.util.Date endDate, java.util.Date startDate, String schemaVersion, Thing about, String accessibilityAPI, String accessibilityControl, String accessibilityFeature, String accessibilityHazard, Person accountablePerson, AggregateRating aggregateRating, String alternativeHeadline, MediaObject associatedMedia, Audience audience, AudioObject audio, OrganizationOrPerson author, String award, CreativeWorkOrString citation, Comment comment, Place contentLocation, String contentRating, OrganizationOrPerson contributor, OrganizationOrPerson copyrightHolder, Number copyrightYear, OrganizationOrPerson creator, java.util.Date dateCreated, java.util.Date dateModified, java.util.Date datePublished, String discussionUrl, Person editor, AlignmentObject educationalAlignment, String educationalUse, MediaObject encoding, String genre, String headline, LanguageOrString inLanguage, String interactivityType, String isBasedOnUrl, Boolean isFamilyFriendly, String keywords, CreativeWorkOrString license, String learningResourceType, Thing mainEntity, Thing mentions, Offer offers, OrganizationOrPerson producer, PublicationEvent publication, Organization publisher, String publishingPrinciples, Event recordedAt, Review review, Organization sourceOrganization, String text, String thumbnailUrl, Duration timeRequired, String typicalAgeRange, Number version, VideoObject video, OrganizationOrPerson provider, int commentCount, HasPart hasPart, CreativeWork workExample, CreativeWork exampleOfWork, Person character, OrganizationOrPerson translator, PublicationEvent releasedEvent, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
    ...
    myTrailer = trailer;
    myNumberOfPlayers = numberOfPlayers;
    myQuest = quest;
    myGameItem = gameItem;
  ...
  private int myNumberOfEpisodes;
  private int myNumberOfSeasons;
  ...
  private Thing myCharacterAttribute;
  private GamePlayMode myPlayMode;
  private CreativeWork myCheatCode;
  private StringOrThing myGamePlatform;
  private PlaceOrPostalAddressOrString myGameLocation;
}
