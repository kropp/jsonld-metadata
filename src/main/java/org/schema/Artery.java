...
public class Artery extends Vessel {
   ...
   */
  public static final class ArteryThingBuilder implements Builder {
    /**
     ...
     * The branches that comprise the arterial structure.
     */
    public Builder arterialBranch(AnatomicalStructure.Builder anatomicalStructure) {
     ...
     * The anatomical or organ system that the artery originates from.
     */
    public Builder source(AnatomicalStructure.Builder anatomicalStructure) {
     ...
     * The area to which the artery supplies blood.
     */
    public Builder supplyTo(AnatomicalStructure.Builder anatomicalStructure) {
  ...
  Builder arterialBranch(AnatomicalStructure anatomicalStructure);
  Builder arterialBranch(AnatomicalStructure.Builder anatomicalStructure);
  Builder source(AnatomicalStructure anatomicalStructure);
  Builder source(AnatomicalStructure.Builder anatomicalStructure);
  Builder supplyTo(AnatomicalStructure anatomicalStructure);
  Builder supplyTo(AnatomicalStructure.Builder anatomicalStructure);
