...
public class Artery extends Vessel {
  ...
  public interface Builder extends ThingBuilder<Artery> {
    @NotNull Builder arterialBranch(@NotNull AnatomicalStructure anatomicalStructure);
    @NotNull Builder arterialBranch(@NotNull AnatomicalStructure.Builder anatomicalStructure);
    @NotNull Builder source(@NotNull AnatomicalStructure anatomicalStructure);
    @NotNull Builder source(@NotNull AnatomicalStructure.Builder anatomicalStructure);
    @NotNull Builder supplyTo(@NotNull AnatomicalStructure anatomicalStructure);
    @NotNull Builder supplyTo(@NotNull AnatomicalStructure.Builder anatomicalStructure);
