...
public class Artery extends Vessel {
  ...
  /**
   * Builder for {@see Artery}
   */
  public static final class Builder {
    public Artery build() {
      return new Artery(supplyTo, potentialAction, connectedTo, additionalType, medicineSystem, source, partOfSystem, code, bodyLocation, image, guideline, description, function, mainEntityOfPage, relatedCondition, subStructure, alternateName, url, associatedPathophysiology, sameAs, recognizingAuthority, study, diagram, name, relevantSpecialty, arterialBranch, relatedTherapy);
    }
    /**
     * The area to which the artery supplies blood.
     */
    public Builder supplyTo(AnatomicalStructure value) {
      supplyTo = value;
      return this;
    }
    /**
     ...
     * The anatomical or organ system that the artery originates from.
     */
    public Builder source(AnatomicalStructure value) {
      source = value;
      return this;
    }
    /**
     ...
     * The branches that comprise the arterial structure.
     */
    public Builder arterialBranch(AnatomicalStructure value) {
      arterialBranch = value;
      return this;
    }
    /**
  ...
  protected Artery(AnatomicalStructure supplyTo, Action potentialAction, AnatomicalStructure connectedTo, String additionalType, MedicineSystem medicineSystem, AnatomicalStructure source, IsPartOf partOfSystem, MedicalCode code, String bodyLocation, Image image, MedicalGuideline guideline, String description, String function, CreativeWork mainEntityOfPage, MedicalCondition relatedCondition, AnatomicalStructure subStructure, String alternateName, String url, String associatedPathophysiology, String sameAs, Organization recognizingAuthority, MedicalStudy study, ImageObject diagram, String name, MedicalSpecialty relevantSpecialty, AnatomicalStructure arterialBranch, MedicalTherapy relatedTherapy) {
