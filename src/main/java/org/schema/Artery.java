...
public class Artery extends Vessel {
  ...
  public static final class Builder {
     ...
     */
    public Artery build() {
      return new Artery(recognizingAuthority, bodyLocation, code, relatedTherapy, connectedTo, name, mainEntityOfPage, diagram, guideline, supplyTo, url, sameAs, additionalType, source, partOfSystem, function, relatedCondition, alternateName, associatedPathophysiology, study, subStructure, arterialBranch, potentialAction, description, relevantSpecialty, medicineSystem);
    }
    /**
  ...
  protected Artery(Organization recognizingAuthority, String bodyLocation, MedicalCode code, MedicalTherapy relatedTherapy, AnatomicalStructure connectedTo, String name, StringOrCreativeWork mainEntityOfPage, ImageObject diagram, MedicalGuideline guideline, AnatomicalStructure supplyTo, String url, String sameAs, String additionalType, AnatomicalStructure source, IsPartOf partOfSystem, String function, MedicalCondition relatedCondition, String alternateName, String associatedPathophysiology, MedicalStudy study, AnatomicalStructure subStructure, AnatomicalStructure arterialBranch, Action potentialAction, String description, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem) {
