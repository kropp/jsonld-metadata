...
public class Artery extends Vessel {
   ...
   */
  static final class ArteryThingBuilder implements Builder {
    /**
     ...
     * The branches that comprise the arterial structure.
     */
    @NotNull public Builder arterialBranch(AnatomicalStructure anatomicalStructure) {
     ...
     * The anatomical or organ system that the artery originates from.
     */
    @NotNull public Builder source(AnatomicalStructure anatomicalStructure) {
     ...
     * The area to which the artery supplies blood.
     */
    @NotNull public Builder supplyTo(AnatomicalStructure anatomicalStructure) {
  ...
  public interface Builder extends ThingBuilder<Artery> {
    @NotNull Builder arterialBranch(AnatomicalStructure anatomicalStructure);
    @NotNull Builder arterialBranch(AnatomicalStructure.Builder anatomicalStructure);
    @NotNull Builder source(AnatomicalStructure anatomicalStructure);
    @NotNull Builder source(AnatomicalStructure.Builder anatomicalStructure);
    @NotNull Builder supplyTo(AnatomicalStructure anatomicalStructure);
    @NotNull Builder supplyTo(AnatomicalStructure.Builder anatomicalStructure);
