...
public class SingleFamilyResidence extends Residence {
   ...
   */
  static final class SingleFamilyResidenceThingBuilder implements Builder {
    /**
     * Creates new {@link SingleFamilyResidence} instance.
     */
    public SingleFamilyResidence build() {
      return new SingleFamilyResidence(address, aggregateRating, containedIn, event, faxNumber, geo, globalLocationNumber, isicV4, logo, hasMap, openingHoursSpecification, photo, review, telephone, additionalProperty, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  public interface Builder extends ThingBuilder<SingleFamilyResidence> {
  ...
  @Override public boolean equals(Object o) {
    ...
    SingleFamilyResidence singleFamilyResidence = (SingleFamilyResidence) o;
