...
public class School extends EducationalOrganization {
  ...
  public static final class Builder {
    /**
     * Creates new {@link School} instance.
     */
    public School build() {
      return new School(aggregateRating, review, logo, duns, department, subOrganization, additionalType, sameAs, event, award, foundingDate, numberOfEmployees, seeks, brand, naics, potentialAction, dissolutionDate, foundingLocation, address, founder, owns, email, makesOffer, member, employee, isicV4, globalLocationNumber, taxID, name, vatID, mainEntityOfPage, legalName, memberOf, url, contactPoint, hasPOS, alumni, alternateName, faxNumber, telephone, description);
    }
    /**
