...
public class School extends EducationalOrganization {
   ...
   */
  static final class SchoolThingBuilder implements Builder {
    /**
  ...
  public interface Builder extends ThingBuilder<School> {
