...
public class RVPark extends CivicStructure {
  /**
   * Builder for {@see RVPark}
   */
  public static final class Builder {
    public RVPark build() {
      return new RVPark(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
