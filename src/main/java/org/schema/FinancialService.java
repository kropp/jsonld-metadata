...
public class FinancialService extends LocalBusiness {
  ...
  public static final class Builder {
    /**
     * Creates new {@link FinancialService} instance.
     */
    public FinancialService build() {
      return new FinancialService(aggregateRating, review, logo, parentOrganization, containedIn, event, additionalType, sameAs, priceRange, openingHoursSpecification, currenciesAccepted, potentialAction, address, additionalProperty, openingHours, globalLocationNumber, isicV4, name, paymentAccepted, mainEntityOfPage, hasMap, url, alternateName, faxNumber, geo, telephone, description, photo);
    }
    /**
