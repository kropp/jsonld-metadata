...
public class Mountain extends Landform {
  ...
  public static final class Builder {
    /**
     * Creates new {@link Mountain} instance.
     */
    public Mountain build() {
      return new Mountain(aggregateRating, review, logo, isicV4, globalLocationNumber, name, mainEntityOfPage, hasMap, event, containedIn, additionalType, sameAs, url, alternateName, openingHoursSpecification, faxNumber, telephone, geo, description, potentialAction, additionalProperty, photo, address);
    }
    /**
