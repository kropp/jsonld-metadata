...
public class DataCatalog extends CreativeWork {
  ...
  static final class DataCatalogThingBuilder implements Builder {
     ...
     * A dataset contained in a catalog.
     */
    @NotNull public Builder dataset(Dataset dataset) {
     ...
     * A dataset contained in a catalog.
     */
    @NotNull public Builder dataset(Dataset.Builder dataset) {
  ...
  public interface Builder extends ThingBuilder<DataCatalog> {
    @NotNull Builder dataset(Dataset dataset);
    @NotNull Builder dataset(Dataset.Builder dataset);
