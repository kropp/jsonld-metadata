...
public class DataCatalog extends CreativeWork {
   ...
   */
  public static final class DataCatalogThingBuilder implements Builder {
    /**
     ...
     * A dataset contained in a catalog.
     */
    public Builder dataset(Dataset.Builder dataset) {
  ...
  Builder dataset(Dataset.Builder dataset);
