...
public class DataCatalog extends CreativeWork {
  ...
  static final class DataCatalogThingBuilder implements Builder {
    ...
    @NotNull public Builder dataset(@NotNull Dataset.Builder dataset) {
      return this.dataset(dataset.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("dataset".equals(key) && value instanceof Dataset) { dataset((Dataset)value); continue; }
  ...
  public interface Builder extends ThingBuilder<DataCatalog> {
    @NotNull Builder dataset(@NotNull Dataset dataset);
    @NotNull Builder dataset(@NotNull Dataset.Builder dataset);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myDataset != null ? myDataset.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    DataCatalog dataCatalog = (DataCatalog) o;
    if (!super.equals(o)) return false;
    if (myDataset != null ? !myDataset.equals(dataCatalog.myDataset) : dataCatalog.myDataset != null) return false;
    return true;
  }
