...
public class ApprovedIndication extends MedicalIndication {
  ...
  public static final class Builder {
    ...
    public ApprovedIndication build() {
      return new ApprovedIndication(recognizingAuthority, code, name, mainEntityOfPage, guideline, url, sameAs, additionalType, alternateName, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
