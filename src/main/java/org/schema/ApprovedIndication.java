...
public class ApprovedIndication extends MedicalIndication {
  /**
   * Builder for {@see ApprovedIndication}
   */
  public static final class Builder {
    public ApprovedIndication build() {
      return new ApprovedIndication(mainEntityOfPage, potentialAction, alternateName, additionalType, url, medicineSystem, sameAs, recognizingAuthority, study, code, name, image, relevantSpecialty, guideline, description);
    }
    /**
