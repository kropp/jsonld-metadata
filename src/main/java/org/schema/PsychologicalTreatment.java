...
public class PsychologicalTreatment extends MedicalTherapy {
  ...
  @Override public boolean equals(Object o) {
    ...
    PsychologicalTreatment psychologicalTreatment = (PsychologicalTreatment) o;
   ...
   */
  public static class Builder implements ThingBuilder<PsychologicalTreatment> {
    public PsychologicalTreatment build() {
      return new PsychologicalTreatment(adverseOutcome, contraindication, duplicateTherapy, indication, seriousAdverseOutcome, code, guideline, medicineSystem, recognizingAuthority, relevantSpecialty, study, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
