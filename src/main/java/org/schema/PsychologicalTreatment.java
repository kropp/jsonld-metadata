...
public class PsychologicalTreatment extends MedicalTherapy {
  ...
  public static final class Builder {
    /**
     * Creates new {@link PsychologicalTreatment} instance.
     */
    public PsychologicalTreatment build() {
      return new PsychologicalTreatment(recognizingAuthority, indication, code, name, adverseOutcome, mainEntityOfPage, seriousAdverseOutcome, guideline, additionalType, url, sameAs, duplicateTherapy, contraindication, alternateName, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
  ...
  protected PsychologicalTreatment(Organization recognizingAuthority, MedicalIndication indication, MedicalCode code, String name, MedicalEntity adverseOutcome, StringOrCreativeWork mainEntityOfPage, MedicalEntity seriousAdverseOutcome, MedicalGuideline guideline, String additionalType, String url, String sameAs, MedicalTherapy duplicateTherapy, MedicalContraindication contraindication, String alternateName, MedicalStudy study, String description, Action potentialAction, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem) {
