...
public class CommunicateAction extends InteractAction {
  ...
  /**
   * Builder for {@see CommunicateAction}
   */
  public static final class Builder {
    public CommunicateAction build() {
      return new CommunicateAction(instrument, recipient, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, startTime, sameAs, about, actionStatus, result, inLanguage, image, name, error, target, object, description, location);
    }
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected CommunicateAction(Instrument instrument, Audience recipient, CreativeWork mainEntityOfPage, Organization agent, java.util.Date endTime, Action potentialAction, String alternateName, Participant participant, String additionalType, String url, java.util.Date startTime, String sameAs, Thing about, ActionStatusType actionStatus, Result result, String inLanguage, Image image, String name, Thing error, EntryPoint target, Object object, String description, Location location) {
