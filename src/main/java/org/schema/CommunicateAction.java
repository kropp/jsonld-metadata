...
public class CommunicateAction extends InteractAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link CommunicateAction} instance.
     */
    public CommunicateAction build() {
      return new CommunicateAction(startTime, about, inLanguage, name, error, mainEntityOfPage, sameAs, url, additionalType, recipient, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
