...
public class Bone extends AnatomicalStructure {
  /**
   * Builder for {@see Bone}
   */
  public static final class Builder {
    public Bone build() {
      return new Bone(function, mainEntityOfPage, relatedCondition, subStructure, alternateName, potentialAction, url, additionalType, connectedTo, medicineSystem, associatedPathophysiology, partOfSystem, sameAs, recognizingAuthority, study, code, diagram, bodyLocation, name, image, relevantSpecialty, guideline, relatedTherapy, description);
    }
    /**
