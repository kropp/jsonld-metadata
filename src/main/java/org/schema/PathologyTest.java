...
public class PathologyTest extends MedicalTest {
  ...
  public static final class Builder {
    ...
    public PathologyTest build() {
      return new PathologyTest(recognizingAuthority, code, usesDevice, tissueSample, name, usedToDiagnose, mainEntityOfPage, guideline, additionalType, url, sameAs, affectedBy, normalRange, alternateName, signDetected, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
     ...
     * The type of tissue sample required for the test.
     */
    public Builder tissueSample(String tissueSample) {
