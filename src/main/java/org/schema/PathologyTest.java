...
public class PathologyTest extends MedicalTest {
  ...
  /**
   * Builder for {@see PathologyTest}
   */
  public static final class Builder {
    public PathologyTest build() {
      return new PathologyTest(usedToDiagnose, tissueSample, mainEntityOfPage, usesDevice, potentialAction, affectedBy, alternateName, additionalType, url, medicineSystem, recognizingAuthority, sameAs, study, code, normalRange, name, image, relevantSpecialty, guideline, signDetected, description);
    }
    /**
     ...
     * The type of tissue sample required for the test.
     */
    public Builder tissueSample(String value) {
      tissueSample = value;
      return this;
    }
    /**
  ...
  protected PathologyTest(MedicalCondition usedToDiagnose, String tissueSample, CreativeWork mainEntityOfPage, MedicalDevice usesDevice, Action potentialAction, Drug affectedBy, String alternateName, String additionalType, String url, MedicineSystem medicineSystem, Organization recognizingAuthority, String sameAs, MedicalStudy study, MedicalCode code, String normalRange, String name, Image image, MedicalSpecialty relevantSpecialty, MedicalGuideline guideline, MedicalSign signDetected, String description) {
