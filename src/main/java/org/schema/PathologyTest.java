...
/**
 * A medical test performed by a laboratory that typically involves examination of a tissue sample by a pathologist.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class PathologyTest extends MedicalTest {
  /**
   * The type of tissue sample required for the test.
   */
  public String getTissueSample() { return myTissueSample; }
   ...
   */
  public static class Builder implements ThingBuilder<PathologyTest> {
