...
public class PathologyTest extends MedicalTest {
  ...
  public String getTissueSample() {
    return myTissueSample;
  }
  /**
   * Builder for {@link PathologyTest}
   */
  static final class PathologyTestThingBuilder implements Builder {
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("tissueSample".equals(key) && value instanceof String) { tissueSample((String)value); continue; }
  ...
  public interface Builder extends ThingBuilder<PathologyTest> {
    @NotNull Builder tissueSample(@NotNull String tissueSample);
