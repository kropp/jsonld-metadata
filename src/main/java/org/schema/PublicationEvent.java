...
public class PublicationEvent extends Event {
   ...
   */
  public Boolean getIsAccessibleForFree() { return myIsAccessibleForFree; }
  /**
   * A broadcast service associated with the publication event.
   */
  public BroadcastService getPublishedOn() { return myPublishedOn; }
   ...
   */
  public static class Builder implements ThingBuilder<PublicationEvent> {
