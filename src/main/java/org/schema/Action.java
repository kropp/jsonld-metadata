...
public class Action extends Thing {
   ...
   */
  public OrganizationOrPerson getAgent() {
    return myAgent;
  }
  /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public static final class Builder {
     ...
     */
    public Action build() {
      return new Action(startTime, name, mainEntityOfPage, error, url, sameAs, additionalType, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
     * The startTime of something. For a reserved event or service (e.g. FoodEstablishmentReservation), the time that it is expected to start. For actions that span a period of time, when the action was performed. e.g. John wrote a book from *January* to December.
