...
public class MedicalDevice extends MedicalEntity {
  ...
  static final class MedicalDeviceThingBuilder implements Builder {
     ...
     * A description of the postoperative procedures, care, and/or followups for this device.
     */
    @NotNull public Builder postOp(String postOp) {
      this.postOp = postOp;
      return this;
    }
    /**
     ...
     * A description of the procedure involved in setting up, using, and/or installing the device.
     */
    @NotNull public Builder procedure(String procedure) {
  ...
  public interface Builder extends ThingBuilder<MedicalDevice> {
    ...
    @NotNull Builder postOp(String postOp);
    @NotNull Builder preOp(String preOp);
    @NotNull Builder procedure(String procedure);
