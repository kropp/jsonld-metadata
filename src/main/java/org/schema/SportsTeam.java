...
public class SportsTeam extends SportsOrganization implements Competitor {
  ...
  static final class SportsTeamThingBuilder implements Builder {
     ...
     * A person that acts in a coaching role for a sports team.
     */
    @NotNull public Builder coach(Person person) {
      this.coach = person;
      return this;
    }
    /**
     * A person that acts in a coaching role for a sports team.
     */
    @NotNull public Builder coach(Person.Builder person) {
      return this.coach(person.build());
    }
    /**
     * A person that acts as performing member of a sports team; a player as opposed to a coach.
     */
    @NotNull public Builder athlete(Person person) {
      this.athlete = person;
      return this;
    }
    /**
     * A person that acts as performing member of a sports team; a player as opposed to a coach.
     */
    @NotNull public Builder athlete(Person.Builder person) {
      return this.athlete(person.build());
    }
    /**
     * A type of sport (e.g. Baseball).
     */
    @NotNull public Builder sport(String sport) {
      this.sport = sport;
      return this;
    }
    /**
  ...
  public interface Builder extends ThingBuilder<SportsTeam> {
    @NotNull Builder coach(Person person);
    @NotNull Builder coach(Person.Builder person);
    @NotNull Builder athlete(Person person);
    @NotNull Builder athlete(Person.Builder person);
    @NotNull Builder sport(String sport);
