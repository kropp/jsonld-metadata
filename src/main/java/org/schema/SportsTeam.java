...
public class SportsTeam extends SportsOrganization implements Competitor {
   ...
   */
  public static final class SportsTeamThingBuilder implements Builder {
    /**
     ...
     * A person that acts in a coaching role for a sports team.
     */
    public Builder coach(Person.Builder person) {
     ...
     * A person that acts as performing member of a sports team; a player as opposed to a coach.
     */
    public Builder athlete(Person.Builder person) {
  ...
  Builder coach(Person person);
  Builder coach(Person.Builder person);
  Builder athlete(Person person);
  Builder athlete(Person.Builder person);
  Builder sport(String sport);
