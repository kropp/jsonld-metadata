...
public class Zoo extends CivicStructure {
  ...
  public static final class Builder {
    /**
     * Creates new {@link Zoo} instance.
     */
    public Zoo build() {
      return new Zoo(aggregateRating, review, openingHours, logo, isicV4, globalLocationNumber, name, mainEntityOfPage, hasMap, url, sameAs, containedIn, event, additionalType, alternateName, openingHoursSpecification, faxNumber, telephone, geo, description, potentialAction, additionalProperty, photo, address);
    }
    /**
