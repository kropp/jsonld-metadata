...
public class OrderAction extends TradeAction {
  ...
  public static final class Builder {
    ...
    public OrderAction build() {
      return new OrderAction(startTime, name, mainEntityOfPage, error, price, deliveryMethod, url, sameAs, additionalType, agent, alternateName, description, priceSpecification, target, potentialAction, endTime, actionStatus);
    }
    /**
