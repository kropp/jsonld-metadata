...
public class OrderAction extends TradeAction {
  ...
  /**
   * Builder for {@see OrderAction}
   */
  public static final class Builder {
    public OrderAction build() {
      return new OrderAction(priceSpecification, instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, deliveryMethod, image, name, error, target, object, description, location, price);
    }
    /**
