...
public class OrderAction extends TradeAction {
   ...
   */
  static final class OrderActionThingBuilder implements Builder {
    /**
     * Creates new {@link OrderAction} instance.
     */
    public OrderAction build() {
      return new OrderAction(deliveryMethod, price, priceSpecification, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of instrument. The method of delivery.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<OrderAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myDeliveryMethod != null ? !myDeliveryMethod.equals(orderAction.myDeliveryMethod) : orderAction.myDeliveryMethod != null) return false;
    return true;
  }
