...
public class ResumeAction extends ControlAction {
   ...
   */
  static final class ResumeActionThingBuilder implements Builder {
    /**
     * Creates new {@link ResumeAction} instance.
     */
    public ResumeAction build() {
      return new ResumeAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<ResumeAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    ResumeAction resumeAction = (ResumeAction) o;
