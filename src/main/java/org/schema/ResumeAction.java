...
public class ResumeAction extends ControlAction {
  /**
   * Builder for {@see ResumeAction}
   */
  public static final class Builder {
    public ResumeAction build() {
      return new ResumeAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
