...
public class DiagnosticLab extends MedicalOrganization {
  ...
  public static final class Builder {
    /**
     * Creates new {@link DiagnosticLab} instance.
     */
    public DiagnosticLab build() {
      return new DiagnosticLab(availableTest, aggregateRating, review, logo, parentOrganization, sameAs, additionalType, event, containedIn, priceRange, openingHoursSpecification, currenciesAccepted, potentialAction, address, additionalProperty, openingHours, globalLocationNumber, isicV4, name, paymentAccepted, mainEntityOfPage, hasMap, url, faxNumber, alternateName, telephone, geo, description, photo);
    }
    /**
     * A diagnostic test or procedure offered by this lab.
     */
    public Builder availableTest(MedicalTest medicalTest) {
      this.availableTest = medicalTest;
      return this;
    }
    /**
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  protected DiagnosticLab(MedicalTest availableTest, AggregateRating aggregateRating, Review review, ImageObjectOrString logo, Organization parentOrganization, String sameAs, String additionalType, Event event, Place containedIn, String priceRange, OpeningHoursSpecification openingHoursSpecification, String currenciesAccepted, Action potentialAction, PostalAddress address, PropertyValue additionalProperty, String openingHours, String globalLocationNumber, String isicV4, String name, String paymentAccepted, StringOrCreativeWork mainEntityOfPage, MapOrString hasMap, String url, String faxNumber, String alternateName, String telephone, GeoCoordinatesOrGeoShape geo, String description, ImageObjectOrPhotograph photo) {
    ...
    myAvailableTest = availableTest;
  }
  private MedicalTest myAvailableTest;
}
