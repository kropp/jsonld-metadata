...
public class DiagnosticLab extends MedicalOrganization {
   ...
   */
  static final class DiagnosticLabThingBuilder implements Builder {
    /**
    ...
    @NotNull public Builder availableTest(@NotNull MedicalTest.Builder medicalTest) {
      return this.availableTest(medicalTest.build());
    }
    /**
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("availableTest".equals(key) && value instanceof MedicalTest) { availableTest((MedicalTest)value); continue; }
  ...
  public interface Builder extends ThingBuilder<DiagnosticLab> {
    @NotNull Builder availableTest(@NotNull MedicalTest medicalTest);
    @NotNull Builder availableTest(@NotNull MedicalTest.Builder medicalTest);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myAvailableTest != null ? myAvailableTest.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    DiagnosticLab diagnosticLab = (DiagnosticLab) o;
    if (!super.equals(o)) return false;
    if (myAvailableTest != null ? !myAvailableTest.equals(diagnosticLab.myAvailableTest) : diagnosticLab.myAvailableTest != null) return false;
    return true;
  }
