...
public class BroadcastEvent extends PublicationEvent {
  ...
  static final class BroadcastEventThingBuilder implements Builder {
     ...
     * True is the broadcast is of a live event.
     */
    @NotNull public Builder isLiveBroadcast(Boolean isLiveBroadcast) {
     ...
     */
    @NotNull public Builder isAccessibleForFree(Boolean isAccessibleForFree) {
     ...
     */
    @NotNull public Builder publishedOn(BroadcastService broadcastService) {
  ...
  public interface Builder extends ThingBuilder<BroadcastEvent> {
    @NotNull Builder isLiveBroadcast(Boolean isLiveBroadcast);
    @NotNull Builder isAccessibleForFree(Boolean isAccessibleForFree);
    @NotNull Builder publishedOn(BroadcastService broadcastService);
    @NotNull Builder publishedOn(BroadcastService.Builder broadcastService);
