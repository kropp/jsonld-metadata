...
public class BroadcastEvent extends PublicationEvent {
  ...
  public static final class Builder {
    /**
     * Creates new {@link BroadcastEvent} instance.
     */
    public BroadcastEvent build() {
      return new BroadcastEvent(aggregateRating, review, isLiveBroadcast, endDate, attendee, isAccessibleForFree, sameAs, additionalType, subEvent, workPerformed, potentialAction, eventStatus, duration, startDate, typicalAgeRange, organizer, doorTime, inLanguage, superEvent, name, mainEntityOfPage, publishedOn, recordedIn, previousStartDate, url, performer, alternateName, description, offers);
    }
    /**
     ...
     * True is the broadcast is of a live event.
     */
    public Builder isLiveBroadcast(Boolean isLiveBroadcast) {
     ...
     */
    public Builder isAccessibleForFree(Boolean isAccessibleForFree) {
     ...
     */
    public Builder publishedOn(BroadcastService broadcastService) {
      this.publishedOn = broadcastService;
      return this;
    }
    /**
  ...
  protected BroadcastEvent(AggregateRating aggregateRating, Review review, Boolean isLiveBroadcast, java.util.Date endDate, OrganizationOrPerson attendee, Boolean isAccessibleForFree, String sameAs, String additionalType, Event subEvent, CreativeWork workPerformed, Action potentialAction, EventStatusType eventStatus, Duration duration, java.util.Date startDate, String typicalAgeRange, OrganizationOrPerson organizer, java.util.Date doorTime, LanguageOrString inLanguage, Event superEvent, String name, StringOrCreativeWork mainEntityOfPage, BroadcastService publishedOn, CreativeWork recordedIn, java.util.Date previousStartDate, String url, OrganizationOrPerson performer, String alternateName, String description, Offer offers) {
    super(aggregateRating, review, endDate, attendee, isAccessibleForFree, additionalType, sameAs, subEvent, workPerformed, potentialAction, eventStatus, duration, startDate, typicalAgeRange, organizer, doorTime, inLanguage, superEvent, name, mainEntityOfPage, publishedOn, recordedIn, previousStartDate, url, performer, alternateName, description, offers);
