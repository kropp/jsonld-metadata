...
public class BroadcastEvent extends PublicationEvent {
   ...
   */
  public static final class BroadcastEventThingBuilder implements Builder {
    /**
     ...
     * A broadcast service associated with the publication event.
     */
    public Builder publishedOn(BroadcastService.Builder broadcastService) {
  ...
  Builder isLiveBroadcast(Boolean isLiveBroadcast);
  Builder isAccessibleForFree(Boolean isAccessibleForFree);
  Builder publishedOn(BroadcastService broadcastService);
  Builder publishedOn(BroadcastService.Builder broadcastService);
