...
public class BroadcastEvent extends PublicationEvent {
   ...
   */
  static final class BroadcastEventThingBuilder implements Builder {
    /**
     * Creates new {@link BroadcastEvent} instance.
     */
    public BroadcastEvent build() {
      return new BroadcastEvent(isLiveBroadcast, isAccessibleForFree, publishedOn, aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * True is the broadcast is of a live event.
     */
    ...
    @NotNull public Builder publishedOn(@NotNull BroadcastService.Builder broadcastService) {
      return this.publishedOn(broadcastService.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("isLiveBroadcast".equals(key) && value instanceof Boolean) { isLiveBroadcast((Boolean)value); continue; }
        if ("isAccessibleForFree".equals(key) && value instanceof Boolean) { isAccessibleForFree((Boolean)value); continue; }
        if ("publishedOn".equals(key) && value instanceof BroadcastService) { publishedOn((BroadcastService)value); continue; }
  ...
  public interface Builder extends ThingBuilder<BroadcastEvent> {
    @NotNull Builder isLiveBroadcast(@NotNull Boolean isLiveBroadcast);
    @NotNull Builder isAccessibleForFree(@NotNull Boolean isAccessibleForFree);
    @NotNull Builder publishedOn(@NotNull BroadcastService broadcastService);
    @NotNull Builder publishedOn(@NotNull BroadcastService.Builder broadcastService);
