...
public class BroadcastEvent extends PublicationEvent {
  ...
  /**
   * Builder for {@see BroadcastEvent}
   */
  public static final class Builder {
    public BroadcastEvent build() {
      return new BroadcastEvent(performer, review, offers, endDate, potentialAction, duration, additionalType, inLanguage, isLiveBroadcast, image, workPerformed, attendee, previousStartDate, description, isAccessibleForFree, mainEntityOfPage, organizer, doorTime, alternateName, eventStatus, url, superEvent, sameAs, aggregateRating, publishedOn, startDate, subEvent, name, recordedIn, typicalAgeRange, location);
    }
    /**
     ...
     * True is the broadcast is of a live event.
     */
    public Builder isLiveBroadcast(Boolean value) {
      isLiveBroadcast = value;
      return this;
    }
     ...
     */
    public Builder isAccessibleForFree(Boolean value) {
     ...
     */
    public Builder publishedOn(BroadcastService value) {
      publishedOn = value;
      return this;
    }
    /**
  ...
  protected BroadcastEvent(Organization performer, Review review, Offer offers, java.util.Date endDate, Action potentialAction, Duration duration, String additionalType, String inLanguage, Boolean isLiveBroadcast, Image image, CreativeWork workPerformed, Organization attendee, java.util.Date previousStartDate, String description, Boolean isAccessibleForFree, CreativeWork mainEntityOfPage, Person organizer, java.util.Date doorTime, String alternateName, EventStatusType eventStatus, String url, Event superEvent, String sameAs, AggregateRating aggregateRating, BroadcastService publishedOn, java.util.Date startDate, Event subEvent, String name, CreativeWork recordedIn, String typicalAgeRange, Location location) {
    super(performer, review, offers, endDate, potentialAction, duration, additionalType, inLanguage, image, workPerformed, attendee, previousStartDate, description, isAccessibleForFree, mainEntityOfPage, organizer, doorTime, alternateName, eventStatus, url, superEvent, sameAs, aggregateRating, publishedOn, startDate, name, subEvent, recordedIn, typicalAgeRange, location);
