...
public class ReserveAction extends PlanAction {
  ...
  public static final class Builder {
    ...
    public ReserveAction build() {
      return new ReserveAction(startTime, name, mainEntityOfPage, error, scheduledTime, sameAs, additionalType, url, agent, alternateName, description, potentialAction, target, endTime, actionStatus);
    }
    /**
