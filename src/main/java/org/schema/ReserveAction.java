...
public class ReserveAction extends PlanAction {
   ...
   */
  static final class ReserveActionThingBuilder implements Builder {
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<ReserveAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    ReserveAction reserveAction = (ReserveAction) o;
