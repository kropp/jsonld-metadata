...
public class DownloadAction extends TransferAction {
  ...
  public static final class Builder {
    ...
    public DownloadAction build() {
      return new DownloadAction(startTime, toLocation, name, mainEntityOfPage, error, fromLocation, url, sameAs, additionalType, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
