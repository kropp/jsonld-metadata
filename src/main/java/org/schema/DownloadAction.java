...
public class DownloadAction extends TransferAction {
  /**
   * Builder for {@see DownloadAction}
   */
  public static final class Builder {
    public DownloadAction build() {
      return new DownloadAction(instrument, mainEntityOfPage, toLocation, agent, endTime, alternateName, potentialAction, fromLocation, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
