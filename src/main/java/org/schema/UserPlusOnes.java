...
public class UserPlusOnes extends UserInteraction {
   ...
   */
  static final class UserPlusOnesThingBuilder implements Builder {
    /**
     * Creates new {@link UserPlusOnes} instance.
     */
    public UserPlusOnes build() {
      return new UserPlusOnes(aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<UserPlusOnes> {
  ...
  @Override public boolean equals(Object o) {
    ...
    UserPlusOnes userPlusOnes = (UserPlusOnes) o;
