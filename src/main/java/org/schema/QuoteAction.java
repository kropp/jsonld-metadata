...
public class QuoteAction extends TradeAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link QuoteAction} instance.
     */
    public QuoteAction build() {
      return new QuoteAction(startTime, name, mainEntityOfPage, error, price, url, sameAs, additionalType, agent, alternateName, description, priceSpecification, potentialAction, target, endTime, actionStatus);
    }
    /**
