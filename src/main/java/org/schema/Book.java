...
public class Book extends CreativeWork {
  ...
  public static final class Builder {
    /**
     * Creates new {@link Book} instance.
     */
    public Book build() {
      return new Book(accessibilityAPI, aggregateRating, hasPart, review, datePublished, comment, schemaVersion, video, award, editor, workExample, potentialAction, producer, publisher, sourceOrganization, genre, learningResourceType, publishingPrinciples, translator, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, bookFormat, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, illustrator, copyrightHolder, accessibilityControl, isbn, citation, educationalUse, keywords, educationalAlignment, text, about, contentLocation, accessibilityHazard, author, version, accountablePerson, sameAs, additionalType, thumbnailUrl, publication, encoding, numberOfPages, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, alternativeHeadline, mainEntity, name, bookEdition, license, copyrightYear, discussionUrl, mainEntityOfPage, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, contributor, creator);
    }
    /**
     ...
     * The format of the book.
     */
    public Builder bookFormat(BookFormatType bookFormatType) {
      this.bookFormat = bookFormatType;
      return this;
    }
    /**
     * URL of the item.
     ...
     * The illustrator of the book.
     */
    public Builder illustrator(Person person) {
     ...
     * The number of pages in the book.
     */
    public Builder numberOfPages(Integer integer) {
      this.numberOfPages = integer;
      return this;
    }
    /**
