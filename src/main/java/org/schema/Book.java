...
public class Book extends CreativeWork {
   ...
   */
  public static final class BookThingBuilder implements Builder {
    /**
     ...
     * The format of the book.
     */
    public Builder bookFormat(BookFormatType.Builder bookFormatType) {
     ...
     * The illustrator of the book.
     */
    public Builder illustrator(Person.Builder person) {
  ...
  Builder bookEdition(String bookEdition);
  Builder bookFormat(BookFormatType bookFormatType);
  Builder bookFormat(BookFormatType.Builder bookFormatType);
  Builder illustrator(Person person);
  Builder illustrator(Person.Builder person);
  Builder isbn(String isbn);
  Builder numberOfPages(Integer integer);
