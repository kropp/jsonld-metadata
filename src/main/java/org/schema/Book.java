...
public class Book extends CreativeWork {
  ...
  /**
   * Builder for {@see Book}
   */
  public static final class Builder {
    public Book build() {
      return new Book(review, producer, editor, timeRequired, offers, creator, educationalUse, alternativeHeadline, illustrator, mentions, additionalType, position, associatedMedia, numberOfPages, isFamilyFriendly, accessibilityControl, image, keywords, discussionUrl, isBasedOnUrl, exampleOfWork, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, bookFormat, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, genre, potentialAction, contentRating, audience, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, releasedEvent, accessibilityFeature, accessibilityHazard, license, isbn, description, publication, provider, educationalAlignment, recordedAt, mainEntityOfPage, contributor, isPartOf, workExample, dateCreated, bookEdition, copyrightHolder, aggregateRating, sameAs, name, typicalAgeRange, citation, copyrightYear, translator, sourceOrganization, text, award);
    }
    /**
     ...
     * The illustrator of the book.
     */
    public Builder illustrator(Person value) {
      illustrator = value;
      return this;
    }
    /**
     ...
     * The number of pages in the book.
     */
    public Builder numberOfPages(Integer value) {
      numberOfPages = value;
      return this;
    }
    /**
     ...
     * The format of the book.
     */
    public Builder bookFormat(BookFormatType value) {
      bookFormat = value;
      return this;
    }
    /**
     ...
     * The edition of the book.
     */
    public Builder bookEdition(String value) {
      bookEdition = value;
      return this;
    }
    /**
  ...
  protected Book(Review review, Person producer, Person editor, Duration timeRequired, Offer offers, Organization creator, String educationalUse, String alternativeHeadline, Person illustrator, Thing mentions, String additionalType, Position position, MediaObject associatedMedia, Integer numberOfPages, Boolean isFamilyFriendly, String accessibilityControl, Image image, String keywords, String discussionUrl, String isBasedOnUrl, CreativeWork exampleOfWork, Comment comment, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, Person character, String schemaVersion, String accessibilityAPI, BookFormatType bookFormat, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, String genre, Action potentialAction, String contentRating, Audience audience, String inLanguage, Place contentLocation, String learningResourceType, Person accountablePerson, AudioObject audio, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, String accessibilityFeature, String accessibilityHazard, CreativeWork license, String isbn, String description, PublicationEvent publication, Person provider, AlignmentObject educationalAlignment, Event recordedAt, CreativeWork mainEntityOfPage, Organization contributor, IsPartOf isPartOf, CreativeWork workExample, java.util.Date dateCreated, String bookEdition, Organization copyrightHolder, AggregateRating aggregateRating, String sameAs, String name, String typicalAgeRange, CreativeWork citation, Number copyrightYear, Person translator, Organization sourceOrganization, String text, String award) {
    ...
    myBookEdition = bookEdition;
    myBookFormat = bookFormat;
    myIllustrator = illustrator;
    myIsbn = isbn;
    myNumberOfPages = numberOfPages;
  }
  private String myBookEdition;
  private BookFormatType myBookFormat;
  private Person myIllustrator;
  private String myIsbn;
  private Integer myNumberOfPages;
}
