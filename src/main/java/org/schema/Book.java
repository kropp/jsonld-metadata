...
public class Book extends CreativeWork {
   ...
   */
  public String getBookEdition() { return myBookEdition; }
  /**
   * The format of the book.
   */
  public BookFormatType getBookFormat() { return myBookFormat; }
  /**
   * The illustrator of the book.
   */
  public Person getIllustrator() { return myIllustrator; }
  /**
   ...
   */
  public Integer getNumberOfPages() { return myNumberOfPages; }
   ...
   */
  public static class Builder implements ThingBuilder<Book> {
    public Book build() {
