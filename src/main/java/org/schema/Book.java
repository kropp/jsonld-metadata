...
public class Book extends CreativeWork {
  ...
  static final class BookThingBuilder implements Builder {
    ...
    @NotNull public Builder bookFormat(@NotNull BookFormatType.Builder bookFormatType) {
      return this.bookFormat(bookFormatType.build());
    }
    /**
     * The illustrator of the book.
     */
    ...
    @NotNull public Builder illustrator(@NotNull Person.Builder person) {
      return this.illustrator(person.build());
    }
    /**
     * The ISBN of the book.
     */
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("bookEdition".equals(key) && value instanceof String) { bookEdition((String)value); continue; }
        if ("bookFormat".equals(key) && value instanceof BookFormatType) { bookFormat((BookFormatType)value); continue; }
        if ("illustrator".equals(key) && value instanceof Person) { illustrator((Person)value); continue; }
        if ("isbn".equals(key) && value instanceof String) { isbn((String)value); continue; }
        if ("numberOfPages".equals(key) && value instanceof Integer) { numberOfPages((Integer)value); continue; }
  ...
  public interface Builder extends ThingBuilder<Book> {
    @NotNull Builder bookEdition(@NotNull String bookEdition);
    @NotNull Builder bookFormat(@NotNull BookFormatType bookFormatType);
    @NotNull Builder bookFormat(@NotNull BookFormatType.Builder bookFormatType);
    @NotNull Builder illustrator(@NotNull Person person);
    @NotNull Builder illustrator(@NotNull Person.Builder person);
    @NotNull Builder isbn(@NotNull String isbn);
    @NotNull Builder numberOfPages(@NotNull Integer integer);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myBookEdition != null ? myBookEdition.hashCode() : 0);
    result = 31 * result + (myBookFormat != null ? myBookFormat.hashCode() : 0);
    result = 31 * result + (myIllustrator != null ? myIllustrator.hashCode() : 0);
    result = 31 * result + (myIsbn != null ? myIsbn.hashCode() : 0);
    result = 31 * result + (myNumberOfPages != null ? myNumberOfPages.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myBookEdition != null ? !myBookEdition.equals(book.myBookEdition) : book.myBookEdition != null) return false;
    if (myBookFormat != null ? !myBookFormat.equals(book.myBookFormat) : book.myBookFormat != null) return false;
    if (myIllustrator != null ? !myIllustrator.equals(book.myIllustrator) : book.myIllustrator != null) return false;
    if (myIsbn != null ? !myIsbn.equals(book.myIsbn) : book.myIsbn != null) return false;
    if (myNumberOfPages != null ? !myNumberOfPages.equals(book.myNumberOfPages) : book.myNumberOfPages != null) return false;
    return true;
  }
