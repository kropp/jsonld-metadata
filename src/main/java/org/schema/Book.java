...
public class Book extends CreativeWork {
  ...
  static final class BookThingBuilder implements Builder {
     ...
     * The edition of the book.
     */
    @NotNull public Builder bookEdition(String bookEdition) {
     ...
     * The format of the book.
     */
    @NotNull public Builder bookFormat(BookFormatType bookFormatType) {
     ...
     * The format of the book.
     */
    @NotNull public Builder bookFormat(BookFormatType.Builder bookFormatType) {
      return this.bookFormat(bookFormatType.build());
    }
    /**
     * The illustrator of the book.
     */
    @NotNull public Builder illustrator(Person person) {
     ...
     * The illustrator of the book.
     */
    @NotNull public Builder illustrator(Person.Builder person) {
      return this.illustrator(person.build());
    }
    /**
     * The ISBN of the book.
     */
    @NotNull public Builder isbn(String isbn) {
      this.isbn = isbn;
      return this;
    }
    /**
     * The number of pages in the book.
     */
    @NotNull public Builder numberOfPages(int numberOfPages) {
  ...
  public interface Builder extends ThingBuilder<Book> {
    @NotNull Builder bookEdition(String bookEdition);
    @NotNull Builder bookFormat(BookFormatType bookFormatType);
    @NotNull Builder bookFormat(BookFormatType.Builder bookFormatType);
    @NotNull Builder illustrator(Person person);
    @NotNull Builder illustrator(Person.Builder person);
    @NotNull Builder isbn(String isbn);
    @NotNull Builder numberOfPages(int numberOfPages);
