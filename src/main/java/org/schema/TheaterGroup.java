...
public class TheaterGroup extends PerformingGroup {
  ...
  public static final class Builder {
    ...
    public TheaterGroup build() {
      return new TheaterGroup(aggregateRating, review, logo, duns, department, subOrganization, additionalType, sameAs, event, award, foundingDate, numberOfEmployees, seeks, brand, naics, potentialAction, dissolutionDate, foundingLocation, address, founder, owns, email, member, makesOffer, employee, isicV4, globalLocationNumber, taxID, name, vatID, mainEntityOfPage, legalName, memberOf, url, contactPoint, hasPOS, alternateName, faxNumber, telephone, description);
    }
    /**
