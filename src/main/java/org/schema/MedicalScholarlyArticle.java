...
public class MedicalScholarlyArticle extends ScholarlyArticle {
  ...
  static final class MedicalScholarlyArticleThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("publicationType".equals(key) && value instanceof String) { publicationType((String)value); continue; }
  ...
  public interface Builder extends ThingBuilder<MedicalScholarlyArticle> {
    @NotNull Builder publicationType(@NotNull String publicationType);
