...
public class MedicalScholarlyArticle extends ScholarlyArticle {
  ...
  public static final class Builder {
    /**
     * Creates new {@link MedicalScholarlyArticle} instance.
     */
    public MedicalScholarlyArticle build() {
      return new MedicalScholarlyArticle(accessibilityAPI, aggregateRating, hasPart, review, datePublished, schemaVersion, comment, video, award, editor, workExample, wordCount, potentialAction, pageStart, producer, publisher, sourceOrganization, genre, learningResourceType, translator, publishingPrinciples, recordedAt, inLanguage, commentCount, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, articleBody, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, about, contentLocation, accessibilityHazard, author, pagination, version, accountablePerson, sameAs, additionalType, thumbnailUrl, articleSection, publication, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, publicationType, dateCreated, provider, alternativeHeadline, mainEntity, name, license, copyrightYear, discussionUrl, mainEntityOfPage, isBasedOnUrl, pageEnd, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, contributor, creator);
    }
    /**
