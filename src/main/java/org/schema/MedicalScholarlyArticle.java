...
public class MedicalScholarlyArticle extends ScholarlyArticle {
  ...
  public interface Builder extends ThingBuilder<MedicalScholarlyArticle> {
    @NotNull Builder publicationType(String publicationType);
