...
public class EmploymentAgency extends LocalBusiness {
  ...
  public static final class Builder {
    /**
     * Creates new {@link EmploymentAgency} instance.
     */
    public EmploymentAgency build() {
      return new EmploymentAgency(aggregateRating, review, logo, parentOrganization, containedIn, event, additionalType, sameAs, priceRange, openingHoursSpecification, currenciesAccepted, potentialAction, address, additionalProperty, openingHours, globalLocationNumber, isicV4, name, paymentAccepted, mainEntityOfPage, hasMap, url, alternateName, faxNumber, geo, telephone, description, photo);
    }
    /**
