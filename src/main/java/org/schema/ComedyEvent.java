...
public class ComedyEvent extends Event {
   ...
   */
  static final class ComedyEventThingBuilder implements Builder {
    /**
     * Creates new {@link ComedyEvent} instance.
     */
    public ComedyEvent build() {
      return new ComedyEvent(aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<ComedyEvent> {
  ...
  @Override public boolean equals(Object o) {
    ...
    ComedyEvent comedyEvent = (ComedyEvent) o;
