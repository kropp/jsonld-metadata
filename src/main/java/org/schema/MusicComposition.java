...
public class MusicComposition extends CreativeWork {
  ...
  static final class MusicCompositionThingBuilder implements Builder {
    ...
    @NotNull public Builder musicArrangement(@NotNull MusicComposition.Builder musicComposition) {
      return this.musicArrangement(musicComposition.build());
    }
    /**
     * The person or organization who wrote the composition.
     */
    @NotNull public Builder composer(@NotNull Organization organization) {
      if (this.composer == null) this.composer = new OrganizationOrPerson();
    ...
    @NotNull public Builder composer(@NotNull Organization.Builder organization) {
      return this.composer(organization.build());
    }
    /**
     * The person or organization who wrote the composition.
     */
    ...
    @NotNull public Builder composer(@NotNull Person.Builder person) {
      return this.composer(person.build());
    }
    /**
     * The date and place the work was first performed.
     */
    ...
    @NotNull public Builder firstPerformance(@NotNull Event.Builder event) {
      return this.firstPerformance(event.build());
    }
    /**
     * Smaller compositions included in this work (e.g. a movement in a symphony).
     */
    ...
    @NotNull public Builder includedComposition(@NotNull MusicComposition.Builder musicComposition) {
      return this.includedComposition(musicComposition.build());
    }
    /**
     * The International Standard Musical Work Code for the composition.
     */
    ...
    @NotNull public Builder lyricist(@NotNull Person.Builder person) {
      return this.lyricist(person.build());
    }
    /**
     * The type of composition (e.g. overture, sonata, symphony, etc.).
     */
    ...
    @NotNull public Builder recordedAs(@NotNull MusicRecording.Builder musicRecording) {
      return this.recordedAs(musicRecording.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("musicArrangement".equals(key) && value instanceof MusicComposition) { musicArrangement((MusicComposition)value); continue; }
        if ("composer".equals(key) && value instanceof Organization) { composer((Organization)value); continue; }
        if ("composer".equals(key) && value instanceof Person) { composer((Person)value); continue; }
        if ("firstPerformance".equals(key) && value instanceof Event) { firstPerformance((Event)value); continue; }
        if ("includedComposition".equals(key) && value instanceof MusicComposition) { includedComposition((MusicComposition)value); continue; }
        if ("iswcCode".equals(key) && value instanceof String) { iswcCode((String)value); continue; }
        if ("lyricist".equals(key) && value instanceof Person) { lyricist((Person)value); continue; }
        if ("musicCompositionForm".equals(key) && value instanceof String) { musicCompositionForm((String)value); continue; }
        if ("musicalKey".equals(key) && value instanceof String) { musicalKey((String)value); continue; }
        if ("recordedAs".equals(key) && value instanceof MusicRecording) { recordedAs((MusicRecording)value); continue; }
  ...
  public interface Builder extends ThingBuilder<MusicComposition> {
    @NotNull Builder musicArrangement(@NotNull MusicComposition musicComposition);
    @NotNull Builder musicArrangement(@NotNull MusicComposition.Builder musicComposition);
    @NotNull Builder composer(@NotNull Organization organization);
    @NotNull Builder composer(@NotNull Organization.Builder organization);
    @NotNull Builder composer(@NotNull Person person);
    @NotNull Builder composer(@NotNull Person.Builder person);
    @NotNull Builder firstPerformance(@NotNull Event event);
    @NotNull Builder firstPerformance(@NotNull Event.Builder event);
    @NotNull Builder includedComposition(@NotNull MusicComposition musicComposition);
    @NotNull Builder includedComposition(@NotNull MusicComposition.Builder musicComposition);
    @NotNull Builder iswcCode(@NotNull String iswcCode);
    @NotNull Builder lyricist(@NotNull Person person);
    @NotNull Builder lyricist(@NotNull Person.Builder person);
    @NotNull Builder musicCompositionForm(@NotNull String musicCompositionForm);
    @NotNull Builder musicalKey(@NotNull String musicalKey);
    @NotNull Builder recordedAs(@NotNull MusicRecording musicRecording);
    @NotNull Builder recordedAs(@NotNull MusicRecording.Builder musicRecording);
