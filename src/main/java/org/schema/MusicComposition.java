...
public class MusicComposition extends CreativeWork {
   ...
   */
  public static final class MusicCompositionThingBuilder implements Builder {
    /**
     ...
     * An arrangement derived from the composition.
     */
    public Builder musicArrangement(MusicComposition.Builder musicComposition) {
     ...
     * The person or organization who wrote the composition.
     */
    public Builder composer(Organization.Builder organization) {
     ...
     * The person or organization who wrote the composition.
     */
    public Builder composer(Person.Builder person) {
     ...
     * The date and place the work was first performed.
     */
    public Builder firstPerformance(Event.Builder event) {
     ...
     * Smaller compositions included in this work (e.g. a movement in a symphony).
     */
    public Builder includedComposition(MusicComposition.Builder musicComposition) {
     ...
     * The person who wrote the words.
     */
    public Builder lyricist(Person.Builder person) {
     ...
     * An audio recording of the work.
     */
    public Builder recordedAs(MusicRecording.Builder musicRecording) {
  ...
  Builder musicArrangement(MusicComposition musicComposition);
  Builder musicArrangement(MusicComposition.Builder musicComposition);
  Builder composer(Organization organization);
  Builder composer(Organization.Builder organization);
  Builder composer(Person person);
  Builder composer(Person.Builder person);
  Builder firstPerformance(Event event);
  Builder firstPerformance(Event.Builder event);
  Builder includedComposition(MusicComposition musicComposition);
  Builder includedComposition(MusicComposition.Builder musicComposition);
  Builder iswcCode(String iswcCode);
  Builder lyricist(Person person);
  Builder lyricist(Person.Builder person);
  Builder musicCompositionForm(String musicCompositionForm);
  Builder musicalKey(String musicalKey);
  Builder recordedAs(MusicRecording musicRecording);
  Builder recordedAs(MusicRecording.Builder musicRecording);
