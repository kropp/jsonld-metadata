...
public class MusicComposition extends CreativeWork {
  ...
  public MusicComposition getMusicArrangement() {
    return myMusicArrangement;
  }
  /**
   * The person or organization who wrote the composition.
   */
  public OrganizationOrPerson getComposer() {
    return myComposer;
  }
  /**
  ...
  public static final class Builder {
    /**
     * Creates new {@link MusicComposition} instance.
     */
    public MusicComposition build() {
      return new MusicComposition(firstPerformance, accessibilityAPI, aggregateRating, hasPart, review, recordedAs, datePublished, schemaVersion, comment, video, musicalKey, award, editor, workExample, potentialAction, musicArrangement, producer, publisher, sourceOrganization, learningResourceType, genre, translator, publishingPrinciples, includedComposition, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, composer, url, headline, interactivityType, character, associatedMedia, musicCompositionForm, contentRating, description, offers, copyrightHolder, accessibilityControl, citation, lyricist, educationalUse, keywords, iswcCode, educationalAlignment, text, about, contentLocation, accessibilityHazard, author, version, accountablePerson, sameAs, additionalType, thumbnailUrl, publication, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, alternativeHeadline, mainEntity, name, license, copyrightYear, discussionUrl, mainEntityOfPage, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, contributor, creator);
    }
    /**
     * The date and place the work was first performed.
     */
    public Builder firstPerformance(Event event) {
      this.firstPerformance = event;
      return this;
    }
    /**
     ...
     * An audio recording of the work.
     */
    public Builder recordedAs(MusicRecording musicRecording) {
      this.recordedAs = musicRecording;
      return this;
    }
    /**
     ...
     * An arrangement derived from the composition.
     */
    public Builder musicArrangement(MusicComposition musicComposition) {
      this.musicArrangement = musicComposition;
      return this;
    }
    /**
     ...
     * Smaller compositions included in this work (e.g. a movement in a symphony).
     */
    public Builder includedComposition(MusicComposition musicComposition) {
      this.includedComposition = musicComposition;
      return this;
    }
    /**
     ...
     * The person or organization who wrote the composition.
     */
    public Builder composer(Organization organization) {
      this.composer.setOrganization(organization);
      return this;
    }
    /**
     * The person or organization who wrote the composition.
     */
    public Builder composer(Person person) {
      this.composer.setPerson(person);
      return this;
    }
    /**
     * URL of the item.
     ...
     * The type of composition (e.g. overture, sonata, symphony, etc.).
     */
    public Builder musicCompositionForm(String musicCompositionForm) {
     ...
     * The person who wrote the words.
     */
    public Builder lyricist(Person person) {
      this.lyricist = person;
      return this;
    }
    /**
     ...
     * The International Standard Musical Work Code for the composition.
     */
    public Builder iswcCode(String iswcCode) {
    ...
    private OrganizationOrPerson composer;
    private String url;
  ...
  protected MusicComposition(Event firstPerformance, String accessibilityAPI, AggregateRating aggregateRating, HasPart hasPart, Review review, MusicRecording recordedAs, java.util.Date datePublished, String schemaVersion, Comment comment, VideoObject video, String musicalKey, String award, Person editor, CreativeWork workExample, Action potentialAction, MusicComposition musicArrangement, OrganizationOrPerson producer, Organization publisher, Organization sourceOrganization, String learningResourceType, String genre, OrganizationOrPerson translator, String publishingPrinciples, MusicComposition includedComposition, Event recordedAt, Integer commentCount, LanguageOrString inLanguage, java.util.Date dateModified, Thing mentions, Audience audience, OrganizationOrPerson composer, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, String musicCompositionForm, String contentRating, String description, Offer offers, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, Person lyricist, String educationalUse, String keywords, String iswcCode, AlignmentObject educationalAlignment, String text, Thing about, Place contentLocation, String accessibilityHazard, OrganizationOrPerson author, Number version, Person accountablePerson, String sameAs, String additionalType, String thumbnailUrl, PublicationEvent publication, MediaObject encoding, Duration timeRequired, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, String alternativeHeadline, Thing mainEntity, String name, StringOrCreativeWork license, Number copyrightYear, String discussionUrl, StringOrCreativeWork mainEntityOfPage, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, String alternateName, PublicationEvent releasedEvent, OrganizationOrPerson contributor, OrganizationOrPerson creator) {
    ...
    myMusicArrangement = musicArrangement;
    myComposer = composer;
    myFirstPerformance = firstPerformance;
    myIncludedComposition = includedComposition;
    myIswcCode = iswcCode;
    myLyricist = lyricist;
    myMusicCompositionForm = musicCompositionForm;
  ...
  private MusicComposition myIncludedComposition;
  private String myIswcCode;
  private Person myLyricist;
  private String myMusicCompositionForm;
  private String myMusicalKey;
  private MusicRecording myRecordedAs;
}
