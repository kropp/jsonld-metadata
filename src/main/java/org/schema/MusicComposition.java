...
public class MusicComposition extends CreativeWork {
  ...
  static final class MusicCompositionThingBuilder implements Builder {
     ...
     * An arrangement derived from the composition.
     */
    @NotNull public Builder musicArrangement(MusicComposition musicComposition) {
     ...
     * An arrangement derived from the composition.
     */
    @NotNull public Builder musicArrangement(MusicComposition.Builder musicComposition) {
      return this.musicArrangement(musicComposition.build());
    }
    /**
     * The person or organization who wrote the composition.
     */
    @NotNull public Builder composer(Organization organization) {
     ...
     * The person or organization who wrote the composition.
     */
    @NotNull public Builder composer(Organization.Builder organization) {
      return this.composer(organization.build());
    }
    /**
     * The person or organization who wrote the composition.
     */
    @NotNull public Builder composer(Person person) {
      if (this.composer == null) this.composer = new OrganizationOrPerson();
     ...
     * The person or organization who wrote the composition.
     */
    @NotNull public Builder composer(Person.Builder person) {
      return this.composer(person.build());
    }
    /**
     * The date and place the work was first performed.
     */
    @NotNull public Builder firstPerformance(Event event) {
     ...
     * The date and place the work was first performed.
     */
    @NotNull public Builder firstPerformance(Event.Builder event) {
      return this.firstPerformance(event.build());
    }
    /**
     * Smaller compositions included in this work (e.g. a movement in a symphony).
     */
    @NotNull public Builder includedComposition(MusicComposition musicComposition) {
     ...
     * Smaller compositions included in this work (e.g. a movement in a symphony).
     */
    @NotNull public Builder includedComposition(MusicComposition.Builder musicComposition) {
      return this.includedComposition(musicComposition.build());
    }
    /**
     * The International Standard Musical Work Code for the composition.
     */
    @NotNull public Builder iswcCode(String iswcCode) {
     ...
     * The person who wrote the words.
     */
    @NotNull public Builder lyricist(Person person) {
     ...
     * The person who wrote the words.
     */
    @NotNull public Builder lyricist(Person.Builder person) {
      return this.lyricist(person.build());
    }
    /**
     * The type of composition (e.g. overture, sonata, symphony, etc.).
     */
    @NotNull public Builder musicCompositionForm(String musicCompositionForm) {
     ...
     * The key, mode, or scale this composition uses.
     */
    @NotNull public Builder musicalKey(String musicalKey) {
     ...
     * An audio recording of the work.
     */
    @NotNull public Builder recordedAs(MusicRecording musicRecording) {
     ...
     * An audio recording of the work.
     */
    @NotNull public Builder recordedAs(MusicRecording.Builder musicRecording) {
  ...
  public interface Builder extends ThingBuilder<MusicComposition> {
    @NotNull Builder musicArrangement(MusicComposition musicComposition);
    @NotNull Builder musicArrangement(MusicComposition.Builder musicComposition);
    @NotNull Builder composer(Organization organization);
    @NotNull Builder composer(Organization.Builder organization);
    @NotNull Builder composer(Person person);
    @NotNull Builder composer(Person.Builder person);
    @NotNull Builder firstPerformance(Event event);
    @NotNull Builder firstPerformance(Event.Builder event);
    @NotNull Builder includedComposition(MusicComposition musicComposition);
    @NotNull Builder includedComposition(MusicComposition.Builder musicComposition);
    @NotNull Builder iswcCode(String iswcCode);
    @NotNull Builder lyricist(Person person);
    @NotNull Builder lyricist(Person.Builder person);
    @NotNull Builder musicCompositionForm(String musicCompositionForm);
    @NotNull Builder musicalKey(String musicalKey);
    @NotNull Builder recordedAs(MusicRecording musicRecording);
    @NotNull Builder recordedAs(MusicRecording.Builder musicRecording);
