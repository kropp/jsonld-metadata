...
public class MusicComposition extends CreativeWork {
  ...
  /**
   * Builder for {@see MusicComposition}
   */
  public static final class Builder {
    public MusicComposition build() {
      return new MusicComposition(review, producer, editor, recordedAs, timeRequired, creator, offers, educationalUse, alternativeHeadline, mentions, additionalType, lyricist, position, associatedMedia, isFamilyFriendly, accessibilityControl, image, keywords, discussionUrl, exampleOfWork, isBasedOnUrl, comment, datePublished, musicalKey, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, genre, musicArrangement, potentialAction, audience, contentRating, iswcCode, inLanguage, composer, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, releasedEvent, accessibilityFeature, accessibilityHazard, firstPerformance, license, description, publication, provider, educationalAlignment, recordedAt, includedComposition, mainEntityOfPage, contributor, musicCompositionForm, isPartOf, workExample, dateCreated, copyrightHolder, aggregateRating, sameAs, name, typicalAgeRange, citation, copyrightYear, translator, sourceOrganization, text, award);
    }
    /**
     ...
     * An audio recording of the work.
     */
    public Builder recordedAs(MusicRecording value) {
      recordedAs = value;
      return this;
    }
    /**
     ...
     * The person who wrote the words.
     */
    public Builder lyricist(Person value) {
      lyricist = value;
      return this;
    }
     ...
     * The key, mode, or scale this composition uses.
     */
    public Builder musicalKey(String value) {
      musicalKey = value;
      return this;
    }
    /**
     ...
     * An arrangement derived from the composition.
     */
    public Builder musicArrangement(MusicComposition value) {
      musicArrangement = value;
      return this;
    }
    /**
     ...
     * The International Standard Musical Work Code for the composition.
     */
    public Builder iswcCode(String value) {
      iswcCode = value;
      return this;
    }
    /**
     ...
     * The person or organization who wrote the composition.
     */
    public Builder composer(Person value) {
      composer = value;
      return this;
    }
    /**
     ...
     * The date and place the work was first performed.
     */
    public Builder firstPerformance(Event value) {
      firstPerformance = value;
      return this;
    }
    /**
     ...
     * Smaller compositions included in this work (e.g. a movement in a symphony).
     */
    public Builder includedComposition(MusicComposition value) {
      includedComposition = value;
      return this;
    }
    /**
     ...
     * The type of composition (e.g. overture, sonata, symphony, etc.).
     */
    public Builder musicCompositionForm(String value) {
      musicCompositionForm = value;
      return this;
    }
  ...
  protected MusicComposition(Review review, Person producer, Person editor, MusicRecording recordedAs, Duration timeRequired, Organization creator, Offer offers, String educationalUse, String alternativeHeadline, Thing mentions, String additionalType, Person lyricist, Position position, MediaObject associatedMedia, Boolean isFamilyFriendly, String accessibilityControl, Image image, String keywords, String discussionUrl, CreativeWork exampleOfWork, String isBasedOnUrl, Comment comment, java.util.Date datePublished, String musicalKey, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, Person character, String schemaVersion, String accessibilityAPI, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, String genre, MusicComposition musicArrangement, Action potentialAction, Audience audience, String contentRating, String iswcCode, String inLanguage, Person composer, Place contentLocation, String learningResourceType, Person accountablePerson, AudioObject audio, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, String accessibilityFeature, String accessibilityHazard, Event firstPerformance, CreativeWork license, String description, PublicationEvent publication, Person provider, AlignmentObject educationalAlignment, Event recordedAt, MusicComposition includedComposition, CreativeWork mainEntityOfPage, Organization contributor, String musicCompositionForm, IsPartOf isPartOf, CreativeWork workExample, java.util.Date dateCreated, Organization copyrightHolder, AggregateRating aggregateRating, String sameAs, String name, String typicalAgeRange, CreativeWork citation, Number copyrightYear, Person translator, Organization sourceOrganization, String text, String award) {
