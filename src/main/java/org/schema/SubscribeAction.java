...
public class SubscribeAction extends InteractAction {
   ...
   */
  static final class SubscribeActionThingBuilder implements Builder {
    /**
     * Creates new {@link SubscribeAction} instance.
     */
    public SubscribeAction build() {
      return new SubscribeAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<SubscribeAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    SubscribeAction subscribeAction = (SubscribeAction) o;
