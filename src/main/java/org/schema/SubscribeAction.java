...
public class SubscribeAction extends InteractAction {
  ...
  public static final class Builder {
    ...
    public SubscribeAction build() {
      return new SubscribeAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
