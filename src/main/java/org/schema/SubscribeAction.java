...
public class SubscribeAction extends InteractAction {
  /**
   * Builder for {@see SubscribeAction}
   */
  public static final class Builder {
    public SubscribeAction build() {
      return new SubscribeAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
