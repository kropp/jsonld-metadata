...
public class SubscribeAction extends InteractAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link SubscribeAction} instance.
     */
    public SubscribeAction build() {
      return new SubscribeAction(startTime, name, error, mainEntityOfPage, url, additionalType, sameAs, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
