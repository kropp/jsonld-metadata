...
public class EngineSpecification extends StructuredValue {
  ...
  public static final class Builder {
    ...
    public EngineSpecification build() {
      return new EngineSpecification(additionalType, sameAs, url, alternateName, fuelType, potentialAction, description, name, mainEntityOfPage);
    }
    /**
  ...
  protected EngineSpecification(String additionalType, String sameAs, String url, String alternateName, StringOrQualitativeValue fuelType, Action potentialAction, String description, String name, StringOrCreativeWork mainEntityOfPage) {
