...
public class DryCleaningOrLaundry extends LocalBusiness {
  ...
  public static final class Builder {
    /**
     * Creates new {@link DryCleaningOrLaundry} instance.
     */
    public DryCleaningOrLaundry build() {
      return new DryCleaningOrLaundry(aggregateRating, review, logo, parentOrganization, containedIn, event, additionalType, sameAs, priceRange, openingHoursSpecification, currenciesAccepted, potentialAction, address, additionalProperty, openingHours, globalLocationNumber, isicV4, name, paymentAccepted, mainEntityOfPage, hasMap, url, alternateName, faxNumber, geo, telephone, description, photo);
    }
    /**
