...
public class RadiationTherapy extends MedicalTherapy {
  ...
  @Override public boolean equals(Object o) {
    ...
    RadiationTherapy radiationTherapy = (RadiationTherapy) o;
   ...
   */
  public static class Builder implements ThingBuilder<RadiationTherapy> {
    public RadiationTherapy build() {
      return new RadiationTherapy(adverseOutcome, contraindication, duplicateTherapy, indication, seriousAdverseOutcome, code, guideline, medicineSystem, recognizingAuthority, relevantSpecialty, study, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
