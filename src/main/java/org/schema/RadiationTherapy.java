...
public class RadiationTherapy extends MedicalTherapy {
  ...
  public static final class Builder {
    /**
     * Creates new {@link RadiationTherapy} instance.
     */
    public RadiationTherapy build() {
      return new RadiationTherapy(recognizingAuthority, indication, code, name, adverseOutcome, mainEntityOfPage, seriousAdverseOutcome, guideline, additionalType, url, sameAs, duplicateTherapy, contraindication, alternateName, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
