...
public class RadiationTherapy extends MedicalTherapy {
  /**
   * Builder for {@see RadiationTherapy}
   */
  public static final class Builder {
    public RadiationTherapy build() {
      return new RadiationTherapy(indication, adverseOutcome, mainEntityOfPage, contraindication, alternateName, potentialAction, additionalType, url, medicineSystem, recognizingAuthority, sameAs, study, code, name, image, duplicateTherapy, relevantSpecialty, seriousAdverseOutcome, guideline, description);
    }
    /**
