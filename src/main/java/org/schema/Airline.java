...
public class Airline extends Organization {
  ...
  public static final class Builder {
    /**
     * Creates new {@link Airline} instance.
     */
    public Airline build() {
      return new Airline(aggregateRating, boardingPolicy, review, logo, duns, department, subOrganization, award, event, sameAs, additionalType, foundingDate, numberOfEmployees, seeks, brand, naics, iataCode, potentialAction, dissolutionDate, foundingLocation, address, founder, owns, email, makesOffer, member, employee, globalLocationNumber, isicV4, taxID, vatID, name, legalName, mainEntityOfPage, memberOf, url, contactPoint, hasPOS, faxNumber, alternateName, telephone, description);
    }
    /**
