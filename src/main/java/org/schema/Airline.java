...
public class Airline extends Organization {
  ...
  /**
   * Builder for {@see Airline}
   */
  public static final class Builder {
    public Airline build() {
      return new Airline(review, owns, boardingPolicy, potentialAction, seeks, additionalType, logo, hasPOS, founder, legalName, makesOffer, image, employee, contactPoint, department, description, foundingLocation, email, event, duns, faxNumber, brand, mainEntityOfPage, globalLocationNumber, numberOfEmployees, iataCode, telephone, alternateName, foundingDate, url, aggregateRating, sameAs, subOrganization, naics, vatID, dissolutionDate, name, address, memberOf, isicV4, member, taxID, location, award);
    }
    /**
  ...
  protected Airline(Review review, OwnershipInfo owns, BoardingPolicyType boardingPolicy, Action potentialAction, Demand seeks, String additionalType, ImageObject logo, Place hasPOS, Person founder, String legalName, Offer makesOffer, Image image, Person employee, ContactPoint contactPoint, Organization department, String description, Place foundingLocation, String email, Event event, String duns, String faxNumber, Brand brand, CreativeWork mainEntityOfPage, String globalLocationNumber, QuantitativeValue numberOfEmployees, String iataCode, String telephone, String alternateName, java.util.Date foundingDate, String url, AggregateRating aggregateRating, String sameAs, Organization subOrganization, String naics, String vatID, java.util.Date dissolutionDate, String name, PostalAddress address, Organization memberOf, String isicV4, Organization member, String taxID, Location location, String award) {
