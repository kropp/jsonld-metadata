...
public class UserLikes extends UserInteraction {
   ...
   */
  public static final class UserLikesThingBuilder implements Builder {
    /**
     * Creates new {@link UserLikes} instance.
     */
    public UserLikes build() {
      return new UserLikes(aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<UserLikes> {
