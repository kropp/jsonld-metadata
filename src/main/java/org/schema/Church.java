...
public class Church extends PlaceOfWorship {
  /**
   * Builder for {@see Church}
   */
  public static final class Builder {
    public Church build() {
      return new Church(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, geo, url, additionalType, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
