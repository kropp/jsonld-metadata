...
public class OrderItem extends Intangible {
  ...
  public static final class Builder {
    ...
    public OrderItem build() {
      return new OrderItem(sameAs, url, additionalType, orderQuantity, alternateName, orderedItem, name, potentialAction, description, orderItemStatus, orderDelivery, mainEntityOfPage, orderItemNumber);
    }
    /**
  ...
  protected OrderItem(String sameAs, String url, String additionalType, Number orderQuantity, String alternateName, ProductOrOrderItem orderedItem, String name, Action potentialAction, String description, OrderStatus orderItemStatus, ParcelDelivery orderDelivery, StringOrCreativeWork mainEntityOfPage, String orderItemNumber) {
