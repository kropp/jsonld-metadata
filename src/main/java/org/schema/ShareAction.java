...
public class ShareAction extends CommunicateAction {
   ...
   */
  public static final class ShareActionThingBuilder implements Builder {
    /**
     * Creates new {@link ShareAction} instance.
     */
    public ShareAction build() {
      return new ShareAction(about, inLanguage, recipient, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<ShareAction> {
