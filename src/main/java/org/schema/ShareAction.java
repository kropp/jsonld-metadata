...
public class ShareAction extends CommunicateAction {
  ...
  public static final class Builder {
    ...
    public ShareAction build() {
      return new ShareAction(about, inLanguage, recipient, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
