...
public class UpdateAction extends Action {
  ...
  public static final class Builder {
    ...
    public UpdateAction build() {
      return new UpdateAction(startTime, name, error, mainEntityOfPage, url, sameAs, additionalType, agent, alternateName, potentialAction, targetCollection, description, target, endTime, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected UpdateAction(java.util.Date startTime, String name, Thing error, StringOrCreativeWork mainEntityOfPage, String url, String sameAs, String additionalType, OrganizationOrPerson agent, String alternateName, Action potentialAction, Thing targetCollection, String description, EntryPoint target, java.util.Date endTime, ActionStatusType actionStatus) {
