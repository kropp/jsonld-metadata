...
public class UpdateAction extends Action {
  ...
  /**
   * Builder for {@see UpdateAction}
   */
  public static final class Builder {
    public UpdateAction build() {
      return new UpdateAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, targetCollection, target, object, location, description);
    }
