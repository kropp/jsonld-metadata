...
public class RadioSeason extends CreativeWorkSeason {
  /**
   * Builder for {@see RadioSeason}
   */
  public static final class Builder {
    public RadioSeason build() {
      return new RadioSeason(review, editor, producer, timeRequired, offers, creator, educationalUse, alternativeHeadline, mentions, additionalType, position, associatedMedia, isFamilyFriendly, accessibilityControl, image, keywords, discussionUrl, isBasedOnUrl, exampleOfWork, trailer, comment, datePublished, author, alternateName, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, actor, episode, genre, endDate, partOfSeries, potentialAction, audience, contentRating, director, inLanguage, contentLocation, learningResourceType, audio, accountablePerson, dateModified, thumbnailUrl, releasedEvent, productionCompany, accessibilityHazard, accessibilityFeature, license, description, seasonNumber, provider, publication, recordedAt, educationalAlignment, mainEntityOfPage, contributor, workExample, isPartOf, dateCreated, copyrightHolder, sameAs, aggregateRating, startDate, name, numberOfEpisodes, typicalAgeRange, translator, copyrightYear, citation, sourceOrganization, text, award);
    }
    /**
     ...
     */
    public Builder partOfSeries(IsPartOf value) {
      partOfSeries = value;
      return this;
    }
    /**
     ...
     */
    public Builder seasonNumber(Integer value) {
      seasonNumber = value;
      return this;
    }
    /**
  ...
  protected RadioSeason(Review review, Person editor, Person producer, Duration timeRequired, Offer offers, Organization creator, String educationalUse, String alternativeHeadline, Thing mentions, String additionalType, Position position, MediaObject associatedMedia, Boolean isFamilyFriendly, String accessibilityControl, Image image, String keywords, String discussionUrl, String isBasedOnUrl, CreativeWork exampleOfWork, VideoObject trailer, Comment comment, java.util.Date datePublished, Organization author, String alternateName, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, Person character, String schemaVersion, String accessibilityAPI, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, Person actor, HasPart episode, String genre, java.util.Date endDate, IsPartOf partOfSeries, Action potentialAction, Audience audience, String contentRating, Person director, String inLanguage, Place contentLocation, String learningResourceType, AudioObject audio, Person accountablePerson, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, Organization productionCompany, String accessibilityHazard, String accessibilityFeature, CreativeWork license, String description, Integer seasonNumber, Person provider, PublicationEvent publication, Event recordedAt, AlignmentObject educationalAlignment, CreativeWork mainEntityOfPage, Organization contributor, CreativeWork workExample, IsPartOf isPartOf, java.util.Date dateCreated, Organization copyrightHolder, String sameAs, AggregateRating aggregateRating, java.util.Date startDate, String name, Integer numberOfEpisodes, String typicalAgeRange, Person translator, Number copyrightYear, CreativeWork citation, Organization sourceOrganization, String text, String award) {
    super(editor, review, producer, timeRequired, creator, offers, educationalUse, alternativeHeadline, mentions, additionalType, position, associatedMedia, isFamilyFriendly, image, accessibilityControl, keywords, discussionUrl, trailer, exampleOfWork, isBasedOnUrl, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, actor, episode, genre, endDate, partOfSeries, potentialAction, audience, contentRating, director, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, releasedEvent, accessibilityFeature, accessibilityHazard, productionCompany, license, description, publication, provider, seasonNumber, educationalAlignment, recordedAt, mainEntityOfPage, contributor, isPartOf, workExample, dateCreated, copyrightHolder, aggregateRating, sameAs, startDate, name, numberOfEpisodes, typicalAgeRange, citation, copyrightYear, translator, sourceOrganization, text, award);
  }
}
