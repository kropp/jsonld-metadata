...
public class ReactAction extends AssessAction {
  ...
  public static final class Builder {
    ...
    public ReactAction build() {
      return new ReactAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
