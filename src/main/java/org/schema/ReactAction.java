...
public class ReactAction extends AssessAction {
  /**
   * Builder for {@see ReactAction}
   */
  public static final class Builder {
    public ReactAction build() {
      return new ReactAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
