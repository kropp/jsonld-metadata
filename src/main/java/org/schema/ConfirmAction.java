...
public class ConfirmAction extends InformAction {
  /**
   * Builder for {@see ConfirmAction}
   */
  public static final class Builder {
    public ConfirmAction build() {
      return new ConfirmAction(instrument, event, recipient, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, startTime, sameAs, about, actionStatus, result, inLanguage, image, name, error, target, object, description, location);
    }
