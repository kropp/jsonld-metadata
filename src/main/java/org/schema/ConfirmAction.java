...
public class ConfirmAction extends InformAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link ConfirmAction} instance.
     */
    public ConfirmAction build() {
      return new ConfirmAction(startTime, inLanguage, about, name, mainEntityOfPage, error, event, sameAs, url, additionalType, recipient, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected ConfirmAction(java.util.Date startTime, LanguageOrString inLanguage, Thing about, String name, StringOrCreativeWork mainEntityOfPage, Thing error, Event event, String sameAs, String url, String additionalType, OrganizationOrPersonOrAudience recipient, OrganizationOrPerson agent, String alternateName, Action potentialAction, EntryPoint target, String description, java.util.Date endTime, ActionStatusType actionStatus) {
