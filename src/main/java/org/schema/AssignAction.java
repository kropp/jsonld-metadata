...
public class AssignAction extends AllocateAction {
   ...
   */
  static final class AssignActionThingBuilder implements Builder {
    /**
     * Creates new {@link AssignAction} instance.
     */
    public AssignAction build() {
      return new AssignAction(purpose, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<AssignAction> {
  ...
  protected AssignAction(MedicalDevicePurposeOrThing purpose, OrganizationOrPerson agent, java.util.Date endTime, java.util.Date startTime, ActionStatusType actionStatus, Thing error, EntryPoint target, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
  ...
  @Override public boolean equals(Object o) {
    ...
    AssignAction assignAction = (AssignAction) o;
