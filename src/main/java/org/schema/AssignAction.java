...
public class AssignAction extends AllocateAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link AssignAction} instance.
     */
    public AssignAction build() {
      return new AssignAction(purpose, startTime, name, mainEntityOfPage, error, sameAs, additionalType, url, agent, alternateName, description, potentialAction, target, endTime, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected AssignAction(ThingOrMedicalDevicePurpose purpose, java.util.Date startTime, String name, StringOrCreativeWork mainEntityOfPage, Thing error, String sameAs, String additionalType, String url, OrganizationOrPerson agent, String alternateName, String description, Action potentialAction, EntryPoint target, java.util.Date endTime, ActionStatusType actionStatus) {
    super(purpose, startTime, name, error, mainEntityOfPage, sameAs, additionalType, url, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
  }
}
