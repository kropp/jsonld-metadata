...
public class AssignAction extends AllocateAction {
  /**
   * Builder for {@see AssignAction}
   */
  public static final class Builder {
    public AssignAction build() {
      return new AssignAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, purpose, object, location, description);
    }
