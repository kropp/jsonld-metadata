...
public class BuddhistTemple extends PlaceOfWorship {
  /**
   * Builder for {@see BuddhistTemple}
   */
  public static final class Builder {
    public BuddhistTemple build() {
      return new BuddhistTemple(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, geo, url, additionalType, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
