...
/**
 * A simple system that adds up the number of risk factors to yield a score that is associated with prognosis, e.g. CHAD score, TIMI risk score.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class MedicalRiskScore extends MedicalRiskEstimator {
  /**
   * The algorithm or rules to follow to compute the score.
   */
  public String getAlgorithm() { return myAlgorithm; }
   ...
   */
  public static class Builder implements ThingBuilder<MedicalRiskScore> {
