...
public class MedicalRiskScore extends MedicalRiskEstimator {
   ...
   */
  static final class MedicalRiskScoreThingBuilder implements Builder {
    /**
     ...
     * The algorithm or rules to follow to compute the score.
     */
    @NotNull public Builder algorithm(String algorithm) {
  ...
  public interface Builder extends ThingBuilder<MedicalRiskScore> {
    @NotNull Builder algorithm(String algorithm);
