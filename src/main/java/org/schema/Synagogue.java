...
public class Synagogue extends PlaceOfWorship {
  /**
   * Builder for {@see Synagogue}
   */
  public static final class Builder {
    public Synagogue build() {
      return new Synagogue(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, geo, url, additionalType, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
