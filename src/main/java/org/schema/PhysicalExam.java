 ...
 */
public class PhysicalExam extends Enumeration {
  /**
   * Builder for {@link PhysicalExam}
   */
  static final class PhysicalExamThingBuilder implements Builder {
    /**
  ...
  public interface Builder extends ThingBuilder<PhysicalExam> {
