...
public class PhysicalExam extends Enumeration {
  ...
  public static final class Builder {
    ...
    public PhysicalExam build() {
      return new PhysicalExam(sameAs, url, additionalType, alternateName, supersededBy, description, potentialAction, name, mainEntityOfPage);
    }
    /**
  ...
  protected PhysicalExam(String sameAs, String url, String additionalType, String alternateName, EnumerationOrProperty supersededBy, String description, Action potentialAction, String name, StringOrCreativeWork mainEntityOfPage) {
