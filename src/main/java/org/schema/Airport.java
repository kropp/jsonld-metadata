...
public class Airport extends CivicStructure {
  ...
  static final class AirportThingBuilder implements Builder {
     ...
     * IACO identifier for an airport.
     */
    @NotNull public Builder iacoCode(@NotNull String iacoCode) {
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("iataCode".equals(key) && value instanceof String) { iataCode((String)value); continue; }
        if ("iacoCode".equals(key) && value instanceof String) { iacoCode((String)value); continue; }
  ...
  public interface Builder extends ThingBuilder<Airport> {
    @NotNull Builder iataCode(@NotNull String iataCode);
    @NotNull Builder iacoCode(@NotNull String iacoCode);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myIacoCode != null ? myIacoCode.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myIataCode != null ? !myIataCode.equals(airport.myIataCode) : airport.myIataCode != null) return false;
    if (myIacoCode != null ? !myIacoCode.equals(airport.myIacoCode) : airport.myIacoCode != null) return false;
    return true;
  }
