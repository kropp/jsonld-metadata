...
public class Airport extends CivicStructure {
   ...
   */
  @JsonIgnore public String getIacoCode() {
    return (String) getValue("iacoCode");
  }
  /**
   * IACO identifier for an airport.
   */
  @JsonIgnore public Collection<String> getIacoCodes() {
    final Object current = myData.get("iacoCode");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<String>) current;
    }
  ...
  public static class Builder extends CivicStructure.Builder {
    ...
    @Override protected void fromMap(String key, Object value) {
      ...
      if ("iacoCode".equals(key) && value instanceof String) { iacoCode((String)value); return; }
