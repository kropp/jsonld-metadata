...
public class MedicalTherapy extends MedicalEntity {
  ...
  public static final class Builder {
    ...
    public MedicalTherapy build() {
      return new MedicalTherapy(recognizingAuthority, indication, code, adverseOutcome, name, mainEntityOfPage, seriousAdverseOutcome, guideline, additionalType, url, sameAs, duplicateTherapy, alternateName, contraindication, study, potentialAction, description, relevantSpecialty, medicineSystem);
    }
    /**
  ...
  protected MedicalTherapy(Organization recognizingAuthority, MedicalIndication indication, MedicalCode code, MedicalEntity adverseOutcome, String name, StringOrCreativeWork mainEntityOfPage, MedicalEntity seriousAdverseOutcome, MedicalGuideline guideline, String additionalType, String url, String sameAs, MedicalTherapy duplicateTherapy, String alternateName, MedicalContraindication contraindication, MedicalStudy study, Action potentialAction, String description, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem) {
