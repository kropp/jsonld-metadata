...
public class PalliativeProcedure extends MedicalTherapy {
  ...
  public static final class Builder {
    ...
    public PalliativeProcedure build() {
      return new PalliativeProcedure(recognizingAuthority, indication, code, name, adverseOutcome, mainEntityOfPage, seriousAdverseOutcome, guideline, additionalType, url, sameAs, duplicateTherapy, contraindication, alternateName, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
