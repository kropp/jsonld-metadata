...
public class PalliativeProcedure extends MedicalTherapy {
  /**
   * Builder for {@see PalliativeProcedure}
   */
  public static final class Builder {
    public PalliativeProcedure build() {
      return new PalliativeProcedure(indication, adverseOutcome, mainEntityOfPage, contraindication, alternateName, potentialAction, additionalType, url, medicineSystem, recognizingAuthority, sameAs, study, code, name, image, duplicateTherapy, relevantSpecialty, seriousAdverseOutcome, guideline, description);
    }
    /**
