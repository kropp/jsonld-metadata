...
/**
 * A medical procedure intended primarily for palliative purposes, aimed at relieving the symptoms of an underlying health condition.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class PalliativeProcedure extends MedicalTherapy {
  ...
  @Override public boolean equals(Object o) {
    ...
    PalliativeProcedure palliativeProcedure = (PalliativeProcedure) o;
   ...
   */
  public static class Builder implements ThingBuilder<PalliativeProcedure> {
    public PalliativeProcedure build() {
      return new PalliativeProcedure(adverseOutcome, contraindication, duplicateTherapy, indication, seriousAdverseOutcome, code, guideline, medicineSystem, recognizingAuthority, relevantSpecialty, study, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
