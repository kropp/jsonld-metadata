...
public class TrackAction extends FindAction {
  ...
  /**
   * Builder for {@see TrackAction}
   */
  public static final class Builder {
    public TrackAction build() {
      return new TrackAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, deliveryMethod, image, name, error, target, object, description, location);
    }
