...
public class TrackAction extends FindAction {
   ...
   */
  static final class TrackActionThingBuilder implements Builder {
    /**
     * Creates new {@link TrackAction} instance.
     */
    public TrackAction build() {
      return new TrackAction(deliveryMethod, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of instrument. The method of delivery.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<TrackAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    TrackAction trackAction = (TrackAction) o;
    if (!super.equals(o)) return false;
    if (myDeliveryMethod != null ? !myDeliveryMethod.equals(trackAction.myDeliveryMethod) : trackAction.myDeliveryMethod != null) return false;
    return true;
  }
