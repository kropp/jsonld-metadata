...
public class TrackAction extends FindAction {
  ...
  public static final class Builder {
    ...
    public TrackAction build() {
      return new TrackAction(startTime, name, error, mainEntityOfPage, deliveryMethod, sameAs, additionalType, url, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
