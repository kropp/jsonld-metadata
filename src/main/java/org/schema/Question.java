...
public class Question extends CreativeWork {
  ...
  public Integer getUpvoteCount() {
    return myUpvoteCount;
  }
  /**
   * The number of downvotes this question, answer or comment has received from the community.
   */
  public Integer getDownvoteCount() {
    return myDownvoteCount;
  }
  /**
  ...
  public static final class Builder {
    /**
     * Creates new {@link Question} instance.
     */
    public Question build() {
      return new Question(accessibilityAPI, aggregateRating, hasPart, review, datePublished, comment, schemaVersion, video, award, editor, workExample, potentialAction, producer, upvoteCount, publisher, sourceOrganization, genre, learningResourceType, publishingPrinciples, translator, recordedAt, commentCount, inLanguage, dateModified, answerCount, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, copyrightHolder, acceptedAnswer, accessibilityControl, citation, educationalUse, suggestedAnswer, keywords, educationalAlignment, text, about, contentLocation, accessibilityHazard, author, version, accountablePerson, sameAs, additionalType, thumbnailUrl, publication, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, alternativeHeadline, mainEntity, name, license, copyrightYear, discussionUrl, mainEntityOfPage, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, downvoteCount, releasedEvent, contributor, creator);
    }
    /**
     ...
     * The number of upvotes this question, answer or comment has received from the community.
     */
    public Builder upvoteCount(Integer integer) {
      this.upvoteCount = integer;
      return this;
    }
    /**
     ...
     * The number of answers this question has received.
     */
    public Builder answerCount(Integer integer) {
      this.answerCount = integer;
      return this;
    }
    /**
     ...
     * The answer that has been accepted as best, typically on a Question/Answer site. Sites vary in their selection mechanisms, e.g. drawing on community opinion and/or the view of the Question author.
     */
    public Builder acceptedAnswer(Answer answer) {
     ...
     * An answer (possibly one of several, possibly incorrect) to a Question, e.g. on a Question/Answer site.
     */
    public Builder suggestedAnswer(SuggestedAnswer suggestedAnswer) {
     ...
     * The number of downvotes this question, answer or comment has received from the community.
     */
    public Builder downvoteCount(Integer integer) {
      this.downvoteCount = integer;
      return this;
    }
    /**
  ...
  protected Question(String accessibilityAPI, AggregateRating aggregateRating, HasPart hasPart, Review review, java.util.Date datePublished, Comment comment, String schemaVersion, VideoObject video, String award, Person editor, CreativeWork workExample, Action potentialAction, OrganizationOrPerson producer, Integer upvoteCount, Organization publisher, Organization sourceOrganization, String genre, String learningResourceType, String publishingPrinciples, OrganizationOrPerson translator, Event recordedAt, Integer commentCount, LanguageOrString inLanguage, java.util.Date dateModified, Integer answerCount, Thing mentions, Audience audience, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, String contentRating, String description, Offer offers, OrganizationOrPerson copyrightHolder, Answer acceptedAnswer, String accessibilityControl, StringOrCreativeWork citation, String educationalUse, SuggestedAnswer suggestedAnswer, String keywords, AlignmentObject educationalAlignment, String text, Thing about, Place contentLocation, String accessibilityHazard, OrganizationOrPerson author, Number version, Person accountablePerson, String sameAs, String additionalType, String thumbnailUrl, PublicationEvent publication, MediaObject encoding, Duration timeRequired, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, String alternativeHeadline, Thing mainEntity, String name, StringOrCreativeWork license, Number copyrightYear, String discussionUrl, StringOrCreativeWork mainEntityOfPage, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, String alternateName, Integer downvoteCount, PublicationEvent releasedEvent, OrganizationOrPerson contributor, OrganizationOrPerson creator) {
    ...
    myUpvoteCount = upvoteCount;
    myDownvoteCount = downvoteCount;
    myAnswerCount = answerCount;
    myAcceptedAnswer = acceptedAnswer;
    mySuggestedAnswer = suggestedAnswer;
  }
  private Integer myUpvoteCount;
  private Integer myDownvoteCount;
  private Integer myAnswerCount;
  private Answer myAcceptedAnswer;
  private SuggestedAnswer mySuggestedAnswer;
}
