...
public class Question extends CreativeWork {
  ...
  static final class QuestionThingBuilder implements Builder {
     ...
     * The number of upvotes this question, answer or comment has received from the community.
     */
    @NotNull public Builder upvoteCount(int upvoteCount) {
     ...
     * The number of downvotes this question, answer or comment has received from the community.
     */
    @NotNull public Builder downvoteCount(int downvoteCount) {
     ...
     * The number of answers this question has received.
     */
    @NotNull public Builder answerCount(int answerCount) {
     ...
     * The answer that has been accepted as best, typically on a Question/Answer site. Sites vary in their selection mechanisms, e.g. drawing on community opinion and/or the view of the Question author.
     */
    @NotNull public Builder acceptedAnswer(Answer answer) {
     ...
     * The answer that has been accepted as best, typically on a Question/Answer site. Sites vary in their selection mechanisms, e.g. drawing on community opinion and/or the view of the Question author.
     */
    @NotNull public Builder acceptedAnswer(Answer.Builder answer) {
      return this.acceptedAnswer(answer.build());
    }
    /**
     * An answer (possibly one of several, possibly incorrect) to a Question, e.g. on a Question/Answer site.
     */
    @NotNull public Builder suggestedAnswer(SuggestedAnswer suggestedAnswer) {
  ...
  public interface Builder extends ThingBuilder<Question> {
    @NotNull Builder upvoteCount(int upvoteCount);
    @NotNull Builder downvoteCount(int downvoteCount);
    @NotNull Builder answerCount(int answerCount);
    @NotNull Builder acceptedAnswer(Answer answer);
    @NotNull Builder acceptedAnswer(Answer.Builder answer);
    @NotNull Builder suggestedAnswer(SuggestedAnswer suggestedAnswer);
