...
public class Question extends CreativeWork {
   ...
   */
  public Integer getUpvoteCount() { return myUpvoteCount; }
  /**
   * The number of downvotes this question, answer or comment has received from the community.
   */
  public Integer getDownvoteCount() { return myDownvoteCount; }
  /**
   * The number of answers this question has received.
   */
  public Integer getAnswerCount() { return myAnswerCount; }
  /**
   ...
   */
  public Answer getAcceptedAnswer() { return myAcceptedAnswer; }
  /**
   * An answer (possibly one of several, possibly incorrect) to a Question, e.g. on a Question/Answer site.
   */
  public SuggestedAnswer getSuggestedAnswer() { return mySuggestedAnswer; }
   ...
   */
  public static class Builder implements ThingBuilder<Question> {
