...
public class Question extends CreativeWork {
  ...
  static final class QuestionThingBuilder implements Builder {
    ...
    @NotNull public Builder acceptedAnswer(@NotNull Answer.Builder answer) {
      return this.acceptedAnswer(answer.build());
    }
    /**
     * An answer (possibly one of several, possibly incorrect) to a Question, e.g. on a Question/Answer site.
     */
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("upvoteCount".equals(key) && value instanceof Integer) { upvoteCount((Integer)value); continue; }
        if ("downvoteCount".equals(key) && value instanceof Integer) { downvoteCount((Integer)value); continue; }
        if ("answerCount".equals(key) && value instanceof Integer) { answerCount((Integer)value); continue; }
        if ("acceptedAnswer".equals(key) && value instanceof Answer) { acceptedAnswer((Answer)value); continue; }
        if ("suggestedAnswer".equals(key) && value instanceof SuggestedAnswer) { suggestedAnswer((SuggestedAnswer)value); continue; }
  ...
  public interface Builder extends ThingBuilder<Question> {
    @NotNull Builder upvoteCount(@NotNull Integer integer);
    @NotNull Builder downvoteCount(@NotNull Integer integer);
    @NotNull Builder answerCount(@NotNull Integer integer);
    @NotNull Builder acceptedAnswer(@NotNull Answer answer);
    @NotNull Builder acceptedAnswer(@NotNull Answer.Builder answer);
    @NotNull Builder suggestedAnswer(@NotNull SuggestedAnswer suggestedAnswer);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myAnswerCount != null ? myAnswerCount.hashCode() : 0);
    result = 31 * result + (myAcceptedAnswer != null ? myAcceptedAnswer.hashCode() : 0);
    result = 31 * result + (mySuggestedAnswer != null ? mySuggestedAnswer.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myUpvoteCount != null ? !myUpvoteCount.equals(question.myUpvoteCount) : question.myUpvoteCount != null) return false;
    if (myDownvoteCount != null ? !myDownvoteCount.equals(question.myDownvoteCount) : question.myDownvoteCount != null) return false;
    if (myAnswerCount != null ? !myAnswerCount.equals(question.myAnswerCount) : question.myAnswerCount != null) return false;
    if (myAcceptedAnswer != null ? !myAcceptedAnswer.equals(question.myAcceptedAnswer) : question.myAcceptedAnswer != null) return false;
    if (mySuggestedAnswer != null ? !mySuggestedAnswer.equals(question.mySuggestedAnswer) : question.mySuggestedAnswer != null) return false;
    return true;
  }
