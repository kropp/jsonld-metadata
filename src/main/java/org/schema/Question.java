...
public class Question extends CreativeWork {
   ...
   */
  public static final class QuestionThingBuilder implements Builder {
    /**
     ...
     * The answer that has been accepted as best, typically on a Question/Answer site. Sites vary in their selection mechanisms, e.g. drawing on community opinion and/or the view of the Question author.
     */
    public Builder acceptedAnswer(Answer.Builder answer) {
  ...
  Builder upvoteCount(Integer integer);
  Builder downvoteCount(Integer integer);
  Builder answerCount(Integer integer);
  Builder acceptedAnswer(Answer answer);
  Builder acceptedAnswer(Answer.Builder answer);
  Builder suggestedAnswer(SuggestedAnswer suggestedAnswer);
