...
public class PlaceOfWorship extends CivicStructure {
  ...
  public static final class Builder {
    ...
    public PlaceOfWorship build() {
      return new PlaceOfWorship(aggregateRating, review, openingHours, logo, isicV4, globalLocationNumber, name, mainEntityOfPage, hasMap, url, sameAs, containedIn, event, additionalType, alternateName, openingHoursSpecification, faxNumber, telephone, geo, description, potentialAction, additionalProperty, photo, address);
    }
    /**
