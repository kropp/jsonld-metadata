...
public class PlaceOfWorship extends CivicStructure {
  ...
  public static final class Builder {
    ...
    public PlaceOfWorship build() {
      return new PlaceOfWorship(openingHours, address, aggregateRating, containedIn, event, faxNumber, geo, globalLocationNumber, isicV4, logo, hasMap, openingHoursSpecification, photo, review, telephone, additionalProperty, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
