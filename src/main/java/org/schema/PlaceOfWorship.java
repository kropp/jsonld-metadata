...
public class PlaceOfWorship extends CivicStructure {
  /**
   * Builder for {@see PlaceOfWorship}
   */
  public static final class Builder {
    public PlaceOfWorship build() {
      return new PlaceOfWorship(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
