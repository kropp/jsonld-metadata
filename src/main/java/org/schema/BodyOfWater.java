...
public class BodyOfWater extends Landform {
  ...
  public static final class Builder {
    /**
     * Creates new {@link BodyOfWater} instance.
     */
    public BodyOfWater build() {
      return new BodyOfWater(aggregateRating, review, logo, isicV4, globalLocationNumber, name, mainEntityOfPage, hasMap, event, containedIn, additionalType, sameAs, url, alternateName, openingHoursSpecification, faxNumber, telephone, geo, description, potentialAction, additionalProperty, photo, address);
    }
    /**
