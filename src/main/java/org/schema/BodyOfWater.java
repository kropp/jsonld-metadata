...
public class BodyOfWater extends Landform {
  /**
   * Builder for {@see BodyOfWater}
   */
  public static final class Builder {
    public BodyOfWater build() {
      return new BodyOfWater(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, url, geo, additionalType, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
