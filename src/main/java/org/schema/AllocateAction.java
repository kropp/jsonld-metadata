...
public class AllocateAction extends OrganizeAction {
  ...
  /**
   * Builder for {@see AllocateAction}
   */
  public static final class Builder {
    public AllocateAction build() {
      return new AllocateAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, purpose, description, location);
    }
