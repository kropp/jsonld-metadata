...
public class AllocateAction extends OrganizeAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link AllocateAction} instance.
     */
    public AllocateAction build() {
      return new AllocateAction(purpose, startTime, name, error, mainEntityOfPage, sameAs, additionalType, url, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
     * A goal towards an action is taken. Can be concrete or abstract.
     */
