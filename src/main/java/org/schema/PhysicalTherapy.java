...
/**
 * A process of progressive physical care and rehabilitation aimed at improving a health condition.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class PhysicalTherapy extends MedicalTherapy {
  ...
  @Override public boolean equals(Object o) {
    ...
    PhysicalTherapy physicalTherapy = (PhysicalTherapy) o;
   ...
   */
  public static class Builder implements ThingBuilder<PhysicalTherapy> {
    public PhysicalTherapy build() {
      return new PhysicalTherapy(adverseOutcome, contraindication, duplicateTherapy, indication, seriousAdverseOutcome, code, guideline, medicineSystem, recognizingAuthority, relevantSpecialty, study, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
