...
public class Waterfall extends BodyOfWater {
  /**
   * Builder for {@see Waterfall}
   */
  public static final class Builder {
    public Waterfall build() {
      return new Waterfall(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, additionalType, url, geo, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
