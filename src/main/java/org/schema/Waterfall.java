...
public class Waterfall extends BodyOfWater {
  ...
  public static final class Builder {
    /**
     * Creates new {@link Waterfall} instance.
     */
    public Waterfall build() {
      return new Waterfall(aggregateRating, review, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, url, event, containedIn, additionalType, sameAs, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
