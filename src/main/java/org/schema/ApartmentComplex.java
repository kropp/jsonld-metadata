...
public class ApartmentComplex extends Residence {
  ...
  public static final class Builder {
    /**
     * Creates new {@link ApartmentComplex} instance.
     */
    public ApartmentComplex build() {
      return new ApartmentComplex(aggregateRating, review, logo, isicV4, globalLocationNumber, name, mainEntityOfPage, hasMap, event, containedIn, additionalType, sameAs, url, alternateName, openingHoursSpecification, faxNumber, telephone, geo, description, potentialAction, additionalProperty, photo, address);
    }
    /**
