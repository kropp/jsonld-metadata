...
public class ApartmentComplex extends Residence {
  ...
  public static final class Builder {
    ...
    public ApartmentComplex build() {
      return new ApartmentComplex(address, aggregateRating, containedIn, event, faxNumber, geo, globalLocationNumber, isicV4, logo, hasMap, openingHoursSpecification, photo, review, telephone, additionalProperty, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
