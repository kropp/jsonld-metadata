...
public class ApartmentComplex extends Residence {
  /**
   * Builder for {@see ApartmentComplex}
   */
  public static final class Builder {
    public ApartmentComplex build() {
      return new ApartmentComplex(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, url, geo, additionalType, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
