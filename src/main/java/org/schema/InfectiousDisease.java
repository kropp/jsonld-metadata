...
public class InfectiousDisease extends MedicalCondition {
   ...
   */
  public String getInfectiousAgent() { return myInfectiousAgent; }
  /**
   * The class of infectious agent (bacteria, prion, etc.) that causes the disease.
   */
  public InfectiousAgentClass getInfectiousAgentClass() { return myInfectiousAgentClass; }
  /**
   * How the disease spreads, either as a route or vector, for example 'direct contact', 'Aedes aegypti', etc.
   */
  public String getTransmissionMethod() { return myTransmissionMethod; }
   ...
   */
  public static class Builder implements ThingBuilder<InfectiousDisease> {
