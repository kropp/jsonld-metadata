...
public class DeleteAction extends UpdateAction {
  ...
  public static final class Builder {
    ...
    public DeleteAction build() {
      return new DeleteAction(targetCollection, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
