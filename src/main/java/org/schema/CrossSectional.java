...
public class CrossSectional {
  ...
  @Override public boolean equals(Object o) {
    ...
    CrossSectional crossSectional = (CrossSectional) o;
   ...
   */
  public static class Builder implements ThingBuilder<CrossSectional> {
    public CrossSectional build() {
      return new CrossSectional();
    }
