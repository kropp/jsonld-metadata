...
public class Country extends AdministrativeArea {
  /**
   * Builder for {@see Country}
   */
  public static final class Builder {
    public Country build() {
      return new Country(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, url, geo, additionalType, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
