...
public class EducationalAudience extends Audience {
   ...
   */
  static final class EducationalAudienceThingBuilder implements Builder {
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("educationalRole".equals(key) && value instanceof String) { educationalRole((String)value); continue; }
  ...
  public interface Builder extends ThingBuilder<EducationalAudience> {
    @NotNull Builder educationalRole(@NotNull String educationalRole);
