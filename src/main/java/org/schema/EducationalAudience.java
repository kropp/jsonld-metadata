...
public class EducationalAudience extends Audience {
  ...
  public static final class Builder {
    ...
    public EducationalAudience build() {
      return new EducationalAudience(url, additionalType, sameAs, geographicArea, audienceType, educationalRole, alternateName, description, potentialAction, name, mainEntityOfPage);
    }
    /**
     * URL of the item.
     */
  ...
  protected EducationalAudience(String url, String additionalType, String sameAs, AdministrativeArea geographicArea, String audienceType, String educationalRole, String alternateName, String description, Action potentialAction, String name, StringOrCreativeWork mainEntityOfPage) {
