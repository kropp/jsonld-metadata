...
public class EducationalAudience extends Audience {
  ...
  /**
   * Builder for {@see EducationalAudience}
   */
  public static final class Builder {
    public EducationalAudience build() {
      return new EducationalAudience(mainEntityOfPage, geographicArea, image, name, audienceType, potentialAction, alternateName, educationalRole, additionalType, url, description, sameAs);
    }
    /**
     ...
     * An educationalRole of an EducationalAudience.
     */
    public Builder educationalRole(String value) {
  ...
  protected EducationalAudience(CreativeWork mainEntityOfPage, AdministrativeArea geographicArea, Image image, String name, String audienceType, Action potentialAction, String alternateName, String educationalRole, String additionalType, String url, String description, String sameAs) {
