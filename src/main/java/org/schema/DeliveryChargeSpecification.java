...
public class DeliveryChargeSpecification extends PriceSpecification {
  ...
  /**
   * Builder for {@see DeliveryChargeSpecification}
   */
  public static final class Builder {
    public DeliveryChargeSpecification build() {
      return new DeliveryChargeSpecification(valueAddedTaxIncluded, mainEntityOfPage, priceCurrency, eligibleTransactionVolume, alternateName, potentialAction, eligibleRegion, additionalType, url, sameAs, validFrom, appliesToDeliveryMethod, image, name, validThrough, maxPrice, minPrice, ineligibleRegion, eligibleQuantity, description, price);
    }
    /**
...
<li>
  ...
  protected DeliveryChargeSpecification(Boolean valueAddedTaxIncluded, CreativeWork mainEntityOfPage, String priceCurrency, PriceSpecification eligibleTransactionVolume, String alternateName, Action potentialAction, GeoShape eligibleRegion, String additionalType, String url, String sameAs, java.util.Date validFrom, DeliveryMethod appliesToDeliveryMethod, Image image, String name, java.util.Date validThrough, Number maxPrice, Number minPrice, GeoShape ineligibleRegion, QuantitativeValue eligibleQuantity, String description, Number price) {
