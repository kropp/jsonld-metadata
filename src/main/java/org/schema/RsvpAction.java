...
public class RsvpAction extends InformAction {
   ...
   */
  public Number getAdditionalNumberOfGuests() { return myAdditionalNumberOfGuests; }
  /**
   * The response (yes, no, maybe) to the RSVP.
   */
  public RsvpResponseType getRsvpResponse() { return myRsvpResponse; }
  /**
   ...
   */
  public static class Builder implements ThingBuilder<RsvpAction> {
