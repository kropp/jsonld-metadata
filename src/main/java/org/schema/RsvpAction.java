...
public class RsvpAction extends InformAction {
   ...
   */
  static final class RsvpActionThingBuilder implements Builder {
    /**
    ...
    @NotNull public Builder additionalNumberOfGuests(@NotNull String additionalNumberOfGuests) {
      if (this.additionalNumberOfGuests == null) this.additionalNumberOfGuests = new Number();
      this.additionalNumberOfGuests.setString(additionalNumberOfGuests);
      return this;
    }
    /**
     * The response (yes, no, maybe) to the RSVP.
    ...
    @NotNull public Builder rsvpResponse(@NotNull RsvpResponseType.Builder rsvpResponseType) {
      return this.rsvpResponse(rsvpResponseType.build());
    }
    /**
     * Comments, typically from users.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("additionalNumberOfGuests".equals(key) && value instanceof Integer) { additionalNumberOfGuests((Integer)value); continue; }
        if ("additionalNumberOfGuests".equals(key) && value instanceof Long) { additionalNumberOfGuests((Long)value); continue; }
        if ("additionalNumberOfGuests".equals(key) && value instanceof Float) { additionalNumberOfGuests((Float)value); continue; }
        if ("additionalNumberOfGuests".equals(key) && value instanceof Double) { additionalNumberOfGuests((Double)value); continue; }
        if ("additionalNumberOfGuests".equals(key) && value instanceof String) { additionalNumberOfGuests((String)value); continue; }
        if ("rsvpResponse".equals(key) && value instanceof RsvpResponseType) { rsvpResponse((RsvpResponseType)value); continue; }
  ...
  public interface Builder extends ThingBuilder<RsvpAction> {
    @NotNull Builder additionalNumberOfGuests(@NotNull Integer integer);
    @NotNull Builder additionalNumberOfGuests(@NotNull Long additionalNumberOfGuests);
    @NotNull Builder additionalNumberOfGuests(@NotNull Float additionalNumberOfGuests);
    @NotNull Builder additionalNumberOfGuests(@NotNull Double additionalNumberOfGuests);
    @NotNull Builder additionalNumberOfGuests(@NotNull String additionalNumberOfGuests);
    @NotNull Builder rsvpResponse(@NotNull RsvpResponseType rsvpResponseType);
    @NotNull Builder rsvpResponse(@NotNull RsvpResponseType.Builder rsvpResponseType);
