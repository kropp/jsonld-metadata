...
public class BuyAction extends TradeAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link BuyAction} instance.
     */
    public BuyAction build() {
      return new BuyAction(startTime, name, mainEntityOfPage, error, seller, price, url, sameAs, additionalType, agent, alternateName, description, priceSpecification, target, potentialAction, endTime, actionStatus);
    }
    /**
