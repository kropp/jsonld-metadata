...
public class BuyAction extends TradeAction {
   ...
   */
  public static final class BuyActionThingBuilder implements Builder {
    /**
     * Creates new {@link BuyAction} instance.
     */
    public BuyAction build() {
      return new BuyAction(seller, price, priceSpecification, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * An entity which offers (sells / leases / lends / loans) the services / goods.  A seller may also be a provider.
     */
