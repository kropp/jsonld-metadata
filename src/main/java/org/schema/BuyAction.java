...
public class BuyAction extends TradeAction {
  ...
  /**
   * Builder for {@see BuyAction}
   */
  public static final class Builder {
    public BuyAction build() {
      return new BuyAction(priceSpecification, instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location, price, seller);
    }
    /**
