...
public class SoftwareApplication extends CreativeWork {
   ...
   */
  public static final class SoftwareApplicationThingBuilder implements Builder {
    /**
     ...
     * A link to a screenshot image of the app.
     */
    public Builder screenshot(ImageObject.Builder imageObject) {
     ...
     * Additional content for a software application.
     */
    public Builder softwareAddOn(SoftwareApplication.Builder softwareApplication) {
     ...
     * Software application help.
     */
    public Builder softwareHelp(CreativeWork.Builder creativeWork) {
  ...
  Builder applicationCategory(String applicationCategory);
  Builder applicationSubCategory(String applicationSubCategory);
  Builder applicationSuite(String applicationSuite);
  Builder countriesNotSupported(String countriesNotSupported);
  Builder countriesSupported(String countriesSupported);
  Builder availableOnDevice(String availableOnDevice);
  Builder downloadUrl(String downloadUrl);
  Builder featureList(String featureList);
  Builder fileFormat(String fileFormat);
  Builder fileSize(Integer integer);
  Builder installUrl(String installUrl);
  ...
  Builder processorRequirements(String processorRequirements);
  Builder releaseNotes(String releaseNotes);
  Builder softwareRequirements(String softwareRequirements);
  Builder screenshot(ImageObject imageObject);
  Builder screenshot(ImageObject.Builder imageObject);
  Builder screenshot(String screenshot);
  Builder softwareVersion(String softwareVersion);
  Builder storageRequirements(String storageRequirements);
  ...
  Builder softwareHelp(CreativeWork creativeWork);
  Builder softwareHelp(CreativeWork.Builder creativeWork);
