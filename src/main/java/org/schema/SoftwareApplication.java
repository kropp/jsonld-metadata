...
public class SoftwareApplication extends CreativeWork {
   ...
   */
  public String getApplicationCategory() { return myApplicationCategory; }
  /**
   * Subcategory of the application, e.g. "Arcade Game".
   */
  public String getApplicationSubCategory() { return myApplicationSubCategory; }
  /**
   * The name of the application suite to which the application belongs (e.g. Excel belongs to Office).
   */
  public String getApplicationSuite() { return myApplicationSuite; }
  /**
   * Countries for which the application is not supported. You can also provide the two-letter ISO 3166-1 alpha-2 country code.
   */
  public String getCountriesNotSupported() { return myCountriesNotSupported; }
  /**
   * Countries for which the application is supported. You can also provide the two-letter ISO 3166-1 alpha-2 country code.
   */
  public String getCountriesSupported() { return myCountriesSupported; }
  /**
   * Device required to run the application. Used in cases where a specific make/model is required to run the application.
   */
  public String getAvailableOnDevice() { return myAvailableOnDevice; }
  /**
   ...
   */
  public static class Builder implements ThingBuilder<SoftwareApplication> {
