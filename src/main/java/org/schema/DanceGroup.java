...
public class DanceGroup extends PerformingGroup {
  ...
  public static final class Builder {
    /**
     * Creates new {@link DanceGroup} instance.
     */
    public DanceGroup build() {
      return new DanceGroup(aggregateRating, review, logo, duns, department, subOrganization, additionalType, sameAs, event, award, foundingDate, numberOfEmployees, seeks, brand, naics, potentialAction, dissolutionDate, foundingLocation, address, founder, owns, email, member, makesOffer, employee, isicV4, globalLocationNumber, taxID, name, vatID, mainEntityOfPage, legalName, memberOf, url, contactPoint, hasPOS, alternateName, faxNumber, telephone, description);
    }
    /**
