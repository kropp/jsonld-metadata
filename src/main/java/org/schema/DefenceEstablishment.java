...
public class DefenceEstablishment extends GovernmentBuilding {
  ...
  public static final class Builder {
    ...
    public DefenceEstablishment build() {
      return new DefenceEstablishment(openingHours, address, aggregateRating, containedIn, event, faxNumber, geo, globalLocationNumber, isicV4, logo, hasMap, openingHoursSpecification, photo, review, telephone, additionalProperty, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
