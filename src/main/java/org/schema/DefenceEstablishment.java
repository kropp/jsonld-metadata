...
public class DefenceEstablishment extends GovernmentBuilding {
  /**
   * Builder for {@see DefenceEstablishment}
   */
  public static final class Builder {
    public DefenceEstablishment build() {
      return new DefenceEstablishment(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, geo, url, additionalType, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
