...
public class Audience extends Intangible {
  ...
  public String getAudienceType() {
    return myAudienceType;
  }
  /**
   * The geographic area associated with the audience.
   */
  public AdministrativeArea getGeographicArea() {
    return myGeographicArea;
  }
  /**
   * Builder for {@see Audience}
   */
  public static final class Builder {
    public Audience build() {
      return new Audience(mainEntityOfPage, geographicArea, image, name, audienceType, alternateName, potentialAction, url, additionalType, description, sameAs);
    }
    /**
  ...
  protected Audience(CreativeWork mainEntityOfPage, AdministrativeArea geographicArea, Image image, String name, String audienceType, String alternateName, Action potentialAction, String url, String additionalType, String description, String sameAs) {
