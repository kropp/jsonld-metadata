...
public class ArriveAction extends MoveAction {
   ...
   */
  static final class ArriveActionThingBuilder implements Builder {
    /**
     * Creates new {@link ArriveAction} instance.
     */
    public ArriveAction build() {
      return new ArriveAction(fromLocation, toLocation, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<ArriveAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    ArriveAction arriveAction = (ArriveAction) o;
