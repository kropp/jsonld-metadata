...
public class ArriveAction extends MoveAction {
  /**
   * Builder for {@see ArriveAction}
   */
  public static final class Builder {
    public ArriveAction build() {
      return new ArriveAction(instrument, mainEntityOfPage, toLocation, agent, endTime, alternateName, potentialAction, fromLocation, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
