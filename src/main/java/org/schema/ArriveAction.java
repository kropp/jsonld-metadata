...
public class ArriveAction extends MoveAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link ArriveAction} instance.
     */
    public ArriveAction build() {
      return new ArriveAction(startTime, toLocation, name, mainEntityOfPage, error, fromLocation, url, sameAs, additionalType, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
