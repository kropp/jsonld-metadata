...
public class ApplyAction extends OrganizeAction {
  /**
   * Builder for {@see ApplyAction}
   */
  public static final class Builder {
    public ApplyAction build() {
      return new ApplyAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
