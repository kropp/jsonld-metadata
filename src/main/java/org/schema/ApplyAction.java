...
public class ApplyAction extends OrganizeAction {
   ...
   */
  static final class ApplyActionThingBuilder implements Builder {
    /**
     * Creates new {@link ApplyAction} instance.
     */
    public ApplyAction build() {
      return new ApplyAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<ApplyAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    ApplyAction applyAction = (ApplyAction) o;
