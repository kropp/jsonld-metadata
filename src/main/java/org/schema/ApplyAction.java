...
public class ApplyAction extends OrganizeAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link ApplyAction} instance.
     */
    public ApplyAction build() {
      return new ApplyAction(startTime, name, error, mainEntityOfPage, url, additionalType, sameAs, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
