...
public class MoveAction extends Action {
   ...
   */
  static final class MoveActionThingBuilder implements Builder {
    /**
     * Creates new {@link MoveAction} instance.
     */
    public MoveAction build() {
      return new MoveAction(fromLocation, toLocation, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of location. The original location of the object or the agent before the action.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<MoveAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myFromLocation != null ? !myFromLocation.equals(moveAction.myFromLocation) : moveAction.myFromLocation != null) return false;
    if (myToLocation != null ? !myToLocation.equals(moveAction.myToLocation) : moveAction.myToLocation != null) return false;
    return true;
  }
