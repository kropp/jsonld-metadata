...
public class MoveAction extends Action {
  ...
  /**
   * Builder for {@see MoveAction}
   */
  public static final class Builder {
    public MoveAction build() {
      return new MoveAction(instrument, mainEntityOfPage, toLocation, agent, endTime, alternateName, potentialAction, fromLocation, participant, additionalType, url, startTime, sameAs, actionStatus, result, error, name, image, target, object, location, description);
    }
