...
public class MoveAction extends Action {
  ...
  public static final class Builder {
    ...
    public MoveAction build() {
      return new MoveAction(startTime, toLocation, name, error, mainEntityOfPage, fromLocation, url, sameAs, additionalType, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
