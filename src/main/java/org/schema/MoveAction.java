...
public class MoveAction extends Action {
  ...
  public static final class Builder {
    ...
    public MoveAction build() {
      return new MoveAction(fromLocation, toLocation, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
     * A sub property of location. The original location of the object or the agent before the action.
     */
