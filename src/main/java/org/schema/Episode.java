...
public class Episode extends CreativeWork {
   ...
   */
  public IntegerOrString getEpisodeNumber() {
    return myEpisodeNumber;
  }
  /**
  ...
  public interface Builder extends ThingBuilder<Episode> {
