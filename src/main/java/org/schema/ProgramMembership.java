...
public class ProgramMembership extends Intangible {
   ...
   */
  public static final class ProgramMembershipThingBuilder implements Builder {
    /**
     ...
     * The organization (airline, travelers' club, etc.) the membership is made with.
     */
    public Builder hostingOrganization(Organization organization) {
     ...
     * The organization (airline, travelers' club, etc.) the membership is made with.
     */
    public Builder hostingOrganization(Organization.Builder organization) {
  ...
  Builder membershipNumber(String membershipNumber);
  Builder programName(String programName);
  Builder hostingOrganization(Organization organization);
  Builder hostingOrganization(Organization.Builder organization);
