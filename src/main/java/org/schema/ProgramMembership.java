...
public class ProgramMembership extends Intangible {
   ...
   */
  public String getMembershipNumber() { return myMembershipNumber; }
  /**
   * The program providing the membership.
   */
  public String getProgramName() { return myProgramName; }
  /**
   * The organization (airline, travelers' club, etc.) the membership is made with.
   */
  public Organization getHostingOrganization() { return myHostingOrganization; }
   ...
   */
  public static class Builder implements ThingBuilder<ProgramMembership> {
