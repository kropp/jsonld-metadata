...
public class ProgramMembership extends Intangible {
  ...
  static final class ProgramMembershipThingBuilder implements Builder {
     ...
     * A unique identifier for the membership.
     */
    @NotNull public Builder membershipNumber(String membershipNumber) {
     ...
     * The program providing the membership.
     */
    @NotNull public Builder programName(String programName) {
     ...
     * The organization (airline, travelers' club, etc.) the membership is made with.
     */
    @NotNull public Builder hostingOrganization(Organization organization) {
     ...
     * The organization (airline, travelers' club, etc.) the membership is made with.
     */
    @NotNull public Builder hostingOrganization(Organization.Builder organization) {
  ...
  public interface Builder extends ThingBuilder<ProgramMembership> {
    @NotNull Builder membershipNumber(String membershipNumber);
    @NotNull Builder programName(String programName);
    @NotNull Builder hostingOrganization(Organization organization);
    @NotNull Builder hostingOrganization(Organization.Builder organization);
