...
public class ProgramMembership extends Intangible {
  ...
  public Organization getHostingOrganization() {
    return myHostingOrganization;
  }
  /**
   * Builder for {@link ProgramMembership}
   */
  static final class ProgramMembershipThingBuilder implements Builder {
    /**
    ...
    @NotNull public Builder hostingOrganization(@NotNull Organization organization) {
      this.hostingOrganization = organization;
      return this;
    }
    /**
     * The organization (airline, travelers' club, etc.) the membership is made with.
    ...
    @NotNull public Builder hostingOrganization(@NotNull Organization.Builder organization) {
      return this.hostingOrganization(organization.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("membershipNumber".equals(key) && value instanceof String) { membershipNumber((String)value); continue; }
        if ("programName".equals(key) && value instanceof String) { programName((String)value); continue; }
        if ("hostingOrganization".equals(key) && value instanceof Organization) { hostingOrganization((Organization)value); continue; }
  ...
  public interface Builder extends ThingBuilder<ProgramMembership> {
    @NotNull Builder membershipNumber(@NotNull String membershipNumber);
    @NotNull Builder programName(@NotNull String programName);
    @NotNull Builder hostingOrganization(@NotNull Organization organization);
    @NotNull Builder hostingOrganization(@NotNull Organization.Builder organization);
