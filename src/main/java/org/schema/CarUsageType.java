...
public class CarUsageType extends QualitativeValue {
  ...
  public static final class Builder {
    ...
    public CarUsageType build() {
      return new CarUsageType(nonEqual, valueReference, equal, greaterOrEqual, name, mainEntityOfPage, lesserOrEqual, url, additionalType, sameAs, alternateName, supersededBy, greater, potentialAction, description, additionalProperty, lesser);
    }
    /**
