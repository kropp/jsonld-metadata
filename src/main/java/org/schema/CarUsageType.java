...
public class CarUsageType extends QualitativeValue {
  /**
   * Builder for {@see CarUsageType}
   */
  public static final class Builder {
    public CarUsageType build() {
      return new CarUsageType(mainEntityOfPage, nonEqual, valueReference, potentialAction, alternateName, equal, lesserOrEqual, additionalType, url, sameAs, greaterOrEqual, name, image, greater, supersededBy, lesser, additionalProperty, description);
    }
    /**
