...
public class Clip extends CreativeWork {
   ...
   */
  public Position getClipNumber() { return myClipNumber; }
  /**
   ...
   */
  public IsPartOf getPartOfEpisode() { return myPartOfEpisode; }
  /**
   ...
   */
  public static class Builder implements ThingBuilder<Clip> {
    public Clip build() {
