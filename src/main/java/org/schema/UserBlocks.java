...
public class UserBlocks extends UserInteraction {
   ...
   */
  static final class UserBlocksThingBuilder implements Builder {
    /**
     * Creates new {@link UserBlocks} instance.
     */
    public UserBlocks build() {
      return new UserBlocks(aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<UserBlocks> {
  ...
  @Override public boolean equals(Object o) {
    ...
    UserBlocks userBlocks = (UserBlocks) o;
