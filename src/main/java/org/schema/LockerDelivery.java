...
public class LockerDelivery extends DeliveryMethod {
  ...
  public static final class Builder {
    ...
    public LockerDelivery build() {
      return new LockerDelivery(supersededBy, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
  ...
  protected LockerDelivery(EnumerationOrProperty supersededBy, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction) {
