...
public class FoodEstablishment extends LocalBusiness {
   ...
   */
  public BooleanOrString getAcceptsReservations() { return myAcceptsReservations; }
  /**
   * Either the actual menu or a URL of the menu.
   */
  public String getMenu() { return myMenu; }
  /**
   * The cuisine of the restaurant.
   */
  public String getServesCuisine() { return myServesCuisine; }
   ...
   */
  public static class Builder implements ThingBuilder<FoodEstablishment> {
