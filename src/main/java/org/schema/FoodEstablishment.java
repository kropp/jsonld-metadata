...
public class FoodEstablishment extends LocalBusiness {
  ...
  static final class FoodEstablishmentThingBuilder implements Builder {
     ...
     * Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings <code>Yes</code> or <code>No</code>.
     */
    @NotNull public Builder acceptsReservations(Boolean acceptsReservations) {
     ...
     * Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings <code>Yes</code> or <code>No</code>.
     */
    @NotNull public Builder acceptsReservations(String acceptsReservations) {
      if (this.acceptsReservations == null) this.acceptsReservations = new BooleanOrString();
     ...
     * Either the actual menu or a URL of the menu.
     */
    @NotNull public Builder menu(String menu) {
      this.menu = menu;
      return this;
    }
    /**
     * The cuisine of the restaurant.
     */
    @NotNull public Builder servesCuisine(String servesCuisine) {
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  public interface Builder extends ThingBuilder<FoodEstablishment> {
    @NotNull Builder acceptsReservations(Boolean acceptsReservations);
    @NotNull Builder acceptsReservations(String acceptsReservations);
    @NotNull Builder menu(String menu);
    @NotNull Builder servesCuisine(String servesCuisine);
