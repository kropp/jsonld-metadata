...
public class FoodEstablishment extends LocalBusiness {
   ...
   */
  public BooleanOrString getAcceptsReservations() {
    return myAcceptsReservations;
  }
  /**
  ...
  public static final class Builder {
    /**
     * Creates new {@link FoodEstablishment} instance.
     */
    public FoodEstablishment build() {
      return new FoodEstablishment(servesCuisine, aggregateRating, review, logo, parentOrganization, containedIn, event, sameAs, additionalType, menu, priceRange, openingHoursSpecification, currenciesAccepted, potentialAction, address, additionalProperty, acceptsReservations, openingHours, globalLocationNumber, isicV4, name, paymentAccepted, mainEntityOfPage, hasMap, url, faxNumber, alternateName, geo, telephone, description, photo);
    }
    /**
     * The cuisine of the restaurant.
     */
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  protected FoodEstablishment(String servesCuisine, AggregateRating aggregateRating, Review review, ImageObjectOrString logo, Organization parentOrganization, Place containedIn, Event event, String sameAs, String additionalType, String menu, String priceRange, OpeningHoursSpecification openingHoursSpecification, String currenciesAccepted, Action potentialAction, PostalAddress address, PropertyValue additionalProperty, BooleanOrString acceptsReservations, String openingHours, String globalLocationNumber, String isicV4, String name, String paymentAccepted, StringOrCreativeWork mainEntityOfPage, MapOrString hasMap, String url, String faxNumber, String alternateName, GeoCoordinatesOrGeoShape geo, String telephone, String description, ImageObjectOrPhotograph photo) {
    super(aggregateRating, review, logo, parentOrganization, additionalType, sameAs, event, containedIn, priceRange, openingHoursSpecification, currenciesAccepted, potentialAction, address, additionalProperty, openingHours, globalLocationNumber, isicV4, name, paymentAccepted, mainEntityOfPage, hasMap, url, alternateName, faxNumber, telephone, geo, description, photo);
    myAcceptsReservations = acceptsReservations;
    myMenu = menu;
