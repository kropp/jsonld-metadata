...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("acceptsReservations".equals(key) && value instanceof Boolean) { acceptsReservations((Boolean)value); continue; }
        if ("acceptsReservations".equals(key) && value instanceof String) { acceptsReservations((String)value); continue; }
        if ("menu".equals(key) && value instanceof String) { menu((String)value); continue; }
        if ("servesCuisine".equals(key) && value instanceof String) { servesCuisine((String)value); continue; }
  ...
  public interface Builder extends ThingBuilder<FoodEstablishment> {
    @NotNull Builder acceptsReservations(@NotNull Boolean acceptsReservations);
    @NotNull Builder acceptsReservations(@NotNull String acceptsReservations);
    @NotNull Builder menu(@NotNull String menu);
    @NotNull Builder servesCuisine(@NotNull String servesCuisine);
