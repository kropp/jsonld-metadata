...
public class FoodEstablishment extends LocalBusiness {
  ...
  /**
   * Builder for {@see FoodEstablishment}
   */
  public static final class Builder {
    public FoodEstablishment build() {
      return new FoodEstablishment(openingHoursSpecification, review, servesCuisine, openingHours, potentialAction, additionalType, logo, currenciesAccepted, parentOrganization, image, menu, containedIn, description, hasMap, acceptsReservations, event, faxNumber, mainEntityOfPage, globalLocationNumber, priceRange, telephone, alternateName, photo, geo, url, aggregateRating, sameAs, name, address, paymentAccepted, additionalProperty, isicV4);
    }
    /**
     ...
     * The cuisine of the restaurant.
     */
    public Builder servesCuisine(String value) {
      servesCuisine = value;
      return this;
    }
    /**
     ...
     * Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings <code>Yes</code> or <code>No</code>.
     */
    public Builder acceptsReservations(String value) {
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
    ...
    private String acceptsReservations;
    private Event event;
  ...
  protected FoodEstablishment(OpeningHoursSpecification openingHoursSpecification, Review review, String servesCuisine, String openingHours, Action potentialAction, String additionalType, ImageObject logo, String currenciesAccepted, Organization parentOrganization, Image image, String menu, Place containedIn, String description, String hasMap, String acceptsReservations, Event event, String faxNumber, CreativeWork mainEntityOfPage, String globalLocationNumber, String priceRange, String telephone, String alternateName, ImageObject photo, GeoCoordinates geo, String url, AggregateRating aggregateRating, String sameAs, String name, PostalAddress address, String paymentAccepted, PropertyValue additionalProperty, String isicV4) {
  ...
  private String myAcceptsReservations;
