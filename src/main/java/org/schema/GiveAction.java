...
public class GiveAction extends TransferAction {
  ...
  public static final class Builder {
    ...
    public GiveAction build() {
      return new GiveAction(startTime, toLocation, name, mainEntityOfPage, error, fromLocation, url, sameAs, additionalType, recipient, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
