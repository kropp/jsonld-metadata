...
public class GiveAction extends TransferAction {
  ...
  public static final class Builder {
    ...
    public GiveAction build() {
      return new GiveAction(recipient, fromLocation, toLocation, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
     * A sub property of participant. The participant who is at the receiving end of the action.
     */
