...
public class GiveAction extends TransferAction {
  ...
  /**
   * Builder for {@see GiveAction}
   */
  public static final class Builder {
    public GiveAction build() {
      return new GiveAction(instrument, recipient, toLocation, mainEntityOfPage, agent, endTime, alternateName, potentialAction, fromLocation, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
