...
public class MusicGroup extends PerformingGroup {
  ...
  public static final class Builder {
    /**
     * Creates new {@link MusicGroup} instance.
     */
    public MusicGroup build() {
      return new MusicGroup(aggregateRating, review, duns, logo, department, subOrganization, sameAs, event, award, additionalType, foundingDate, numberOfEmployees, seeks, brand, track, naics, potentialAction, dissolutionDate, foundingLocation, address, founder, owns, email, makesOffer, member, employee, genre, isicV4, globalLocationNumber, taxID, name, vatID, mainEntityOfPage, legalName, memberOf, url, contactPoint, hasPOS, alternateName, faxNumber, telephone, description, album);
    }
    /**
     ...
     * A music album.
     */
    public Builder album(MusicAlbum musicAlbum) {
  ...
  protected MusicGroup(AggregateRating aggregateRating, Review review, String duns, ImageObjectOrString logo, Organization department, Organization subOrganization, String sameAs, Event event, String award, String additionalType, java.util.Date foundingDate, QuantitativeValue numberOfEmployees, Demand seeks, OrganizationOrBrand brand, MusicRecordingOrItemList track, String naics, Action potentialAction, java.util.Date dissolutionDate, Place foundingLocation, PostalAddress address, Person founder, ProductOrOwnershipInfo owns, String email, Offer makesOffer, OrganizationOrPerson member, Person employee, String genre, String isicV4, String globalLocationNumber, String taxID, String name, String vatID, StringOrCreativeWork mainEntityOfPage, String legalName, OrganizationOrProgramMembership memberOf, String url, ContactPoint contactPoint, Place hasPOS, String alternateName, String faxNumber, String telephone, String description, MusicAlbum album) {
