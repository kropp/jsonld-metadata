...
public class MusicGroup extends PerformingGroup {
   ...
   */
  public static final class MusicGroupThingBuilder implements Builder {
    /**
     ...
     * A music album.
     */
    public Builder album(MusicAlbum.Builder musicAlbum) {
  ...
  Builder album(MusicAlbum musicAlbum);
  Builder album(MusicAlbum.Builder musicAlbum);
