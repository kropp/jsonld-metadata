...
public class MusicGroup extends PerformingGroup {
  ...
  static final class MusicGroupThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("album".equals(key) && value instanceof MusicAlbum) { album((MusicAlbum)value); continue; }
  ...
  public interface Builder extends ThingBuilder<MusicGroup> {
    @NotNull Builder album(@NotNull MusicAlbum musicAlbum);
    @NotNull Builder album(@NotNull MusicAlbum.Builder musicAlbum);
