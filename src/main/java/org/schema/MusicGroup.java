...
public class MusicGroup extends PerformingGroup {
  ...
  /**
   * Builder for {@see MusicGroup}
   */
  public static final class Builder {
    public MusicGroup build() {
      return new MusicGroup(review, genre, owns, potentialAction, seeks, additionalType, logo, hasPOS, founder, legalName, makesOffer, employee, image, contactPoint, department, description, foundingLocation, email, event, duns, faxNumber, brand, mainEntityOfPage, globalLocationNumber, numberOfEmployees, telephone, alternateName, foundingDate, url, sameAs, aggregateRating, subOrganization, track, vatID, naics, dissolutionDate, name, memberOf, address, isicV4, member, taxID, album, location, award);
    }
    /**
     ...
     * A music album.
     */
    public Builder album(MusicAlbum value) {
      album = value;
      return this;
    }
  ...
  protected MusicGroup(Review review, String genre, OwnershipInfo owns, Action potentialAction, Demand seeks, String additionalType, ImageObject logo, Place hasPOS, Person founder, String legalName, Offer makesOffer, Person employee, Image image, ContactPoint contactPoint, Organization department, String description, Place foundingLocation, String email, Event event, String duns, String faxNumber, Brand brand, CreativeWork mainEntityOfPage, String globalLocationNumber, QuantitativeValue numberOfEmployees, String telephone, String alternateName, java.util.Date foundingDate, String url, String sameAs, AggregateRating aggregateRating, Organization subOrganization, ItemList track, String vatID, String naics, java.util.Date dissolutionDate, String name, Organization memberOf, PostalAddress address, String isicV4, Organization member, String taxID, MusicAlbum album, Location location, String award) {
    super(review, owns, potentialAction, additionalType, seeks, logo, hasPOS, founder, legalName, makesOffer, employee, image, contactPoint, department, description, foundingLocation, email, event, duns, faxNumber, brand, mainEntityOfPage, globalLocationNumber, numberOfEmployees, telephone, alternateName, foundingDate, url, aggregateRating, sameAs, subOrganization, naics, vatID, dissolutionDate, name, address, memberOf, isicV4, member, taxID, location, award);
    myAlbum = album;
    myTrack = track;
    myGenre = genre;
  }
  private MusicAlbum myAlbum;
  private ItemList myTrack;
