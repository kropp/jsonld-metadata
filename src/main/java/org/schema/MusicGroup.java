...
public class MusicGroup extends PerformingGroup {
   ...
   */
  public ItemListOrMusicRecording getTrack() {
    return myTrack;
  }
  /**
   ...
   */
  static final class MusicGroupThingBuilder implements Builder {
    /**
     * Creates new {@link MusicGroup} instance.
     */
    public MusicGroup build() {
      return new MusicGroup(album, track, genre, address, aggregateRating, award, brand, contactPoint, department, duns, email, employee, event, faxNumber, founder, dissolutionDate, foundingDate, globalLocationNumber, hasPOS, isicV4, legalName, logo, makesOffer, member, memberOf, naics, numberOfEmployees, owns, review, seeks, subOrganization, taxID, telephone, vatID, foundingLocation, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A music album.
     */
    @NotNull public Builder album(MusicAlbum musicAlbum) {
     ...
     * A music album.
     */
    @NotNull public Builder album(MusicAlbum.Builder musicAlbum) {
      return this.album(musicAlbum.build());
    }
    /**
     * A music recording (track)&#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
     */
  ...
  public interface Builder extends ThingBuilder<MusicGroup> {
    @NotNull Builder album(MusicAlbum musicAlbum);
    @NotNull Builder album(MusicAlbum.Builder musicAlbum);
