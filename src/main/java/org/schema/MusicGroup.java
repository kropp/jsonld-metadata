...
public class MusicGroup extends PerformingGroup {
   ...
   * A music album.
   */
  public MusicAlbum getAlbum() { return myAlbum; }
  /**
   * A music recording (track)&#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
   */
  public ItemListOrMusicRecording getTrack() { return myTrack; }
  /**
   ...
   */
  public static class Builder implements ThingBuilder<MusicGroup> {
