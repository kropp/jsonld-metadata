...
public class ImagingTest extends MedicalTest {
  ...
  static final class ImagingTestThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("imagingTechnique".equals(key) && value instanceof MedicalImagingTechnique) { imagingTechnique((MedicalImagingTechnique)value); continue; }
  ...
  public interface Builder extends ThingBuilder<ImagingTest> {
    @NotNull Builder imagingTechnique(@NotNull MedicalImagingTechnique medicalImagingTechnique);
    @NotNull Builder imagingTechnique(@NotNull MedicalImagingTechnique.Builder medicalImagingTechnique);
