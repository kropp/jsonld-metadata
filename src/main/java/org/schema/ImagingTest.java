...
public class ImagingTest extends MedicalTest {
  ...
  /**
   * Builder for {@see ImagingTest}
   */
  public static final class Builder {
    public ImagingTest build() {
      return new ImagingTest(usedToDiagnose, mainEntityOfPage, usesDevice, potentialAction, affectedBy, alternateName, additionalType, url, imagingTechnique, medicineSystem, recognizingAuthority, sameAs, study, code, normalRange, name, image, relevantSpecialty, guideline, signDetected, description);
    }
    /**
     ...
     * Imaging technique used.
     */
    public Builder imagingTechnique(MedicalImagingTechnique value) {
      imagingTechnique = value;
      return this;
    }
    /**
  ...
  protected ImagingTest(MedicalCondition usedToDiagnose, CreativeWork mainEntityOfPage, MedicalDevice usesDevice, Action potentialAction, Drug affectedBy, String alternateName, String additionalType, String url, MedicalImagingTechnique imagingTechnique, MedicineSystem medicineSystem, Organization recognizingAuthority, String sameAs, MedicalStudy study, MedicalCode code, String normalRange, String name, Image image, MedicalSpecialty relevantSpecialty, MedicalGuideline guideline, MedicalSign signDetected, String description) {
