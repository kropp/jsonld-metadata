...
public class ImagingTest extends MedicalTest {
  ...
  public static final class Builder {
    ...
    public ImagingTest build() {
      return new ImagingTest(recognizingAuthority, code, usesDevice, name, usedToDiagnose, mainEntityOfPage, guideline, additionalType, url, sameAs, affectedBy, normalRange, alternateName, signDetected, study, description, potentialAction, relevantSpecialty, medicineSystem, imagingTechnique);
    }
    /**
  ...
  protected ImagingTest(Organization recognizingAuthority, MedicalCode code, MedicalDevice usesDevice, String name, MedicalCondition usedToDiagnose, StringOrCreativeWork mainEntityOfPage, MedicalGuideline guideline, String additionalType, String url, String sameAs, Drug affectedBy, String normalRange, String alternateName, MedicalSign signDetected, MedicalStudy study, String description, Action potentialAction, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem, MedicalImagingTechnique imagingTechnique) {
