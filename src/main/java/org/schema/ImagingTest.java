...
public class ImagingTest extends MedicalTest {
   ...
   */
  static final class ImagingTestThingBuilder implements Builder {
    /**
     ...
     * Imaging technique used.
     */
    @NotNull public Builder imagingTechnique(MedicalImagingTechnique medicalImagingTechnique) {
     ...
     * Imaging technique used.
     */
    @NotNull public Builder imagingTechnique(MedicalImagingTechnique.Builder medicalImagingTechnique) {
  ...
  public interface Builder extends ThingBuilder<ImagingTest> {
    @NotNull Builder imagingTechnique(MedicalImagingTechnique medicalImagingTechnique);
    @NotNull Builder imagingTechnique(MedicalImagingTechnique.Builder medicalImagingTechnique);
