...
public class ListItem extends Intangible implements Position {
  ...
  /**
   * Builder for {@see ListItem}
   */
  public static final class Builder {
    public ListItem build() {
      return new ListItem(previousItem, item, mainEntityOfPage, nextItem, image, name, alternateName, potentialAction, url, additionalType, description, sameAs);
    }
    /**
     * A link to the ListItem that preceeds the current one.
     */
    public Builder previousItem(ListItem value) {
      previousItem = value;
      return this;
    }
    /**
     * An entity represented by an entry in a list (e.g. an 'artist' in a list of 'artists')’.
     */
    public Builder item(Thing value) {
      item = value;
      return this;
    }
    /**
     ...
     * A link to the ListItem that follows the current one.
     */
    public Builder nextItem(ListItem value) {
      nextItem = value;
      return this;
    }
  ...
  protected ListItem(ListItem previousItem, Thing item, CreativeWork mainEntityOfPage, ListItem nextItem, Image image, String name, String alternateName, Action potentialAction, String url, String additionalType, String description, String sameAs) {
