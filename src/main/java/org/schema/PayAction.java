...
public class PayAction extends TradeAction {
  ...
  public static final class Builder {
    ...
    public PayAction build() {
      return new PayAction(purpose, recipient, price, priceSpecification, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
     * A goal towards an action is taken. Can be concrete or abstract.
     */
