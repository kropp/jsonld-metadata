...
public class PayAction extends TradeAction {
  ...
  /**
   * Builder for {@see PayAction}
   */
  public static final class Builder {
    public PayAction build() {
      return new PayAction(instrument, priceSpecification, recipient, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, purpose, description, location, price);
    }
