...
public class PayAction extends TradeAction {
  ...
  public static final class Builder {
    ...
    public PayAction build() {
      return new PayAction(purpose, startTime, name, mainEntityOfPage, error, price, url, sameAs, additionalType, recipient, agent, alternateName, description, priceSpecification, target, potentialAction, endTime, actionStatus);
    }
    /**
     * A goal towards an action is taken. Can be concrete or abstract.
     */
