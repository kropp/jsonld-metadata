...
public class OrganizationRole extends Role {
  ...
  public Number getNumberedPosition() {
    return myNumberedPosition;
  }
  /**
   * Builder for {@link OrganizationRole}
   */
  public static final class OrganizationRoleThingBuilder implements Builder {
    /**
     * Creates new {@link OrganizationRole} instance.
     */
    public OrganizationRole build() {
      return new OrganizationRole(numberedPosition, startDate, roleName, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A number associated with a role in an organization, for example, the number on an athlete's jersey.
     */
     ...
     * A number associated with a role in an organization, for example, the number on an athlete's jersey.
     */
    public Builder numberedPosition(String numberedPosition) {
      if (this.numberedPosition == null) this.numberedPosition = new Number();
  ...
  public interface Builder extends ThingBuilder<OrganizationRole> {
  Builder numberedPosition(Integer integer);
  Builder numberedPosition(Long numberedPosition);
  Builder numberedPosition(Float numberedPosition);
  Builder numberedPosition(Double numberedPosition);
  Builder numberedPosition(String numberedPosition);
  ...
  protected OrganizationRole(Number numberedPosition, java.util.Date startDate, String roleName, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
