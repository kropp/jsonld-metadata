...
public class BusinessEntityType extends Enumeration {
  ...
  public static final class Builder {
    ...
    public BusinessEntityType build() {
      return new BusinessEntityType(supersededBy, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
  ...
  protected BusinessEntityType(EnumerationOrProperty supersededBy, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction) {
