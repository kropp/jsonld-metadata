...
public class BusinessEntityType extends Enumeration {
  /**
   * Builder for {@see BusinessEntityType}
   */
  public static final class Builder {
    public BusinessEntityType build() {
      return new BusinessEntityType(mainEntityOfPage, name, image, supersededBy, potentialAction, alternateName, additionalType, url, description, sameAs);
    }
    /**
  ...
  protected BusinessEntityType(CreativeWork mainEntityOfPage, String name, Image image, Property supersededBy, Action potentialAction, String alternateName, String additionalType, String url, String description, String sameAs) {
