...
public class Cemetery extends CivicStructure {
  /**
   * Builder for {@see Cemetery}
   */
  public static final class Builder {
    public Cemetery build() {
      return new Cemetery(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
