...
public class MusicRecording extends CreativeWork {
  ...
  /**
   * Builder for {@see MusicRecording}
   */
  public static final class Builder {
    public MusicRecording build() {
      return new MusicRecording(review, producer, editor, timeRequired, offers, creator, educationalUse, alternativeHeadline, mentions, duration, additionalType, position, associatedMedia, isFamilyFriendly, accessibilityControl, image, keywords, inAlbum, discussionUrl, exampleOfWork, isBasedOnUrl, comment, datePublished, recordingOf, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, genre, potentialAction, contentRating, audience, isrcCode, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, byArtist, releasedEvent, accessibilityFeature, accessibilityHazard, license, description, publication, provider, inPlaylist, educationalAlignment, recordedAt, mainEntityOfPage, contributor, isPartOf, workExample, dateCreated, copyrightHolder, aggregateRating, sameAs, name, typicalAgeRange, citation, copyrightYear, translator, sourceOrganization, text, award);
    }
    /**
     ...
     * The album to which this recording belongs.
     */
    public Builder inAlbum(MusicAlbum value) {
      inAlbum = value;
      return this;
    }
    /**
     ...
     * The composition this track is a recording of.
     */
    public Builder recordingOf(MusicComposition value) {
      recordingOf = value;
      return this;
    }
    /**
     ...
     * The International Standard Recording Code for the recording.
     */
    public Builder isrcCode(String value) {
      isrcCode = value;
      return this;
    }
    /**
     ...
     * The playlist to which this recording belongs.
     */
    public Builder inPlaylist(MusicPlaylist value) {
      inPlaylist = value;
      return this;
    }
    /**
  ...
  protected MusicRecording(Review review, Person producer, Person editor, Duration timeRequired, Offer offers, Organization creator, String educationalUse, String alternativeHeadline, Thing mentions, Duration duration, String additionalType, Position position, MediaObject associatedMedia, Boolean isFamilyFriendly, String accessibilityControl, Image image, String keywords, MusicAlbum inAlbum, String discussionUrl, CreativeWork exampleOfWork, String isBasedOnUrl, Comment comment, java.util.Date datePublished, MusicComposition recordingOf, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, Person character, String schemaVersion, String accessibilityAPI, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, String genre, Action potentialAction, String contentRating, Audience audience, String isrcCode, String inLanguage, Place contentLocation, String learningResourceType, Person accountablePerson, AudioObject audio, java.util.Date dateModified, String thumbnailUrl, MusicGroup byArtist, PublicationEvent releasedEvent, String accessibilityFeature, String accessibilityHazard, CreativeWork license, String description, PublicationEvent publication, Person provider, MusicPlaylist inPlaylist, AlignmentObject educationalAlignment, Event recordedAt, CreativeWork mainEntityOfPage, Organization contributor, IsPartOf isPartOf, CreativeWork workExample, java.util.Date dateCreated, Organization copyrightHolder, AggregateRating aggregateRating, String sameAs, String name, String typicalAgeRange, CreativeWork citation, Number copyrightYear, Person translator, Organization sourceOrganization, String text, String award) {
  ...
  private MusicPlaylist myInPlaylist;
  private String myIsrcCode;
  private MusicComposition myRecordingOf;
}
