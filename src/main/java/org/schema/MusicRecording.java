  ...
  public static class Builder implements ThingBuilder<MusicRecording> {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("inAlbum".equals(key) && value instanceof MusicAlbum) { inAlbum((MusicAlbum)value); continue; }
        if ("inPlaylist".equals(key) && value instanceof MusicPlaylist) { inPlaylist((MusicPlaylist)value); continue; }
        if ("isrcCode".equals(key) && value instanceof String) { isrcCode((String)value); continue; }
        if ("recordingOf".equals(key) && value instanceof MusicComposition) { recordingOf((MusicComposition)value); continue; }
