...
public class MusicRecording extends CreativeWork {
  ...
  static final class MusicRecordingThingBuilder implements Builder {
     ...
     * The album to which this recording belongs.
     */
    @NotNull public Builder inAlbum(MusicAlbum musicAlbum) {
     ...
     * The album to which this recording belongs.
     */
    @NotNull public Builder inAlbum(MusicAlbum.Builder musicAlbum) {
      return this.inAlbum(musicAlbum.build());
    }
    /**
     * The playlist to which this recording belongs.
     */
    @NotNull public Builder inPlaylist(MusicPlaylist musicPlaylist) {
     ...
     * The playlist to which this recording belongs.
     */
    @NotNull public Builder inPlaylist(MusicPlaylist.Builder musicPlaylist) {
      return this.inPlaylist(musicPlaylist.build());
    }
    /**
     * The International Standard Recording Code for the recording.
     */
    @NotNull public Builder isrcCode(String isrcCode) {
     ...
     * The composition this track is a recording of.
     */
    @NotNull public Builder recordingOf(MusicComposition musicComposition) {
     ...
     * The composition this track is a recording of.
     */
    @NotNull public Builder recordingOf(MusicComposition.Builder musicComposition) {
      return this.recordingOf(musicComposition.build());
    }
    /**
  ...
  public interface Builder extends ThingBuilder<MusicRecording> {
    ...
    @NotNull Builder inAlbum(MusicAlbum musicAlbum);
    @NotNull Builder inAlbum(MusicAlbum.Builder musicAlbum);
    @NotNull Builder inPlaylist(MusicPlaylist musicPlaylist);
    @NotNull Builder inPlaylist(MusicPlaylist.Builder musicPlaylist);
    @NotNull Builder isrcCode(String isrcCode);
    @NotNull Builder recordingOf(MusicComposition musicComposition);
    @NotNull Builder recordingOf(MusicComposition.Builder musicComposition);
