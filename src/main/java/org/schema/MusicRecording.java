...
public class MusicRecording extends CreativeWork {
   ...
   */
  public static final class MusicRecordingThingBuilder implements Builder {
    /**
     ...
     * The album to which this recording belongs.
     */
    public Builder inAlbum(MusicAlbum.Builder musicAlbum) {
     ...
     * The playlist to which this recording belongs.
     */
    public Builder inPlaylist(MusicPlaylist.Builder musicPlaylist) {
     ...
     * The composition this track is a recording of.
     */
    public Builder recordingOf(MusicComposition.Builder musicComposition) {
  ...
  Builder inAlbum(MusicAlbum musicAlbum);
  Builder inAlbum(MusicAlbum.Builder musicAlbum);
  Builder inPlaylist(MusicPlaylist musicPlaylist);
  Builder inPlaylist(MusicPlaylist.Builder musicPlaylist);
  Builder isrcCode(String isrcCode);
  Builder recordingOf(MusicComposition musicComposition);
  Builder recordingOf(MusicComposition.Builder musicComposition);
