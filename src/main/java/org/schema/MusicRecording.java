...
public class MusicRecording extends CreativeWork {
  ...
  public static final class Builder {
    ...
    public MusicRecording build() {
      return new MusicRecording(accessibilityAPI, aggregateRating, hasPart, review, datePublished, schemaVersion, comment, video, byArtist, award, editor, workExample, inPlaylist, potentialAction, producer, publisher, sourceOrganization, genre, learningResourceType, translator, publishingPrinciples, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, recordingOf, contentRating, isrcCode, inAlbum, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, about, contentLocation, accessibilityHazard, author, version, accountablePerson, sameAs, additionalType, thumbnailUrl, publication, encoding, timeRequired, duration, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, alternativeHeadline, mainEntity, name, license, copyrightYear, discussionUrl, mainEntityOfPage, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, contributor, creator);
    }
    /**
     ...
     * The playlist to which this recording belongs.
     */
    public Builder inPlaylist(MusicPlaylist musicPlaylist) {
      this.inPlaylist = musicPlaylist;
      return this;
    }
    /**
     ...
     * The composition this track is a recording of.
     */
    public Builder recordingOf(MusicComposition musicComposition) {
      this.recordingOf = musicComposition;
      return this;
    }
    /**
     ...
     * The International Standard Recording Code for the recording.
     */
    public Builder isrcCode(String isrcCode) {
     ...
     * The album to which this recording belongs.
     */
    public Builder inAlbum(MusicAlbum musicAlbum) {
      this.inAlbum = musicAlbum;
      return this;
    }
    /**
  ...
  protected MusicRecording(String accessibilityAPI, AggregateRating aggregateRating, HasPart hasPart, Review review, java.util.Date datePublished, String schemaVersion, Comment comment, VideoObject video, MusicGroup byArtist, String award, Person editor, CreativeWork workExample, MusicPlaylist inPlaylist, Action potentialAction, OrganizationOrPerson producer, Organization publisher, Organization sourceOrganization, String genre, String learningResourceType, OrganizationOrPerson translator, String publishingPrinciples, Event recordedAt, Integer commentCount, LanguageOrString inLanguage, java.util.Date dateModified, Thing mentions, Audience audience, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, MusicComposition recordingOf, String contentRating, String isrcCode, MusicAlbum inAlbum, String description, Offer offers, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, String educationalUse, String keywords, AlignmentObject educationalAlignment, String text, Thing about, Place contentLocation, String accessibilityHazard, OrganizationOrPerson author, Number version, Person accountablePerson, String sameAs, String additionalType, String thumbnailUrl, PublicationEvent publication, MediaObject encoding, Duration timeRequired, Duration duration, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, String alternativeHeadline, Thing mainEntity, String name, StringOrCreativeWork license, Number copyrightYear, String discussionUrl, StringOrCreativeWork mainEntityOfPage, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, String alternateName, PublicationEvent releasedEvent, OrganizationOrPerson contributor, OrganizationOrPerson creator) {
