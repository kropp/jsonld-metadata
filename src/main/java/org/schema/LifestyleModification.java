...
public class LifestyleModification extends MedicalTherapy {
  /**
   * Builder for {@see LifestyleModification}
   */
  public static final class Builder {
    public LifestyleModification build() {
      return new LifestyleModification(indication, adverseOutcome, mainEntityOfPage, contraindication, alternateName, potentialAction, additionalType, url, medicineSystem, recognizingAuthority, sameAs, study, code, name, image, duplicateTherapy, relevantSpecialty, seriousAdverseOutcome, guideline, description);
    }
    /**
