...
public class LifestyleModification extends MedicalTherapy {
  ...
  public static final class Builder {
    /**
     * Creates new {@link LifestyleModification} instance.
     */
    public LifestyleModification build() {
      return new LifestyleModification(recognizingAuthority, indication, code, name, adverseOutcome, mainEntityOfPage, seriousAdverseOutcome, guideline, additionalType, url, sameAs, duplicateTherapy, contraindication, alternateName, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
