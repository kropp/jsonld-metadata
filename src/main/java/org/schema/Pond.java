...
public class Pond extends BodyOfWater {
  ...
  public static final class Builder {
    /**
     * Creates new {@link Pond} instance.
     */
    public Pond build() {
      return new Pond(aggregateRating, review, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, url, event, containedIn, additionalType, sameAs, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
