...
public class Pond extends BodyOfWater {
  /**
   * Builder for {@see Pond}
   */
  public static final class Builder {
    public Pond build() {
      return new Pond(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, additionalType, url, geo, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
