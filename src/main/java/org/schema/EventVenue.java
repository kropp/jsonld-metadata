...
public class EventVenue extends CivicStructure {
  ...
  public static final class Builder {
    ...
    public EventVenue build() {
      return new EventVenue(openingHours, address, aggregateRating, containedIn, event, faxNumber, geo, globalLocationNumber, isicV4, logo, hasMap, openingHoursSpecification, photo, review, telephone, additionalProperty, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
