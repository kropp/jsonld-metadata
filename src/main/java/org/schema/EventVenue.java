...
public class EventVenue extends CivicStructure {
  /**
   * Builder for {@see EventVenue}
   */
  public static final class Builder {
    public EventVenue build() {
      return new EventVenue(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
