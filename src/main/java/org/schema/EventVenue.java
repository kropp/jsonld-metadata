...
public class EventVenue extends CivicStructure {
  ...
  public static final class Builder {
    ...
    public EventVenue build() {
      return new EventVenue(aggregateRating, review, openingHours, logo, isicV4, globalLocationNumber, name, mainEntityOfPage, hasMap, url, sameAs, containedIn, event, additionalType, alternateName, openingHoursSpecification, faxNumber, telephone, geo, description, potentialAction, additionalProperty, photo, address);
    }
    /**
