...
public class NewsArticle extends Article {
   ...
   */
  public static final class NewsArticleThingBuilder implements Builder {
    /**
  ...
  Builder dateline(String dateline);
  Builder printColumn(String printColumn);
  Builder printEdition(String printEdition);
  Builder printPage(String printPage);
  Builder printSection(String printSection);
  Builder articleBody(String articleBody);
  Builder articleSection(String articleSection);
  Builder wordCount(Integer integer);
  Builder pageEnd(Integer integer);
  Builder pageEnd(String pageEnd);
  Builder pageStart(Integer integer);
  Builder pageStart(String pageStart);
  Builder pagination(String pagination);
