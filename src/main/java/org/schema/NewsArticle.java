...
public class NewsArticle extends Article {
  ...
  static final class NewsArticleThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("dateline".equals(key) && value instanceof String) { dateline((String)value); continue; }
        if ("printColumn".equals(key) && value instanceof String) { printColumn((String)value); continue; }
        if ("printEdition".equals(key) && value instanceof String) { printEdition((String)value); continue; }
        if ("printPage".equals(key) && value instanceof String) { printPage((String)value); continue; }
        if ("printSection".equals(key) && value instanceof String) { printSection((String)value); continue; }
        if ("articleBody".equals(key) && value instanceof String) { articleBody((String)value); continue; }
        if ("articleSection".equals(key) && value instanceof String) { articleSection((String)value); continue; }
        if ("wordCount".equals(key) && value instanceof Integer) { wordCount((Integer)value); continue; }
  ...
  public interface Builder extends ThingBuilder<NewsArticle> {
    @NotNull Builder dateline(@NotNull String dateline);
    @NotNull Builder printColumn(@NotNull String printColumn);
    @NotNull Builder printEdition(@NotNull String printEdition);
    @NotNull Builder printPage(@NotNull String printPage);
    @NotNull Builder printSection(@NotNull String printSection);
    @NotNull Builder articleBody(@NotNull String articleBody);
    @NotNull Builder articleSection(@NotNull String articleSection);
    @NotNull Builder wordCount(@NotNull Integer integer);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myDateline != null ? myDateline.hashCode() : 0);
    result = 31 * result + (myPrintColumn != null ? myPrintColumn.hashCode() : 0);
    result = 31 * result + (myPrintEdition != null ? myPrintEdition.hashCode() : 0);
    result = 31 * result + (myPrintPage != null ? myPrintPage.hashCode() : 0);
    result = 31 * result + (myPrintSection != null ? myPrintSection.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myDateline != null ? !myDateline.equals(newsArticle.myDateline) : newsArticle.myDateline != null) return false;
    if (myPrintColumn != null ? !myPrintColumn.equals(newsArticle.myPrintColumn) : newsArticle.myPrintColumn != null) return false;
    if (myPrintEdition != null ? !myPrintEdition.equals(newsArticle.myPrintEdition) : newsArticle.myPrintEdition != null) return false;
    if (myPrintPage != null ? !myPrintPage.equals(newsArticle.myPrintPage) : newsArticle.myPrintPage != null) return false;
    if (myPrintSection != null ? !myPrintSection.equals(newsArticle.myPrintSection) : newsArticle.myPrintSection != null) return false;
    return true;
  }
