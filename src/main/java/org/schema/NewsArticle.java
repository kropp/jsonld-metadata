...
public class NewsArticle extends Article {
  ...
  static final class NewsArticleThingBuilder implements Builder {
     ...
     * The location where the NewsArticle was produced.
     */
    @NotNull public Builder dateline(String dateline) {
     ...
     * The number of the column in which the NewsArticle appears in the print edition.
     */
    @NotNull public Builder printColumn(String printColumn) {
     ...
     * The edition of the print product in which the NewsArticle appears.
     */
    @NotNull public Builder printEdition(String printEdition) {
     ...
     * If this NewsArticle appears in print, this field indicates the name of the page on which the article is found. Please note that this field is intended for the exact page name (e.g. A5, B18).
     */
    @NotNull public Builder printPage(String printPage) {
     ...
     * If this NewsArticle appears in print, this field indicates the print section in which the article appeared.
     */
    @NotNull public Builder printSection(String printSection) {
     ...
     */
    @NotNull public Builder articleBody(String articleBody) {
     ...
     */
    @NotNull public Builder articleSection(String articleSection) {
     ...
     */
    @NotNull public Builder wordCount(int wordCount) {
     ...
     */
    @NotNull public Builder pageEnd(String pageEnd) {
      if (this.pageEnd == null) this.pageEnd = new StringOrInt();
     ...
     * The page on which the work ends; for example "138" or "xvi".
     */
    @NotNull public Builder pageEnd(int pageEnd) {
      if (this.pageEnd == null) this.pageEnd = new StringOrInt();
      this.pageEnd.setInt(pageEnd);
      return this;
    }
    /**
     * The page on which the work starts; for example "135" or "xiii".
     */
    @NotNull public Builder pageStart(String pageStart) {
      if (this.pageStart == null) this.pageStart = new StringOrInt();
     ...
     * The page on which the work starts; for example "135" or "xiii".
     */
    @NotNull public Builder pageStart(int pageStart) {
      if (this.pageStart == null) this.pageStart = new StringOrInt();
      this.pageStart.setInt(pageStart);
      return this;
    }
    /**
     * Any description of pages that is not separated into pageStart and pageEnd; for example, "1-6, 9, 55" or "10-12, 46-49".
     */
    @NotNull public Builder pagination(String pagination) {
    ...
    private StringOrInt pageEnd;
    private StringOrInt pageStart;
  ...
  public interface Builder extends ThingBuilder<NewsArticle> {
    @NotNull Builder dateline(String dateline);
    @NotNull Builder printColumn(String printColumn);
    @NotNull Builder printEdition(String printEdition);
    @NotNull Builder printPage(String printPage);
    @NotNull Builder printSection(String printSection);
    @NotNull Builder articleBody(String articleBody);
    @NotNull Builder articleSection(String articleSection);
    @NotNull Builder wordCount(int wordCount);
    @NotNull Builder pageEnd(String pageEnd);
    @NotNull Builder pageEnd(int pageEnd);
    @NotNull Builder pageStart(String pageStart);
    @NotNull Builder pageStart(int pageStart);
    @NotNull Builder pagination(String pagination);
