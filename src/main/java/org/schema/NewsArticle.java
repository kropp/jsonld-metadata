...
public class NewsArticle extends Article {
  ...
  public String getPrintSection() {
    return myPrintSection;
  }
  /**
   * Builder for {@see NewsArticle}
   */
  public static final class Builder {
    public NewsArticle build() {
      return new NewsArticle(dateline, review, producer, editor, timeRequired, offers, creator, wordCount, educationalUse, pagination, alternativeHeadline, mentions, additionalType, position, associatedMedia, isFamilyFriendly, image, accessibilityControl, keywords, articleSection, printEdition, discussionUrl, exampleOfWork, isBasedOnUrl, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, printSection, character, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, genre, potentialAction, audience, contentRating, pageStart, inLanguage, printPage, contentLocation, learningResourceType, printColumn, audio, accountablePerson, dateModified, thumbnailUrl, releasedEvent, accessibilityHazard, accessibilityFeature, license, description, provider, publication, recordedAt, educationalAlignment, pageEnd, mainEntityOfPage, contributor, articleBody, workExample, isPartOf, dateCreated, copyrightHolder, sameAs, aggregateRating, name, typicalAgeRange, translator, copyrightYear, citation, sourceOrganization, text, award);
    }
    /**
     * The location where the NewsArticle was produced.
     */
    public Builder dateline(String value) {
      dateline = value;
      return this;
    }
    /**
     ...
     * The edition of the print product in which the NewsArticle appears.
     */
    public Builder printEdition(String value) {
      printEdition = value;
      return this;
    }
    /**
     ...
     * If this NewsArticle appears in print, this field indicates the print section in which the article appeared.
     */
    public Builder printSection(String value) {
      printSection = value;
      return this;
    }
    /**
     ...
     * If this NewsArticle appears in print, this field indicates the name of the page on which the article is found. Please note that this field is intended for the exact page name (e.g. A5, B18).
     */
    public Builder printPage(String value) {
      printPage = value;
      return this;
    }
    /**
     ...
     * The number of the column in which the NewsArticle appears in the print edition.
     */
    public Builder printColumn(String value) {
      printColumn = value;
      return this;
    }
    /**
  ...
  protected NewsArticle(String dateline, Review review, Person producer, Person editor, Duration timeRequired, Offer offers, Organization creator, Integer wordCount, String educationalUse, String pagination, String alternativeHeadline, Thing mentions, String additionalType, Position position, MediaObject associatedMedia, Boolean isFamilyFriendly, Image image, String accessibilityControl, String keywords, String articleSection, String printEdition, String discussionUrl, CreativeWork exampleOfWork, String isBasedOnUrl, Comment comment, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, String printSection, Person character, String schemaVersion, String accessibilityAPI, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, String genre, Action potentialAction, Audience audience, String contentRating, Integer pageStart, String inLanguage, String printPage, Place contentLocation, String learningResourceType, String printColumn, AudioObject audio, Person accountablePerson, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, String accessibilityHazard, String accessibilityFeature, CreativeWork license, String description, Person provider, PublicationEvent publication, Event recordedAt, AlignmentObject educationalAlignment, Integer pageEnd, CreativeWork mainEntityOfPage, Organization contributor, String articleBody, CreativeWork workExample, IsPartOf isPartOf, java.util.Date dateCreated, Organization copyrightHolder, String sameAs, AggregateRating aggregateRating, String name, String typicalAgeRange, Person translator, Number copyrightYear, CreativeWork citation, Organization sourceOrganization, String text, String award) {
    super(review, producer, editor, timeRequired, offers, creator, educationalUse, wordCount, alternativeHeadline, pagination, mentions, additionalType, position, associatedMedia, isFamilyFriendly, accessibilityControl, image, keywords, articleSection, discussionUrl, exampleOfWork, isBasedOnUrl, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, genre, potentialAction, contentRating, audience, pageStart, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, releasedEvent, accessibilityFeature, accessibilityHazard, license, description, publication, provider, educationalAlignment, recordedAt, pageEnd, mainEntityOfPage, contributor, isPartOf, workExample, articleBody, dateCreated, copyrightHolder, aggregateRating, sameAs, name, typicalAgeRange, citation, copyrightYear, translator, sourceOrganization, text, award);
    myDateline = dateline;
    myPrintColumn = printColumn;
    myPrintEdition = printEdition;
    myPrintPage = printPage;
    myPrintSection = printSection;
  }
  private String myDateline;
  private String myPrintColumn;
  private String myPrintEdition;
  private String myPrintPage;
  private String myPrintSection;
}
