...
public class NewsArticle extends Article {
  ...
  public static final class Builder {
    ...
    public NewsArticle build() {
      return new NewsArticle(accessibilityAPI, printEdition, aggregateRating, hasPart, review, datePublished, schemaVersion, comment, video, award, editor, dateline, workExample, wordCount, potentialAction, pageStart, producer, publisher, sourceOrganization, learningResourceType, genre, translator, publishingPrinciples, recordedAt, commentCount, inLanguage, dateModified, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, articleBody, offers, copyrightHolder, accessibilityControl, printColumn, citation, educationalUse, printPage, keywords, educationalAlignment, text, about, contentLocation, author, accessibilityHazard, pagination, version, printSection, accountablePerson, additionalType, sameAs, articleSection, thumbnailUrl, publication, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, mainEntity, alternativeHeadline, name, license, mainEntityOfPage, discussionUrl, copyrightYear, pageEnd, isBasedOnUrl, isFamilyFriendly, exampleOfWork, alternateName, releasedEvent, creator, contributor);
    }
    /**
     ...
     * The edition of the print product in which the NewsArticle appears.
     */
    public Builder printEdition(String printEdition) {
     ...
     * The location where the NewsArticle was produced.
     */
    public Builder dateline(String dateline) {
     ...
     * The number of the column in which the NewsArticle appears in the print edition.
     */
    public Builder printColumn(String printColumn) {
     ...
     * If this NewsArticle appears in print, this field indicates the name of the page on which the article is found. Please note that this field is intended for the exact page name (e.g. A5, B18).
     */
    public Builder printPage(String printPage) {
     ...
     * If this NewsArticle appears in print, this field indicates the print section in which the article appeared.
     */
    public Builder printSection(String printSection) {
  ...
  protected NewsArticle(String accessibilityAPI, String printEdition, AggregateRating aggregateRating, HasPart hasPart, Review review, java.util.Date datePublished, String schemaVersion, Comment comment, VideoObject video, String award, Person editor, String dateline, CreativeWork workExample, Integer wordCount, Action potentialAction, IntegerOrString pageStart, OrganizationOrPerson producer, Organization publisher, Organization sourceOrganization, String learningResourceType, String genre, OrganizationOrPerson translator, String publishingPrinciples, Event recordedAt, Integer commentCount, LanguageOrString inLanguage, java.util.Date dateModified, Thing mentions, Audience audience, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, String contentRating, String description, String articleBody, Offer offers, OrganizationOrPerson copyrightHolder, String accessibilityControl, String printColumn, StringOrCreativeWork citation, String educationalUse, String printPage, String keywords, AlignmentObject educationalAlignment, String text, Thing about, Place contentLocation, OrganizationOrPerson author, String accessibilityHazard, String pagination, Number version, String printSection, Person accountablePerson, String additionalType, String sameAs, String articleSection, String thumbnailUrl, PublicationEvent publication, MediaObject encoding, Duration timeRequired, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, Thing mainEntity, String alternativeHeadline, String name, StringOrCreativeWork license, StringOrCreativeWork mainEntityOfPage, String discussionUrl, Number copyrightYear, IntegerOrString pageEnd, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, String alternateName, PublicationEvent releasedEvent, OrganizationOrPerson creator, OrganizationOrPerson contributor) {
