...
public class GovernmentPermit extends Permit {
  ...
  public static final class Builder {
    ...
    public GovernmentPermit build() {
      return new GovernmentPermit(permitAudience, name, validUntil, mainEntityOfPage, validFor, validFrom, additionalType, url, sameAs, issuedThrough, alternateName, description, validIn, potentialAction, issuedBy);
    }
    /**
  ...
  protected GovernmentPermit(Audience permitAudience, String name, java.util.Date validUntil, StringOrCreativeWork mainEntityOfPage, Duration validFor, java.util.Date validFrom, String additionalType, String url, String sameAs, Service issuedThrough, String alternateName, String description, AdministrativeArea validIn, Action potentialAction, Organization issuedBy) {
    super(permitAudience, name, validUntil, mainEntityOfPage, validFor, validFrom, additionalType, url, sameAs, issuedThrough, alternateName, potentialAction, validIn, description, issuedBy);
  }
}
