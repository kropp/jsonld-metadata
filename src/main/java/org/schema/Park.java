...
public class Park extends CivicStructure {
  ...
  public static final class Builder {
     ...
     */
    public Park build() {
      return new Park(aggregateRating, review, openingHours, logo, isicV4, globalLocationNumber, name, mainEntityOfPage, hasMap, url, sameAs, containedIn, event, additionalType, alternateName, openingHoursSpecification, faxNumber, telephone, geo, description, potentialAction, additionalProperty, photo, address);
    }
    /**
