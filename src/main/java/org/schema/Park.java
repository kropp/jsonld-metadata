...
public class Park extends CivicStructure {
  /**
   * Builder for {@see Park}
   */
  public static final class Builder {
    public Park build() {
      return new Park(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
