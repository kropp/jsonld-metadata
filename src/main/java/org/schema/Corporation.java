...
public class Corporation extends Organization {
  ...
  public static final class Builder {
    ...
    public Corporation build() {
      return new Corporation(aggregateRating, review, logo, duns, department, subOrganization, award, event, sameAs, additionalType, foundingDate, numberOfEmployees, seeks, brand, naics, potentialAction, dissolutionDate, foundingLocation, address, founder, owns, email, makesOffer, member, employee, globalLocationNumber, isicV4, taxID, vatID, name, legalName, mainEntityOfPage, memberOf, url, contactPoint, hasPOS, tickerSymbol, faxNumber, alternateName, telephone, description);
    }
    /**
