...
public class Corporation extends Organization {
   ...
   */
  public String getTickerSymbol() { return myTickerSymbol; }
   ...
   */
  public static class Builder implements ThingBuilder<Corporation> {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("tickerSymbol".equals(key) && value instanceof String) { tickerSymbol((String)value); continue; }
