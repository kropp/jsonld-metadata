...
public class Corporation extends Organization {
  ...
  /**
   * Builder for {@see Corporation}
   */
  public static final class Builder {
    public Corporation build() {
      return new Corporation(review, owns, potentialAction, additionalType, seeks, logo, hasPOS, founder, legalName, makesOffer, image, employee, contactPoint, tickerSymbol, department, description, foundingLocation, email, event, duns, faxNumber, brand, mainEntityOfPage, globalLocationNumber, numberOfEmployees, telephone, alternateName, foundingDate, url, aggregateRating, sameAs, subOrganization, naics, vatID, dissolutionDate, name, address, memberOf, isicV4, member, taxID, location, award);
    }
    /**
     ...
     * The exchange traded instrument associated with a Corporation object. The tickerSymbol is expressed as an exchange and an instrument name separated by a space character. For the exchange component of the tickerSymbol attribute, we reccommend using the controlled vocaulary of Market Identifier Codes (MIC) specified in ISO15022.
     */
    public Builder tickerSymbol(String value) {
      tickerSymbol = value;
      return this;
    }
    /**
  ...
  protected Corporation(Review review, OwnershipInfo owns, Action potentialAction, String additionalType, Demand seeks, ImageObject logo, Place hasPOS, Person founder, String legalName, Offer makesOffer, Image image, Person employee, ContactPoint contactPoint, String tickerSymbol, Organization department, String description, Place foundingLocation, String email, Event event, String duns, String faxNumber, Brand brand, CreativeWork mainEntityOfPage, String globalLocationNumber, QuantitativeValue numberOfEmployees, String telephone, String alternateName, java.util.Date foundingDate, String url, AggregateRating aggregateRating, String sameAs, Organization subOrganization, String naics, String vatID, java.util.Date dissolutionDate, String name, PostalAddress address, Organization memberOf, String isicV4, Organization member, String taxID, Location location, String award) {
