...
public class CreateAction extends Action {
  ...
  public static final class Builder {
    ...
    public CreateAction build() {
      return new CreateAction(additionalType, url, sameAs, agent, startTime, alternateName, potentialAction, target, description, name, endTime, mainEntityOfPage, error, actionStatus);
    }
    /**
