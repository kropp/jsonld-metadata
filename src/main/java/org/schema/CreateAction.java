...
public class CreateAction extends Action {
  ...
  public static final class Builder {
    ...
    public CreateAction build() {
      return new CreateAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
