...
public class CreateAction extends Action {
  /**
   * Builder for {@see CreateAction}
   */
  public static final class Builder {
    public CreateAction build() {
      return new CreateAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, object, location, description);
    }
