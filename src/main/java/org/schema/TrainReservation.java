...
public class TrainReservation extends Reservation {
  /**
   * Builder for {@see TrainReservation}
   */
  public static final class Builder {
    public TrainReservation build() {
      return new TrainReservation(reservedTicket, mainEntityOfPage, priceCurrency, reservationStatus, potentialAction, alternateName, url, additionalType, modifiedTime, sameAs, underName, bookingTime, image, name, reservationFor, reservationId, broker, totalPrice, programMembershipUsed, description, provider);
    }
    /**
