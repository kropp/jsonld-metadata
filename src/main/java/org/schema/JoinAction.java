...
public class JoinAction extends InteractAction {
  ...
  public static final class Builder {
    ...
    public JoinAction build() {
      return new JoinAction(startTime, name, error, mainEntityOfPage, sameAs, event, additionalType, url, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
