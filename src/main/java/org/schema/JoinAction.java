...
public class JoinAction extends InteractAction {
  ...
  /**
   * Builder for {@see JoinAction}
   */
  public static final class Builder {
    public JoinAction build() {
      return new JoinAction(event, instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
    /**
     * Upcoming or past event associated with this place, organization, or action.
     */
