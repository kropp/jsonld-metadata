...
public class CityHall extends GovernmentBuilding {
  ...
  public static final class Builder {
    ...
    public CityHall build() {
      return new CityHall(aggregateRating, review, openingHours, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, additionalType, event, url, sameAs, containedIn, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
