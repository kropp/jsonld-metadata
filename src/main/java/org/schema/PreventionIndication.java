...
public class PreventionIndication extends MedicalIndication {
  ...
  public static final class Builder {
    /**
     * Creates new {@link PreventionIndication} instance.
     */
    public PreventionIndication build() {
      return new PreventionIndication(recognizingAuthority, code, name, mainEntityOfPage, guideline, url, sameAs, additionalType, alternateName, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
