...
public class PreventionIndication extends MedicalIndication {
  /**
   * Builder for {@see PreventionIndication}
   */
  public static final class Builder {
    public PreventionIndication build() {
      return new PreventionIndication(mainEntityOfPage, potentialAction, alternateName, additionalType, url, medicineSystem, sameAs, recognizingAuthority, study, code, name, image, relevantSpecialty, guideline, description);
    }
    /**
