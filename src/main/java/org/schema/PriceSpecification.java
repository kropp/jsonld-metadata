...
<li>
  ...
  public static final class Builder {
    ...
    public PriceSpecification build() {
      return new PriceSpecification(eligibleQuantity, maxPrice, valueAddedTaxIncluded, priceCurrency, name, eligibleTransactionVolume, mainEntityOfPage, price, minPrice, validFrom, sameAs, additionalType, url, validThrough, alternateName, potentialAction, description);
    }
    /**
     * The interval and unit of measurement of ordering quantities for which the offer or price specification is valid. This allows e.g. specifying that a certain freight charge is valid only for a certain quantity.
     */
...
<li>
  ...
  protected PriceSpecification(QuantitativeValue eligibleQuantity, Number maxPrice, Boolean valueAddedTaxIncluded, String priceCurrency, String name, PriceSpecification eligibleTransactionVolume, StringOrCreativeWork mainEntityOfPage, StringOrNumber price, Number minPrice, java.util.Date validFrom, String sameAs, String additionalType, String url, java.util.Date validThrough, String alternateName, Action potentialAction, String description) {
