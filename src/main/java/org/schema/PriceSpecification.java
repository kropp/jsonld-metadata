...
<li>
  ...
  /**
   * Builder for {@see PriceSpecification}
   */
  public static final class Builder {
    public PriceSpecification build() {
      return new PriceSpecification(valueAddedTaxIncluded, mainEntityOfPage, priceCurrency, eligibleTransactionVolume, alternateName, potentialAction, additionalType, url, sameAs, validFrom, name, image, maxPrice, validThrough, minPrice, eligibleQuantity, description, price);
    }
    /**
     * Specifies whether the applicable value-added tax (VAT) is included in the price specification or not.
     */
...
<li>
  ...
  protected PriceSpecification(Boolean valueAddedTaxIncluded, CreativeWork mainEntityOfPage, String priceCurrency, PriceSpecification eligibleTransactionVolume, String alternateName, Action potentialAction, String additionalType, String url, String sameAs, java.util.Date validFrom, String name, Image image, Number maxPrice, java.util.Date validThrough, Number minPrice, QuantitativeValue eligibleQuantity, String description, Number price) {
