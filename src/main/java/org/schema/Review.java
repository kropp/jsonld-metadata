...
public class Review extends CreativeWork {
   ...
   */
  public Thing getItemReviewed() { return myItemReviewed; }
  /**
   * The actual body of the review.
   */
  public String getReviewBody() { return myReviewBody; }
  /**
   ...
   */
  public Rating getReviewRating() { return myReviewRating; }
   ...
   */
  public static class Builder implements ThingBuilder<Review> {
    public Review build() {
