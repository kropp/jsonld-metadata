...
public class Review extends CreativeWork {
  ...
  static final class ReviewThingBuilder implements Builder {
    ...
    @NotNull public Builder reviewRating(@NotNull Rating.Builder rating) {
      return this.reviewRating(rating.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("reviewBody".equals(key) && value instanceof String) { reviewBody((String)value); continue; }
        if ("reviewRating".equals(key) && value instanceof Rating) { reviewRating((Rating)value); continue; }
  ...
  public interface Builder extends ThingBuilder<Review> {
    @NotNull Builder itemReviewed(@NotNull Thing thing);
    @NotNull Builder itemReviewed(@NotNull Thing.Builder thing);
    @NotNull Builder reviewBody(@NotNull String reviewBody);
    @NotNull Builder reviewRating(@NotNull Rating rating);
    @NotNull Builder reviewRating(@NotNull Rating.Builder rating);
