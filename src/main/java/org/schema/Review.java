...
public class Review extends CreativeWork {
  ...
  static final class ReviewThingBuilder implements Builder {
     ...
     * The actual body of the review.
     */
    @NotNull public Builder reviewBody(String reviewBody) {
     ...
     * The rating given in this review. Note that reviews can themselves be rated. The <code>reviewRating</code> applies to rating given by the review. The <code>aggregateRating</code> property applies to the review itself, as a creative work.
     */
    @NotNull public Builder reviewRating(Rating rating) {
     ...
     * The rating given in this review. Note that reviews can themselves be rated. The <code>reviewRating</code> applies to rating given by the review. The <code>aggregateRating</code> property applies to the review itself, as a creative work.
     */
    @NotNull public Builder reviewRating(Rating.Builder rating) {
  ...
  public interface Builder extends ThingBuilder<Review> {
    ...
    @NotNull Builder reviewBody(String reviewBody);
    @NotNull Builder reviewRating(Rating rating);
    @NotNull Builder reviewRating(Rating.Builder rating);
