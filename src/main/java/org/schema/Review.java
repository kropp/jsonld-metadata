...
public class Review extends CreativeWork {
   ...
   */
  public static final class ReviewThingBuilder implements Builder {
    /**
     ...
     * The rating given in this review. Note that reviews can themselves be rated. The <code>reviewRating</code> applies to rating given by the review. The <code>aggregateRating</code> property applies to the review itself, as a creative work.
     */
    public Builder reviewRating(Rating.Builder rating) {
  ...
  Builder reviewBody(String reviewBody);
  Builder reviewRating(Rating rating);
  Builder reviewRating(Rating.Builder rating);
