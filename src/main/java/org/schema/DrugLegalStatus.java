...
public class DrugLegalStatus extends MedicalIntangible {
   ...
   */
  static final class DrugLegalStatusThingBuilder implements Builder {
    /**
     * Creates new {@link DrugLegalStatus} instance.
     */
    public DrugLegalStatus build() {
      return new DrugLegalStatus(applicableLocation, code, guideline, medicineSystem, recognizingAuthority, relevantSpecialty, study, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * The location in which the status applies.
     */
  ...
  public interface Builder extends ThingBuilder<DrugLegalStatus> {
    @NotNull Builder applicableLocation(@NotNull AdministrativeArea administrativeArea);
    @NotNull Builder applicableLocation(@NotNull AdministrativeArea.Builder administrativeArea);
  ...
  @Override public boolean equals(Object o) {
    ...
    DrugLegalStatus drugLegalStatus = (DrugLegalStatus) o;
    if (!super.equals(o)) return false;
    if (myApplicableLocation != null ? !myApplicableLocation.equals(drugLegalStatus.myApplicableLocation) : drugLegalStatus.myApplicableLocation != null) return false;
    return true;
  }
