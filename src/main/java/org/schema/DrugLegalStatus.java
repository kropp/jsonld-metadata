...
/**
 * The legal availability status of a medical drug.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class DrugLegalStatus extends MedicalIntangible {
   ...
   */
  public static class Builder implements ThingBuilder<DrugLegalStatus> {
