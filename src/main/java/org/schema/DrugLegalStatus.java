...
public class DrugLegalStatus extends MedicalIntangible {
  ...
  public static final class Builder {
    ...
    public DrugLegalStatus build() {
      return new DrugLegalStatus(recognizingAuthority, code, applicableLocation, name, mainEntityOfPage, guideline, url, sameAs, additionalType, alternateName, study, potentialAction, description, relevantSpecialty, medicineSystem);
    }
    /**
