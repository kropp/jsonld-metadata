...
public class DrugLegalStatus extends MedicalIntangible {
  ...
  /**
   * Builder for {@see DrugLegalStatus}
   */
  public static final class Builder {
    public DrugLegalStatus build() {
      return new DrugLegalStatus(mainEntityOfPage, alternateName, potentialAction, additionalType, url, medicineSystem, sameAs, recognizingAuthority, applicableLocation, study, code, image, name, relevantSpecialty, guideline, description);
    }
    /**
