...
public class MedicalProcedure extends MedicalEntity {
   ...
   */
  static final class MedicalProcedureThingBuilder implements Builder {
    /**
  ...
  public interface Builder extends ThingBuilder<MedicalProcedure> {
    @NotNull Builder followup(@NotNull String followup);
    @NotNull Builder howPerformed(@NotNull String howPerformed);
    @NotNull Builder preparation(@NotNull String preparation);
    @NotNull Builder procedureType(@NotNull MedicalProcedureType medicalProcedureType);
    @NotNull Builder procedureType(@NotNull MedicalProcedureType.Builder medicalProcedureType);
