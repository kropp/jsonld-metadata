...
public class MedicalProcedure extends MedicalEntity {
  ...
  public static final class Builder {
    ...
    public MedicalProcedure build() {
      return new MedicalProcedure(recognizingAuthority, code, name, followup, mainEntityOfPage, preparation, guideline, howPerformed, url, sameAs, additionalType, procedureType, alternateName, study, potentialAction, description, relevantSpecialty, medicineSystem);
    }
    /**
  ...
  protected MedicalProcedure(Organization recognizingAuthority, MedicalCode code, String name, String followup, StringOrCreativeWork mainEntityOfPage, String preparation, MedicalGuideline guideline, String howPerformed, String url, String sameAs, String additionalType, MedicalProcedureType procedureType, String alternateName, MedicalStudy study, Action potentialAction, String description, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem) {
