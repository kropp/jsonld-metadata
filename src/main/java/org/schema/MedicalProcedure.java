...
public class MedicalProcedure extends MedicalEntity {
  ...
  /**
   * Builder for {@see MedicalProcedure}
   */
  public static final class Builder {
    public MedicalProcedure build() {
      return new MedicalProcedure(mainEntityOfPage, procedureType, potentialAction, alternateName, howPerformed, followup, additionalType, url, medicineSystem, sameAs, recognizingAuthority, code, study, image, name, relevantSpecialty, guideline, description, preparation);
    }
    /**
     ...
     * The type of procedure, for example Surgical, Noninvasive, or Percutaneous.
     */
    public Builder procedureType(MedicalProcedureType value) {
      procedureType = value;
      return this;
    }
    /**
     ...
     * How the procedure is performed.
     */
    public Builder howPerformed(String value) {
      howPerformed = value;
      return this;
    }
    /**
     * Typical or recommended followup care after the procedure is performed.
     */
    public Builder followup(String value) {
      followup = value;
      return this;
    }
    /**
     ...
     * Typical preparation that a patient must undergo before having the procedure performed.
     */
    public Builder preparation(String value) {
      preparation = value;
      return this;
    }
  ...
  protected MedicalProcedure(CreativeWork mainEntityOfPage, MedicalProcedureType procedureType, Action potentialAction, String alternateName, String howPerformed, String followup, String additionalType, String url, MedicineSystem medicineSystem, String sameAs, Organization recognizingAuthority, MedicalCode code, MedicalStudy study, Image image, String name, MedicalSpecialty relevantSpecialty, MedicalGuideline guideline, String description, String preparation) {
