...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  protected LocalBusiness(AggregateRating aggregateRating, Review review, ImageObjectOrString logo, Organization parentOrganization, String additionalType, String sameAs, Event event, Place containedIn, String priceRange, OpeningHoursSpecification openingHoursSpecification, String currenciesAccepted, Action potentialAction, PostalAddress address, PropertyValue additionalProperty, String openingHours, String globalLocationNumber, String isicV4, String name, String paymentAccepted, StringOrCreativeWork mainEntityOfPage, MapOrString hasMap, String url, String alternateName, String faxNumber, String telephone, GeoCoordinatesOrGeoShape geo, String description, ImageObjectOrPhotograph photo) {
    super(aggregateRating, review, logo, isicV4, globalLocationNumber, name, mainEntityOfPage, hasMap, additionalType, sameAs, url, event, containedIn, alternateName, openingHoursSpecification, faxNumber, telephone, geo, description, potentialAction, additionalProperty, photo, address);
