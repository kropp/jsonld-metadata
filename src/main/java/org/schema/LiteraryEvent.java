...
public class LiteraryEvent extends Event {
   ...
   */
  static final class LiteraryEventThingBuilder implements Builder {
    /**
     * Creates new {@link LiteraryEvent} instance.
     */
    public LiteraryEvent build() {
      return new LiteraryEvent(aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<LiteraryEvent> {
  ...
  @Override public boolean equals(Object o) {
    ...
    LiteraryEvent literaryEvent = (LiteraryEvent) o;
