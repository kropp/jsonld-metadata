...
public class VideoGameClip extends Clip {
  /**
   * Builder for {@see VideoGameClip}
   */
  public static final class Builder {
    public VideoGameClip build() {
      return new VideoGameClip(clipNumber, editor, producer, partOfEpisode, review, timeRequired, creator, offers, educationalUse, alternativeHeadline, mentions, additionalType, position, associatedMedia, isFamilyFriendly, image, accessibilityControl, keywords, discussionUrl, isBasedOnUrl, exampleOfWork, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, musicBy, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, actor, genre, partOfSeries, potentialAction, director, contentRating, audience, partOfSeason, inLanguage, contentLocation, learningResourceType, audio, accountablePerson, dateModified, thumbnailUrl, releasedEvent, accessibilityHazard, accessibilityFeature, license, description, provider, publication, recordedAt, educationalAlignment, mainEntityOfPage, contributor, workExample, isPartOf, dateCreated, copyrightHolder, sameAs, aggregateRating, name, typicalAgeRange, translator, copyrightYear, citation, sourceOrganization, text, award);
    }
    /**
     * Position of the clip within an ordered group of clips.
     */
    public Builder clipNumber(Position value) {
      clipNumber = value;
      return this;
    }
    /**
     ...
     */
    public Builder partOfEpisode(IsPartOf value) {
      partOfEpisode = value;
      return this;
    }
    /**
  ...
  protected VideoGameClip(Position clipNumber, Person editor, Person producer, IsPartOf partOfEpisode, Review review, Duration timeRequired, Organization creator, Offer offers, String educationalUse, String alternativeHeadline, Thing mentions, String additionalType, Position position, MediaObject associatedMedia, Boolean isFamilyFriendly, Image image, String accessibilityControl, String keywords, String discussionUrl, String isBasedOnUrl, CreativeWork exampleOfWork, Comment comment, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, Person character, String schemaVersion, String accessibilityAPI, MusicGroup musicBy, Number version, String publishingPrinciples, String headline, MediaObject encoding, Integer commentCount, Thing mainEntity, Person actor, String genre, IsPartOf partOfSeries, Action potentialAction, Person director, String contentRating, Audience audience, IsPartOf partOfSeason, String inLanguage, Place contentLocation, String learningResourceType, AudioObject audio, Person accountablePerson, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, String accessibilityHazard, String accessibilityFeature, CreativeWork license, String description, Person provider, PublicationEvent publication, Event recordedAt, AlignmentObject educationalAlignment, CreativeWork mainEntityOfPage, Organization contributor, CreativeWork workExample, IsPartOf isPartOf, java.util.Date dateCreated, Organization copyrightHolder, String sameAs, AggregateRating aggregateRating, String name, String typicalAgeRange, Person translator, Number copyrightYear, CreativeWork citation, Organization sourceOrganization, String text, String award) {
    super(clipNumber, partOfEpisode, review, producer, editor, timeRequired, creator, offers, educationalUse, alternativeHeadline, mentions, additionalType, position, associatedMedia, isFamilyFriendly, accessibilityControl, image, keywords, discussionUrl, exampleOfWork, isBasedOnUrl, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, character, schemaVersion, accessibilityAPI, musicBy, version, publishingPrinciples, headline, encoding, commentCount, mainEntity, actor, genre, partOfSeries, potentialAction, director, contentRating, audience, partOfSeason, inLanguage, contentLocation, learningResourceType, accountablePerson, audio, dateModified, thumbnailUrl, releasedEvent, accessibilityFeature, accessibilityHazard, license, description, publication, provider, educationalAlignment, recordedAt, mainEntityOfPage, contributor, isPartOf, workExample, dateCreated, copyrightHolder, aggregateRating, sameAs, name, typicalAgeRange, citation, copyrightYear, translator, sourceOrganization, text, award);
  }
}
