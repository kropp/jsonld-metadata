...
public class CheckInAction extends CommunicateAction {
   ...
   */
  static final class CheckInActionThingBuilder implements Builder {
    /**
     * Creates new {@link CheckInAction} instance.
     */
    public CheckInAction build() {
      return new CheckInAction(about, inLanguage, recipient, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<CheckInAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    CheckInAction checkInAction = (CheckInAction) o;
