...
public class CheckInAction extends CommunicateAction {
  ...
  public static final class Builder {
    ...
    public CheckInAction build() {
      return new CheckInAction(startTime, about, inLanguage, name, mainEntityOfPage, error, sameAs, url, additionalType, recipient, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
