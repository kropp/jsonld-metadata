...
public class CheckInAction extends CommunicateAction {
  /**
   * Builder for {@see CheckInAction}
   */
  public static final class Builder {
    public CheckInAction build() {
      return new CheckInAction(instrument, recipient, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, about, startTime, sameAs, actionStatus, inLanguage, result, error, name, image, target, object, location, description);
    }
