...
public class EndorseAction extends ReactAction {
   ...
   */
  public static final class EndorseActionThingBuilder implements Builder {
    /**
     ...
     * A sub property of participant. The person/organization being supported.
     */
    public Builder endorsee(Organization.Builder organization) {
     ...
     * A sub property of participant. The person/organization being supported.
     */
    public Builder endorsee(Person.Builder person) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  Builder endorsee(Organization organization);
  Builder endorsee(Organization.Builder organization);
  Builder endorsee(Person person);
  Builder endorsee(Person.Builder person);
