...
public class EndorseAction extends ReactAction {
  ...
  /**
   * Builder for {@see EndorseAction}
   */
  public static final class Builder {
    public EndorseAction build() {
      return new EndorseAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, endorsee, object, location, description);
    }
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
     ...
     * A sub property of participant. The person/organization being supported.
     */
    public Builder endorsee(Organization value) {
      endorsee = value;
      return this;
    }
  ...
  protected EndorseAction(Instrument instrument, CreativeWork mainEntityOfPage, Organization agent, java.util.Date endTime, String alternateName, Action potentialAction, Participant participant, String additionalType, String url, String sameAs, java.util.Date startTime, ActionStatusType actionStatus, Result result, Thing error, String name, Image image, EntryPoint target, Organization endorsee, Object object, Location location, String description) {
  ...
  private Organization myEndorsee;
}
