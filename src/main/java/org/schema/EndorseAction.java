...
public class EndorseAction extends ReactAction {
  ...
  public static final class Builder {
    ...
    public EndorseAction build() {
      return new EndorseAction(startTime, name, mainEntityOfPage, error, url, additionalType, sameAs, agent, alternateName, description, potentialAction, target, endTime, endorsee, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
     ...
     * A sub property of participant. The person/organization being supported.
     */
    public Builder endorsee(Organization organization) {
     ...
     * A sub property of participant. The person/organization being supported.
     */
    public Builder endorsee(Person person) {
  ...
  protected EndorseAction(java.util.Date startTime, String name, StringOrCreativeWork mainEntityOfPage, Thing error, String url, String additionalType, String sameAs, OrganizationOrPerson agent, String alternateName, String description, Action potentialAction, EntryPoint target, java.util.Date endTime, OrganizationOrPerson endorsee, ActionStatusType actionStatus) {
    super(startTime, name, error, mainEntityOfPage, url, additionalType, sameAs, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    myEndorsee = endorsee;
  }
