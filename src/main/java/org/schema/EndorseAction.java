...
public class EndorseAction extends ReactAction {
  ...
  public static final class Builder {
    ...
    public EndorseAction build() {
      return new EndorseAction(endorsee, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
     * A sub property of participant. The person/organization being supported.
     */
