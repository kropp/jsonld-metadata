...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<EndorseAction> {
    @NotNull Builder endorsee(@NotNull Organization organization);
    @NotNull Builder endorsee(@NotNull Organization.Builder organization);
    @NotNull Builder endorsee(@NotNull Person person);
    @NotNull Builder endorsee(@NotNull Person.Builder person);
