...
public class CivicStructure extends Place {
  ...
  public static final class Builder {
    /**
     * Creates new {@link CivicStructure} instance.
     */
    public CivicStructure build() {
      return new CivicStructure(aggregateRating, review, openingHours, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, containedIn, event, additionalType, sameAs, url, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
