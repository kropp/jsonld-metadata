...
public class CivicStructure extends Place {
  ...
  /**
   * Builder for {@see CivicStructure}
   */
  public static final class Builder {
    public CivicStructure build() {
      return new CivicStructure(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, geo, url, additionalType, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
