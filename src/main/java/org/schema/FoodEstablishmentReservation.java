...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public static final class Builder {
    /**
     * Creates new {@link FoodEstablishmentReservation} instance.
     */
    public FoodEstablishmentReservation build() {
      return new FoodEstablishmentReservation(bookingTime, modifiedTime, reservationStatus, startTime, provider, reservationId, totalPrice, priceCurrency, name, underName, reservedTicket, mainEntityOfPage, additionalType, url, sameAs, broker, partySize, programMembershipUsed, reservationFor, alternateName, description, potentialAction);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
     ...
     * Number of people the reservation should accommodate.
     */
    public Builder partySize(Integer integer) {
     ...
     * Number of people the reservation should accommodate.
     */
    public Builder partySize(QuantitativeValue quantitativeValue) {
  ...
  protected FoodEstablishmentReservation(java.util.Date bookingTime, java.util.Date modifiedTime, ReservationStatusType reservationStatus, java.util.Date startTime, OrganizationOrPerson provider, String reservationId, PriceSpecificationOrStringOrNumber totalPrice, String priceCurrency, String name, OrganizationOrPerson underName, Ticket reservedTicket, StringOrCreativeWork mainEntityOfPage, String additionalType, String url, String sameAs, OrganizationOrPerson broker, IntegerOrQuantitativeValue partySize, ProgramMembership programMembershipUsed, Thing reservationFor, String alternateName, String description, Action potentialAction) {
