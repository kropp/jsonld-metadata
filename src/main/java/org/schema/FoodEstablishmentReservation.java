...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  /**
   * Builder for {@see FoodEstablishmentReservation}
   */
  public static final class Builder {
    public FoodEstablishmentReservation build() {
      return new FoodEstablishmentReservation(reservedTicket, mainEntityOfPage, priceCurrency, reservationStatus, alternateName, potentialAction, partySize, url, additionalType, modifiedTime, startTime, sameAs, bookingTime, underName, image, name, reservationFor, reservationId, broker, totalPrice, programMembershipUsed, description, provider);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected FoodEstablishmentReservation(Ticket reservedTicket, CreativeWork mainEntityOfPage, String priceCurrency, ReservationStatusType reservationStatus, String alternateName, Action potentialAction, Integer partySize, String url, String additionalType, java.util.Date modifiedTime, java.util.Date startTime, String sameAs, java.util.Date bookingTime, Person underName, Image image, String name, Thing reservationFor, String reservationId, Person broker, Number totalPrice, ProgramMembership programMembershipUsed, String description, Person provider) {
