...
<a href='unitCode'>unitCode</a>.
  ...
  public static final class Builder {
    ...
    public TypeAndQuantityNode build() {
      return new TypeAndQuantityNode(url, additionalType, sameAs, unitText, alternateName, businessFunction, unitCode, potentialAction, description, name, amountOfThisGood, typeOfGood, mainEntityOfPage);
    }
    /**
     * URL of the item.
     */
...
<a href='unitCode'>unitCode</a>.
     ...
     * The quantity of the goods included in the offer.
     */
    public Builder amountOfThisGood(Number number) {
      this.amountOfThisGood = number;
      return this;
    }
    /**
     * The product that this structured value is referring to.
  ...
  protected TypeAndQuantityNode(String url, String additionalType, String sameAs, String unitText, String alternateName, BusinessFunction businessFunction, String unitCode, Action potentialAction, String description, String name, Number amountOfThisGood, Product typeOfGood, StringOrCreativeWork mainEntityOfPage) {
