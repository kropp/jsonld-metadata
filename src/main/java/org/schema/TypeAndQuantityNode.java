...
<a href='unitCode'>unitCode</a>.
  ...
  public interface Builder extends ThingBuilder<TypeAndQuantityNode> {
    @NotNull Builder amountOfThisGood(@NotNull Integer integer);
    @NotNull Builder amountOfThisGood(@NotNull Long amountOfThisGood);
    @NotNull Builder amountOfThisGood(@NotNull Float amountOfThisGood);
    @NotNull Builder amountOfThisGood(@NotNull Double amountOfThisGood);
    @NotNull Builder amountOfThisGood(@NotNull String amountOfThisGood);
