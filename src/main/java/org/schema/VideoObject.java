...
public class VideoObject extends MediaObject {
  ...
  /**
   * Builder for {@see VideoObject}
   */
  public static final class Builder {
    public VideoObject build() {
      return new VideoObject(editor, producer, review, timeRequired, offers, creator, educationalUse, alternativeHeadline, mentions, duration, additionalType, contentUrl, position, associatedMedia, associatedArticle, isFamilyFriendly, playerType, image, accessibilityControl, videoFrameSize, keywords, embedUrl, discussionUrl, encodingFormat, exampleOfWork, isBasedOnUrl, comment, datePublished, alternateName, author, video, publisher, url, interactivityType, about, bitrate, regionsAllowed, character, schemaVersion, accessibilityAPI, contentSize, musicBy, version, publishingPrinciples, headline, encoding, transcript, commentCount, mainEntity, width, actor, genre, requiresSubscription, potentialAction, contentRating, audience, director, inLanguage, contentLocation, learningResourceType, audio, accountablePerson, dateModified, thumbnailUrl, releasedEvent, caption, productionCompany, accessibilityHazard, accessibilityFeature, license, description, uploadDate, provider, publication, recordedAt, educationalAlignment, mainEntityOfPage, contributor, workExample, isPartOf, dateCreated, copyrightHolder, sameAs, aggregateRating, expires, height, name, encodesCreativeWork, typicalAgeRange, translator, copyrightYear, citation, sourceOrganization, videoQuality, text, thumbnail, award);
    }
    /**
     ...
     * The frame size of the video.
     */
    public Builder videoFrameSize(String value) {
     ...
     * If this MediaObject is an AudioObject or VideoObject, the transcript of that object.
     */
    public Builder transcript(String value) {
      transcript = value;
      return this;
    }
    /**
     ...
     * The quality of the video.
     */
    public Builder videoQuality(String value) {
      videoQuality = value;
      return this;
    }
    /**
     ...
     * Thumbnail image for an image or video.
     */
    public Builder thumbnail(ImageObject value) {
      thumbnail = value;
      return this;
    }
    /**
  ...
  protected VideoObject(Person editor, Person producer, Review review, Duration timeRequired, Offer offers, Organization creator, String educationalUse, String alternativeHeadline, Thing mentions, Duration duration, String additionalType, String contentUrl, Position position, MediaObject associatedMedia, NewsArticle associatedArticle, Boolean isFamilyFriendly, String playerType, Image image, String accessibilityControl, String videoFrameSize, String keywords, String embedUrl, String discussionUrl, String encodingFormat, CreativeWork exampleOfWork, String isBasedOnUrl, Comment comment, java.util.Date datePublished, String alternateName, Organization author, VideoObject video, Organization publisher, String url, String interactivityType, Thing about, String bitrate, Place regionsAllowed, Person character, String schemaVersion, String accessibilityAPI, String contentSize, MusicGroup musicBy, Number version, String publishingPrinciples, String headline, MediaObject encoding, String transcript, Integer commentCount, Thing mainEntity, Distance width, Person actor, String genre, Boolean requiresSubscription, Action potentialAction, String contentRating, Audience audience, Person director, String inLanguage, Place contentLocation, String learningResourceType, AudioObject audio, Person accountablePerson, java.util.Date dateModified, String thumbnailUrl, PublicationEvent releasedEvent, String caption, Organization productionCompany, String accessibilityHazard, String accessibilityFeature, CreativeWork license, String description, java.util.Date uploadDate, Person provider, PublicationEvent publication, Event recordedAt, AlignmentObject educationalAlignment, CreativeWork mainEntityOfPage, Organization contributor, CreativeWork workExample, IsPartOf isPartOf, java.util.Date dateCreated, Organization copyrightHolder, String sameAs, AggregateRating aggregateRating, java.util.Date expires, Distance height, String name, CreativeWork encodesCreativeWork, String typicalAgeRange, Person translator, Number copyrightYear, CreativeWork citation, Organization sourceOrganization, String videoQuality, String text, ImageObject thumbnail, String award) {
