...
public class VideoObject extends MediaObject {
  ...
  public static final class Builder {
    ...
    public VideoObject build() {
      return new VideoObject(accessibilityAPI, requiresSubscription, aggregateRating, hasPart, review, thumbnail, datePublished, comment, schemaVersion, video, award, expires, editor, workExample, director, potentialAction, transcript, producer, publisher, contentSize, sourceOrganization, learningResourceType, genre, regionsAllowed, translator, publishingPrinciples, recordedAt, commentCount, inLanguage, dateModified, contentUrl, mentions, audience, videoQuality, embedUrl, url, headline, interactivityType, character, associatedMedia, encodesCreativeWork, contentRating, description, offers, associatedArticle, width, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, about, contentLocation, musicBy, author, accessibilityHazard, version, accountablePerson, additionalType, sameAs, bitrate, thumbnailUrl, publication, actor, encoding, playerType, uploadDate, timeRequired, duration, caption, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, mainEntity, alternativeHeadline, name, license, mainEntityOfPage, discussionUrl, copyrightYear, encodingFormat, isBasedOnUrl, isFamilyFriendly, exampleOfWork, height, alternateName, releasedEvent, productionCompany, videoFrameSize, creator, contributor);
    }
    /**
     ...
     * Thumbnail image for an image or video.
     */
    public Builder thumbnail(ImageObject imageObject) {
     ...
     * The quality of the video.
     */
    public Builder videoQuality(String videoQuality) {
     ...
     * The frame size of the video.
     */
    public Builder videoFrameSize(String videoFrameSize) {
  ...
  protected VideoObject(String accessibilityAPI, Boolean requiresSubscription, AggregateRating aggregateRating, HasPart hasPart, Review review, ImageObject thumbnail, java.util.Date datePublished, Comment comment, String schemaVersion, VideoObject video, String award, java.util.Date expires, Person editor, CreativeWork workExample, Person director, Action potentialAction, String transcript, OrganizationOrPerson producer, Organization publisher, String contentSize, Organization sourceOrganization, String learningResourceType, String genre, Place regionsAllowed, OrganizationOrPerson translator, String publishingPrinciples, Event recordedAt, Integer commentCount, LanguageOrString inLanguage, java.util.Date dateModified, String contentUrl, Thing mentions, Audience audience, String videoQuality, String embedUrl, String url, String headline, String interactivityType, Person character, MediaObject associatedMedia, CreativeWork encodesCreativeWork, String contentRating, String description, Offer offers, NewsArticle associatedArticle, QuantitativeValueOrDistance width, OrganizationOrPerson copyrightHolder, String accessibilityControl, StringOrCreativeWork citation, String educationalUse, String keywords, AlignmentObject educationalAlignment, String text, Thing about, Place contentLocation, MusicGroupOrPerson musicBy, OrganizationOrPerson author, String accessibilityHazard, Number version, Person accountablePerson, String additionalType, String sameAs, String bitrate, String thumbnailUrl, PublicationEvent publication, Person actor, MediaObject encoding, String playerType, java.util.Date uploadDate, Duration timeRequired, Duration duration, String caption, String accessibilityFeature, AudioObject audio, String typicalAgeRange, java.util.Date dateCreated, OrganizationOrPerson provider, Thing mainEntity, String alternativeHeadline, String name, StringOrCreativeWork license, StringOrCreativeWork mainEntityOfPage, String discussionUrl, Number copyrightYear, String encodingFormat, String isBasedOnUrl, Boolean isFamilyFriendly, CreativeWork exampleOfWork, QuantitativeValueOrDistance height, String alternateName, PublicationEvent releasedEvent, Organization productionCompany, String videoFrameSize, OrganizationOrPerson creator, OrganizationOrPerson contributor) {
