...
public class VideoObject extends MediaObject {
  ...
  static final class VideoObjectThingBuilder implements Builder {
     ...
     * The caption for this object.
     */
    @NotNull public Builder caption(String caption) {
     ...
     * Thumbnail image for an image or video.
     */
    @NotNull public Builder thumbnail(ImageObject imageObject) {
     ...
     * Thumbnail image for an image or video.
     */
    @NotNull public Builder thumbnail(ImageObject.Builder imageObject) {
      return this.thumbnail(imageObject.build());
    }
    /**
     * If this MediaObject is an AudioObject or VideoObject, the transcript of that object.
     */
    @NotNull public Builder transcript(String transcript) {
     ...
     * The frame size of the video.
     */
    @NotNull public Builder videoFrameSize(String videoFrameSize) {
     ...
     * The quality of the video.
     */
    @NotNull public Builder videoQuality(String videoQuality) {
     ...
     */
    @NotNull public Builder bitrate(String bitrate) {
     ...
     */
    @NotNull public Builder contentSize(String contentSize) {
     ...
     */
    @NotNull public Builder contentUrl(String contentUrl) {
     ...
     */
    @NotNull public Builder embedUrl(String embedUrl) {
     ...
     */
    @NotNull public Builder encodesCreativeWork(CreativeWork creativeWork) {
     ...
     * The CreativeWork encoded by this media object.
     */
    @NotNull public Builder encodesCreativeWork(CreativeWork.Builder creativeWork) {
      return this.encodesCreativeWork(creativeWork.build());
    }
    /**
     * mp3, mpeg4, etc.
     */
    @NotNull public Builder encodingFormat(String encodingFormat) {
     ...
     */
    @NotNull public Builder expires(java.util.Date date) {
      this.expires = date;
      return this;
    }
    /**
     ...
     */
    @NotNull public Builder playerType(String playerType) {
     ...
     */
    @NotNull public Builder regionsAllowed(Place place) {
     ...
     * The regions where the media is allowed. If not specified, then it's assumed to be allowed everywhere. Specify the countries in <a href='http://en.wikipedia.org/wiki/ISO_3166'>ISO 3166 format</a>.
     */
    @NotNull public Builder regionsAllowed(Place.Builder place) {
      return this.regionsAllowed(place.build());
    }
    /**
     * Indicates if use of the media require a subscription  (either paid or free). Allowed values are <code>true</code> or <code>false</code> (note that an earlier version had 'yes', 'no').
     */
    @NotNull public Builder requiresSubscription(Boolean requiresSubscription) {
     ...
     */
    @NotNull public Builder uploadDate(java.util.Date date) {
  ...
  public interface Builder extends ThingBuilder<VideoObject> {
    ...
    @NotNull Builder caption(String caption);
    ...
    @NotNull Builder thumbnail(ImageObject imageObject);
    @NotNull Builder thumbnail(ImageObject.Builder imageObject);
    @NotNull Builder transcript(String transcript);
    @NotNull Builder videoFrameSize(String videoFrameSize);
    @NotNull Builder videoQuality(String videoQuality);
    @NotNull Builder associatedArticle(NewsArticle newsArticle);
    @NotNull Builder associatedArticle(NewsArticle.Builder newsArticle);
    @NotNull Builder bitrate(String bitrate);
    @NotNull Builder contentSize(String contentSize);
    @NotNull Builder contentUrl(String contentUrl);
    @NotNull Builder duration(Duration duration);
    @NotNull Builder duration(Duration.Builder duration);
    @NotNull Builder embedUrl(String embedUrl);
    @NotNull Builder encodesCreativeWork(CreativeWork creativeWork);
    @NotNull Builder encodesCreativeWork(CreativeWork.Builder creativeWork);
    @NotNull Builder encodingFormat(String encodingFormat);
    @NotNull Builder expires(java.util.Date date);
    ...
    @NotNull Builder playerType(String playerType);
    ...
    @NotNull Builder regionsAllowed(Place place);
    @NotNull Builder regionsAllowed(Place.Builder place);
    @NotNull Builder requiresSubscription(Boolean requiresSubscription);
    @NotNull Builder uploadDate(java.util.Date date);
