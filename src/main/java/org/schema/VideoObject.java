...
public class VideoObject extends MediaObject {
  ...
  static final class VideoObjectThingBuilder implements Builder {
    ...
    @NotNull public Builder thumbnail(@NotNull ImageObject.Builder imageObject) {
      return this.thumbnail(imageObject.build());
    }
    /**
     * If this MediaObject is an AudioObject or VideoObject, the transcript of that object.
     */
    ...
    @NotNull public Builder associatedArticle(@NotNull NewsArticle.Builder newsArticle) {
      return this.associatedArticle(newsArticle.build());
    }
    /**
    ...
    @NotNull public Builder encodesCreativeWork(@NotNull CreativeWork.Builder creativeWork) {
      return this.encodesCreativeWork(creativeWork.build());
    }
    /**
     * mp3, mpeg4, etc.
     */
    ...
    @NotNull public Builder regionsAllowed(@NotNull Place.Builder place) {
      return this.regionsAllowed(place.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("caption".equals(key) && value instanceof String) { caption((String)value); continue; }
        ...
        if ("thumbnail".equals(key) && value instanceof ImageObject) { thumbnail((ImageObject)value); continue; }
        if ("transcript".equals(key) && value instanceof String) { transcript((String)value); continue; }
        if ("videoFrameSize".equals(key) && value instanceof String) { videoFrameSize((String)value); continue; }
        if ("videoQuality".equals(key) && value instanceof String) { videoQuality((String)value); continue; }
        if ("associatedArticle".equals(key) && value instanceof NewsArticle) { associatedArticle((NewsArticle)value); continue; }
        if ("bitrate".equals(key) && value instanceof String) { bitrate((String)value); continue; }
        if ("contentSize".equals(key) && value instanceof String) { contentSize((String)value); continue; }
        if ("contentUrl".equals(key) && value instanceof String) { contentUrl((String)value); continue; }
        if ("duration".equals(key) && value instanceof Duration) { duration((Duration)value); continue; }
        if ("embedUrl".equals(key) && value instanceof String) { embedUrl((String)value); continue; }
        if ("encodesCreativeWork".equals(key) && value instanceof CreativeWork) { encodesCreativeWork((CreativeWork)value); continue; }
        if ("encodingFormat".equals(key) && value instanceof String) { encodingFormat((String)value); continue; }
        if ("expires".equals(key) && value instanceof java.util.Date) { expires((java.util.Date)value); continue; }
        ...
        if ("playerType".equals(key) && value instanceof String) { playerType((String)value); continue; }
        if ("productionCompany".equals(key) && value instanceof Organization) { productionCompany((Organization)value); continue; }
        if ("regionsAllowed".equals(key) && value instanceof Place) { regionsAllowed((Place)value); continue; }
        if ("requiresSubscription".equals(key) && value instanceof Boolean) { requiresSubscription((Boolean)value); continue; }
        if ("uploadDate".equals(key) && value instanceof java.util.Date) { uploadDate((java.util.Date)value); continue; }
  ...
  public interface Builder extends ThingBuilder<VideoObject> {
    ...
    @NotNull Builder thumbnail(@NotNull ImageObject imageObject);
    @NotNull Builder thumbnail(@NotNull ImageObject.Builder imageObject);
    @NotNull Builder transcript(@NotNull String transcript);
    @NotNull Builder videoFrameSize(@NotNull String videoFrameSize);
    @NotNull Builder videoQuality(@NotNull String videoQuality);
    @NotNull Builder associatedArticle(@NotNull NewsArticle newsArticle);
    @NotNull Builder associatedArticle(@NotNull NewsArticle.Builder newsArticle);
    @NotNull Builder bitrate(@NotNull String bitrate);
    @NotNull Builder contentSize(@NotNull String contentSize);
    @NotNull Builder contentUrl(@NotNull String contentUrl);
    @NotNull Builder duration(@NotNull Duration duration);
    @NotNull Builder duration(@NotNull Duration.Builder duration);
    @NotNull Builder embedUrl(@NotNull String embedUrl);
    @NotNull Builder encodesCreativeWork(@NotNull CreativeWork creativeWork);
    @NotNull Builder encodesCreativeWork(@NotNull CreativeWork.Builder creativeWork);
    @NotNull Builder encodingFormat(@NotNull String encodingFormat);
    @NotNull Builder expires(@NotNull java.util.Date date);
    ...
    @NotNull Builder playerType(@NotNull String playerType);
    ...
    @NotNull Builder regionsAllowed(@NotNull Place place);
    @NotNull Builder regionsAllowed(@NotNull Place.Builder place);
    @NotNull Builder requiresSubscription(@NotNull Boolean requiresSubscription);
    @NotNull Builder uploadDate(@NotNull java.util.Date date);
  ...
  private ImageObject myThumbnail;
  private String myTranscript;
  private String myVideoFrameSize;
  private String myVideoQuality;
}
