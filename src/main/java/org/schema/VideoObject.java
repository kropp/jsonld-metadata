...
public class VideoObject extends MediaObject {
   ...
   */
  public String getCaption() { return myCaption; }
  /**
   ...
   */
  public ImageObject getThumbnail() { return myThumbnail; }
  /**
   * If this MediaObject is an AudioObject or VideoObject, the transcript of that object.
   */
  public String getTranscript() { return myTranscript; }
  /**
   * The frame size of the video.
   */
  public String getVideoFrameSize() { return myVideoFrameSize; }
  /**
   * The quality of the video.
   */
  public String getVideoQuality() { return myVideoQuality; }
   ...
   */
  public static class Builder implements ThingBuilder<VideoObject> {
