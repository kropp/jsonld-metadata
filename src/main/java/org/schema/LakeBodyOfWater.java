...
public class LakeBodyOfWater extends BodyOfWater {
  ...
  public static final class Builder {
    /**
     * Creates new {@link LakeBodyOfWater} instance.
     */
    public LakeBodyOfWater build() {
      return new LakeBodyOfWater(aggregateRating, review, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, url, event, containedIn, additionalType, sameAs, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
