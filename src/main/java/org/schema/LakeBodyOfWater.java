...
public class LakeBodyOfWater extends BodyOfWater {
  /**
   * Builder for {@see LakeBodyOfWater}
   */
  public static final class Builder {
    public LakeBodyOfWater build() {
      return new LakeBodyOfWater(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, additionalType, url, geo, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
