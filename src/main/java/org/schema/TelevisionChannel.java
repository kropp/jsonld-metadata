...
public class TelevisionChannel extends BroadcastChannel {
  ...
  public static final class Builder {
    ...
    public TelevisionChannel build() {
      return new TelevisionChannel(url, sameAs, additionalType, alternateName, providesBroadcastService, inBroadcastLineup, broadcastChannelId, description, potentialAction, name, broadcastServiceTier, mainEntityOfPage);
    }
    /**
     * URL of the item.
     */
