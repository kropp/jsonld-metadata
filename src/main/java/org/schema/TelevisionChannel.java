...
public class TelevisionChannel extends BroadcastChannel {
  /**
   * Builder for {@see TelevisionChannel}
   */
  public static final class Builder {
    public TelevisionChannel build() {
      return new TelevisionChannel(broadcastChannelId, mainEntityOfPage, name, image, providesBroadcastService, broadcastServiceTier, potentialAction, alternateName, additionalType, url, inBroadcastLineup, description, sameAs);
    }
    /**
