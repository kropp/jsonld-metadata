...
public class TelevisionChannel extends BroadcastChannel {
  ...
  public interface Builder extends ThingBuilder<TelevisionChannel> {
    @NotNull Builder broadcastChannelId(@NotNull String broadcastChannelId);
    @NotNull Builder inBroadcastLineup(@NotNull CableOrSatelliteService cableOrSatelliteService);
    @NotNull Builder inBroadcastLineup(@NotNull CableOrSatelliteService.Builder cableOrSatelliteService);
    @NotNull Builder broadcastServiceTier(@NotNull String broadcastServiceTier);
    @NotNull Builder providesBroadcastService(@NotNull BroadcastService broadcastService);
    @NotNull Builder providesBroadcastService(@NotNull BroadcastService.Builder broadcastService);
  ...
  @Override public boolean equals(Object o) {
    ...
    TelevisionChannel televisionChannel = (TelevisionChannel) o;
