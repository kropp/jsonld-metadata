...
public class Vein extends Vessel {
  ...
  /**
   * Builder for {@see Vein}
   */
  public static final class Builder {
    public Vein build() {
      return new Vein(potentialAction, connectedTo, additionalType, medicineSystem, partOfSystem, code, bodyLocation, image, guideline, description, function, mainEntityOfPage, relatedCondition, subStructure, alternateName, drainsTo, url, associatedPathophysiology, sameAs, recognizingAuthority, study, diagram, regionDrained, name, relevantSpecialty, tributary, relatedTherapy);
    }
    /**
     ...
     * The vasculature that the vein drains into.
     */
    public Builder drainsTo(Vessel value) {
      drainsTo = value;
      return this;
    }
    /**
     ...
     * The anatomical or organ system that the vein flows into; a larger structure that the vein connects to.
     */
    public Builder tributary(AnatomicalStructure value) {
      tributary = value;
      return this;
    }
    /**
  ...
  protected Vein(Action potentialAction, AnatomicalStructure connectedTo, String additionalType, MedicineSystem medicineSystem, IsPartOf partOfSystem, MedicalCode code, String bodyLocation, Image image, MedicalGuideline guideline, String description, String function, CreativeWork mainEntityOfPage, MedicalCondition relatedCondition, AnatomicalStructure subStructure, String alternateName, Vessel drainsTo, String url, String associatedPathophysiology, String sameAs, Organization recognizingAuthority, MedicalStudy study, ImageObject diagram, AnatomicalStructure regionDrained, String name, MedicalSpecialty relevantSpecialty, AnatomicalStructure tributary, MedicalTherapy relatedTherapy) {
