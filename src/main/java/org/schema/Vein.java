...
public class Vein extends Vessel {
   ...
   */
  public static final class VeinThingBuilder implements Builder {
    /**
     ...
     * The vasculature that the vein drains into.
     */
    public Builder drainsTo(Vessel vessel) {
     ...
     * The vasculature that the vein drains into.
     */
    public Builder drainsTo(Vessel.Builder vessel) {
     ...
     * The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
     */
    public Builder regionDrained(AnatomicalStructure.Builder anatomicalStructure) {
     ...
     * The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
     */
    public Builder regionDrained(AnatomicalSystem.Builder anatomicalSystem) {
      return this.regionDrained(anatomicalSystem.build());
    }
    /**
     * The anatomical or organ system that the vein flows into; a larger structure that the vein connects to.
     */
    public Builder tributary(AnatomicalStructure anatomicalStructure) {
     ...
     * The anatomical or organ system that the vein flows into; a larger structure that the vein connects to.
     */
    public Builder tributary(AnatomicalStructure.Builder anatomicalStructure) {
  ...
  Builder drainsTo(Vessel vessel);
  Builder drainsTo(Vessel.Builder vessel);
  Builder regionDrained(AnatomicalStructure anatomicalStructure);
  Builder regionDrained(AnatomicalStructure.Builder anatomicalStructure);
  Builder regionDrained(AnatomicalSystem anatomicalSystem);
  Builder regionDrained(AnatomicalSystem.Builder anatomicalSystem);
  Builder tributary(AnatomicalStructure anatomicalStructure);
  Builder tributary(AnatomicalStructure.Builder anatomicalStructure);
