...
public class Vein extends Vessel {
  ...
  static final class VeinThingBuilder implements Builder {
     ...
     * The vasculature that the vein drains into.
     */
    @NotNull public Builder drainsTo(Vessel vessel) {
     ...
     * The vasculature that the vein drains into.
     */
    @NotNull public Builder drainsTo(Vessel.Builder vessel) {
      return this.drainsTo(vessel.build());
    }
    /**
     * The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
     */
    @NotNull public Builder regionDrained(AnatomicalStructure anatomicalStructure) {
     ...
     * The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
     */
    @NotNull public Builder regionDrained(AnatomicalStructure.Builder anatomicalStructure) {
      return this.regionDrained(anatomicalStructure.build());
    }
    /**
     * The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
     */
    @NotNull public Builder regionDrained(AnatomicalSystem anatomicalSystem) {
      if (this.regionDrained == null) this.regionDrained = new AnatomicalStructureOrAnatomicalSystem();
     ...
     * The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
     */
    @NotNull public Builder regionDrained(AnatomicalSystem.Builder anatomicalSystem) {
      return this.regionDrained(anatomicalSystem.build());
    }
    /**
     * The anatomical or organ system that the vein flows into; a larger structure that the vein connects to.
     */
    @NotNull public Builder tributary(AnatomicalStructure anatomicalStructure) {
  ...
  public interface Builder extends ThingBuilder<Vein> {
    @NotNull Builder drainsTo(Vessel vessel);
    @NotNull Builder drainsTo(Vessel.Builder vessel);
    @NotNull Builder regionDrained(AnatomicalStructure anatomicalStructure);
    @NotNull Builder regionDrained(AnatomicalStructure.Builder anatomicalStructure);
    @NotNull Builder regionDrained(AnatomicalSystem anatomicalSystem);
    @NotNull Builder regionDrained(AnatomicalSystem.Builder anatomicalSystem);
    @NotNull Builder tributary(AnatomicalStructure anatomicalStructure);
    @NotNull Builder tributary(AnatomicalStructure.Builder anatomicalStructure);
