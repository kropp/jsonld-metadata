...
public class Vein extends Vessel {
  ...
  public static final class Builder {
     ...
     */
    public Vein build() {
      return new Vein(recognizingAuthority, bodyLocation, code, diagram, additionalType, sameAs, associatedPathophysiology, study, potentialAction, relevantSpecialty, regionDrained, medicineSystem, drainsTo, relatedTherapy, connectedTo, name, mainEntityOfPage, guideline, tributary, url, partOfSystem, relatedCondition, function, alternateName, subStructure, description);
    }
    /**
  ...
  protected Vein(Organization recognizingAuthority, String bodyLocation, MedicalCode code, ImageObject diagram, String additionalType, String sameAs, String associatedPathophysiology, MedicalStudy study, Action potentialAction, MedicalSpecialty relevantSpecialty, AnatomicalSystemOrAnatomicalStructure regionDrained, MedicineSystem medicineSystem, Vessel drainsTo, MedicalTherapy relatedTherapy, AnatomicalStructure connectedTo, String name, StringOrCreativeWork mainEntityOfPage, MedicalGuideline guideline, AnatomicalStructure tributary, String url, IsPartOf partOfSystem, MedicalCondition relatedCondition, String function, String alternateName, AnatomicalStructure subStructure, String description) {
