...
public class ConsumeAction extends Action {
  ...
  public static final class Builder {
    ...
    public ConsumeAction build() {
      return new ConsumeAction(startTime, name, error, mainEntityOfPage, url, sameAs, additionalType, agent, expectsAcceptanceOf, alternateName, potentialAction, description, target, endTime, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected ConsumeAction(java.util.Date startTime, String name, Thing error, StringOrCreativeWork mainEntityOfPage, String url, String sameAs, String additionalType, OrganizationOrPerson agent, Offer expectsAcceptanceOf, String alternateName, Action potentialAction, String description, EntryPoint target, java.util.Date endTime, ActionStatusType actionStatus) {
