...
public class ConsumeAction extends Action {
  ...
  public static final class Builder {
    ...
    public ConsumeAction build() {
      return new ConsumeAction(expectsAcceptanceOf, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
     * An Offer which must be accepted before the user can perform the Action. For example, the user may need to buy a movie before being able to watch it.
     */
