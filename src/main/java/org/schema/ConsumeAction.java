...
public class ConsumeAction extends Action {
  ...
  /**
   * Builder for {@see ConsumeAction}
   */
  public static final class Builder {
    public ConsumeAction build() {
      return new ConsumeAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, expectsAcceptanceOf, object, location, description);
    }
