...
public class ConsumeAction extends Action {
  ...
  public Offer getExpectsAcceptanceOf() {
    return myExpectsAcceptanceOf;
  }
  /**
   * Builder for {@link ConsumeAction}
   */
  static final class ConsumeActionThingBuilder implements Builder {
    /**
     * Creates new {@link ConsumeAction} instance.
     */
    public ConsumeAction build() {
      return new ConsumeAction(expectsAcceptanceOf, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * An Offer which must be accepted before the user can perform the Action. For example, the user may need to buy a movie before being able to watch it.
     */
    @NotNull public Builder expectsAcceptanceOf(@NotNull Offer offer) {
      this.expectsAcceptanceOf = offer;
      return this;
    }
    /**
     * An Offer which must be accepted before the user can perform the Action. For example, the user may need to buy a movie before being able to watch it.
    ...
    @NotNull public Builder expectsAcceptanceOf(@NotNull Offer.Builder offer) {
      return this.expectsAcceptanceOf(offer.build());
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("expectsAcceptanceOf".equals(key) && value instanceof Offer) { expectsAcceptanceOf((Offer)value); continue; }
  ...
  public interface Builder extends ThingBuilder<ConsumeAction> {
    @NotNull Builder expectsAcceptanceOf(@NotNull Offer offer);
    @NotNull Builder expectsAcceptanceOf(@NotNull Offer.Builder offer);
  ...
  protected ConsumeAction(Offer expectsAcceptanceOf, OrganizationOrPerson agent, java.util.Date endTime, java.util.Date startTime, ActionStatusType actionStatus, Thing error, EntryPoint target, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
    ...
    myExpectsAcceptanceOf = expectsAcceptanceOf;
  }

  @Override public int hashCode() {
    int result = super.hashCode();
    result = 31 * result + (myExpectsAcceptanceOf != null ? myExpectsAcceptanceOf.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    ConsumeAction consumeAction = (ConsumeAction) o;
    if (!super.equals(o)) return false;
    if (myExpectsAcceptanceOf != null ? !myExpectsAcceptanceOf.equals(consumeAction.myExpectsAcceptanceOf) : consumeAction.myExpectsAcceptanceOf != null) return false;
    return true;
  }

  private Offer myExpectsAcceptanceOf;
}
