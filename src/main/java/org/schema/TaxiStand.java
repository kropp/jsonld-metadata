...
public class TaxiStand extends CivicStructure {
  /**
   * Builder for {@see TaxiStand}
   */
  public static final class Builder {
    public TaxiStand build() {
      return new TaxiStand(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
