...
public class AdministrativeArea extends Place {
  /**
   * Builder for {@see AdministrativeArea}
   */
  public static final class Builder {
    public AdministrativeArea build() {
      return new AdministrativeArea(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, geo, additionalType, url, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
...
Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. http://schema.org/width, http://schema.org/color, http://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
  ...
  protected AdministrativeArea(Event event, Review review, OpeningHoursSpecification openingHoursSpecification, String faxNumber, CreativeWork mainEntityOfPage, String globalLocationNumber, String telephone, String alternateName, Action potentialAction, ImageObject photo, GeoCoordinates geo, String additionalType, String url, AggregateRating aggregateRating, ImageObject logo, String sameAs, String name, Image image, PostalAddress address, PropertyValue additionalProperty, Place containedIn, String isicV4, String description, String hasMap) {
