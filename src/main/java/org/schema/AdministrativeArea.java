...
public class AdministrativeArea extends Place {
  ...
  public static final class Builder {
    /**
     * Creates new {@link AdministrativeArea} instance.
     */
    public AdministrativeArea build() {
      return new AdministrativeArea(aggregateRating, review, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, containedIn, additionalType, sameAs, url, event, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
