...
public class MedicalGuidelineContraindication extends MedicalGuideline {
   ...
   */
  static final class MedicalGuidelineContraindicationThingBuilder implements Builder {
    /**
  ...
  public interface Builder extends ThingBuilder<MedicalGuidelineContraindication> {
