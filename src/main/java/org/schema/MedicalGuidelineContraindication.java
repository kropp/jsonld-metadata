...
public class MedicalGuidelineContraindication extends MedicalGuideline {
  ...
  public static final class Builder {
    ...
    public MedicalGuidelineContraindication build() {
      return new MedicalGuidelineContraindication(recognizingAuthority, code, evidenceLevel, name, mainEntityOfPage, guideline, url, sameAs, additionalType, alternateName, study, description, potentialAction, relevantSpecialty, evidenceOrigin, guidelineDate, guidelineSubject, medicineSystem);
    }
    /**
