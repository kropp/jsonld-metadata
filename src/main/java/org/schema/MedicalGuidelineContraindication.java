...
/**
 * A guideline contraindication that designates a process as harmful and where quality of the data supporting the contraindication is sound.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class MedicalGuidelineContraindication extends MedicalGuideline {
   ...
   */
  public static class Builder implements ThingBuilder<MedicalGuidelineContraindication> {
