...
public class MedicalGuidelineContraindication extends MedicalGuideline {
  /**
   * Builder for {@see MedicalGuidelineContraindication}
   */
  public static final class Builder {
    public MedicalGuidelineContraindication build() {
      return new MedicalGuidelineContraindication(mainEntityOfPage, potentialAction, alternateName, url, additionalType, medicineSystem, sameAs, recognizingAuthority, code, study, evidenceLevel, guidelineSubject, evidenceOrigin, name, image, relevantSpecialty, guideline, guidelineDate, description);
    }
    /**
  ...
  protected MedicalGuidelineContraindication(CreativeWork mainEntityOfPage, Action potentialAction, String alternateName, String url, String additionalType, MedicineSystem medicineSystem, String sameAs, Organization recognizingAuthority, MedicalCode code, MedicalStudy study, MedicalEvidenceLevel evidenceLevel, MedicalEntity guidelineSubject, String evidenceOrigin, String name, Image image, MedicalSpecialty relevantSpecialty, MedicalGuideline guideline, java.util.Date guidelineDate, String description) {
