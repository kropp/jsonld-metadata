...
public class DeactivateAction extends ControlAction {
  ...
  public static final class Builder {
    ...
    public DeactivateAction build() {
      return new DeactivateAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
