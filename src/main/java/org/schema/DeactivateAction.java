...
public class DeactivateAction extends ControlAction {
   ...
   */
  static final class DeactivateActionThingBuilder implements Builder {
    /**
     * Creates new {@link DeactivateAction} instance.
     */
    public DeactivateAction build() {
      return new DeactivateAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<DeactivateAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    DeactivateAction deactivateAction = (DeactivateAction) o;
