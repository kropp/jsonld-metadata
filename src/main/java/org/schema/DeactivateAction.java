...
public class DeactivateAction extends ControlAction {
  /**
   * Builder for {@see DeactivateAction}
   */
  public static final class Builder {
    public DeactivateAction build() {
      return new DeactivateAction(instrument, mainEntityOfPage, agent, endTime, alternateName, potentialAction, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, target, object, description, location);
    }
