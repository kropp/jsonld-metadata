...
public class MedicalRiskFactor extends MedicalEntity {
   ...
   */
  static final class MedicalRiskFactorThingBuilder implements Builder {
    /**
     ...
     * The condition, complication, etc. influenced by this factor.
     */
    @NotNull public Builder increasesRiskOf(MedicalEntity medicalEntity) {
     ...
     * The condition, complication, etc. influenced by this factor.
     */
    @NotNull public Builder increasesRiskOf(MedicalEntity.Builder medicalEntity) {
  ...
  public interface Builder extends ThingBuilder<MedicalRiskFactor> {
    @NotNull Builder increasesRiskOf(MedicalEntity medicalEntity);
    @NotNull Builder increasesRiskOf(MedicalEntity.Builder medicalEntity);
