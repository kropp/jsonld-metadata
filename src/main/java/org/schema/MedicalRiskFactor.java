...
public class MedicalRiskFactor extends MedicalEntity {
  ...
  public static final class Builder {
    ...
    public MedicalRiskFactor build() {
      return new MedicalRiskFactor(recognizingAuthority, code, name, increasesRiskOf, mainEntityOfPage, guideline, url, sameAs, additionalType, alternateName, study, potentialAction, description, relevantSpecialty, medicineSystem);
    }
    /**
