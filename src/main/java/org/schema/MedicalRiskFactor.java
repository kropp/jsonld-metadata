...
/**
 * A risk factor is anything that increases a person's likelihood of developing or contracting a disease, medical condition, or complication.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_WikiDoc
 */
public class MedicalRiskFactor extends MedicalEntity {
  /**
   * The condition, complication, etc. influenced by this factor.
   */
  public MedicalEntity getIncreasesRiskOf() { return myIncreasesRiskOf; }
   ...
   */
  public static class Builder implements ThingBuilder<MedicalRiskFactor> {
    ...
    @NotNull public Builder increasesRiskOf(@NotNull MedicalEntity medicalEntity) {
      this.increasesRiskOf = medicalEntity;
      return this;
    }
    /**
     * The condition, complication, etc. influenced by this factor.
    ...
    @NotNull public Builder increasesRiskOf(@NotNull MedicalEntity.Builder medicalEntity) {
      return this.increasesRiskOf(medicalEntity.build());
    }
    /**
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("increasesRiskOf".equals(key) && value instanceof MedicalEntity) { increasesRiskOf((MedicalEntity)value); continue; }
