...
public class MedicalRiskFactor extends MedicalEntity {
   ...
   */
  public static final class MedicalRiskFactorThingBuilder implements Builder {
    /**
     ...
     * The condition, complication, etc. influenced by this factor.
     */
    public Builder increasesRiskOf(MedicalEntity medicalEntity) {
     ...
     * The condition, complication, etc. influenced by this factor.
     */
    public Builder increasesRiskOf(MedicalEntity.Builder medicalEntity) {
  ...
  Builder increasesRiskOf(MedicalEntity medicalEntity);
  Builder increasesRiskOf(MedicalEntity.Builder medicalEntity);
