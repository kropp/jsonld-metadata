...
public class DietarySupplement extends MedicalTherapy {
  ...
  static final class DietarySupplementThingBuilder implements Builder {
     ...
     * Descriptive information establishing a historical perspective on the supplement. May include the rationale for the name, the population where the supplement first came to prominence, etc.
     */
    @NotNull public Builder background(String background) {
     ...
     * Recommended intake of this supplement for a given population as defined by a specific recommending authority.
     */
    @NotNull public Builder maximumIntake(MaximumDoseSchedule maximumDoseSchedule) {
     ...
     * Recommended intake of this supplement for a given population as defined by a specific recommending authority.
     */
    @NotNull public Builder maximumIntake(MaximumDoseSchedule.Builder maximumDoseSchedule) {
     ...
     * Recommended intake of this supplement for a given population as defined by a specific recommending authority.
     */
    @NotNull public Builder recommendedIntake(RecommendedDoseSchedule recommendedDoseSchedule) {
  ...
  public interface Builder extends ThingBuilder<DietarySupplement> {
    ...
    @NotNull Builder background(String background);
    ...
    @NotNull Builder maximumIntake(MaximumDoseSchedule maximumDoseSchedule);
    @NotNull Builder maximumIntake(MaximumDoseSchedule.Builder maximumDoseSchedule);
    @NotNull Builder mechanismOfAction(String mechanismOfAction);
    @NotNull Builder nonProprietaryName(String nonProprietaryName);
    @NotNull Builder recommendedIntake(RecommendedDoseSchedule recommendedDoseSchedule);
    @NotNull Builder recommendedIntake(RecommendedDoseSchedule.Builder recommendedDoseSchedule);
