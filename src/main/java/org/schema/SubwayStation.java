...
public class SubwayStation extends CivicStructure {
  /**
   * Builder for {@see SubwayStation}
   */
  public static final class Builder {
    public SubwayStation build() {
      return new SubwayStation(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
