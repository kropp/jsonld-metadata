...
public class SubwayStation extends CivicStructure {
  ...
  public static final class Builder {
    ...
    public SubwayStation build() {
      return new SubwayStation(aggregateRating, review, openingHours, logo, isicV4, globalLocationNumber, name, mainEntityOfPage, hasMap, url, sameAs, containedIn, event, additionalType, alternateName, openingHoursSpecification, faxNumber, telephone, geo, description, potentialAction, additionalProperty, photo, address);
    }
    /**
