...
public class Courthouse extends GovernmentBuilding {
  ...
  public static final class Builder {
    ...
    public Courthouse build() {
      return new Courthouse(aggregateRating, review, openingHours, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, additionalType, event, url, sameAs, containedIn, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
