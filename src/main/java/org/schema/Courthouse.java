...
public class Courthouse extends GovernmentBuilding {
  /**
   * Builder for {@see Courthouse}
   */
  public static final class Builder {
    public Courthouse build() {
      return new Courthouse(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, geo, url, additionalType, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
