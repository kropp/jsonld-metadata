...
public class State extends AdministrativeArea {
  ...
  public static final class Builder {
     ...
     */
    public State build() {
      return new State(aggregateRating, review, logo, isicV4, globalLocationNumber, name, mainEntityOfPage, hasMap, event, containedIn, additionalType, sameAs, url, alternateName, openingHoursSpecification, faxNumber, telephone, geo, description, potentialAction, additionalProperty, photo, address);
    }
    /**
