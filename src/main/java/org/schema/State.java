...
public class State extends AdministrativeArea {
  /**
   * Builder for {@see State}
   */
  public static final class Builder {
    public State build() {
      return new State(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, url, geo, additionalType, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
