...
public class MedicalEntity extends Thing {
  ...
  public static final class Builder {
    ...
    public MedicalEntity build() {
      return new MedicalEntity(recognizingAuthority, code, name, mainEntityOfPage, guideline, url, sameAs, additionalType, alternateName, study, description, potentialAction, relevantSpecialty, medicineSystem);
    }
    /**
     * If applicable, the organization that officially recognizes this entity as part of its endorsed system of medicine.
     */
