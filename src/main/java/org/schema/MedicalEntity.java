...
public class MedicalEntity extends Thing {
  ...
  /**
   * Builder for {@see MedicalEntity}
   */
  public static final class Builder {
    public MedicalEntity build() {
      return new MedicalEntity(mainEntityOfPage, potentialAction, alternateName, additionalType, url, medicineSystem, sameAs, recognizingAuthority, study, code, name, image, relevantSpecialty, guideline, description);
    }
    /**
