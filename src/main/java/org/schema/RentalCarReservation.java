...
public class RentalCarReservation extends Reservation {
  ...
  static final class RentalCarReservationThingBuilder implements Builder {
     ...
     * Where a rental car can be dropped off.
     */
    @NotNull public Builder dropoffLocation(Place place) {
     ...
     * Where a rental car can be dropped off.
     */
    @NotNull public Builder dropoffLocation(Place.Builder place) {
     ...
     * When a rental car can be dropped off.
     */
    @NotNull public Builder dropoffTime(java.util.Date date) {
  ...
  public interface Builder extends ThingBuilder<RentalCarReservation> {
    ...
    @NotNull Builder dropoffLocation(Place place);
    @NotNull Builder dropoffLocation(Place.Builder place);
    @NotNull Builder pickupTime(java.util.Date date);
    @NotNull Builder dropoffTime(java.util.Date date);
