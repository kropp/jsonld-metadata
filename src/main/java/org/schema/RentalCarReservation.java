...
public class RentalCarReservation extends Reservation {
   ...
   */
  static final class RentalCarReservationThingBuilder implements Builder {
    /**
    ...
    @NotNull public Builder pickupLocation(@NotNull Place.Builder place) {
      return this.pickupLocation(place.build());
    }
    /**
     * Where a rental car can be dropped off.
     */
    @NotNull public Builder dropoffLocation(@NotNull Place place) {
      this.dropoffLocation = place;
      return this;
    }
    /**
     * Where a rental car can be dropped off.
    ...
    @NotNull public Builder dropoffLocation(@NotNull Place.Builder place) {
      return this.dropoffLocation(place.build());
    }
    /**
     * When a taxi will pickup a passenger or a rental car can be picked up.
     */
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("pickupLocation".equals(key) && value instanceof Place) { pickupLocation((Place)value); continue; }
        if ("dropoffLocation".equals(key) && value instanceof Place) { dropoffLocation((Place)value); continue; }
        if ("pickupTime".equals(key) && value instanceof java.util.Date) { pickupTime((java.util.Date)value); continue; }
        if ("dropoffTime".equals(key) && value instanceof java.util.Date) { dropoffTime((java.util.Date)value); continue; }
  ...
  public interface Builder extends ThingBuilder<RentalCarReservation> {
    @NotNull Builder pickupLocation(@NotNull Place place);
    @NotNull Builder pickupLocation(@NotNull Place.Builder place);
    @NotNull Builder dropoffLocation(@NotNull Place place);
    @NotNull Builder dropoffLocation(@NotNull Place.Builder place);
    @NotNull Builder pickupTime(@NotNull java.util.Date date);
    @NotNull Builder dropoffTime(@NotNull java.util.Date date);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myPickupLocation != null ? myPickupLocation.hashCode() : 0);
    result = 31 * result + (myDropoffLocation != null ? myDropoffLocation.hashCode() : 0);
    result = 31 * result + (myPickupTime != null ? myPickupTime.hashCode() : 0);
    result = 31 * result + (myDropoffTime != null ? myDropoffTime.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    RentalCarReservation rentalCarReservation = (RentalCarReservation) o;
    if (!super.equals(o)) return false;
    if (myPickupLocation != null ? !myPickupLocation.equals(rentalCarReservation.myPickupLocation) : rentalCarReservation.myPickupLocation != null) return false;
    if (myDropoffLocation != null ? !myDropoffLocation.equals(rentalCarReservation.myDropoffLocation) : rentalCarReservation.myDropoffLocation != null) return false;
    if (myPickupTime != null ? !myPickupTime.equals(rentalCarReservation.myPickupTime) : rentalCarReservation.myPickupTime != null) return false;
    if (myDropoffTime != null ? !myDropoffTime.equals(rentalCarReservation.myDropoffTime) : rentalCarReservation.myDropoffTime != null) return false;
    return true;
  }
