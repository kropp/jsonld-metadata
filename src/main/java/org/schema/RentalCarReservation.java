...
public class RentalCarReservation extends Reservation {
   ...
   */
  public Place getPickupLocation() { return myPickupLocation; }
  /**
   * Where a rental car can be dropped off.
   */
  public Place getDropoffLocation() { return myDropoffLocation; }
  /**
   * When a taxi will pickup a passenger or a rental car can be picked up.
   */
  @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd'T'HH:mm:ss'Z'")
  public java.util.Date getPickupTime() { return myPickupTime; }
  /**
   * When a rental car can be dropped off.
   */
  @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd'T'HH:mm:ss'Z'")
  public java.util.Date getDropoffTime() { return myDropoffTime; }
   ...
   */
  public static class Builder implements ThingBuilder<RentalCarReservation> {
