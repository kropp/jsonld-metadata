...
public class RentalCarReservation extends Reservation {
   ...
   */
  public static final class RentalCarReservationThingBuilder implements Builder {
    /**
     ...
     * Where a rental car can be dropped off.
     */
    public Builder dropoffLocation(Place place) {
     ...
     * Where a rental car can be dropped off.
     */
    public Builder dropoffLocation(Place.Builder place) {
  ...
  Builder dropoffLocation(Place place);
  Builder dropoffLocation(Place.Builder place);
  Builder pickupTime(java.util.Date date);
  Builder dropoffTime(java.util.Date date);
