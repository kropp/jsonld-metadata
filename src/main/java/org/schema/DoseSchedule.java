...
public class DoseSchedule extends MedicalIntangible {
   ...
   */
  public String getDoseUnit() { return myDoseUnit; }
  /**
   * The value of the dose, e.g. 500.
   */
  public Number getDoseValue() { return myDoseValue; }
  /**
   * How often the dose is taken, e.g. 'daily'.
   */
  public String getFrequency() { return myFrequency; }
  /**
   ...
   */
  public static class Builder implements ThingBuilder<DoseSchedule> {
