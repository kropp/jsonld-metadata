...
public class DoseSchedule extends MedicalIntangible {
   ...
   */
  @JsonIgnore public String getFrequency() {
    return (String) getValue("frequency");
  }
  /**
   * How often the dose is taken, e.g. 'daily'.
   */
  @JsonIgnore public Collection<String> getFrequencys() {
  ...
  public static class Builder extends MedicalIntangible.Builder {
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("doseUnit".equals(key) && value instanceof String) { doseUnit((String)value); return; }
      if ("doseValue".equals(key) && value instanceof Integer) { doseValue((Integer)value); return; }
      if ("doseValue".equals(key) && value instanceof Long) { doseValue((Long)value); return; }
      if ("doseValue".equals(key) && value instanceof Float) { doseValue((Float)value); return; }
      if ("doseValue".equals(key) && value instanceof Double) { doseValue((Double)value); return; }
      if ("doseValue".equals(key) && value instanceof String) { doseValue((String)value); return; }
      if ("frequency".equals(key) && value instanceof String) { frequency((String)value); return; }
