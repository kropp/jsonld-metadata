...
public class DoseSchedule extends MedicalIntangible {
  ...
  public static final class Builder {
    ...
    public DoseSchedule build() {
      return new DoseSchedule(recognizingAuthority, code, name, mainEntityOfPage, guideline, doseValue, url, sameAs, additionalType, doseUnit, alternateName, frequency, study, targetPopulation, potentialAction, description, relevantSpecialty, medicineSystem);
    }
    /**
  ...
  protected DoseSchedule(Organization recognizingAuthority, MedicalCode code, String name, StringOrCreativeWork mainEntityOfPage, MedicalGuideline guideline, Number doseValue, String url, String sameAs, String additionalType, String doseUnit, String alternateName, String frequency, MedicalStudy study, String targetPopulation, Action potentialAction, String description, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem) {
