...
public class Landform extends Place {
  /**
   * Builder for {@see Landform}
   */
  public static final class Builder {
    public Landform build() {
      return new Landform(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, geo, additionalType, url, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
