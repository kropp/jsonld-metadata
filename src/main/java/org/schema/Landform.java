...
public class Landform extends Place {
  ...
  public static final class Builder {
    /**
     * Creates new {@link Landform} instance.
     */
    public Landform build() {
      return new Landform(aggregateRating, review, globalLocationNumber, isicV4, logo, name, mainEntityOfPage, hasMap, containedIn, additionalType, sameAs, url, event, faxNumber, openingHoursSpecification, alternateName, geo, telephone, potentialAction, description, address, photo, additionalProperty);
    }
    /**
