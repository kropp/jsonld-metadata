...
public class DislikeAction extends ReactAction {
  ...
  public static final class Builder {
    ...
    public DislikeAction build() {
      return new DislikeAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
