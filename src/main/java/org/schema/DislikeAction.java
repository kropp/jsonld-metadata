...
public class DislikeAction extends ReactAction {
  /**
   * Builder for {@see DislikeAction}
   */
  public static final class Builder {
    public DislikeAction build() {
      return new DislikeAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, object, location, description);
    }
