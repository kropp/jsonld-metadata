...
public class DislikeAction extends ReactAction {
   ...
   */
  static final class DislikeActionThingBuilder implements Builder {
    /**
     * Creates new {@link DislikeAction} instance.
     */
    public DislikeAction build() {
      return new DislikeAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<DislikeAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    DislikeAction dislikeAction = (DislikeAction) o;
