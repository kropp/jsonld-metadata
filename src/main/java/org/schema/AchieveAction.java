...
public class AchieveAction extends Action {
  ...
  public static final class Builder {
    ...
    public AchieveAction build() {
      return new AchieveAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
