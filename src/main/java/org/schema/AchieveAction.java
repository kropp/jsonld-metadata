...
public class AchieveAction extends Action {
  /**
   * Builder for {@see AchieveAction}
   */
  public static final class Builder {
    public AchieveAction build() {
      return new AchieveAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, object, location, description);
    }
