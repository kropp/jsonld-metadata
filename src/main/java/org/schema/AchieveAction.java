...
public class AchieveAction extends Action {
  ...
  public static final class Builder {
    ...
    public AchieveAction build() {
      return new AchieveAction(additionalType, url, sameAs, agent, startTime, alternateName, potentialAction, target, description, name, endTime, mainEntityOfPage, error, actionStatus);
    }
    /**
