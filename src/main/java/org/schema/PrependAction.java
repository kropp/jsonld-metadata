...
public class PrependAction extends InsertAction {
   ...
   */
  static final class PrependActionThingBuilder implements Builder {
    /**
     * Creates new {@link PrependAction} instance.
     */
    public PrependAction build() {
      return new PrependAction(toLocation, targetCollection, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<PrependAction> {
  ...
  protected PrependAction(Place toLocation, Thing targetCollection, OrganizationOrPerson agent, java.util.Date endTime, java.util.Date startTime, ActionStatusType actionStatus, Thing error, EntryPoint target, String additionalType, String alternateName, String description, CreativeWorkOrString mainEntityOfPage, String name, String sameAs, String url, Action potentialAction, String id) {
    super(toLocation, targetCollection, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    PrependAction prependAction = (PrependAction) o;
