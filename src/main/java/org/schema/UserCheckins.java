...
public class UserCheckins extends UserInteraction {
   ...
   */
  static final class UserCheckinsThingBuilder implements Builder {
    /**
     * Creates new {@link UserCheckins} instance.
     */
    public UserCheckins build() {
      return new UserCheckins(aggregateRating, organizer, attendee, doorTime, duration, endDate, eventStatus, inLanguage, offers, performer, previousStartDate, recordedIn, review, startDate, subEvent, superEvent, typicalAgeRange, workPerformed, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
  ...
  public interface Builder extends ThingBuilder<UserCheckins> {
  ...
  @Override public boolean equals(Object o) {
    ...
    UserCheckins userCheckins = (UserCheckins) o;
