...
public class OceanBodyOfWater extends BodyOfWater {
  /**
   * Builder for {@see OceanBodyOfWater}
   */
  public static final class Builder {
    public OceanBodyOfWater build() {
      return new OceanBodyOfWater(event, review, openingHoursSpecification, faxNumber, mainEntityOfPage, globalLocationNumber, telephone, alternateName, potentialAction, photo, additionalType, url, geo, aggregateRating, logo, sameAs, name, image, address, additionalProperty, containedIn, isicV4, description, hasMap);
    }
    /**
