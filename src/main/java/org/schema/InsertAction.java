...
public class InsertAction extends AddAction {
   ...
   */
  static final class InsertActionThingBuilder implements Builder {
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<InsertAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myToLocation != null ? !myToLocation.equals(insertAction.myToLocation) : insertAction.myToLocation != null) return false;
    return true;
  }
