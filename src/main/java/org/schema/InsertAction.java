...
public class InsertAction extends AddAction {
  ...
  public static final class Builder {
    ...
    public InsertAction build() {
      return new InsertAction(startTime, toLocation, name, error, mainEntityOfPage, sameAs, url, additionalType, agent, alternateName, description, targetCollection, target, potentialAction, endTime, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected InsertAction(java.util.Date startTime, Place toLocation, String name, Thing error, StringOrCreativeWork mainEntityOfPage, String sameAs, String url, String additionalType, OrganizationOrPerson agent, String alternateName, String description, Thing targetCollection, EntryPoint target, Action potentialAction, java.util.Date endTime, ActionStatusType actionStatus) {
    super(startTime, name, mainEntityOfPage, error, sameAs, url, additionalType, agent, alternateName, target, potentialAction, targetCollection, description, endTime, actionStatus);
