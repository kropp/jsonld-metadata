...
public class InsertAction extends AddAction {
  ...
  /**
   * Builder for {@see InsertAction}
   */
  public static final class Builder {
    public InsertAction build() {
      return new InsertAction(instrument, toLocation, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, targetCollection, target, object, location, description);
    }
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  protected InsertAction(Instrument instrument, Place toLocation, CreativeWork mainEntityOfPage, Organization agent, java.util.Date endTime, Action potentialAction, String alternateName, Participant participant, String additionalType, String url, String sameAs, java.util.Date startTime, ActionStatusType actionStatus, Result result, Thing error, String name, Image image, Thing targetCollection, EntryPoint target, Object object, Location location, String description) {
    super(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, image, name, error, targetCollection, target, object, description, location);
