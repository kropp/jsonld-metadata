...
public class WarrantyPromise extends StructuredValue {
   ...
   */
  public QuantitativeValue getDurationOfWarranty() { return myDurationOfWarranty; }
  /**
   * The scope of the warranty promise.
   */
  public WarrantyScope getWarrantyScope() { return myWarrantyScope; }
   ...
   */
  public static class Builder implements ThingBuilder<WarrantyPromise> {
