...
public class WarrantyPromise extends StructuredValue {
  ...
  static final class WarrantyPromiseThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("durationOfWarranty".equals(key) && value instanceof QuantitativeValue) { durationOfWarranty((QuantitativeValue)value); continue; }
        if ("warrantyScope".equals(key) && value instanceof WarrantyScope) { warrantyScope((WarrantyScope)value); continue; }
  ...
  public interface Builder extends ThingBuilder<WarrantyPromise> {
    @NotNull Builder durationOfWarranty(@NotNull QuantitativeValue quantitativeValue);
    @NotNull Builder durationOfWarranty(@NotNull QuantitativeValue.Builder quantitativeValue);
    @NotNull Builder warrantyScope(@NotNull WarrantyScope warrantyScope);
    @NotNull Builder warrantyScope(@NotNull WarrantyScope.Builder warrantyScope);
