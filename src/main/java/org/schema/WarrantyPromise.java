...
public class WarrantyPromise extends StructuredValue {
  ...
  public static final class Builder {
    ...
    public WarrantyPromise build() {
      return new WarrantyPromise(sameAs, additionalType, url, alternateName, warrantyScope, potentialAction, description, name, mainEntityOfPage, durationOfWarranty);
    }
    /**
  ...
  protected WarrantyPromise(String sameAs, String additionalType, String url, String alternateName, WarrantyScope warrantyScope, Action potentialAction, String description, String name, StringOrCreativeWork mainEntityOfPage, QuantitativeValue durationOfWarranty) {
