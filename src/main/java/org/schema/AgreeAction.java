...
public class AgreeAction extends ReactAction {
  /**
   * Builder for {@see AgreeAction}
   */
  public static final class Builder {
    public AgreeAction build() {
      return new AgreeAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, object, location, description);
    }
