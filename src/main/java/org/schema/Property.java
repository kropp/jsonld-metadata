...
public class Property extends Intangible {
  ...
  public static final class Builder {
    ...
    public Property build() {
      return new Property(additionalType, url, sameAs, alternateName, supersededBy, name, potentialAction, description, inverseOf, mainEntityOfPage);
    }
    /**
     ...
     * Relates a property to a property that is its inverse. Inverse properties relate the same pairs of items to each other, but in reversed direction. For example, the 'alumni' and 'alumniOf' properties are inverseOf each other. Some properties don't have explicit inverses; in these situations RDFa and JSON-LD syntax for reverse properties can be used.
     */
    public Builder inverseOf(Property property) {
  ...
  protected Property(String additionalType, String url, String sameAs, String alternateName, EnumerationOrProperty supersededBy, String name, Action potentialAction, String description, Property inverseOf, StringOrCreativeWork mainEntityOfPage) {
