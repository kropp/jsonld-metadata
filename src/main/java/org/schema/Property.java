...
public class Property extends Intangible {
   ...
   */
  public EnumerationOrProperty getSupersededBy() {
    return mySupersededBy;
  }
  /**
   * Builder for {@link Property}
   */
  static final class PropertyThingBuilder implements Builder {
    /**
     ...
     * Relates a property to a property that is its inverse. Inverse properties relate the same pairs of items to each other, but in reversed direction. For example, the 'alumni' and 'alumniOf' properties are inverseOf each other. Some properties don't have explicit inverses; in these situations RDFa and JSON-LD syntax for reverse properties can be used.
     */
    @NotNull public Builder inverseOf(Property property) {
     ...
     * Relates a property to a property that is its inverse. Inverse properties relate the same pairs of items to each other, but in reversed direction. For example, the 'alumni' and 'alumniOf' properties are inverseOf each other. Some properties don't have explicit inverses; in these situations RDFa and JSON-LD syntax for reverse properties can be used.
     */
    @NotNull public Builder inverseOf(Property.Builder property) {
  ...
  public interface Builder extends ThingBuilder<Property> {
    @NotNull Builder inverseOf(Property property);
    @NotNull Builder inverseOf(Property.Builder property);
