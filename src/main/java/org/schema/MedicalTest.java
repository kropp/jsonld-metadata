...
public class MedicalTest extends MedicalEntity {
  ...
  public static final class Builder {
    ...
    public MedicalTest build() {
      return new MedicalTest(recognizingAuthority, code, usesDevice, usedToDiagnose, name, mainEntityOfPage, guideline, additionalType, url, sameAs, affectedBy, alternateName, normalRange, study, signDetected, potentialAction, description, relevantSpecialty, medicineSystem);
    }
    /**
  ...
  protected MedicalTest(Organization recognizingAuthority, MedicalCode code, MedicalDevice usesDevice, MedicalCondition usedToDiagnose, String name, StringOrCreativeWork mainEntityOfPage, MedicalGuideline guideline, String additionalType, String url, String sameAs, Drug affectedBy, String alternateName, String normalRange, MedicalStudy study, MedicalSign signDetected, Action potentialAction, String description, MedicalSpecialty relevantSpecialty, MedicineSystem medicineSystem) {
