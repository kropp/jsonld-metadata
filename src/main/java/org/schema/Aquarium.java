...
public class Aquarium extends CivicStructure {
  /**
   * Builder for {@see Aquarium}
   */
  public static final class Builder {
    public Aquarium build() {
      return new Aquarium(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
