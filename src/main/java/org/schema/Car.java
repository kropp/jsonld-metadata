...
public class Car extends Vehicle {
  ...
  public static final class Builder {
    public Car build() {
      return new Car(review, numberOfAxles, productID, offers, vin, fuelEfficiency, fuelConsumption, itemCondition, additionalType, numberOfPreviousOwners, logo, image, vehicleConfiguration, vehicleModelDate, gtin12, isAccessoryOrSparePartFor, vehicleInteriorColor, brand, gtin13, alternateName, isConsumableFor, url, gtin14, gtin8, isSimilarTo, vehicleTransmission, driveWheelConfiguration, depth, mileageFromOdometer, additionalProperty, numberOfDoors, productionDate, width, steeringPosition, vehicleSeatingCapacity, potentialAction, weight, audience, isRelatedTo, fuelType, knownVehicleDamages, cargoVolume, vehicleInteriorType, description, model, mainEntityOfPage, manufacturer, color, purchaseDate, numberOfAirbags, vehicleEngine, numberOfForwardGears, sameAs, aggregateRating, dateVehicleFirstRegistered, height, releaseDate, name, category, sku, mpn, award);
    }
    /**
