...
public class CommentAction extends CommunicateAction {
  ...
  public static final class Builder {
    /**
     * Creates new {@link CommentAction} instance.
     */
    public CommentAction build() {
      return new CommentAction(startTime, resultComment, inLanguage, about, name, error, mainEntityOfPage, sameAs, url, additionalType, recipient, agent, alternateName, description, target, potentialAction, endTime, actionStatus);
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
     ...
     * A sub property of result. The Comment created or sent as a result of this action.
     */
    public Builder resultComment(Comment comment) {
