...
public class CommentAction extends CommunicateAction {
  ...
  /**
   * Builder for {@see CommentAction}
   */
  public static final class Builder {
    public CommentAction build() {
      return new CommentAction(instrument, recipient, mainEntityOfPage, agent, resultComment, endTime, potentialAction, alternateName, participant, additionalType, url, about, sameAs, startTime, actionStatus, inLanguage, result, error, name, image, target, object, location, description);
    }
