...
public class CommentAction extends CommunicateAction {
   ...
   */
  static final class CommentActionThingBuilder implements Builder {
    /**
     * Creates new {@link CommentAction} instance.
     */
    public CommentAction build() {
      return new CommentAction(resultComment, about, inLanguage, recipient, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of result. The Comment created or sent as a result of this action.
     */
    @NotNull public Builder resultComment(Comment comment) {
     ...
     * A sub property of result. The Comment created or sent as a result of this action.
     */
    @NotNull public Builder resultComment(Comment.Builder comment) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<CommentAction> {
    @NotNull Builder resultComment(Comment comment);
    @NotNull Builder resultComment(Comment.Builder comment);
