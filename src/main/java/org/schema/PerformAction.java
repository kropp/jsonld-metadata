...
public class PerformAction extends PlayAction {
   ...
   */
  public static final class PerformActionThingBuilder implements Builder {
    /**
     ...
     * A sub property of location. The entertainment business where the action occurred.
     */
    public Builder entertainmentBusiness(EntertainmentBusiness entertainmentBusiness) {
     ...
     * A sub property of location. The entertainment business where the action occurred.
     */
    public Builder entertainmentBusiness(EntertainmentBusiness.Builder entertainmentBusiness) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  Builder entertainmentBusiness(EntertainmentBusiness entertainmentBusiness);
  Builder entertainmentBusiness(EntertainmentBusiness.Builder entertainmentBusiness);
