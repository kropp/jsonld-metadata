...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("entertainmentBusiness".equals(key) && value instanceof EntertainmentBusiness) { entertainmentBusiness((EntertainmentBusiness)value); continue; }
  ...
  public interface Builder extends ThingBuilder<PerformAction> {
    @NotNull Builder entertainmentBusiness(@NotNull EntertainmentBusiness entertainmentBusiness);
    @NotNull Builder entertainmentBusiness(@NotNull EntertainmentBusiness.Builder entertainmentBusiness);
