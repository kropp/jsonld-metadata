...
public class PerformAction extends PlayAction {
  ...
  public EntertainmentBusiness getEntertainmentBusiness() {
    return myEntertainmentBusiness;
  }
  /**
   * Builder for {@link PerformAction}
   */
  static final class PerformActionThingBuilder implements Builder {
    /**
     * Creates new {@link PerformAction} instance.
     */
    public PerformAction build() {
      return new PerformAction(entertainmentBusiness, audience, event, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of location. The entertainment business where the action occurred.
     */
    @NotNull public Builder entertainmentBusiness(EntertainmentBusiness entertainmentBusiness) {
     ...
     * A sub property of location. The entertainment business where the action occurred.
     */
    @NotNull public Builder entertainmentBusiness(EntertainmentBusiness.Builder entertainmentBusiness) {
      return this.entertainmentBusiness(entertainmentBusiness.build());
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<PerformAction> {
    @NotNull Builder entertainmentBusiness(EntertainmentBusiness entertainmentBusiness);
    @NotNull Builder entertainmentBusiness(EntertainmentBusiness.Builder entertainmentBusiness);
