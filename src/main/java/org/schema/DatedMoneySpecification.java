...
public class DatedMoneySpecification extends StructuredValue {
  ...
  public static final class Builder {
    ...
    public DatedMoneySpecification build() {
      return new DatedMoneySpecification(url, sameAs, additionalType, amount, alternateName, endDate, potentialAction, description, name, mainEntityOfPage, startDate, currency);
    }
    /**
     * URL of the item.
     */
  ...
  protected DatedMoneySpecification(String url, String sameAs, String additionalType, Number amount, String alternateName, java.util.Date endDate, Action potentialAction, String description, String name, StringOrCreativeWork mainEntityOfPage, java.util.Date startDate, String currency) {
