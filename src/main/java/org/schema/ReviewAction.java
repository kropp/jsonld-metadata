...
public class ReviewAction extends AssessAction {
   ...
   */
  static final class ReviewActionThingBuilder implements Builder {
    /**
     * Creates new {@link ReviewAction} instance.
     */
    public ReviewAction build() {
      return new ReviewAction(resultReview, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of result. The review that resulted in the performing of the action.
     */
    ...
    @NotNull public Builder resultReview(@NotNull Review.Builder review) {
      return this.resultReview(review.build());
    }
    /**
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("resultReview".equals(key) && value instanceof Review) { resultReview((Review)value); continue; }
  ...
  public interface Builder extends ThingBuilder<ReviewAction> {
    @NotNull Builder resultReview(@NotNull Review review);
    @NotNull Builder resultReview(@NotNull Review.Builder review);
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (myResultReview != null ? myResultReview.hashCode() : 0);
    return result;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    ReviewAction reviewAction = (ReviewAction) o;
    if (!super.equals(o)) return false;
    if (myResultReview != null ? !myResultReview.equals(reviewAction.myResultReview) : reviewAction.myResultReview != null) return false;
    return true;
  }
