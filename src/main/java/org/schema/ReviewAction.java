...
public class ReviewAction extends AssessAction {
   ...
   */
  public static final class ReviewActionThingBuilder implements Builder {
    /**
     ...
     * A sub property of result. The review that resulted in the performing of the action.
     */
    public Builder resultReview(Review.Builder review) {
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  Builder resultReview(Review review);
  Builder resultReview(Review.Builder review);
