...
public class ReviewAction extends AssessAction {
  ...
  public static final class Builder {
    ...
    public ReviewAction build() {
      return new ReviewAction(resultReview, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
     * A sub property of result. The review that resulted in the performing of the action.
     */
