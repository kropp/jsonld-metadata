...
public class TaxiService extends Service {
   ...
   */
  public static final class TaxiServiceThingBuilder implements Builder {
    /**
     ...
     * A means of accessing the service (e.g. a phone bank, a web site, a location, etc.).
     */
    public Builder availableChannel(ServiceChannel.Builder serviceChannel) {
     ...
     * The tangible thing generated by the service, e.g. a passport, permit, etc.
     */
    public Builder serviceOutput(Thing.Builder thing) {
     ...
     * The geographic area where the service is provided.
     */
    public Builder serviceArea(AdministrativeArea.Builder administrativeArea) {
  ...
  Builder availableChannel(ServiceChannel serviceChannel);
  Builder availableChannel(ServiceChannel.Builder serviceChannel);
  Builder serviceOutput(Thing thing);
  Builder serviceOutput(Thing.Builder thing);
  Builder review(Review review);
  Builder review(Review.Builder review);
  Builder serviceArea(AdministrativeArea administrativeArea);
  Builder serviceArea(AdministrativeArea.Builder administrativeArea);
