...
public class TaxiService extends Service {
  ...
  public static final class Builder {
    ...
    public TaxiService build() {
      return new TaxiService(aggregateRating, availableChannel, serviceOutput, review, serviceArea, serviceType, provider, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
