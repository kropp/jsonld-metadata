...
public class TaxiService extends Service {
  /**
   * Builder for {@see TaxiService}
   */
  public static final class Builder {
    public TaxiService build() {
      return new TaxiService(review, availableChannel, mainEntityOfPage, alternateName, potentialAction, url, additionalType, serviceArea, sameAs, aggregateRating, serviceOutput, name, image, serviceType, description, provider);
    }
    /**
