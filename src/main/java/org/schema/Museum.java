...
public class Museum extends CivicStructure {
  /**
   * Builder for {@see Museum}
   */
  public static final class Builder {
    public Museum build() {
      return new Museum(event, openingHoursSpecification, review, faxNumber, mainEntityOfPage, globalLocationNumber, openingHours, telephone, alternateName, potentialAction, photo, additionalType, url, geo, sameAs, logo, aggregateRating, image, name, address, additionalProperty, isicV4, containedIn, description, hasMap);
    }
    /**
