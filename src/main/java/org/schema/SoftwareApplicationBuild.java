...
public class SoftwareApplicationBuild extends SoftwareApplication {
   ...
   */
  static final class SoftwareApplicationBuildThingBuilder implements Builder {
    /**
     ...
     * Software application product this build belongs to.
     */
    @NotNull public Builder softwareApplication(SoftwareApplication softwareApplication) {
     ...
     * Software application product this build belongs to.
     */
    @NotNull public Builder softwareApplication(SoftwareApplication.Builder softwareApplication) {
      return this.softwareApplication(softwareApplication.build());
    }
    /**
     * Project this build belongs to.
     */
    @NotNull public Builder project(Project project) {
     ...
     * Project this build belongs to.
     */
    @NotNull public Builder project(Project.Builder project) {
      return this.project(project.build());
    }
    /**
     * Type of software application, e.g. "Game, Multimedia".
     */
    @NotNull public Builder applicationCategory(String applicationCategory) {
     ...
     */
    @NotNull public Builder applicationSubCategory(String applicationSubCategory) {
     ...
     */
    @NotNull public Builder applicationSuite(String applicationSuite) {
     ...
     */
    @NotNull public Builder countriesNotSupported(String countriesNotSupported) {
     ...
     */
    @NotNull public Builder countriesSupported(String countriesSupported) {
     ...
     */
    @NotNull public Builder availableOnDevice(String availableOnDevice) {
     ...
     */
    @NotNull public Builder downloadUrl(String downloadUrl) {
     ...
     */
    @NotNull public Builder featureList(String featureList) {
     ...
     */
    @NotNull public Builder fileFormat(String fileFormat) {
     ...
     */
    @NotNull public Builder fileSize(int fileSize) {
     ...
     */
    @NotNull public Builder installUrl(String installUrl) {
     ...
     */
    @NotNull public Builder operatingSystem(String operatingSystem) {
     ...
     */
    @NotNull public Builder permissions(String permissions) {
     ...
     */
    @NotNull public Builder processorRequirements(String processorRequirements) {
     ...
     */
    @NotNull public Builder releaseNotes(String releaseNotes) {
     ...
     */
    @NotNull public Builder softwareRequirements(String softwareRequirements) {
     ...
     */
    @NotNull public Builder screenshot(ImageObject imageObject) {
     ...
     * A link to a screenshot image of the app.
     */
    @NotNull public Builder screenshot(ImageObject.Builder imageObject) {
      return this.screenshot(imageObject.build());
    }
    /**
     * A link to a screenshot image of the app.
     */
    @NotNull public Builder screenshot(String screenshot) {
      if (this.screenshot == null) this.screenshot = new ImageObjectOrString();
     ...
     */
    @NotNull public Builder softwareVersion(String softwareVersion) {
     ...
     */
    @NotNull public Builder softwareHelp(CreativeWork creativeWork) {
     ...
     * Software application help.
     */
    @NotNull public Builder softwareHelp(CreativeWork.Builder creativeWork) {
  ...
  public interface Builder extends ThingBuilder<SoftwareApplicationBuild> {
    @NotNull Builder softwareApplication(SoftwareApplication softwareApplication);
    @NotNull Builder softwareApplication(SoftwareApplication.Builder softwareApplication);
    @NotNull Builder project(Project project);
    @NotNull Builder project(Project.Builder project);
    @NotNull Builder applicationCategory(String applicationCategory);
    @NotNull Builder applicationSubCategory(String applicationSubCategory);
    @NotNull Builder applicationSuite(String applicationSuite);
    @NotNull Builder countriesNotSupported(String countriesNotSupported);
    @NotNull Builder countriesSupported(String countriesSupported);
    @NotNull Builder availableOnDevice(String availableOnDevice);
    @NotNull Builder downloadUrl(String downloadUrl);
    @NotNull Builder featureList(String featureList);
    @NotNull Builder fileFormat(String fileFormat);
    @NotNull Builder fileSize(int fileSize);
    @NotNull Builder installUrl(String installUrl);
    @NotNull Builder memoryRequirements(String memoryRequirements);
    @NotNull Builder operatingSystem(String operatingSystem);
    @NotNull Builder permissions(String permissions);
    @NotNull Builder processorRequirements(String processorRequirements);
    @NotNull Builder releaseNotes(String releaseNotes);
    @NotNull Builder softwareRequirements(String softwareRequirements);
    @NotNull Builder screenshot(ImageObject imageObject);
    @NotNull Builder screenshot(ImageObject.Builder imageObject);
    @NotNull Builder screenshot(String screenshot);
    @NotNull Builder softwareVersion(String softwareVersion);
    @NotNull Builder storageRequirements(String storageRequirements);
    ...
    @NotNull Builder softwareHelp(CreativeWork creativeWork);
    @NotNull Builder softwareHelp(CreativeWork.Builder creativeWork);
