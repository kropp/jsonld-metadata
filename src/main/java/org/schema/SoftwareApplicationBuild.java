...
public class SoftwareApplicationBuild extends SoftwareApplication {
   ...
   */
  public static final class SoftwareApplicationBuildThingBuilder implements Builder {
    /**
     ...
     * Software application product this build belongs to.
     */
    public Builder softwareApplication(SoftwareApplication.Builder softwareApplication) {
     ...
     * Project this build belongs to.
     */
    public Builder project(Project.Builder project) {
  ...
  Builder softwareApplication(SoftwareApplication softwareApplication);
  Builder softwareApplication(SoftwareApplication.Builder softwareApplication);
  Builder project(Project project);
  Builder project(Project.Builder project);
