...
public class TransferAction extends Action {
   ...
   */
  static final class TransferActionThingBuilder implements Builder {
    /**
     * Creates new {@link TransferAction} instance.
     */
    public TransferAction build() {
      return new TransferAction(fromLocation, toLocation, agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction, id);
    }
    /**
     * A sub property of location. The original location of the object or the agent before the action.
     */
...
Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
  ...
  public interface Builder extends ThingBuilder<TransferAction> {
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myFromLocation != null ? !myFromLocation.equals(transferAction.myFromLocation) : transferAction.myFromLocation != null) return false;
    if (myToLocation != null ? !myToLocation.equals(transferAction.myToLocation) : transferAction.myToLocation != null) return false;
    return true;
  }
