...
public class TransferAction extends Action {
  ...
  public static final class Builder {
    ...
    public TransferAction build() {
      return new TransferAction(startTime, toLocation, name, error, mainEntityOfPage, fromLocation, url, sameAs, additionalType, agent, alternateName, potentialAction, target, description, endTime, actionStatus);
    }
    /**
