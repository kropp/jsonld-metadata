...
public class DriveWheelConfigurationValue extends QualitativeValue {
  ...
  public static final class Builder {
    ...
    public DriveWheelConfigurationValue build() {
      return new DriveWheelConfigurationValue(nonEqual, valueReference, equal, greaterOrEqual, name, mainEntityOfPage, lesserOrEqual, url, additionalType, sameAs, alternateName, supersededBy, greater, potentialAction, description, additionalProperty, lesser);
    }
    /**
