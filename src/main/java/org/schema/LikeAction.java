...
public class LikeAction extends ReactAction {
  /**
   * Builder for {@see LikeAction}
   */
  public static final class Builder {
    public LikeAction build() {
      return new LikeAction(instrument, mainEntityOfPage, agent, endTime, potentialAction, alternateName, participant, additionalType, url, sameAs, startTime, actionStatus, result, error, name, image, target, object, location, description);
    }
