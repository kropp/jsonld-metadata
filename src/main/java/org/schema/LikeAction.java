...
public class LikeAction extends ReactAction {
  ...
  public static final class Builder {
    ...
    public LikeAction build() {
      return new LikeAction(agent, endTime, startTime, actionStatus, error, target, additionalType, alternateName, description, mainEntityOfPage, name, sameAs, url, potentialAction);
    }
    /**
