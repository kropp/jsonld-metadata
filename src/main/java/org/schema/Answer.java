...
public class Answer extends Comment implements SuggestedAnswer {
  ...
  public static final class Builder {
    /**
     * Creates new {@link Answer} instance.
     */
    public Answer build() {
      return new Answer(accessibilityAPI, aggregateRating, hasPart, review, datePublished, comment, schemaVersion, video, award, editor, workExample, potentialAction, producer, upvoteCount, publisher, sourceOrganization, learningResourceType, genre, translator, publishingPrinciples, recordedAt, dateModified, inLanguage, commentCount, mentions, audience, url, headline, interactivityType, character, associatedMedia, contentRating, description, offers, copyrightHolder, accessibilityControl, citation, educationalUse, keywords, educationalAlignment, text, parentItem, about, contentLocation, author, accessibilityHazard, version, accountablePerson, additionalType, sameAs, thumbnailUrl, publication, encoding, timeRequired, accessibilityFeature, audio, typicalAgeRange, dateCreated, provider, mainEntity, alternativeHeadline, name, license, mainEntityOfPage, discussionUrl, copyrightYear, isBasedOnUrl, isFamilyFriendly, exampleOfWork, downvoteCount, alternateName, releasedEvent, creator, contributor);
    }
    /**
     ...
     */
    public Builder parentItem(Question question) {
      this.parentItem = question;
      return this;
    }
    /**
