...
public class Answer extends Comment implements SuggestedAnswer {
   ...
   */
  public static final class AnswerThingBuilder implements Builder {
    /**
     ...
     * The parent of a question, answer or item in general.
     */
    public Builder parentItem(Question.Builder question) {
  ...
  Builder parentItem(Question question);
  Builder parentItem(Question.Builder question);
