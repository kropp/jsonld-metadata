...
public class Answer extends Comment implements SuggestedAnswer {
  ...
  static final class AnswerThingBuilder implements Builder {
    ...
    @Override public void fromMap(java.util.Map<String, Object> map) {
      for (java.util.Map.Entry<String, Object> entry : map.entrySet()) {
        ...
        if ("parentItem".equals(key) && value instanceof Question) { parentItem((Question)value); continue; }
  ...
  public interface Builder extends ThingBuilder<Answer> {
    ...
    @NotNull Builder parentItem(@NotNull Question question);
    @NotNull Builder parentItem(@NotNull Question.Builder question);
