...
public class Answer extends Comment implements SuggestedAnswer {
  ...
  static final class AnswerThingBuilder implements Builder {
     ...
     */
    @NotNull public Builder parentItem(Question question) {
     ...
     * The parent of a question, answer or item in general.
     */
    @NotNull public Builder parentItem(Question.Builder question) {
      return this.parentItem(question.build());
    }
    /**
  ...
  public interface Builder extends ThingBuilder<Answer> {
    @NotNull Builder upvoteCount(int upvoteCount);
    @NotNull Builder downvoteCount(int downvoteCount);
    @NotNull Builder parentItem(Question question);
    @NotNull Builder parentItem(Question.Builder question);
